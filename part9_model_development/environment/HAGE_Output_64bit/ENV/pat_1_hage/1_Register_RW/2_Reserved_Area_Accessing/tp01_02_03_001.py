...
for i in range(0,1):
 SCHEAP.sc_start (50)
 SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x1, iodef.RESERVEDAREA0_ADDR + i*4, 0x4, 0xFFFFFF, 0x0, 0x0)
 SCHEAP.sc_start (50)
 SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x0, iodef.RESERVEDAREA0_ADDR + i*4, 0x4, 0xFFFFFF, 0x0, 0x0)
 SCHEAP.sc_start (50)
