...
//     %%REG     TSCR2D        TSCR2D        16|8          8|16|32       16            0x0D4        -             -             -             -         R|W1:0        0x0000        TRUE          -
// 
// 
// %REG_NAME     TCRD
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file atu5010_timerd_sub_regif.h
...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5010_TIMERD_SUB_REGIF_H__
#define __ATU5010_TIMERD_SUB_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5010_TIMERD_SUB model
class Catu5010_timerd_sub_regif
...
public:
    Catu5010_timerd_sub_regif(std::string name, uint buswidth);
    ~Catu5010_timerd_sub_regif();
...
protected:
    ...
    vpcl::re_register *ONCAPD1   [4];
    vpcl::re_register *ONCAPD2   [4];
    vpcl::re_register *OFCAPD1   [4];
    vpcl::re_register *OFCAPD2   [4];
    ...
    scml2::reg<uint>      *CW_ONCAPD1   [4];
    scml2::reg<uint>      *CW_ONCAPD2   [4];
    scml2::reg<uint>      *CW_OFCAPD1   [4];
    scml2::reg<uint>      *CW_OFCAPD2   [4];
    ...
    uint ONCAPD1_ONCAPD1[4];
    uint ONCAPD2_ONCAPD2[4];
    uint OFCAPD1_OFCAPD1[4];
    uint OFCAPD2_OFCAPD2[4];
    uint TSR2D_FEFD3  ;
    uint TSR2D_FEFD2  ;
    uint TSR2D_FEFD1  ;
    uint TSR2D_FEFD0  ;
    ...
    virtual void cb_OFMICNTD_OFMICNTD(RegCBstr str) = 0;
    virtual void cb_ONMICNTD_ONMICNTD(RegCBstr str) = 0;
    virtual void cb_OTONMICNTD_OTONMICNTD(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Catu5010_timerd_sub_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5010_timerd_sub_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5010_TIMERD_SUB_REG_DEF_H__
