// ---------------------------------------------------------------------
// $Id: MECCCAP_CFL_FCC2_Func.h,v 1.5 2019/09/06 08:33:53 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __MECCCAP_CFL_FCC2_FUNC_H__
#define __MECCCAP_CFL_FCC2_FUNC_H__

#include "BusSlaveFuncIf.h"
#include "mecccap_cfl_fcc2_regif.h"
#include "ECC_CFLASH_E2_FCC2_AgentController.h"
#include "global.h"

class MECCCAP_CFL_FCC2_Func: public Cmecccap_cfl_fcc2_regif
                ,public BusSlaveFuncIf
{
public:
    SC_HAS_PROCESS (MECCCAP_CFL_FCC2_Func);
    MECCCAP_CFL_FCC2_Func(std::string name, ECC_CFLASH_E2_FCC2_AgentController* CFLASHAgentController);
    ~MECCCAP_CFL_FCC2_Func();
...
#endif //__MECCCAP_CFL_FCC2_FUNC_H__
