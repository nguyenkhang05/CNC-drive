// -----------------------------------------------------------------------------
// $Id: atu5_timerb_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERB_REGIF_H__
#define __ATU5_TIMERB_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERB model
class Catu5_timerb_regif
...
public:
    Catu5_timerb_regif(std::string name, uint buswidth);
    ~Catu5_timerb_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timerb_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timerb_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5_TIMERB_REG_DEF_H__
