...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __ADC_U2A_REGIF_H__
#define __ADC_U2A_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ADC_U2A model
class Cadc_u2a_regif
...
protected:
    ...
    typedef void (Cadc_u2a_regif::* ptrRegValueIDFunc) (std::string);
    ptrRegValueIDFunc mNotifyRegValueIDAPI;
    virtual void NotifyRegValueID(const std::string reg_val_id) = 0;
#endif

public:
    Cadc_u2a_regif(std::string name, uint buswidth);
    ~Cadc_u2a_regif();
...
protected:
    ...
    virtual void cb_GTMENTSGER_GTMENTSG0E(RegCBstr str) = 0;
    ...
    virtual void cb_VCLMINTER3_ADUL64IE(RegCBstr str) = 0;
    ...
    virtual void cb_VCLMSCR3_VC64LMSC(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cadc_u2a_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cadc_u2a_regif::*) (RegCBstr)> > mRdCbAPI;
    std::map<std::string, std::map<std::string, void (Cadc_u2a_regif::*) (RegCBstr)> > mWrDbgCbAPI;
    std::map<std::string, std::map<std::string, void (Cadc_u2a_regif::*) (RegCBstr)> > mRdDbgCbAPI;
