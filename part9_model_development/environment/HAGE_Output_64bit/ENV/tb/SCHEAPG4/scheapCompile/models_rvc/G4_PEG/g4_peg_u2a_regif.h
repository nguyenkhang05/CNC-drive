// -----------------------------------------------------------------------------
// $Id: g4_peg_u2a_regif.h,v 1.6 2020/01/14 02:39:30 nhutminhdang Exp $
//
...
/// $Author: nhutminhdang $
////////////////////////////////////////////////////////////////////////////////
#ifndef __G4_PEG_U2A_REGIF_H__
#define __G4_PEG_U2A_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of G4_PEG_U2A model
class Cg4_peg_u2a_regif
...
public:
    Cg4_peg_u2a_regif(std::string name, uint buswidth);
    ~Cg4_peg_u2a_regif();

protected:
    vpcl::re_register *PEGKCPROT;
    vpcl::re_register *PEGPROT  [8];
    vpcl::re_register *PEGSPID  [8];
    vpcl::re_register *PEGBAD   [8];
    vpcl::re_register *PEGADV   [8];

    #ifdef USR_CWR_SYSTEMC
    scml2::memory<uint> cwmem;
    scml2::reg<uint> *CW_PEGKCPROT;
    scml2::reg<uint> *CW_PEGPROT  [8];
    scml2::reg<uint> *CW_PEGSPID  [8];
    scml2::reg<uint> *CW_PEGBAD   [8];
    scml2::reg<uint> *CW_PEGADV   [8];
    #endif
    ...
    std::map<std::string, std::map<std::string, void (Cg4_peg_u2a_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cg4_peg_u2a_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__G4_PEG_U2A_REG_DEF_H__
