...
//
// Input file : sarad_info.txt
////////////////////////////////////////////////////////////////////////////////
#ifndef __SARAD_REGIF_H__
#define __SARAD_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of SARAD model
class Csarad_regif
...
public:
    Csarad_regif(std::string name, uint buswidth);
    ~Csarad_regif();

protected:
    vpcl::re_register *ADSYNSTCR ;
    vpcl::re_register *ADTSYNSTCR;
    vpcl::re_register *RDRVR     ;
    ...
    uint ADSYNSTCR_ADSTART;
    uint ADTSYNSTCR_ADTSTART;
    uint RDRVR_KEY ;
    uint RDRVR_RVRS;
    uint VMONVDCR1_VDE1;
    uint VMONVDCR2_VDE2;
    ...
    std::map<std::string, std::map<std::string, void (Csarad_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Csarad_regif::*) (RegCBstr)> > mRdCbAPI;
