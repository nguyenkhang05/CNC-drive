// ---------------------------------------------------------------------
// $Id: ECC_LRAM_E2_FCC2.h,v 1.8 2019/09/06 08:49:32 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_LRAM_E2_FCC2_H__
#define __ECC_LRAM_E2_FCC2_H__
...
#define DEFAULT_AWIDTH_MSB_LR0 15
...
#define DEFAULT_AWIDTH_MSB_LR1 23
...
class ECCCNT_LR0_PEn_FCC2_Func;
class MECCCAP_LR0_PEn_FCC2_Func;
class MECCCAP_LR1_FCC2_Func;

class ECC_LRAM_E2_FCC2: public sc_module
            ,public ECC_LRAM_E2_FCC2_AgentController
...
public:
    ...
    ECCCNT_LR0_PEn_FCC2_Func     **mpECCCNT_LR0Func;  // Pointer of ECCCNT_LR0_PEn Func
    MECCCAP_LR0_PEn_FCC2_Func    **mpMECCCAP_LR0Func; // Pointer of MECCCAP_LR0_PEn Func
    MECCCAP_LR1_FCC2_Func        *mpMECCCAP_LR1Func; // Pointer of MECCCAP_LR1 Func
...
private:
    ...
    // Overwrite firtual functions of ECC_LRAM_E2_FCC2_AgentController
...
public:
    SC_HAS_PROCESS (ECC_LRAM_E2_FCC2);
    ECC_LRAM_E2_FCC2 (sc_module_name name, const uint8_t iPE_NUM, const unsigned int rLatency, const unsigned int wLatency);
    ~ECC_LRAM_E2_FCC2 ();
