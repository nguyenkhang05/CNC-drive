// ---------------------------------------------------------------------
// $Id: AHBFSGuard.h,v 1.5 2014/04/11 05:42:45 duymai Exp $
//
...
#ifndef __AHBFSGUARD_H__
#define __AHBFSGUARD_H__
#include "BusSlaveFuncIf.h"
#include "CmErrMsg.h" // for WinMsg
#include "Common.h"
#include "AhgAgentController.h"
#include "ahbfsguard_regif.h"
#include <map>

/// AHBFSGUARD model class
class AHBFSGuard:   public Cahbfsguard_regif
                   ,public BusSlaveFuncIf
{
public:
    AHBFSGuard(std::string name, 
