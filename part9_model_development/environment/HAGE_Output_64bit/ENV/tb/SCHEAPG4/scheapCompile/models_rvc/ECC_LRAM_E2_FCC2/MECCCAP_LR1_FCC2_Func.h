// ---------------------------------------------------------------------
// $Id: MECCCAP_LR1_FCC2_Func.h,v 1.5 2019/09/06 08:49:32 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __MECCCAP_LR1_FCC2_FUNC_H__
#define __MECCCAP_LR1_FCC2_FUNC_H__

#include "BusSlaveFuncIf.h"
#include "mecccap_lr1_fcc2_regif.h"
#include "ECC_LRAM_E2_FCC2_AgentController.h"
#include "global.h"

class MECCCAP_LR1_FCC2_Func: public Cmecccap_lr1_fcc2_regif
                ,public BusSlaveFuncIf
{
public:
    SC_HAS_PROCESS (MECCCAP_LR1_FCC2_Func);
    MECCCAP_LR1_FCC2_Func(std::string name, ECC_LRAM_E2_FCC2_AgentController* LRAMAgentController);
    ~MECCCAP_LR1_FCC2_Func();
...
#endif //__MECCCAP_LR1_FCC2_FUNC_H__
