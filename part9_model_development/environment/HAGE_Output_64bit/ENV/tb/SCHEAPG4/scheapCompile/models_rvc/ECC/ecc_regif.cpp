...
/// @return none
Cecc_regif::Cecc_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    EC710CTL = new vpcl::re_register(0x0000, this, "EC710CTL", name.c_str());
    EC710TMC = new vpcl::re_register(0x0004, this, "EC710TMC", name.c_str());
    EC710TRC = new vpcl::re_register(0x0008, this, "EC710TRC", name.c_str());
    EC710TED = new vpcl::re_register(0x000C, this, "EC710TED", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_EC710EAD; i++) {
        str_tmp.str("");
        str_tmp<<"EC710EAD"<< i;
        EC710EAD[i] = new vpcl::re_register((0x0010) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_EC710TMC_, "EC710TMC_", 0x0004);
    CW_EC710TMC = new scml2::bitfield<uint>(EC710TMC->name(), CW_EC710TMC_       ,  0, 16);
    cw_instantiate_reg(CW_EC710CTL  , EC710CTL->name(), EC710CTL->addr());
    cw_instantiate_reg(CW_EC710TRC  , EC710TRC->name(), EC710TRC->addr());
    cw_instantiate_reg(CW_EC710TED  , EC710TED->name(), EC710TED->addr());
    for(uint i = 0; i < emNUM_EC710EAD; i++) cw_instantiate_reg(CW_EC710EAD  [i], EC710EAD[i]->name(), EC710EAD[i]->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(EC710CTL  , mCurReg, 0,  4, "32|16|8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(EC710TMC  , mCurReg, 0,  2, "32|16|8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(EC710TRC  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(EC710TED  , mCurReg, 0,  4,      "32", "8|16|32");
    for(uint i = 0; i < emNUM_EC710EAD; i++) mCurReg = mRegArray[index++] = new SRegList(EC710EAD  [i], mCurReg, i,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*EC710CTL  ) (31, 31, "ECDEDF7" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (30, 30, "ECSEDF7" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (29, 29, "ECDEDF6" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (28, 28, "ECSEDF6" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (27, 27, "ECDEDF5" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (26, 26, "ECSEDF5" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (25, 25, "ECDEDF4" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (24, 24, "ECSEDF4" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (23, 23, "ECDEDF3" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (22, 22, "ECSEDF3" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (21, 21, "ECDEDF2" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (20, 20, "ECSEDF2" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (19, 19, "ECDEDF1" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (18, 18, "ECSEDF1" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (17, 17, "ECDEDF0" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (16, 16, "ECSEDF0" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (15, 15, "EMCA1"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (14, 14, "EMCA0"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (11, 11, "ECOVFF"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) (10, 10, "ECER2C"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 9,  9, "ECER1C"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 7,  7, "ECTHM"   , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710CTL  ) ( 6,  6, "ECERVF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 5,  5, "EC1ECP"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710CTL  ) ( 4,  4, "EC2EDIC" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 3,  3, "EC1EDIC" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 2,  2, "ECER2F"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 1,  1, "ECER1F"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710CTL  ) ( 0,  0, "ECEMF"   , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710TMC  ) (15, 15, "ETMA1"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710TMC  ) (14, 14, "ETMA0"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710TMC  ) ( 7,  7, "ECTMCE"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710TMC  ) ( 4,  4, "ECTRRS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710TMC  ) ( 3,  3, "ECREOS"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710TMC  ) ( 2,  2, "ECENS"   , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710TMC  ) ( 1,  1, "ECDCS"   , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710TMC  ) ( 0,  0, "ECREIS"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*EC710TRC  ) (30, 24, "ECSYND"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710TRC  ) (22, 16, "ECHORD"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710TRC  ) (14,  8, "ECECRD"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*EC710TRC  ) ( 6,  0, "ECERDB"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EC710TED  ) (31,  0, "ECEDB"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_EC710EAD; i++) {
        (*EC710EAD  [i]) (30,  0, "ECEAD"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["EC710CTL"]["EMCA1" ] = &Cecc_regif::cb_EC710CTL_EMCA1;
    mWrCbAPI["EC710TMC"]["ETMA1" ] = &Cecc_regif::cb_EC710TMC_ETMA1;
    mWrCbAPI["EC710TRC"]["ECERDB"] = &Cecc_regif::cb_EC710TRC_ECERDB;
    mWrCbAPI["EC710TED"]["ECEDB" ] = &Cecc_regif::cb_EC710TED_ECEDB;

    mRdCbAPI["EC710CTL"]["EMCA1" ] = &Cecc_regif::cb_EC710CTL_EMCA1;
    mRdCbAPI["EC710TMC"]["ETMA1" ] = &Cecc_regif::cb_EC710TMC_ETMA1;
    mRdCbAPI["EC710TRC"]["ECERDB"] = &Cecc_regif::cb_EC710TRC_ECERDB;
    mRdCbAPI["EC710TED"]["ECEDB" ] = &Cecc_regif::cb_EC710TED_ECEDB;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecc_regif::~Cecc_regif()
{
...
Cecc_regif::uint Cecc_regif::bit_select(
...
bool Cecc_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecc_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                            const unsigned char *p_data,   ///< [in] Writing data
                            cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                            unsigned char *p_data,   ///< [out] Reading data
                            cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                const unsigned char *p_data,  ///< [in] Writing data
                                cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                unsigned char *p_data,   ///< [out] Reading data
                                cuint size,              ///< [in]  Data size (byte)
                                bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecc_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                             unsigned char *p_data,          ///< [out] Reading data
                             cuint size,                     ///< [in]  Data size (byte)
...
bool Cecc_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                             const unsigned char *p_data,      ///< [in] Writing data
                             cuint size,                       ///< [in] Data size (byte)
                             cuint reg_index,                  ///< [in] Register index
...
bool Cecc_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return string
std::string Cecc_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecc_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecc_regif::InitLocalVal()
{
    // Initialize local variables
    EC710CTL_ECDEDF7 = 0x0;
    EC710CTL_ECSEDF7 = 0x0;
    EC710CTL_ECDEDF6 = 0x0;
    EC710CTL_ECSEDF6 = 0x0;
    EC710CTL_ECDEDF5 = 0x0;
    EC710CTL_ECSEDF5 = 0x0;
    EC710CTL_ECDEDF4 = 0x0;
    EC710CTL_ECSEDF4 = 0x0;
    EC710CTL_ECDEDF3 = 0x0;
    EC710CTL_ECSEDF3 = 0x0;
    EC710CTL_ECDEDF2 = 0x0;
    EC710CTL_ECSEDF2 = 0x0;
    EC710CTL_ECDEDF1 = 0x0;
    EC710CTL_ECSEDF1 = 0x0;
    EC710CTL_ECDEDF0 = 0x0;
    EC710CTL_ECSEDF0 = 0x0;
    EC710CTL_EMCA1 = 0x0;
    EC710CTL_EMCA0 = 0x0;
    EC710CTL_ECOVFF = 0x0;
    EC710CTL_ECER2C = 0x0;
    ...
    EC710CTL_ECERVF = 0x0;
    EC710CTL_EC1ECP = 0x0;
    EC710CTL_EC2EDIC = 0x1;
    EC710CTL_EC1EDIC = 0x0;
    EC710CTL_ECER2F = 0x0;
    EC710CTL_ECER1F = 0x0;
    EC710CTL_ECEMF = 0x0;
    EC710TMC_ETMA1 = 0x0;
    ...
    EC710TED_ECEDB = 0x0;
    for(uint i = 0; i < emNUM_EC710EAD; i++) {
        EC710EAD_ECEAD[i] = 0x0;
    }
}

/// Update bit value to local value
/// @return None
void Cecc_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        EC710CTL_ECDEDF7             = (*EC710CTL)["ECDEDF7" ];
        EC710CTL_ECSEDF7             = (*EC710CTL)["ECSEDF7" ];
        EC710CTL_ECDEDF6             = (*EC710CTL)["ECDEDF6" ];
        EC710CTL_ECSEDF6             = (*EC710CTL)["ECSEDF6" ];
        EC710CTL_ECDEDF5             = (*EC710CTL)["ECDEDF5" ];
        EC710CTL_ECSEDF5             = (*EC710CTL)["ECSEDF5" ];
        EC710CTL_ECDEDF4             = (*EC710CTL)["ECDEDF4" ];
        EC710CTL_ECSEDF4             = (*EC710CTL)["ECSEDF4" ];
        EC710CTL_ECDEDF3             = (*EC710CTL)["ECDEDF3" ];
        EC710CTL_ECSEDF3             = (*EC710CTL)["ECSEDF3" ];
        EC710CTL_ECDEDF2             = (*EC710CTL)["ECDEDF2" ];
        EC710CTL_ECSEDF2             = (*EC710CTL)["ECSEDF2" ];
        EC710CTL_ECDEDF1             = (*EC710CTL)["ECDEDF1" ];
        EC710CTL_ECSEDF1             = (*EC710CTL)["ECSEDF1" ];
        EC710CTL_ECDEDF0             = (*EC710CTL)["ECDEDF0" ];
        EC710CTL_ECSEDF0             = (*EC710CTL)["ECSEDF0" ];
        EC710CTL_EMCA1               = (*EC710CTL)["EMCA1"   ];
        EC710CTL_EMCA0               = (*EC710CTL)["EMCA0"   ];
        EC710CTL_ECOVFF              = (*EC710CTL)["ECOVFF"  ];
        EC710CTL_ECER2C              = (*EC710CTL)["ECER2C"  ];
        EC710CTL_ECER1C              = (*EC710CTL)["ECER1C"  ];
        EC710CTL_ECTHM               = (*EC710CTL)["ECTHM"   ];
        EC710CTL_ECERVF              = (*EC710CTL)["ECERVF"  ];
        EC710CTL_EC1ECP              = (*EC710CTL)["EC1ECP"  ];
        EC710CTL_EC2EDIC             = (*EC710CTL)["EC2EDIC" ];
        EC710CTL_EC1EDIC             = (*EC710CTL)["EC1EDIC" ];
        EC710CTL_ECER2F              = (*EC710CTL)["ECER2F"  ];
        EC710CTL_ECER1F              = (*EC710CTL)["ECER1F"  ];
        EC710CTL_ECEMF               = (*EC710CTL)["ECEMF"   ];
        return;
    }
    if (addr == 0x0004) {
        EC710TMC_ETMA1               = (*EC710TMC)["ETMA1"   ];
        EC710TMC_ETMA0               = (*EC710TMC)["ETMA0"   ];
        EC710TMC_ECTMCE              = (*EC710TMC)["ECTMCE"  ];
        EC710TMC_ECTRRS              = (*EC710TMC)["ECTRRS"  ];
        EC710TMC_ECREOS              = (*EC710TMC)["ECREOS"  ];
        EC710TMC_ECENS               = (*EC710TMC)["ECENS"   ];
        EC710TMC_ECDCS               = (*EC710TMC)["ECDCS"   ];
        EC710TMC_ECREIS              = (*EC710TMC)["ECREIS"  ];
        return;
    }
    if (addr == 0x0008) {
        EC710TRC_ECSYND              = (*EC710TRC)["ECSYND"  ];
        EC710TRC_ECHORD              = (*EC710TRC)["ECHORD"  ];
        EC710TRC_ECECRD              = (*EC710TRC)["ECECRD"  ];
        EC710TRC_ECERDB              = (*EC710TRC)["ECERDB"  ];
        return;
    }
    if (addr == 0x000C) {
        EC710TED_ECEDB               = (*EC710TED)["ECEDB"   ];
        return;
    }
    if ((0x0010 <= addr) && (addr <= (0x0010)+(4*7)) && ((addr-0x0010)%4 == 0)) {
        uint i = (addr - 0x0010)/4;
        EC710EAD_ECEAD              [i] = (*(EC710EAD[i]))["ECEAD"   ];
        return;
    }
}
...
/// @return None
void Cecc_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*EC710CTL)["ECDEDF7" ] = EC710CTL_ECDEDF7;
        (*EC710CTL)["ECSEDF7" ] = EC710CTL_ECSEDF7;
        (*EC710CTL)["ECDEDF6" ] = EC710CTL_ECDEDF6;
        (*EC710CTL)["ECSEDF6" ] = EC710CTL_ECSEDF6;
        (*EC710CTL)["ECDEDF5" ] = EC710CTL_ECDEDF5;
        (*EC710CTL)["ECSEDF5" ] = EC710CTL_ECSEDF5;
        (*EC710CTL)["ECDEDF4" ] = EC710CTL_ECDEDF4;
        (*EC710CTL)["ECSEDF4" ] = EC710CTL_ECSEDF4;
        (*EC710CTL)["ECDEDF3" ] = EC710CTL_ECDEDF3;
        (*EC710CTL)["ECSEDF3" ] = EC710CTL_ECSEDF3;
        (*EC710CTL)["ECDEDF2" ] = EC710CTL_ECDEDF2;
        (*EC710CTL)["ECSEDF2" ] = EC710CTL_ECSEDF2;
        (*EC710CTL)["ECDEDF1" ] = EC710CTL_ECDEDF1;
        (*EC710CTL)["ECSEDF1" ] = EC710CTL_ECSEDF1;
        (*EC710CTL)["ECDEDF0" ] = EC710CTL_ECDEDF0;
        (*EC710CTL)["ECSEDF0" ] = EC710CTL_ECSEDF0;
        (*EC710CTL)["EMCA1"   ] = EC710CTL_EMCA1;
        (*EC710CTL)["EMCA0"   ] = EC710CTL_EMCA0;
        (*EC710CTL)["ECOVFF"  ] = EC710CTL_ECOVFF;
        (*EC710CTL)["ECER2C"  ] = EC710CTL_ECER2C;
        (*EC710CTL)["ECER1C"  ] = EC710CTL_ECER1C;
        (*EC710CTL)["ECTHM"   ] = EC710CTL_ECTHM;
        (*EC710CTL)["ECERVF"  ] = EC710CTL_ECERVF;
        (*EC710CTL)["EC1ECP"  ] = EC710CTL_EC1ECP;
        (*EC710CTL)["EC2EDIC" ] = EC710CTL_EC2EDIC;
        (*EC710CTL)["EC1EDIC" ] = EC710CTL_EC1EDIC;
        (*EC710CTL)["ECER2F"  ] = EC710CTL_ECER2F;
        (*EC710CTL)["ECER1F"  ] = EC710CTL_ECER1F;
        (*EC710CTL)["ECEMF"   ] = EC710CTL_ECEMF;
        return;
    }
    if (addr == 0x0004) {
        (*EC710TMC)["ETMA1"   ] = EC710TMC_ETMA1;
        (*EC710TMC)["ETMA0"   ] = EC710TMC_ETMA0;
        (*EC710TMC)["ECTMCE"  ] = EC710TMC_ECTMCE;
        (*EC710TMC)["ECTRRS"  ] = EC710TMC_ECTRRS;
        (*EC710TMC)["ECREOS"  ] = EC710TMC_ECREOS;
        (*EC710TMC)["ECENS"   ] = EC710TMC_ECENS;
        (*EC710TMC)["ECDCS"   ] = EC710TMC_ECDCS;
        (*EC710TMC)["ECREIS"  ] = EC710TMC_ECREIS;
        return;
    }
    if (addr == 0x0008) {
        (*EC710TRC)["ECSYND"  ] = EC710TRC_ECSYND;
        (*EC710TRC)["ECHORD"  ] = EC710TRC_ECHORD;
        (*EC710TRC)["ECECRD"  ] = EC710TRC_ECECRD;
        (*EC710TRC)["ECERDB"  ] = EC710TRC_ECERDB;
        return;
    }
    if (addr == 0x000C) {
        (*EC710TED)["ECEDB"   ] = EC710TED_ECEDB;
        return;
    }
    if ((0x0010 <= addr) && (addr <= (0x0010)+(4*7)) && ((addr-0x0010)%4 == 0)) {
        uint i = (addr - 0x0010)/4;
        (*(EC710EAD[i]))["ECEAD"   ] = EC710EAD_ECEAD[i];
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecc_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecc_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecc_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecc_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecc_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecc_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecc_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cecc_regif::uint Cecc_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cecc_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecc_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecc_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecc_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cecc_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecc_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecc_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
