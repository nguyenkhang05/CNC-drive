// -----------------------------------------------------------------------------
// $Id: atu5_timerg_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERG_REGIF_H__
#define __ATU5_TIMERG_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERG model
class Catu5_timerg_regif
...
public:
    Catu5_timerg_regif(std::string name, uint buswidth);
    ~Catu5_timerg_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timerg_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timerg_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5_TIMERG_REG_DEF_H__
