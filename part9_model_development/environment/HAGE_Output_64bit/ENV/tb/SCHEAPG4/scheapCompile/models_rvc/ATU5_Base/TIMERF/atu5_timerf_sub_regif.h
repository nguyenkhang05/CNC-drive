// -----------------------------------------------------------------------------
// $Id: atu5_timerf_sub_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERF_SUB_REGIF_H__
#define __ATU5_TIMERF_SUB_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERF_SUB model
class Catu5_timerf_sub_regif
...
public:
    Catu5_timerf_sub_regif(std::string name, uint buswidth);
    ~Catu5_timerf_sub_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timerf_sub_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timerf_sub_regif::*) (RegCBstr)> > mRdCbAPI;
    std::string mFileName;
    std::string mInstName;
    int mLineNum;
    std::list<uint> list_rdcb_dbg; // list of registers whose read callbacks are executed in debug mode
...
#endif //__ATU5_TIMERF_SUB_REG_DEF_H__
