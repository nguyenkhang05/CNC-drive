// ---------------------------------------------------------------------
// $Id: ECC_LRAM_E2.cpp,v 1.4 2019/10/23 08:29:14 landang Exp $
//
...
#include "ECC_def.h"
#include "ECC_LRAM_E2.h"
#include "ECCCNT_LR0_PEn_Func.h"
#include "MECCCAP_LR0_PEn_Func.h"
#include "MECCCAP_LR1_Func.h"

/// Constructor and Destructor
ECC_LRAM_E2::ECC_LRAM_E2(sc_module_name name, const uint8_t iPE_NUM, const unsigned int rLatency, const unsigned int wLatency)
        :sc_module(name)
        ,ECC_LRAM_E2_AgentController()
        ,PE_NUM(iPE_NUM)
        // Clock/Reset
        ,pclk("pclk")
        ,presetn("presetn")
...
{//{{{ 
    ...
    // New instance and port
    mpECCCNT_LR0Func = new ECCCNT_LR0_PEn_Func*[PE_MAX_NUM];
    mpMECCCAP_LR0Func = new MECCCAP_LR0_PEn_Func*[PE_MAX_NUM];
  
    for (unsigned int i = 0; i < PE_MAX_NUM; i++){
        mpECCCNT_LR0Func[i] = new ECCCNT_LR0_PEn_Func((std::string)name, i, this);
        mpMECCCAP_LR0Func[i] = new MECCCAP_LR0_PEn_Func((std::string)name, i, this);
    }
    mpMECCCAP_LR1Func = new MECCCAP_LR1_Func((std::string)name, this);
    ...
    for (unsigned int reset_id = 0; reset_id < emNumReset; reset_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::HandleResetHardMethod, this, reset_id),
    ...
    for (unsigned int reset_id = 0; reset_id < emNumReset; reset_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::HandleResetCmdMethod, this, reset_id),
    ...
    for (unsigned int reset_id = 0; reset_id < emNumReset; reset_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::CancelResetCmdMethod, this, reset_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteProhibitionPortMethod, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteERROVFOUT0_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteERROVFOUT1_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NegateERROVFOUT0_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NegateERROVFOUT1_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteSEDERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::AssertSEDERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NegateSEDERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NegateDEDERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NegateAFEERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteDEDERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::WriteAFEERROUT_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::Process1bitError_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::ProcessFatalError_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::SetFatalErrorStatus_LR0Method, this, pe_id),
    ...
    for (unsigned int pe_id = 0; pe_id < PE_NUM; pe_id++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ECC_LRAM_E2::NotifyFatalError_LR0Method, this, pe_id),
...
{//{{{
    ...
    for (unsigned int i = 0; i < PE_NUM; i++){
        if(eccdisable[i] != NULL){
            delete eccdisable[i]; 
        }
        if(secdisable[i] != NULL){
            delete secdisable[i]; 
        }
        if(afedisable[i] != NULL){
            delete afedisable[i]; 
        }
        if(errovfout1_LR0[i] != NULL){
            delete errovfout1_LR0[i]; 
        }
        if(errovfout0_LR0[i] != NULL){
            delete errovfout0_LR0[i]; 
        }
        if(afeerrout_LR0[i] != NULL){
            delete afeerrout_LR0[i]; 
        }
        if(dederrout_LR0[i] != NULL){
            delete dederrout_LR0[i]; 
        }
        if(sederrout_LR0[i] != NULL){
...
void ECC_LRAM_E2::Initialize(void)
{//{{{
    for (unsigned int i = 0; i < PE_MAX_NUM; i++){
...
void ECC_LRAM_E2::WriteProhibitionSignal(unsigned int pe_id, unsigned int value)
{//{{{
...
/// Get CAP DEPTH
unsigned int ECC_LRAM_E2::GetCapDepth(std::string sub_name)
{//{{{
...
void ECC_LRAM_E2::AssertERROVFOUT0_LR0(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::AssertERROVFOUT1_LR0(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::AssertERROVFOUT0_LR1()
{//{{{
...
void ECC_LRAM_E2::AssertERROVFOUT1_LR1()
{//{{{
...
/// Get keycode value
bool ECC_LRAM_E2::GetKeyOpen()
{//{{{
    return mKeyOpen;
}//}}}

/// Get AWIDTH_MSB
unsigned int ECC_LRAM_E2::GetAWIDTH_MSB(std::string sub_name)
{//{{{
    sc_assert((sub_name == "LR0") || (sub_name == "LR1"));
    unsigned int ret = 0;
...
//========================================================
/// Monitor pclk clock
void ECC_LRAM_E2::MonitorpclkMethod()
{//{{{
...
void ECC_LRAM_E2::Monitorsys_clkMethod()
{//{{{
...
void ECC_LRAM_E2::MonitorpresetnMethod()
{//{{{
...
/// Monitor presetn port
void ECC_LRAM_E2::Monitorsys_resetzMethod()
{//{{{
...
void ECC_LRAM_E2::HandleResetHardMethod (const unsigned int reset_id)
{//{{{
...
void ECC_LRAM_E2::HandleResetCmdMethod (const unsigned int reset_id)
{//{{{
...
void ECC_LRAM_E2::CancelResetCmdMethod (const unsigned int reset_id)
{//{{{
    std::string reset_name = "presetn";
    if (reset_id == empresetnId) {
        reset_name = "presetn";
...
void ECC_LRAM_E2::EnableReset (const std::string reset_name, const bool is_active)
{//{{{
...
/// Get reset status
bool ECC_LRAM_E2::GetResetStatus (const std::string reset_name)
{//{{{
...
/// Check clock period 
bool ECC_LRAM_E2::CheckClockPeriod (const std::string clock_name)
{//{{{
...
void ECC_LRAM_E2::MonitorkeyopenMethod()
{//{{{
    mKeyOpen = keyopen.read();
}//}}}

/// Write eccdisable_cfp port
void ECC_LRAM_E2::WriteProhibitionPortMethod(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteERROVFOUT0_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteERROVFOUT1_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NegateERROVFOUT0_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NegateERROVFOUT1_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteSEDERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::AssertSEDERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NegateSEDERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NegateDEDERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NegateAFEERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteDEDERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteAFEERROUT_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::Process1bitError_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::WriteERROVFOUT0_LR1Method()
{//{{{
...
void ECC_LRAM_E2::WriteERROVFOUT1_LR1Method()
{//{{{
...
void ECC_LRAM_E2::NegateERROVFOUT0_LR1Method()
{//{{{
    mERROVFOUT0_LR1 = false;
    mWriteERROVFOUT0_LR1Event.notify();
}//}}}
...
void ECC_LRAM_E2::NegateERROVFOUT1_LR1Method()
{//{{{
    mERROVFOUT1_LR1 = false;
    mWriteERROVFOUT1_LR1Event.notify();
}//}}}
...
void ECC_LRAM_E2::WriteSEDERROUT_LR1Method()
{//{{{
...
/// Assert 1bit error notification (to output port)
void ECC_LRAM_E2::AssertSEDERROUT_LR1Method()
{//{{{
...
void ECC_LRAM_E2::NegateSEDERROUT_LR1Method()
{//{{{
    mSEDERROUT_LR1 = false;
    mWriteSEDERROUT_LR1Event.notify();
}//}}}
...
void ECC_LRAM_E2::NegateDEDERROUT_LR1Method()
{//{{{
    mDEDERROUT_LR1 = false;
    mWriteDEDERROUT_LR1Event.notify();
}//}}}
...
void ECC_LRAM_E2::WriteDEDERROUT_LR1Method()
{//{{{
...
void ECC_LRAM_E2::Set1bitErrorStatusThread()
{//{{{
    while (true){
...
bool ECC_LRAM_E2::CheckAnyFIFOHasElement()
{//{{{
    for (unsigned int i = 0; i < PE_MAX_NUM; i++){
...
void ECC_LRAM_E2::Process1bitError_LR1Method()
{//{{{
    // Update 1bit error FIFO
...
void ECC_LRAM_E2::ProcessFatalError_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::ProcessFatalError_LR1Method()
{//{{{
    bool is_update_status = false;
    double current_time = sc_time_stamp().to_double();
    unsigned int mod_address = 0;
...
void ECC_LRAM_E2::SetFatalErrorStatus_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::SetFatalErrorStatus_LR1Method()
{//{{{
...
void ECC_LRAM_E2::NotifyFatalError_LR0Method(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::NotifyFatalError_LR1Method()
{//{{{
...
bool ECC_LRAM_E2::CheckNoFatalStatus_LR0(unsigned int pe_id)
{//{{{
    return mpMECCCAP_LR0Func[pe_id]->CheckNoFatalStatus();
}//}}}

/// Check no fatal status of LR1
bool ECC_LRAM_E2::CheckNoFatalStatus_LR1()
{//{{{
    return mpMECCCAP_LR1Func->CheckNoFatalStatus();
}//}}}

/// Check an address is masked or not for LR0
bool ECC_LRAM_E2::CheckMaskAddress_LR0(const unsigned int pe_id, const unsigned int address)
{//{{{
...
bool ECC_LRAM_E2::CheckMaskAddress_LR1(const unsigned int address)
{//{{{
    for (unsigned int i = 0; i < emNumMaskedArea; i++){
...
bool ECC_LRAM_E2::Check1bitAddressNotCaptured_LR0(unsigned int pe_id, unsigned int mod_address)
{//{{{
...
bool ECC_LRAM_E2::Check1bitAddressNotCaptured_LR1(unsigned int mod_address)
{//{{{
...
void ECC_LRAM_E2::Update1bitErrorList_LR0(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::Update1bitErrorList_LR1()
{//{{{
    bool is_same_port = false;
...
void ECC_LRAM_E2::UpdateFatalErrorList_LR0(unsigned int pe_id)
{//{{{
...
void ECC_LRAM_E2::UpdateFatalErrorList_LR1()
{//{{{
    bool is_same_port_and_type = false;
    // Update new address if havingpe_id change in slave port
    for (unsigned int i = 0; i < mSizeFatalErrorList_LR1; i++){
...
std::string ECC_LRAM_E2::CombineStringUint(std::string name, unsigned int index)
{//{{{
...
unsigned int ECC_LRAM_E2::ShiftAddress(std::string sub_name, unsigned int address)
{//{{{
...
void ECC_LRAM_E2::SetMessageLevel (const std::string msg_lv)
{//{{{
...
void ECC_LRAM_E2::DumpRegisterRW (const std::string is_enable)
{//{{{
    std::vector<std::string> cmd;
    cmd.push_back("reg");
...
void ECC_LRAM_E2::DumpInterrupt (const std::string is_enable)
{//{{{
    ...
    if (word_vector.size() == 1) {
        if (word_vector[0] == "true") {
            ...
            re_printf("warning","Invalid argument: ECC_LRAM_E2_DumpInterrupt %s\n", is_enable.c_str());
        }
        ...
        re_printf("info","ECC_LRAM_E2_DumpInterrupt %s\n",temp.c_str());
    } else {
        re_printf("warning","Invalid argument: ECC_LRAM_E2_DumpInterrupt %s\n", is_enable.c_str());
    }
}//}}}
...
void ECC_LRAM_E2::AWIDTH_MSB(const std::string sub_name, const unsigned int value)
{//{{{
    if (sub_name == "LR0"){
        if ((mAWIDTH_LSB_LR0 <= value) && (value <= MAX_ADDWIDTH_MSB)){
            mAWIDTH_MSB_LR0 = value;
        }else{
            re_printf("warning", "Invalid AWIDTH_MSB (%d) of the ECC_LRAM_E2_AWIDTH_MSB parameter. Valid range is %d-%d. Value %d is set as default.\n", value, mAWIDTH_LSB_LR0, MAX_ADDWIDTH_MSB, DEFAULT_AWIDTH_MSB_LR0);
        }
        ...
        re_printf("warning", "Invalid name of sub-block (%s) of the ECC_LRAM_E2_AWIDTH_MSB parameter. Valid name of sub-block is LR0 or LR1.\n", sub_name.c_str());
    }
}//}}}

/// Set AWIDTH_LSB
void ECC_LRAM_E2::AWIDTH_LSB(const std::string sub_name, const unsigned int value)
{//{{{
    if (sub_name == "LR0"){
        if ((MIN_ADDWIDTH_LSB <= (int)value) && (value <= mAWIDTH_MSB_LR0)){
            mAWIDTH_LSB_LR0 = value;
        }else{
            re_printf("warning", "Invalid AWIDTH_LSB (%d) of the ECC_LRAM_E2_AWIDTH_LSB parameter. Valid range is %d-%d. Value %d is set as default.\n", value, MIN_ADDWIDTH_LSB, mAWIDTH_MSB_LR0, DEFAULT_AWIDTH_LSB_LR0);
        }
    }else if (sub_name == "LR1"){
        ...
        re_printf("warning", "Invalid name of sub-block (%s) of the ECC_LRAM_E2_AWIDTH_LSB parameter. Valid name of sub-block is LR0 or LR1.\n", sub_name.c_str());
    }
}//}}}

/// Set CAP_DEPTH
void ECC_LRAM_E2::CAP_DEPTH(const std::string sub_name, const unsigned int value)
{//{{{
    if (sub_name == "LR0"){
        if ((MIN_CAP_DEPTH <= value) && (value <= MAX_CAP_DEPTH)){
            mCAP_DEPTH_LR0 = value;
        }else{
            re_printf("warning", "Invalid CAP_DEPTH (%d) of the ECC_LRAM_E2_CAP_DEPTH parameter. Valid range is %d-%d. Value %d is set as default.\n", value, MIN_CAP_DEPTH, MAX_CAP_DEPTH, DEFAULT_CAP_DEPTH_LR0);
        }
    }else if (sub_name == "LR1"){
        if ((MIN_CAP_DEPTH <= value) && (value <= MAX_CAP_DEPTH)){
        ...
        re_printf("warning", "Invalid name of sub-block (%s) of the ECC_LRAM_E2_CAP_DEPTH parameter. Valid name of sub-block is LR0 or LR1.\n", sub_name.c_str());
    }
}//}}}

/// Set ERRINT_INIT
void ECC_LRAM_E2::ERRINT_INIT(const std::string sub_name, const unsigned int value)
{//{{{
    if (sub_name == "LR0"){
        if ((MIN_ERRINT_INIT <= (int)value) && (value <= MAX_ERRINT_INIT)){
            mERRINT_INIT_LR0 = value;
        }else{
            re_printf("warning", "Invalid ERRINT_INIT (%d) of the ECC_LRAM_E2_ERRINT_INIT parameter. Valid range is %d-%d. Value %d is set as default.\n", value, MIN_ERRINT_INIT, MAX_ERRINT_INIT, DEFAULT_ERRINT_INIT_LR0);
        }
    }else if (sub_name == "LR1"){
        if ((MIN_ERRINT_INIT <= (int)value) && (value <= MAX_ERRINT_INIT)){
        ...
        re_printf("warning", "Invalid name of sub-block (%s) of the ECC_LRAM_E2_ERRINT_INIT parameter. Valid name of sub-block is LR0 or LR1.\n", sub_name.c_str());
    }
}//}}}

/// Calculate EDL code
std::string ECC_LRAM_E2::CalculateEDLCode()
{//{{{
    std::string edl_name = "";
...
/// Issue error to ECC
void ECC_LRAM_E2::IssueError(const unsigned int errortype)
{//{{{
    ...
    if ((mIsEDLConfig) && (mIsAddrConfig)){
        if ((((errortype == em1bitError) || (errortype == em2bitError) || (errortype == emAddressFeedbackError)) && (mCurConfigSubName == "LR0"))
            ...
            re_printf("warning", "Invalid error type (%d) of ECC_LRAM_E2_IssueError command.\n", errortype);
        }
    }else{
...
void ECC_LRAM_E2::SetErrorAddr(const unsigned int addr_value)
{//{{{
...
void ECC_LRAM_E2::SetEDL (const std::string edl, const unsigned int pe_index)
{//{{{
    // Dump warning message if config wrong EDL
    if (((edl != "LSU") && (edl != "Bank") && (edl != "PE")) || (pe_index > 7)){
        re_printf("warning", "Invalid EDL (%s, %d) of ECC_LRAM_E2_SetEDL command.\n", edl.c_str(), pe_index);
...
/// Dump Status info
void ECC_LRAM_E2::DumpStatusInfo()
{//{{{
    // For LR0 - PEn
    for (unsigned int i = 0; i < PE_NUM; i++){
        const char *type = CombineStringUint("StatInfo LR0 - PE", i).c_str();
        DumpInfo(type, "Info [%20s] (%10s):\n", sc_time_stamp().to_string().c_str(), this->name());
        DumpInfo(type, "  LR0_SERSTR: 0x%08X\n", mpMECCCAP_LR0Func[i]->GetLR0_SERSTR());
        DumpInfo(type, "  LR0_DERSTR: 0x%08X\n", mpMECCCAP_LR0Func[i]->GetLR0_DERSTR());
        DumpInfo(type, "  LR0_OVFSTR: 0x%08X\n", mpMECCCAP_LR0Func[i]->GetLR0_OVFSTR());
        for (unsigned int k = 0; k < mCAP_DEPTH_LR0; k++){
            ...
            DumpInfo(type, "  LR0_%2dSEADR: SEDL = 0x%02X, SEADR = 0x%08X\n", k, sedl, seadr);
        }
        ...
        DumpInfo(type, "  LR0_00DEADR: DEDL = 0x%02X, DEADR = 0x%08X\n", dedl, deadr);
    }

    // For LR1
    const char *type1 = "StatInfo LR1";
    DumpInfo(type1, "Info [%20s] (%10s):\n", sc_time_stamp().to_string().c_str(), this->name());
    DumpInfo(type1, "  LR1_SERSTR: 0x%08X\n", mpMECCCAP_LR1Func->GetLR1_SERSTR());
    DumpInfo(type1, "  LR1_DERSTR: 0x%08X\n", mpMECCCAP_LR1Func->GetLR1_DERSTR());
    DumpInfo(type1, "  LR1_OVFSTR: 0x%08X\n", mpMECCCAP_LR1Func->GetLR1_OVFSTR());
    for (unsigned int i = 0; i < mCAP_DEPTH_LR1; i++){
        ...
        DumpInfo(type1, "  LR1_%2dSEADR: SEDL = 0x%02X, SEADR = 0x%08X\n", i, sedl, seadr);
    }
    ...
    DumpInfo(type1, "  LR1_00DEADR: DEDL = 0x%02X, DEADR = 0x%08X\n", dedl1, deadr1);
}//}}}

/// Common dump info message

void ECC_LRAM_E2::DumpInfo(const char *type, const char *message, ...)
{//{{{
    if ((message != NULL) && (type != NULL)){
        printf("PROFILE(%s): ECC_LRAM_E2: ", type);
        // Print body
        va_list argptr;
...
void ECC_LRAM_E2::AssertReset (const std::string reset_name, const double start_time, const double period)
{//{{{
    if (reset_name == "presetn") {
...
void ECC_LRAM_E2::SetCLKFreq (const std::string clock_name, const sc_dt::uint64 freq, const std::string unit)
{//{{{
    std::vector<std::string> word_vector;
...
/// Get clock value
void ECC_LRAM_E2::GetCLKFreq (const std::string clock_name)
{//{{{
    std::vector<std::string> word_vector;
    SeparateString(word_vector, clock_name);
    if (word_vector.size() == 1) {
...
void ECC_LRAM_E2::ForceRegister (const std::string block_name, const unsigned int block_index, const std::string reg_name, const unsigned int reg_value)
{//{{{ 
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ECC_LRAM_E2::ReleaseRegister (const std::string block_name, const unsigned int block_index, const std::string reg_name)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ECC_LRAM_E2::WriteRegister (const std::string block_name, const unsigned int block_index, const std::string reg_name, const unsigned int reg_value)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ECC_LRAM_E2::ReadRegister (const std::string block_name, const unsigned int block_index, const std::string reg_name)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ECC_LRAM_E2::ListRegister (void)
{//{{{
    std::vector<std::string> cmd;
    cmd.push_back("reg");
    for (unsigned int i = 0; i < PE_NUM; i++){
...
void ECC_LRAM_E2::Help (const std::string type)
{//{{{
    std::vector<std::string> word_vector;
    SeparateString(word_vector, type);
    if (word_vector.size() == 1) {
        if (word_vector[0] == "parameters") {
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_MessageLevel (\"ECC_LRAM_E2 instance\", \"fatal|error|warning|info\")                          Set debug message level (Default: fatal|error)");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_DumpRegisterRW (\"ECC_LRAM_E2 instance\", \"true/false\")                                      Enable/disable dumping access register (Default: false)");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_DumpInterrupt (\"ECC_LRAM_E2 instance\", \"true/false\")                                       Enable/disable dumping interrupt info (Default: false)");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_AWIDTH_MSB (\"ECC_LRAM_E2 instance\", \"sub_name\", value)                                     Set address bit width MSB for LR0 or LR1 (Default: 14 for LR0, 21 for LR1). Valid range to be set: 7-26");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_AWIDTH_LSB (\"ECC_LRAM_E2 instance\", \"sub_name\", value)                                     Set address bit width LSB for LR0 or LR1 (Default: 2 for both LR0 and LR1). Valid range to be set: 2-4");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_CAP_DEPTH (\"ECC_LRAM_E2 instance\", \"sub_name\", value)                                      Set number of address registers for LR0 or LR1 (Default: 8 for both LR0 or LR1). Valid range to be set: 1-32");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_ERRINT_INIT (\"ECC_LRAM_E2 instance\", \"sub_name\", value)                                    Set initial value of ERRINT register for LR0 or LR1 (Default: 0x8F for LR0, 0x87 for LR1). Valid range to be set: 0x0-0xFF");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_EnableRegisterMessage (\"ECC_LRAM_E2 instance\", \"true/false\")             Enable/disable info/warning/error message of register IF (Default: true)");
        } else if (word_vector[0] == "commands") {
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_IssueError (\"ECC_LRAM_E2 instance\", error_type)                                              Issue pseudo error to the ECC_LRAM_E2 model");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_SetErrorAddr (\"ECC_LRAM_E2 instance\", addr_value)                                            Set error detection address");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_SetEDL (\"ECC_LRAM_E2 instance\", \"edl\", pe_index)                                           Set error detection location");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_DumpStatusInfo (\"ECC_LRAM_E2 instance\")                                                      Dump information of the error status registers of the ECC_LRAM_E2 model");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_AssertReset (\"ECC_LRAM_E2 instance\", \"reset_name\", start_time, period)                     Assert and de-assert reset signal to the ECC_LRAM_E2 model");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_SetCLKFreq (\"ECC_LRAM_E2 instance\", \"clock_name\", freq, \"unit\")                          Set clock frequency value to ECC_LRAM_E2 model. Valid clock_name is pclk or sys_clk");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_GetCLKFreq (\"ECC_LRAM_E2 instance\", \"clock_name\")                                          Get clock frequency value of ECC_LRAM_E2 model. Valid clock_name is pclk or sys_clk");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_ForceRegister (\"ECC_LRAM_E2 instance\", \"block_name\", block_index, \"reg_name\", reg_value) Force register with setting value");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_ReleaseRegister (\"ECC_LRAM_E2 instance\", \"block_name\", block_index, \"reg_name\")          Release register from force value");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_WriteRegister (\"ECC_LRAM_E2 instance\", \"block_name\", block_index, \"reg_name\", reg_value) Write a value to a register");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_ReadRegister (\"ECC_LRAM_E2 instance\", \"block_name\", block_index, \"reg_name\")             Read a value from a register");
            SC_REPORT_INFO(this->basename(),"ECC_LRAM_E2_ListRegister (\"ECC_LRAM_E2 instance\")                                                        Dump name of all registers");
        } else {
...
void ECC_LRAM_E2::EnableRegisterMessage(const std::string is_enable)
{//{{{
    std::vector<std::string> word_vector;
    SeparateString(word_vector, is_enable);
    if (word_vector.size() == 1) {
        if (word_vector[0] == "true") {
            ...
            re_printf("warning","Invalid argument: ECC_LRAM_E2_EnableRegisterMessage %s.\n", is_enable.c_str());
        }
    } else if (word_vector.size() == 0) {
        std::string temp = "false";
        ...
        re_printf("info","ECC_LRAM_E2_EnableRegisterMessage %s \n", temp.c_str());
    } else {
        re_printf("warning","Invalid argument: ECC_LRAM_E2_EnableRegisterMessage %s.\n ", is_enable.c_str());
    }
}//}}}
