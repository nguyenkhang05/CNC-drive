// -----------------------------------------------------------------------------
// $Id: g4_pegcap_u2a_regif.h,v 1.6 2020/01/14 02:39:30 nhutminhdang Exp $
//
...
/// $Author: nhutminhdang $
////////////////////////////////////////////////////////////////////////////////
#ifndef __G4_PEGCAP_U2A_REGIF_H__
#define __G4_PEGCAP_U2A_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of G4_PEGCAP_U2A model
class Cg4_pegcap_u2a_regif
...
public:
    Cg4_pegcap_u2a_regif(std::string name, uint buswidth);
    ~Cg4_pegcap_u2a_regif();

protected:
    vpcl::re_register *PEGOVFCLR     ;
    vpcl::re_register *PEGOVFSTAT    ;
    vpcl::re_register *PEGERRADDR    ;
    vpcl::re_register *PEGERRTYPE    ;
    vpcl::re_register *PEGSPIDERRCLR ;
    vpcl::re_register *PEGSPIDERRSTAT;

    #ifdef USR_CWR_SYSTEMC
    scml2::memory<uint> cwmem;
    scml2::reg<uint> *CW_PEGOVFCLR     ;
    scml2::reg<uint> *CW_PEGOVFSTAT    ;
    scml2::reg<uint> *CW_PEGERRADDR    ;
    scml2::reg<uint> *CW_PEGERRTYPE    ;
    scml2::reg<uint> *CW_PEGSPIDERRCLR ;
    scml2::reg<uint> *CW_PEGSPIDERRSTAT;
    #endif
    ...
    uint PEGSPIDERRCLR_SPIDCLR;
    uint PEGSPIDERRSTAT_SPIDERR;
    ...
    virtual void cb_PEGOVFCLR_CLRO(RegCBstr str) = 0;
    virtual void cb_PEGSPIDERRCLR_SPIDCLR(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cg4_pegcap_u2a_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cg4_pegcap_u2a_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__G4_PEGCAP_U2A_REG_DEF_H__
