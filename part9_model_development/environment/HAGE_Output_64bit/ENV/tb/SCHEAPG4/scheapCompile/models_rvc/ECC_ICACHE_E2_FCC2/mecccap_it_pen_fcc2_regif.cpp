// -----------------------------------------------------------------------------
// $Id: mecccap_it_pen_fcc2_regif.cpp,v 1.4 2019/03/05 04:44:48 synguyen Exp $
//
...
//
// Input file : mecccap_it_pen_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE mecccap_it_pen_fcc2
//     #              name     offset_size
...
////////////////////////////////////////////////////////////////////////////////
/// @file mecccap_it_pen_fcc2_regif.cpp
/// @brief Register IF class of model MECCCAP_IT_PEN
/// $Id: mecccap_it_pen_fcc2_regif.cpp,v 1.4 2019/03/05 04:44:48 synguyen Exp $
...
/// @return none
Cmecccap_it_pen_fcc2_regif::Cmecccap_it_pen_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    IT_ERRINT  = new vpcl::re_register(0x0000, this, "IT_ERRINT" , name.c_str());
    IT_SSTCLR  = new vpcl::re_register(0x0010, this, "IT_SSTCLR" , name.c_str());
    IT_DSTCLR  = new vpcl::re_register(0x0014, this, "IT_DSTCLR" , name.c_str());
    IT_OVFCLR  = new vpcl::re_register(0x0018, this, "IT_OVFCLR" , name.c_str());
    IT_SERSTR  = new vpcl::re_register(0x0020, this, "IT_SERSTR" , name.c_str());
    IT_DERSTR  = new vpcl::re_register(0x0024, this, "IT_DERSTR" , name.c_str());
    IT_OVFSTR  = new vpcl::re_register(0x0028, this, "IT_OVFSTR" , name.c_str());
    IT_SERINF  = new vpcl::re_register(0x0030, this, "IT_SERINF" , name.c_str());
    IT_00DEADR = new vpcl::re_register(0x00F0, this, "IT_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_IT_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"IT_nSEADR"<< i;
        IT_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_IT_ERRINT   , IT_ERRINT->name() , IT_ERRINT->addr() );
    cw_instantiate_reg(CW_IT_SSTCLR   , IT_SSTCLR->name() , IT_SSTCLR->addr() );
    cw_instantiate_reg(CW_IT_DSTCLR   , IT_DSTCLR->name() , IT_DSTCLR->addr() );
    cw_instantiate_reg(CW_IT_OVFCLR   , IT_OVFCLR->name() , IT_OVFCLR->addr() );
    cw_instantiate_reg(CW_IT_SERSTR   , IT_SERSTR->name() , IT_SERSTR->addr() );
    cw_instantiate_reg(CW_IT_DERSTR   , IT_DERSTR->name() , IT_DERSTR->addr() );
    cw_instantiate_reg(CW_IT_OVFSTR   , IT_OVFSTR->name() , IT_OVFSTR->addr() );
    cw_instantiate_reg(CW_IT_SERINF   , IT_SERINF->name() , IT_SERINF->addr() );
    for(uint i = 0; i < emNUM_IT_nSEADR ; i++) cw_instantiate_reg(CW_IT_nSEADR   [i], IT_nSEADR [i]->name(), IT_nSEADR [i]->addr());
    cw_instantiate_reg(CW_IT_00DEADR  , IT_00DEADR->name(), IT_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(IT_ERRINT   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_SSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_DSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_OVFCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_SERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_DERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_OVFSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_SERINF   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    for(uint i = 0; i < emNUM_IT_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(IT_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IT_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*IT_ERRINT   ) ( 3,  3, "AFEIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IT_ERRINT   ) ( 1,  1, "DEDIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IT_ERRINT   ) ( 0,  0, "SEDIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IT_SSTCLR   ) (31,  0, "IT_SSTCLR", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*IT_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*IT_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*IT_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*IT_SERSTR   ) (31,  0, "IT_SERSTR", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_DERSTR   ) ( 3,  3, "AFEF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_SERINF   ) ( 3,  0, "SEDLINF" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IT_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_IT_nSEADR; i++) {
        (*IT_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*IT_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["IT_SSTCLR"]["IT_SSTCLR"] = &Cmecccap_it_pen_fcc2_regif::cb_IT_SSTCLR_IT_SSTCLR;
    mWrCbAPI["IT_DSTCLR"]["DSTCLR00"] = &Cmecccap_it_pen_fcc2_regif::cb_IT_DSTCLR_DSTCLR00;
    mWrCbAPI["IT_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_it_pen_fcc2_regif::cb_IT_OVFCLR_SERROVFCLR0;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_it_pen_fcc2_regif::~Cmecccap_it_pen_fcc2_regif()
{
...
Cmecccap_it_pen_fcc2_regif::uint Cmecccap_it_pen_fcc2_regif::bit_select(
...
bool Cmecccap_it_pen_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_it_pen_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_it_pen_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                            const unsigned char *p_data,   ///< [in] Writing data
                                            cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_it_pen_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_it_pen_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                                const unsigned char *p_data,  ///< [in] Writing data
                                                cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_it_pen_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                                unsigned char *p_data,   ///< [out] Reading data
                                                cuint size,              ///< [in]  Data size (byte)
                                                bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_it_pen_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                             unsigned char *p_data,          ///< [out] Reading data
                                             cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_it_pen_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                             const unsigned char *p_data,      ///< [in] Writing data
                                             cuint size,                       ///< [in] Data size (byte)
                                             cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_it_pen_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_it_pen_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_it_pen_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    IT_ERRINT_AFEIE = 0x0;
    IT_ERRINT_DEDIE = 0x0;
    IT_ERRINT_SEDIE = 0x0;
    IT_SSTCLR_IT_SSTCLR = 0x0;
    IT_DSTCLR_DSTCLR00 = 0x0;
    IT_OVFCLR_SERROVFCLR1 = 0x0;
    IT_OVFCLR_SERROVFCLR0 = 0x0;
    IT_SERSTR_IT_SERSTR = 0x0;
    IT_DERSTR_AFEF00 = 0x0;
    IT_DERSTR_DEDF00 = 0x0;
    IT_OVFSTR_SERROVF1 = 0x0;
    IT_OVFSTR_SERROVF0 = 0x0;
    IT_SERINF_SEDLINF = 0x0;
    for(uint i = 0; i < emNUM_IT_nSEADR; i++) {
        IT_nSEADR_SEDL[i] = 0x0;
        IT_nSEADR_SEADR0[i] = 0x0;
    }
    IT_00DEADR_DEDL = 0x0;
    IT_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_it_pen_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        IT_ERRINT_AFEIE                = (*IT_ERRINT )["AFEIE"     ];
        IT_ERRINT_DEDIE                = (*IT_ERRINT )["DEDIE"     ];
        IT_ERRINT_SEDIE                = (*IT_ERRINT )["SEDIE"     ];
        return;
    }
    if (addr == 0x0010) {
        IT_SSTCLR_IT_SSTCLR            = (*IT_SSTCLR )["IT_SSTCLR" ];
        return;
    }
    if (addr == 0x0014) {
        IT_DSTCLR_DSTCLR00             = (*IT_DSTCLR )["DSTCLR00"  ];
        return;
    }
    if (addr == 0x0018) {
        IT_OVFCLR_SERROVFCLR1          = (*IT_OVFCLR )["SERROVFCLR1"];
        IT_OVFCLR_SERROVFCLR0          = (*IT_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        IT_SERSTR_IT_SERSTR            = (*IT_SERSTR )["IT_SERSTR" ];
        return;
    }
    if (addr == 0x0024) {
        IT_DERSTR_AFEF00               = (*IT_DERSTR )["AFEF00"    ];
        IT_DERSTR_DEDF00               = (*IT_DERSTR )["DEDF00"    ];
        return;
    }
    if (addr == 0x0028) {
        IT_OVFSTR_SERROVF1             = (*IT_OVFSTR )["SERROVF1"  ];
        IT_OVFSTR_SERROVF0             = (*IT_OVFSTR )["SERROVF0"  ];
        return;
    }
    if (addr == 0x0030) {
        IT_SERINF_SEDLINF              = (*IT_SERINF )["SEDLINF"   ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        IT_nSEADR_SEDL                [i] = (*(IT_nSEADR [i]))["SEDL"      ];
        IT_nSEADR_SEADR0              [i] = (*(IT_nSEADR [i]))["SEADR0"    ];
        return;
    }
    if (addr == 0x00F0) {
        IT_00DEADR_DEDL                = (*IT_00DEADR)["DEDL"      ];
        IT_00DEADR_DEADR0              = (*IT_00DEADR)["DEADR0"    ];
        return;
    }
}
...
/// @return None
void Cmecccap_it_pen_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*IT_ERRINT )["AFEIE"     ] = IT_ERRINT_AFEIE;
        (*IT_ERRINT )["DEDIE"     ] = IT_ERRINT_DEDIE;
        (*IT_ERRINT )["SEDIE"     ] = IT_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*IT_SSTCLR )["IT_SSTCLR" ] = IT_SSTCLR_IT_SSTCLR;
        return;
    }
    if (addr == 0x0014) {
        (*IT_DSTCLR )["DSTCLR00"  ] = IT_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*IT_OVFCLR )["SERROVFCLR1"] = IT_OVFCLR_SERROVFCLR1;
        (*IT_OVFCLR )["SERROVFCLR0"] = IT_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*IT_SERSTR )["IT_SERSTR" ] = IT_SERSTR_IT_SERSTR;
        return;
    }
    if (addr == 0x0024) {
        (*IT_DERSTR )["AFEF00"    ] = IT_DERSTR_AFEF00;
        (*IT_DERSTR )["DEDF00"    ] = IT_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*IT_OVFSTR )["SERROVF1"  ] = IT_OVFSTR_SERROVF1;
        (*IT_OVFSTR )["SERROVF0"  ] = IT_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*IT_SERINF )["SEDLINF"   ] = IT_SERINF_SEDLINF;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(IT_nSEADR [i]))["SEDL"      ] = IT_nSEADR_SEDL[i];
        (*(IT_nSEADR [i]))["SEADR0"    ] = IT_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*IT_00DEADR)["DEDL"      ] = IT_00DEADR_DEDL;
        (*IT_00DEADR)["DEADR0"    ] = IT_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_it_pen_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_it_pen_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_it_pen_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_it_pen_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_it_pen_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_it_pen_fcc2_regif::uint Cmecccap_it_pen_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_it_pen_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_it_pen_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_it_pen_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_it_pen_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
