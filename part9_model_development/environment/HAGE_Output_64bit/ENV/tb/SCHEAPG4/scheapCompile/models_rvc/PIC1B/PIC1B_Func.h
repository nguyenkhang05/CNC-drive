// ---------------------------------------------------------------------
// $Id: PIC1B_Func.h,v 1.2 2015/08/19 17:24:12 huepham Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __PIC1B_FUNC_H__
#define __PIC1B_FUNC_H__
#include "BusSlaveFuncIf.h"
#include "pic1b_regif.h"

class PIC1B_AgentController;

class PIC1B_Func: public Cpic1b_regif
                ,public BusSlaveFuncIf
{
public:
    PIC1B_Func (std::string name,
               PIC1B_AgentController *PIC1B_AgentControllerPtr);
    ~PIC1B_Func (void);
    ...
    void CalcTSGnTSST (void);
    void CalcPORTTSGTSST (void);
    void CalcPIC1TSSTOUT (void);
...
private:
    PIC1B_AgentController *mPIC1B_AgentController;
    std::string mModuleName;//Module name
    
    /// Internal variables
    bool mDelay_PIC0SST;                    // Store the value of PIC0SST register
    ...
    /// Declare virtual function of pic1b_regif class
    void cb_PIC0EN_PIC0EN0(RegCBstr str);
    void cb_PIC0SST_SYNCTRG(RegCBstr str);
    void cb_PIC0SSTSGSEL_PIC0SSTSGSEL0(RegCBstr str);
    void cb_PIC0SSTOUTEN_PIC0SSTOUTEN0(RegCBstr str);
