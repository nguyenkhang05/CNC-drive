// -----------------------------------------------------------------------------
// $Id: atu5_timerc_sub_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
//   %REG_NAME CUCRC
//      %%TITLE  name        upper  lower  init  access  support  callback
//      %%BIT    CUCRC       31      0   0xFFFFFFFF  W|R     TRUE     W
//  
//  %REG_NAME GRCn
//      %%TITLE  name        upper  lower  init  access  support  callback
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERC_SUB_REGIF_H__
#define __ATU5_TIMERC_SUB_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERC_SUB model
class Catu5_timerc_sub_regif
...
protected:
    ...
    uint *mRegMap;
    uint mTotalRegNum;
    uint msub_no; //added for ver 0.080
public:
    Catu5_timerc_sub_regif(std::string name, uint buswidth, uint sub_no);
    ~Catu5_timerc_sub_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timerc_sub_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timerc_sub_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5_TIMERC_SUB_REG_DEF_H__
