// -----------------------------------------------------------------------------
// $Id: ahbfsguard_regif.h,v 1.6 2014/09/25 09:03:39 dungvannguyen Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __AHBFSGUARD_REGIF_H__
#define __AHBFSGUARD_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of AHBFSGUARD model
class Cahbfsguard_regif
...
public:
    Cahbfsguard_regif(std::string name,
                      uint buswidth,
                      uint version = 0,
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Cahbfsguard_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cahbfsguard_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__AHBFSGUARD_REG_DEF_H__
