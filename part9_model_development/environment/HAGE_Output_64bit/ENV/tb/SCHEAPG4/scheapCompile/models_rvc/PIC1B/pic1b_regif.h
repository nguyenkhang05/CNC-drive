// -----------------------------------------------------------------------------
// $Id: pic1b_regif.h,v 1.1 2015/08/14 12:23:30 huepham Exp $
//
...
/// $Author: huepham $
////////////////////////////////////////////////////////////////////////////////
#ifndef __PIC1B_REGIF_H__
#define __PIC1B_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of PIC1B model
class Cpic1b_regif
...
public:
    Cpic1b_regif(std::string name, uint buswidth);
    ~Cpic1b_regif();

protected:
    vpcl::re_register *PIC0EN        ;
    vpcl::re_register *PIC0SST       ;
    vpcl::re_register *PIC0SSTSGSEL  ;
    vpcl::re_register *PIC0SSTOUTEN  ;
    ...
    scml2::reg<uint>      *CW_PIC0SSTSGSEL_ ;
    scml2::reg<uint>      *CW_PIC0SSTOUTEN_ ;
    ...
    scml2::bitfield<uint> *CW_PIC0SSTSGSEL  ;
    scml2::bitfield<uint> *CW_PIC0SSTOUTEN  ;
    ...
    uint PIC0SSTSGSEL_PIC0SSTSGSEL1;
    uint PIC0SSTSGSEL_PIC0SSTSGSEL0;
    uint PIC0SSTOUTEN_PIC0SSTOUTEN0;
    ...
    virtual void cb_PIC0SSTOUTEN_PIC0SSTOUTEN0(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cpic1b_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cpic1b_regif::*) (RegCBstr)> > mRdCbAPI;
