...
#ifndef ECM_WP_CMDIF_H
#define ECM_WP_CMDIF_H
...
std::string own_handle_command(std::vector<std::string>& args)
{
  ...
  if (args[0] == "help") {
    ...
    ret += "    EnableTransInfo <enable>                  Enable/disable information display when ECM is turned on/off ( Default:false  )\n";
    ret += "    DumpStatInfo                              Dumps statistical information of ECM\n";
