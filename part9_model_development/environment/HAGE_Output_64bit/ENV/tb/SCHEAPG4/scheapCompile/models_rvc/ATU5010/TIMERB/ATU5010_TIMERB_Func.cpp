// ---------------------------------------------------------------------
// $Id: ATU5010_TIMERB_Func.cpp,v 1.2 2018/01/26 10:15:45 binhnguyen Exp $
//
...
/*********************************
// Function     : ATU5010_TIMERB_Func
// Description  : Constructor of ATU5010_TIMERB_Func class
// Parameter    :
//      name            Module name
//      Parent          Indicate base class
// Return value : None
**********************************/
ATU5010_TIMERB_Func::ATU5010_TIMERB_Func(std::string name, ATU5010_TIMERB *ATU5010_TIB_ptr):
                             Catu5010_timerb_regif(name,32)
{//{{{
    assert(ATU5010_TIB_ptr != NULL);
    mATU5010_TIB = ATU5010_TIB_ptr;
    mATU5010_TIB->CommandInit(name);
    Catu5010_timerb_regif::set_instance_name(name);
    mModuleName = name;
    mIsCMFB6M = false;
}//}}}
...
/*********************************
// Function     : ~ATU5010_TIMERB_Func
// Description  : Destructor of ATU5010_TIMERB_Func class
// Parameter    : None
// Return value : None
**********************************/
ATU5010_TIMERB_Func::~ATU5010_TIMERB_Func (void)
{//{{{
}//}}}
...
void ATU5010_TIMERB_Func::read (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::write (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
    unsigned int addr = (unsigned int)(trans.get_address()-0x400)&0x1FF;
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::PreReadCall (const unsigned int addr)
{//{{{
    if ((addr == 0x40)&&(mATU5010_TIB->IsTCNTB0Running(1))) { //Read TCNTB0S1
        SetTCNTB0(1, mATU5010_TIB->GetCounterValue("TCNTB0", 1));
    } else if ((addr == 0x60)&&(mATU5010_TIB->IsTCNTB0Running(2))) { //Read TCNTB0S2
        SetTCNTB0(2, mATU5010_TIB->GetCounterValue("TCNTB0", 2));
    } else if ((addr == 0x80)&&(mATU5010_TIB->IsTCNTB0Running(0))) { //Read TCNTB0
        SetTCNTB0(0, mATU5010_TIB->GetCounterValue("TCNTB0", 0));
    } else if (addr == 0x108) { //Read TCNTB2
        SetTCNTB2(mATU5010_TIB->GetCounterValue("TCNTB2", 0));
        ...
        SetTCNTB5(mATU5010_TIB->GetCounterValue("TCNTB5", 0));
    }
}//}}}

/*********************************
// Function     : RegisterHandler
// Description  : Set parameters or commands to Catu5010_timerb_regif class
// Parameter    :
//      args            Argument of parameter/command
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::RegisterHandler (const std::vector<std::string> &args)
{//{{{
    ...
    if (args.size() == 1) {//Dump registers name
        ...
        if (args[1] == "*") {//Set message level for each register
            ...
            while (reg_p != NULL) {
                ...
                msg_return = Catu5010_timerb_regif::reg_handle_command(cmd);
                if (msg_return != "") {
        ...
        } else {//Set handle command to Catu5010_timerb_regif class
            msg_return = Catu5010_timerb_regif::reg_handle_command(args);
            if (msg_return != "") {
                SC_REPORT_INFO(mModuleName.c_str(), msg_return.c_str());
            }
        }
...
// Description  : Reset ATU5010_TIMERB's registers
// Parameter    :
//      is_active           Active state of reset
// Return value : Register value
**********************************/
void ATU5010_TIMERB_Func::EnableReset (const bool is_active)
{//{{{
    Catu5010_timerb_regif::EnableReset(is_active);
}//}}}
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetCLKBusSel (void)
{//{{{
...
// Return value : Clock bus selection
**********************************/
unsigned int ATU5010_TIMERB_Func::GetChannelSel (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB0 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB1 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB2 (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB3 (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB4 (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCNTB5 (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTCCLRB (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetOCRB1 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetOCRB10 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetOCRB11 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetOCRB12 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
// Return value : OCRB1 value
**********************************/
unsigned int ATU5010_TIMERB_Func::GetICRB0 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
// Return value : OCRB1 value
**********************************/
unsigned int ATU5010_TIMERB_Func::GetICRB1 (const unsigned int block_num)
{//{{{
    if (block_num == 2) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetOCRB20_43 (const unsigned int state)
{//{{{
    unsigned int ret = 0;
    if (state > 0) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTEPCFB (const unsigned int state)
{//{{{
    unsigned int ret = 0;
    if (state > 0) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetPIM (void)
{//{{{
    unsigned int ret = (unsigned int)(*PIMR1)["PIM1"];
    if (((bool)(*TCRB)["PIMRSEL"]) && (mATU5010_TIB->IsTCNTB11COR(GetChannelSel()))) {
        ret = (unsigned int)(*PIMR2)["PIM2"];
    }
    return ret;
}//}}}

unsigned int ATU5010_TIMERB_Func::GetPIM1 (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetRLDB (void)
{//{{{
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetLDVal (void)
{//{{{
...
// Return value : load value
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTICRBVal (void)
{//{{{
...
// Return value : load value
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTIORBVal (void)
{//{{{
...
**********************************/
bool ATU5010_TIMERB_Func::GetTSEQNENB (const unsigned int state)
{//{{{
    bool ret = false;
    if (state > 0 && state <= 8) {
...
**********************************/
bool ATU5010_TIMERB_Func::GetFON (const unsigned int state)
{//{{{
    bool ret = false;
    if (state > 0 && state <= 8) {
...
**********************************/
bool ATU5010_TIMERB_Func::GetWriteCondition (const unsigned int addr)
{//{{{
    bool ret = true;
    if (addr == 0x4C || addr == 0x6C || addr == 0xC4) { //Write to TCNTB1S1/TCNTB1S2/TCNTB1
        if (((unsigned int)(*TSEQCRB)["EVSEQENB"]) == 1) {
            ret = false;
            mATU5010_TIB->re_printf("warning","Writing to TCNTB1/TCNTB1S1/TCNTB1S2 when TSEQCRB.EVSEQENB = 1 is prohibited\n");
        }
    }
    return ret;
}//}}}
...
// Description  : Return timer status stored in TSRA register
// Parameter    :
//      interrupt_id        Interrupt ID (according ATU5010_TIMERB::eInterruptId)
// Return value : Timer status stored in TSRB register
**********************************/
bool ATU5010_TIMERB_Func::GetTimerStatus (const unsigned int interrupt_id)
{//{{{
    if (interrupt_id == ATU5010_TIMERB::emCMIB0) {
        return (bool)(*TSRB)["CMFB0"];
    } else if (interrupt_id == ATU5010_TIMERB::emICIB0) {
        return (bool)(*TSRB)["ICFB0"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB1) {
        return (bool)(*TSRB)["CMFB1"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB6) {
        return (bool)(*TSRB)["CMFB6"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB10) {
        return (bool)(*TSRB)["CMFB10"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB11) {
        return (bool)(*TSRB)["CMFB11"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB12) {
        return (bool)(*TSRB)["CMFB12"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB6M) {
        return (bool)(*TSRB)["CMFB6M"];
    } else if (interrupt_id == ATU5010_TIMERB::emCMIB6E) {
        return (bool)(*TSRB)["CMFB6E"];
    }
}//}}}
...
**********************************/
bool ATU5010_TIMERB_Func::IsInterruptEnable (const std::string bit_name)
{//{{{
...
**********************************/
bool ATU5010_TIMERB_Func::IsEventInputEnable (void)
{//{{{
...
/*********************************
// Function     : IsLDEN
// Description  : Return true if TIORB.LDEN = 0
// Parameter    : None
// Return value : TCNTB2 and RLDB are updated on ICEB0 input capture or not
**********************************/
bool ATU5010_TIMERB_Func::IsLDEN (void)
{//{{{
    bool ret = false;
    if ((*TIORB)["LDEN"] == 0) {
        ret = true;
...
**********************************/
double ATU5010_TIMERB_Func::CalCycleCorrection (const unsigned int state)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB0 (const unsigned int block_num, const unsigned int value)
{//{{{
    if (block_num == 2) {
        (*TCNTB0S2) = value;
    } else if (block_num == 1) {
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB1 (const unsigned int block_num, const bool clear_trig, const bool clrb1sel)
{//{{{
    unsigned int tcntb1_val = 0;
    if (block_num == 2) {
        if (clear_trig) {
            if (((*TCRBS2)["CLRB1S2"] == 1) && (clrb1sel == ((bool)(*TCRBS2)["CLRB1SELS2"]))) {
                (*TCNTB1S2) = 1;
            }
        } else {
        ...
        if (clear_trig) {
            if (((*TCRBS1)["CLRB1S1"] == 1) && (clrb1sel == ((bool)(*TCRBS1)["CLRB1SELS1"]))) {
                (*TCNTB1S1) = 1;
            }
        } else {
        ...
        if (clear_trig) {
            if (((*TCRB)["CLRB1"] == 1) && (clrb1sel == ((bool)(*TCRB)["CLRB1SEL"]))) {
                (*TCNTB1) = 1;
            }
        } else {
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB2 (const unsigned int value)
{//{{{
    (*TCNTB2)["CNTB2"] = value;
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB3 (const bool clear_trig, const unsigned int clrb3sel)
{//{{{
    if (clear_trig) {
...
// Return value : None
**********************************/
bool ATU5010_TIMERB_Func::SetTCNTB4 (void)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB5 (const unsigned int value)
{//{{{
    (*TCNTB5)["CNTB5"] = value;
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCNTB6 (const bool clear_trig)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetICRB0 (const unsigned int block_num, const bool agck_trig, const unsigned int value)
{//{{{
    if (agck_trig) {
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetICRB1 (const unsigned int block_num, const bool clear_trig, const bool agck_trig, const unsigned int value)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetICRB2 (const unsigned int block_num, const unsigned int value)
{//{{{
    if (block_num == 2) {
        (*ICRB2S2) = value;
    } else if (block_num == 1) {
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetICRB3 (const unsigned int event_id, const unsigned int value)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTSEQRB (const unsigned int state)
{//{{{
    if ((state > 0) && (state <= 24)) {
...
**********************************/
unsigned int ATU5010_TIMERB_Func::GetTSEQRB (void)
{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTEPCVALRB0 (const unsigned int state)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::UpdateTimerStatus (const unsigned int interrupt_id)
{//{{{
    if (interrupt_id == ATU5010_TIMERB::emCMIB0) {
        (*TSRB)["CMFB0"] = 1;
    } else if (interrupt_id == ATU5010_TIMERB::emICIB0) {
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetRLDB (const unsigned int value)
{//{{{
    (*RLDB)["RLDVAL"] = value;
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::SetTCCLFB (const unsigned int value, const bool clear_trig)
{//{{{
    (*TCCLFRB)["TCCLFB"] = value & 0x1;
    if (clear_trig) {
        if ((*TCNT4CRB)["CU4SEL"] == 1) {
            (*TCNTB5)["CNTB5"] = 0x0;
        } else {
            (*TCNTB5)["CNTB5"] = 0x1;
        }
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCRB_CKSELB(RegCBstr str)
{//{{{
    unsigned int ckselb_val = (unsigned int)(*TCRB)["CKSELB"];
    unsigned int pre_ckselb_val = (unsigned int)(str.pre_data & 0x3);
    if ((ckselb_val != pre_ckselb_val)&&(mATU5010_TIB->IsTIBEn())) {
        mATU5010_TIB->re_printf("warning","Can not change selected counting clock\n");
        (*TCRB)["CKSELB"] = pre_ckselb_val;
    }
    if ((unsigned int)(*TCRB)["CLRB3SEL"] == 0x3) {
        mATU5010_TIB->re_printf("warning","Setting prohibited. There is no operation for this setting\n");
    }
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TSCRB_CMFCB0(RegCBstr str)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TICRB_IREGB6(RegCBstr str)
{//{{{
    if (mATU5010_TIB->IsTIBEn()) {
        mATU5010_TIB->re_printf("warning","Modifying register setting while the Timer B is enabled does not guarantee function correctly\n");
    }
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCNTB0S1_CNTB0S1(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB0", 1);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_OCRB0S1_OCB0S1(RegCBstr str)
{//{{{
    mATU5010_TIB->SetTCNTB0CORVal(1,(unsigned int)(*OCRB0S1)["OCB0S1"]);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCNTB0S2_CNTB0S2(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB0", 2);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_OCRB0S2_OCB0S2(RegCBstr str)
{//{{{
    mATU5010_TIB->SetTCNTB0CORVal(2,(unsigned int)(*OCRB0S2)["OCB0S2"]);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCNTB0_CNTB0(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB0", 0);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_OCRB0_OCB0(RegCBstr str)
{//{{{
    mATU5010_TIB->SetTCNTB0CORVal(0,(unsigned int)(*OCRB0)["OCB0"]);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCNTB2_CNTB2(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB2", 0);
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_PIMR1_PIM1(RegCBstr str)
{//{{{
    if (((*TCRB)["PIMRSEL"] == 0) || (!mATU5010_TIB->IsTCNTB11COR(GetChannelSel()))) {
        mATU5010_TIB->NotifyUpdatedPIMVal();
    }
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TSEQCRB_EVSEQENB(RegCBstr str)
{//{{{
    bool seq_en = (bool)(*TSEQCRB)["EVSEQENB"];
    if (seq_en != (bool)(str.pre_data & 0x1)) {
        mATU5010_TIB->EnableSeq(seq_en);
    }
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCNTB5_CNTB5(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB5", 0);
}//}}}

/*********************************
// Function     : cb_TCCLFSRB_TCCLFSB
// Description  : Callback function when TCCLFSRB register is written
// Parameter    :
//      str                 Register's callback string
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCCLFSRB_TCCLFSB(RegCBstr str)
{//{{{
    if ((bool)(*TCCLFSRB)["TCCLFSB"]) {
        if ((*TCNTB5)["CNTB5"] != (unsigned int)(*TCCLRB)["CCLRB"]) {
            if ((mATU5010_TIB->mIsTIBEnDontCareClock) && ((*TIORB)["CTCNTB5"] == 0x0) && (!mATU5010_TIB->mIsTCNTB5AutoCnt)) {
                SetTCCLFB(1, false);
                mATU5010_TIB->EnableTCNTB5AutoCounting(true);
            }
        } else {
            SetTCCLFB(0, true);
        }
...
/*********************************
// Function     : cb_TCCLFCRB_TCCLFCB
// Description  : Callback function when TCCLFCRB register is written
// Parameter    :
//      str                 Register's callback string
// Return value : None
**********************************/
void ATU5010_TIMERB_Func::cb_TCCLFCRB_TCCLFCB(RegCBstr str)
{//{{{
    if ((bool)(*TCCLFCRB)["TCCLFCB"]) {
        if ((bool)(*TCCLFRB)["TCCLFB"]) {
            mATU5010_TIB->EnableTCNTB5AutoCounting(false);
        }
        SetTCCLFB(0, false);
    }
    (*TCCLFCRB) = 0;
...
void ATU5010_TIMERB_Func::UpdateRBURB (void)
{//{{{
    if (GetChannelSel() == 0) {
...
void ATU5010_TIMERB_Func::cb_OCRB_OCB(RegCBstr str)
{//{{{
    if (((bool)(*TSEQCRB)["EVSEQENB"]) && (GetTSEQNENB(str.channel - 19))) {
        mATU5010_TIB->re_printf("warning","Write to OCRB%d register while sequencer is running is prohibited\n", str.channel);
        (*OCRB[str.channel]) = (unsigned int)str.pre_data;
    }
}//}}}

void ATU5010_TIMERB_Func::cb_TEPCFB_CRFIT2(RegCBstr str)
{//{{{
    if (((bool)(*TSEQCRB)["EVSEQENB"]) && (GetTSEQNENB(str.channel + 1))) {
        mATU5010_TIB->re_printf("warning","Write to TEPCFB%d register while sequencer is running is prohibited\n", str.channel);
        (*TEPCFB[str.channel]) = (unsigned int)str.pre_data;
    }
}//}}}

void ATU5010_TIMERB_Func::cb_TCCLRB_CCLRB(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedTCCLRBVal((unsigned int)(*TCCLRB)["CCLRB"]);
}//}}}

void ATU5010_TIMERB_Func::cb_TCNTB4_CNTB4(RegCBstr str)
{//{{{
    mATU5010_TIB->NotifyUpdatedCntVal("TCNTB4", 0);
}//}}}

void ATU5010_TIMERB_Func::cb_TIORB_LDSEL(RegCBstr str)
{//{{{
    if (((*TIORB)["CTCNTB5"] == 0x1) && ((((unsigned int)str.pre_data >> 6) & 0x1) == 0x0)) {
        // Disable TCNTB5
        if (mATU5010_TIB->mIsTCNTB5AutoCnt) {
            mATU5010_TIB->EnableTCNTB5AutoCounting(false);
        }
    } else if (((*TIORB)["CTCNTB5"] == 0x0) && ((((unsigned int)str.pre_data >> 6) & 0x1) == 0x1)) {
        // Enable TCNTB5
        if (mATU5010_TIB->mIsTIBEnDontCareClock) {
            mATU5010_TIB->CheckTCNTB5Update();
        }
    }
}//}}}
