// -----------------------------------------------------------------------------
// $Id: fcla_regif.h,v 1.3 2014/09/23 04:36:59 dungvannguyen Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __FCLA_REGIF_H__
#define __FCLA_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of FCLA model
class Cfcla_regif
...
public:
    Cfcla_regif(std::string name, uint buswidth);
    ~Cfcla_regif();

protected:
    vpcl::re_register *FCLA0CTL[8];

    #ifdef CWR_SYSTEMC
    scml2::memory<unsigned char> cwmem;
    scml2::reg<unsigned char> *CW_FCLA0CTL[8];
    #endif

    uint FCLA0CTL_FCLA0INTR[8];
    uint FCLA0CTL_FCLA0INTF[8];
    uint FCLA0CTL_FCLA0INTL[8];
    uint FCLA0CTL_FCLA0BYPS[8];
    ...
    virtual void cb_FCLA0CTL_FCLA0INTR(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cfcla_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cfcla_regif::*) (RegCBstr)> > mRdCbAPI;
