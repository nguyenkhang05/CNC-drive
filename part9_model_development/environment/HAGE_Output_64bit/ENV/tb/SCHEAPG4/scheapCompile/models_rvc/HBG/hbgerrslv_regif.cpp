// -----------------------------------------------------------------------------
// $Id: hbgerrslv_regif.cpp,v 1.9 2020/02/18 07:24:22 huyquocpham Exp $
//
...
/// @return none
Chbgerrslv_regif::Chbgerrslv_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
...
{
    CommandInit();
    HBGOVFCLR      = new vpcl::re_register(0x0000, this, "HBGOVFCLR"     , name.c_str());
    HBGOVFSTAT     = new vpcl::re_register(0x0004, this, "HBGOVFSTAT"    , name.c_str());
    HBGERRADDR     = new vpcl::re_register(0x0008, this, "HBGERRADDR"    , name.c_str());
    HBGERRTYPE     = new vpcl::re_register(0x000C, this, "HBGERRTYPE"    , name.c_str());
    HBGSPIDERRCLR  = new vpcl::re_register(0x0010, this, "HBGSPIDERRCLR" , name.c_str());
    HBGSPIDERRSTAT = new vpcl::re_register(0x0014, this, "HBGSPIDERRSTAT", name.c_str());
    HBGKCPROT      = new vpcl::re_register(0x0018, this, "HBGKCPROT"     , name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC 
    cw_instantiate_reg(CW_HBGOVFCLR       , HBGOVFCLR->name()     , HBGOVFCLR->addr()     );
    cw_instantiate_reg(CW_HBGOVFSTAT      , HBGOVFSTAT->name()    , HBGOVFSTAT->addr()    );
    cw_instantiate_reg(CW_HBGERRADDR      , HBGERRADDR->name()    , HBGERRADDR->addr()    );
    cw_instantiate_reg(CW_HBGERRTYPE      , HBGERRTYPE->name()    , HBGERRTYPE->addr()    );
    cw_instantiate_reg(CW_HBGSPIDERRCLR   , HBGSPIDERRCLR->name() , HBGSPIDERRCLR->addr() );
    cw_instantiate_reg(CW_HBGSPIDERRSTAT  , HBGSPIDERRSTAT->name(), HBGSPIDERRSTAT->addr());
    cw_instantiate_reg(CW_HBGKCPROT       , HBGKCPROT->name()     , HBGKCPROT->addr()     );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(HBGOVFCLR       , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGOVFSTAT      , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGERRADDR      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGERRTYPE      , mCurReg, 0,  4,   "16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGSPIDERRCLR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGSPIDERRSTAT  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HBGKCPROT       , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*HBGOVFCLR       ) ( 1,  1, "CLRO"    , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*HBGOVFSTAT      ) ( 1,  1, "OVF"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRADDR      ) (31,  0, "ADDR"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRTYPE      ) (13, 13, "SEC"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRTYPE      ) (12, 12, "DBG"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRTYPE      ) (11, 11, "UM"      , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRTYPE      ) (10,  6, "SPID"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGERRTYPE      ) ( 0,  0, "WRITE"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGSPIDERRCLR   ) (31,  0, "SPIDCLR" , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*HBGSPIDERRSTAT  ) (31,  0, "SPIDERR" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*HBGKCPROT       ) (31,  1, "KCPROT"  , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*HBGKCPROT       ) ( 0,  0, "KCE"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["HBGOVFCLR"   ]["CLRO"        ] = &Chbgerrslv_regif::cb_HBGOVFCLR_CLRO;
    mWrCbAPI["HBGSPIDERRCLR"]["SPIDCLR"     ] = &Chbgerrslv_regif::cb_HBGSPIDERRCLR_SPIDCLR;
    mWrCbAPI["HBGKCPROT"   ]["KCPROT"      ] = &Chbgerrslv_regif::cb_HBGKCPROT_KCPROT;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Chbgerrslv_regif::~Chbgerrslv_regif()
{
...
Chbgerrslv_regif::uint Chbgerrslv_regif::bit_select(
...
bool Chbgerrslv_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chbgerrslv_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chbgerrslv_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                  const unsigned char *p_data,   ///< [in] Writing data
                                  cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chbgerrslv_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                  unsigned char *p_data,   ///< [out] Reading data
                                  cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chbgerrslv_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                      const unsigned char *p_data,  ///< [in] Writing data
                                      cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chbgerrslv_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size,              ///< [in]  Data size (byte)
                                      bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Chbgerrslv_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                   unsigned char *p_data,          ///< [out] Reading data
                                   cuint size,                     ///< [in]  Data size (byte)
...
bool Chbgerrslv_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                   const unsigned char *p_data,      ///< [in] Writing data
                                   cuint size,                       ///< [in] Data size (byte)
                                   cuint reg_index,                  ///< [in] Register index
...
bool Chbgerrslv_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Chbgerrslv_regif::CommandInit()
{
...
/// @return string
std::string Chbgerrslv_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chbgerrslv_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chbgerrslv_regif::InitLocalVal()
{
    // Initialize local variables
    HBGOVFCLR_CLRO = 0x0;
    HBGOVFSTAT_OVF = 0x0;
    ...
    HBGERRTYPE_UM  = 0x0;
    HBGERRTYPE_SPID = 0x0;
    HBGERRTYPE_WRITE = 0x0;
    HBGSPIDERRCLR_SPIDCLR = 0x0;
    HBGSPIDERRSTAT_SPIDERR = 0x0;
    HBGKCPROT_KCPROT = 0x0;
    HBGKCPROT_KCE  = 0x0;
}

/// Update bit value to local value
/// @return None
void Chbgerrslv_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        HBGOVFCLR_CLRO                     = (*HBGOVFCLR     )["CLRO"          ];
        return;
    }
    if (addr == 0x0004) {
        HBGOVFSTAT_OVF                     = (*HBGOVFSTAT    )["OVF"           ];
        return;
    }
    if (addr == 0x0008) {
        HBGERRADDR_ADDR                    = (*HBGERRADDR    )["ADDR"          ];
        return;
    }
    if (addr == 0x000C) {
        HBGERRTYPE_SEC                     = (*HBGERRTYPE    )["SEC"           ];
        HBGERRTYPE_DBG                     = (*HBGERRTYPE    )["DBG"           ];
        HBGERRTYPE_UM                      = (*HBGERRTYPE    )["UM"            ];
        HBGERRTYPE_SPID                    = (*HBGERRTYPE    )["SPID"          ];
        HBGERRTYPE_WRITE                   = (*HBGERRTYPE    )["WRITE"         ];
        return;
    }
    if (addr == 0x0010) {
        HBGSPIDERRCLR_SPIDCLR              = (*HBGSPIDERRCLR )["SPIDCLR"       ];
        return;
    }
    if (addr == 0x0014) {
        HBGSPIDERRSTAT_SPIDERR             = (*HBGSPIDERRSTAT)["SPIDERR"       ];
        return;
    }
    if (addr == 0x0018) {
        HBGKCPROT_KCPROT                   = (*HBGKCPROT     )["KCPROT"        ];
        HBGKCPROT_KCE                      = (*HBGKCPROT     )["KCE"           ];
        return;
    }
}
...
/// @return None
void Chbgerrslv_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*HBGOVFCLR     )["CLRO"          ] = HBGOVFCLR_CLRO;
        return;
    }
    if (addr == 0x0004) {
        (*HBGOVFSTAT    )["OVF"           ] = HBGOVFSTAT_OVF;
        return;
    }
    if (addr == 0x0008) {
        (*HBGERRADDR    )["ADDR"          ] = HBGERRADDR_ADDR;
        return;
    }
    if (addr == 0x000C) {
        (*HBGERRTYPE    )["SEC"           ] = HBGERRTYPE_SEC;
        (*HBGERRTYPE    )["DBG"           ] = HBGERRTYPE_DBG;
        (*HBGERRTYPE    )["UM"            ] = HBGERRTYPE_UM;
        (*HBGERRTYPE    )["SPID"          ] = HBGERRTYPE_SPID;
        (*HBGERRTYPE    )["WRITE"         ] = HBGERRTYPE_WRITE;
        return;
    }
    if (addr == 0x0010) {
        (*HBGSPIDERRCLR )["SPIDCLR"       ] = HBGSPIDERRCLR_SPIDCLR;
        return;
    }
    if (addr == 0x0014) {
        (*HBGSPIDERRSTAT)["SPIDERR"       ] = HBGSPIDERRSTAT_SPIDERR;
        return;
    }
    if (addr == 0x0018) {
        (*HBGKCPROT     )["KCPROT"        ] = HBGKCPROT_KCPROT;
        (*HBGKCPROT     )["KCE"           ] = HBGKCPROT_KCE;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Chbgerrslv_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chbgerrslv_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chbgerrslv_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Chbgerrslv_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Chbgerrslv_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chbgerrslv_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Chbgerrslv_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC 
...
/// @return read data
Chbgerrslv_regif::uint Chbgerrslv_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC 
...
/// @return none
void Chbgerrslv_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chbgerrslv_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chbgerrslv_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Chbgerrslv_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC 
uint Chbgerrslv_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Chbgerrslv_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Chbgerrslv_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
