// -----------------------------------------------------------------------------
// $Id: atu5010_timere_sub_regif.h,v 1.1 2018/01/26 10:15:45 binhnguyen Exp $
//
...
//  ////////////////////////////////////////////////////////////////////////////////
/// @file atu5010_timere_sub_regif.h
...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5010_TIMERE_SUB_REGIF_H__
#define __ATU5010_TIMERE_SUB_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5010_TIMERE_SUB model
class Catu5010_timere_sub_regif
...
public:
    Catu5010_timere_sub_regif(std::string name, uint buswidth, uint subnum);
    ~Catu5010_timere_sub_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5010_timere_sub_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5010_timere_sub_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5010_TIMERE_SUB_REG_DEF_H__
