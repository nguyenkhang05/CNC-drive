// ---------------------------------------------------------------------
// $Id: ECC_LRAM_E2_FCC2_AgentController.h,v 1.3 2019/03/05 04:30:08 synguyen Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_LRAM_E2_FCC2_AGENT_CONTROLLER_H__
#define __ECC_LRAM_E2_FCC2_AGENT_CONTROLLER_H__
#include <systemc.h>
#include <iostream>
#include <cstring>
#include <iterator>
...
// Class ECC_LRAM_E2_FCC2_AgentController
class ECC_LRAM_E2_FCC2_AgentController
{
#include "ECC_LRAM_E2_FCC2_cmdif.h"
public:
    // Constructor/Destructor
    ECC_LRAM_E2_FCC2_AgentController(void) {;}
    virtual ~ECC_LRAM_E2_FCC2_AgentController(void) {;}
...
#endif //__ECC_LRAM_E2_FCC2_AGENT_CONTROLLER_H__
