// ---------------------------------------------------------------------
// $Id: IBG_U2_CommonGuardAgentControllerIf.h,v 1.2 2020/02/26 06:51:33 duongphan Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef IBG_U2_IBG_U2_COMMONGUARDAGENTCONTROLLERIF_H_
#define IBG_U2_IBG_U2_COMMONGUARDAGENTCONTROLLERIF_H_
 ...
 */
class IBG_U2_CommonGuardAgentControllerIf {
public:
    enum eErrorType {
          errSPID=0,
          errOtherSPID,
    ...
    virtual ~IBG_U2_CommonGuardAgentControllerIf () {};
     ...
     */
    virtual bool CheckGuardClock (std::string clock_name) = 0;
    ...
    virtual void TransferErrInfo (const std::string  groupName
                                ...
                                ,const uint8_t      SPID) {};
    //Commented by Quang
    //virtual void TransferErrInfo (const TlmBasicPayload &trans) {};
...
#endif /* IBG_U2_IBG_U2_COMMONGUARDAGENTCONTROLLERIF_H_ */
