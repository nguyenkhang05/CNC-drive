// ---------------------------------------------------------------------
// $Id: ECC_CRAM_E2_FCC2.h,v 1.7 2019/09/06 08:48:32 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_CRAM_E2_FCC2_H__
#define __ECC_CRAM_E2_FCC2_H__
...
#define CRAM_DEFAULT_AWIDTH_MSB 20
#define CRAM_HIGHEST_PORT_INDEX 0x15    // of CRam1U: slave port 21
#define CRAM_DEFAULT_AWIDTH_LSB 2
#define CRAM_DEFAULT_CAP_DEPTH 8
#define CRAM_DEFAULT_ERRINT_INIT 0x8F
//#define PE_MAX_NUM 8

class ECCCNT_CRCn_FCC2_Func;
class ECCCNT_CRA_FCC2_Func;
class MECCCAP_CR_FCC2_Func;

class ECC_CRAM_E2_FCC2: public sc_module
            ,public ECC_CRAM_E2_FCC2_AgentController
...
public:
    ...
    ECCCNT_CRCn_FCC2_Func        **mpECCCNT_CRCFunc;  // Pointer of ECCCNT_CRCn Func
    ECCCNT_CRA_FCC2_Func         *mpECCCNT_CRAFunc;          // Pointer of ECCCNT_CRA Func
    MECCCAP_CR_FCC2_Func         *mpMECCCAP_CRFunc;          // Pointer of MECCCAP_CR Func
...
private:
    ...
    enum eCRAMInfo{
        emTotalSlavePorts= PE_MAX_NUM + 12
    ...
    // Overwrite firtual functions of ECC_CRAM_E2_FCC2_AgentController
...
public:
    SC_HAS_PROCESS (ECC_CRAM_E2_FCC2);
    ECC_CRAM_E2_FCC2 (sc_module_name name, const uint8_t iPE_NUM, const unsigned int rLatency, const unsigned int wLatency);
    ~ECC_CRAM_E2_FCC2 ();
