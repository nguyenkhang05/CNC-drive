// -----------------------------------------------------------------------------
// $Id: dfe_fifo_regif.h,v 1.2 2018/09/06 10:17:09 huepham Exp $
//
...
/// $Author: huepham $
////////////////////////////////////////////////////////////////////////////////
#ifndef __DFE_FIFO_REGIF_H__
#define __DFE_FIFO_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of DFE_FIFO model
class Cdfe_fifo_regif
...
public:
    Cdfe_fifo_regif(std::string name, uint buswidth);
    ~Cdfe_fifo_regif();

protected:
    vpcl::re_register *DFBFACCTL ;
    vpcl::re_register *DFBFACTLCH[6];
    vpcl::re_register *DFBFADOCH [6];
    ...
    scml2::reg<uint> *CW_DFBFACTLCH[6];
    scml2::reg<uint> *CW_DFBFADOCH [6];
    ...
    uint DFBFACCTL_AIEE;
    uint DFBFACCTL_AUNE;
    uint DFBFACTLCH_CHEN[6];
    uint DFBFACTLCH_ADSL[6];
    uint DFBFACTLCH_BFACH[6];
    uint DFBFADOCH_ADO[6];
    uint DFBFACLR_CLRA;
    uint DFBFACST_OVFA;
    uint DFBFACST_EMPA;
    uint DFBFBCTL_BEN ;
    ...
    std::map<std::string, std::map<std::string, void (Cdfe_fifo_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cdfe_fifo_regif::*) (RegCBstr)> > mRdCbAPI;
