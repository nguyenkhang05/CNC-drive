// ---------------------------------------------------------------------
// $Id: ATU5011.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5011_H__
#define __ATU5011_H__
...
class ATU5011_Func;
class ATU5011: public sc_module,
            public ATU5011_AgentController,
...
private:
    ...
    ATU5011_Func *mATU5011_Func;            // ATU5011_Func class instance
    ...
    sc_event mResetCmdCancelEvent[emResetSignalNum];    //Call CancelResetCmdMethod when AssertReset is over                         //Notify clock is zero
...
public:
    ...
    /// Socket declaration
    TlmTargetSocket<32> *ts;            // For ATU5011's registers

    SC_HAS_PROCESS (ATU5011);
    ATU5011 (sc_module_name name,
...
private:
    ...
    /// Virtual functions of ATU5011_AgentController class
