// ---------------------------------------------------------------------
// $Id: ATU5010_TIMERA_Func.h,v 1.0 2016/11/24 10:15:45 binhnguyen Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5010_TIMERA_FUNC_H__
#define __ATU5010_TIMERA_FUNC_H__

#include "atu5010_timera_regif.h"
#include "OSCI2.h"

class ATU5010_TIMERA_Base;
class ATU5010_TIMERA_Func: public Catu5010_timera_regif
{
public:
    ATU5010_TIMERA_Func(std::string name, ATU5010_TIMERA_Base *ATU5010_TIA_Base_ptr);
    ~ATU5010_TIMERA_Func (void);
...
private:
    ATU5010_TIMERA_Base                *mATU5010_TIA_Base;
