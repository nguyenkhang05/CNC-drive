// -----------------------------------------------------------------------------
// $Id: dfe0051_regif.h,v 1.1 2017/07/14 03:22:20 chuonghoangle Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __DFE0051_REGIF_H__
#define __DFE0051_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of DFE0051 model
class Cdfe0051_regif
...
protected:
    ...
    enum eRegIndex {
        emNUM_DFEjCTLACHn     = 16,
        emNUM_DFEjCTLBCHn     = 16,
        emNUM_DFEjDOCHn       = 16,
        emNUM_DFEjPHCHn       = 16,
        emNUM_DFEjPHINDCHn    = 16,
        emNUM_DFEjSTCHn       = 16,
        emNUM_DFEjCLRSTCHn    = 16,
        emNUM_DFEjERMCHn      = 16,
        emNUM_DFEjTRGCHn      = 16,
        emNUM_DFEjTRHCHn      = 16,
        emNUM_DFEjPHUPDCn     = 4,
        emNUM_DFEjGAINCHn     = 16,
        emNUM_DFEjTMTRGCHn    = 16,
        emNUM_DFEjCPOFSTn     = 3,
...
public:
    Cdfe0051_regif(std::string name, uint buswidth);
    ~Cdfe0051_regif();

protected:
    vpcl::re_register *DFEjCTLACHn    [16];
    vpcl::re_register *DFEjCTLBCHn    [16];
    vpcl::re_register *DFEjDOCHn      [16];
    vpcl::re_register *DFEjPHCHn      [16];
    vpcl::re_register *DFEjPHINDCHn   [16];
    vpcl::re_register *DFEjSTCHn      [16];
    vpcl::re_register *DFEjCLRSTCHn   [16];
    vpcl::re_register *DFEjERMCHn     [16];
    vpcl::re_register *DFEjTRGCHn     [16];
    vpcl::re_register *DFEjTRHCHn     [16];
    ...
    vpcl::re_register *DFEjHOLCH12    ;
    vpcl::re_register *DFEjHOHCH12    ;
    vpcl::re_register *DFEjHOLCH14    ;
    vpcl::re_register *DFEjHOHCH14    ;
    ...
    vpcl::re_register *DFEjHOLMCH12   ;
    vpcl::re_register *DFEjHOLMCH14   ;
    vpcl::re_register *DFEjGAINCHn    [16];
    vpcl::re_register *DFEjTMTRGCHn   [16];
    ...
    scml2::reg<uint> *CW_DFEjCTLACHn    [16];
    scml2::reg<uint> *CW_DFEjCTLBCHn    [16];
    scml2::reg<uint> *CW_DFEjDOCHn      [16];
    scml2::reg<uint> *CW_DFEjPHCHn      [16];
    scml2::reg<uint> *CW_DFEjPHINDCHn   [16];
    scml2::reg<uint> *CW_DFEjSTCHn      [16];
    scml2::reg<uint> *CW_DFEjCLRSTCHn   [16];
    scml2::reg<uint> *CW_DFEjERMCHn     [16];
    scml2::reg<uint> *CW_DFEjTRGCHn     [16];
    scml2::reg<uint> *CW_DFEjTRHCHn     [16];
    ...
    scml2::reg<uint> *CW_DFEjACA        ;
    scml2::reg<uint> *CW_DFEjACB        ;
    scml2::reg<uint> *CW_DFEjACC        ;
    scml2::reg<uint> *CW_DFEjACD        ;
    scml2::reg<uint> *CW_DFEjDI         ;
    scml2::reg<uint> *CW_DFEjTRG        ;
    ...
    scml2::reg<uint> *CW_DFEjPHUPDCn    [4];
    ...
    scml2::reg<uint> *CW_DFEjHOLCH12    ;
    scml2::reg<uint> *CW_DFEjHOHCH12    ;
    scml2::reg<uint> *CW_DFEjHOLCH14    ;
    scml2::reg<uint> *CW_DFEjHOHCH14    ;
    ...
    scml2::reg<uint> *CW_DFEjHOLMCH12   ;
    scml2::reg<uint> *CW_DFEjHOLMCH14   ;
    scml2::reg<uint> *CW_DFEjGAINCHn    [16];
    scml2::reg<uint> *CW_DFEjTMTRGCHn   [16];
    ...
    uint DFEjCTLACHn_CATAG [16];
    uint DFEjCTLACHn_CAEN  [16];
    uint DFEjCTLACHn_TAG   [16];
    uint DFEjCTLACHn_CMD   [16];
    uint DFEjCTLACHn_FMT   [16];
    uint DFEjCTLACHn_IEP   [16];
    uint DFEjCTLACHn_IEE   [16];
    uint DFEjCTLACHn_IEC   [16];
    uint DFEjCTLACHn_IEO   [16];
    uint DFEjCTLACHn_CNSL  [16];
    uint DFEjCTLACHn_CNSLE [16];
    uint DFEjCTLACHn_AIME  [16];
    uint DFEjCTLACHn_EN    [16];
    uint DFEjCTLBCHn_OFSL  [16];
    uint DFEjCTLBCHn_DISB  [16];
    uint DFEjCTLBCHn_PHPS  [16];
    uint DFEjCTLBCHn_CPCS  [16];
    uint DFEjCTLBCHn_PHSLB2[16];
    uint DFEjCTLBCHn_DISA  [16];
    uint DFEjCTLBCHn_PRCSC [16];
    uint DFEjCTLBCHn_SELB2 [16];
    uint DFEjCTLBCHn_SELB1 [16];
    uint DFEjCTLBCHn_PRCSB [16];
    uint DFEjCTLBCHn_HOFS  [16];
    uint DFEjCTLBCHn_PICS  [16];
    uint DFEjCTLBCHn_SELA  [16];
    uint DFEjCTLBCHn_PFMT  [16];
    uint DFEjCTLBCHn_ABS   [16];
    uint DFEjCTLBCHn_PRCSA [16];
    uint DFEjDOCHn_DFEjDOCHn[16];
    uint DFEjPHCHn_DFEjPHCHn[16];
    uint DFEjPHINDCHn_PHIOW[16];
    uint DFEjPHINDCHn_PHIOF[16];
    uint DFEjPHINDCHn_PHIND[16];
    uint DFEjSTCHn_PH23ST  [16];
    uint DFEjSTCHn_VALID   [16];
    uint DFEjSTCHn_PHE     [16];
    uint DFEjSTCHn_CND     [16];
    uint DFEjSTCHn_DOEN    [16];
    uint DFEjSTCHn_CER     [16];
    uint DFEjSTCHn_AER     [16];
    uint DFEjSTCHn_MER     [16];
    uint DFEjSTCHn_GER     [16];
    uint DFEjSTCHn_DOOW    [16];
    uint DFEjSTCHn_DIOW    [16];
    uint DFEjCLRSTCHn_CLRPHIOW[16];
    uint DFEjCLRSTCHn_CLRPHE[16];
    uint DFEjCLRSTCHn_CLRCND[16];
    uint DFEjCLRSTCHn_CLRDOEN[16];
    uint DFEjCLRSTCHn_CLRCER[16];
    uint DFEjCLRSTCHn_CLRAER[16];
    uint DFEjCLRSTCHn_CLRMER[16];
    uint DFEjCLRSTCHn_CLRGER[16];
    uint DFEjCLRSTCHn_CLRDOOW[16];
    uint DFEjCLRSTCHn_CLRDIOW[16];
    uint DFEjERMCHn_MSKCER [16];
    uint DFEjERMCHn_MSKAER [16];
    uint DFEjERMCHn_MSKMER [16];
    uint DFEjERMCHn_MSKGER [16];
    uint DFEjERMCHn_MSKDOOW[16];
    uint DFEjERMCHn_MSKDIOW[16];
    uint DFEjTRGCHn_PMFE   [16];
    uint DFEjTRGCHn_PME    [16];
    uint DFEjTRGCHn_PFE    [16];
    uint DFEjTRGCHn_AFE    [16];
    uint DFEjTRGCHn_PE     [16];
    uint DFEjTRGCHn_PT     [16];
    uint DFEjTRGCHn_AE     [16];
    uint DFEjTRGCHn_AT     [16];
    uint DFEjTRGCHn_FE     [16];
    uint DFEjTRGCHn_FT     [16];
    uint DFEjTRHCHn_PMITS  [16];
    uint DFEjTRHCHn_PMETS  [16];
    uint DFEjTRHCHn_PITS   [16];
    uint DFEjTRHCHn_PETS   [16];
    uint DFEjTRHCHn_MITS   [16];
    uint DFEjTRHCHn_METS   [16];
    uint DFEjTRHCHn_FITS   [16];
    ...
    uint DFEjHOLCH12_DFEjHOLCH12;
    uint DFEjHOHCH12_GURD  ;
    uint DFEjHOLCH14_DFEjHOLCH14;
    uint DFEjHOHCH14_GURD  ;
    ...
    uint DFEjHOLMCH12_DFEjHOLMCH12;
    uint DFEjHOLMCH14_DFEjHOLMCH14;
    uint DFEjGAINCHn_GAIN3 [16];
    uint DFEjGAINCHn_GAIN2 [16];
    uint DFEjTMTRGCHn_PMT  [16];
    uint DFEjTMTRGCHn_PT   [16];
    uint DFEjTMTRGCHn_AT   [16];
    uint DFEjTMTRGCHn_FT   [16];
    ...
    virtual void cb_DFEjHOLCH12_DFEjHOLCH12(RegCBstr str) = 0;
    virtual void cb_DFEjHOHCH12_GURD(RegCBstr str) = 0;
    virtual void cb_DFEjHOLCH14_DFEjHOLCH14(RegCBstr str) = 0;
    virtual void cb_DFEjHOHCH14_GURD(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cdfe0051_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cdfe0051_regif::*) (RegCBstr)> > mRdCbAPI;
