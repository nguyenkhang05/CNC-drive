// ---------------------------------------------------------------------
// $Id: ATU5010_GLUE_Func.h,v 1.0 2016/11/24 10:15:45 binhnguyen Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5010_GLUE_FUNC_H__
#define __ATU5010_GLUE_FUNC_H__
#include "BusSlaveFuncIf.h"
#include "atu5010_glue_regif.h"

class ATU5010_GLUE_AgentController;

class ATU5010_GLUE_Func: public Catu5010_glue_regif,
                 public BusSlaveFuncIf
{
public:
    ATU5010_GLUE_Func (std::string name, ATU5010_GLUE_AgentController *ATU5010_GLUE_AgentControllerPtr);
    ~ATU5010_GLUE_Func (void);
...
private:
    ATU5010_GLUE_AgentController *mATU5010_GLUE_AgentController;
    std::string mModuleName;        //Module name

    /// Declare virtual functions of atu5010_glue_regif class
    void cb_ATUINTSELA_ATU_INTSEL_A0(RegCBstr str);
    //void cb_ATUINTSELC0_ATU_INTSEL_C0(RegCBstr str);
    //void cb_ATUINTSELC1_ATU_INTSEL_C1(RegCBstr str);
    void cb_ATUINTSELD_ATU_INTSEL_D00(RegCBstr str);
    void cb_ATUINTSELD7_ATU_INTSEL_D00(RegCBstr str);
    ...
    void cb_ATUP5SSEL_ATU_P5SSEL_TGC0(RegCBstr str);
};
