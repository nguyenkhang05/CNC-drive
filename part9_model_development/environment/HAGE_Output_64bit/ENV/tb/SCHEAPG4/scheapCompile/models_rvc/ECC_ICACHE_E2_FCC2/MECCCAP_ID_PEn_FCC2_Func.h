// ---------------------------------------------------------------------
// $Id: MECCCAP_ID_PEn_FCC2_Func.h,v 1.5 2019/09/06 08:49:26 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __MECCCAP_ID_PEN_FCC2_FUNC_H__
#define __MECCCAP_ID_PEN_FCC2_FUNC_H__

#include "BusSlaveFuncIf.h"
#include "mecccap_id_pen_fcc2_regif.h"
#include "ECC_ICACHE_E2_FCC2_AgentController.h"
#include "global.h"

class MECCCAP_ID_PEn_FCC2_Func: public Cmecccap_id_pen_fcc2_regif
                ,public BusSlaveFuncIf
{
public:
    SC_HAS_PROCESS (MECCCAP_ID_PEn_FCC2_Func);
    MECCCAP_ID_PEn_FCC2_Func(std::string name, unsigned int pe_id, ECC_ICACHE_E2_FCC2_AgentController* ICACHEAgentController);
    ~MECCCAP_ID_PEn_FCC2_Func();
    ...
    unsigned int GetID_SERSTR();
    unsigned int GetID_DERSTR();
    unsigned int GetID_OVFSTR();
...
private:
    ...
    // Callback
    void cb_ID_SSTCLR_ID_SSTCLR(RegCBstr str);
    void cb_ID_DSTCLR_DSTCLR00(RegCBstr str);
    void cb_ID_OVFCLR_SERROVFCLR0(RegCBstr str);

};
#endif //__MECCCAP_ID_PEN_FCC2_FUNC_H__
