// -----------------------------------------------------------------------------
// $Id: atu5_timerb_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
//
// Input file : atu5_timerb_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ATU5_TIMERB
//     #                   name            offset_size
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file atu5_timerb_regif.cpp
/// @brief Register IF class of model ATU5_TIMERB
/// $Id: atu5_timerb_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
...
/// @return none
Catu5_timerb_regif::Catu5_timerb_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    cw_instantiate_reg(CW_TCCLFRB_, "TCCLFRB_", 0x018C);
    CW_TCCLFRB    = new scml2::bitfield<uint>(TCCLFRB->name()   , CW_TCCLFRB_            ,  0,  8);
    ...
    mWrCbAPI["TCRB"    ]["CKSELB"  ] = &Catu5_timerb_regif::cb_TCRB_CKSELB;
    mWrCbAPI["TIORB"   ]["LDSEL"   ] = &Catu5_timerb_regif::cb_TIORB_LDSEL;
    mWrCbAPI["TSCRB"   ]["CMFCB0"  ] = &Catu5_timerb_regif::cb_TSCRB_CMFCB0;
    mWrCbAPI["TICRB"   ]["IREGB6"  ] = &Catu5_timerb_regif::cb_TICRB_IREGB6;
    mWrCbAPI["TCNTB0S1"]["CNTB0S1" ] = &Catu5_timerb_regif::cb_TCNTB0S1_CNTB0S1;
    mWrCbAPI["OCRB0S1" ]["OCB0S1"  ] = &Catu5_timerb_regif::cb_OCRB0S1_OCB0S1;
    mWrCbAPI["TCNTB0S2"]["CNTB0S2" ] = &Catu5_timerb_regif::cb_TCNTB0S2_CNTB0S2;
    mWrCbAPI["OCRB0S2" ]["OCB0S2"  ] = &Catu5_timerb_regif::cb_OCRB0S2_OCB0S2;
    mWrCbAPI["TCNTB0"  ]["CNTB0"   ] = &Catu5_timerb_regif::cb_TCNTB0_CNTB0;
    mWrCbAPI["OCRB0"   ]["OCB0"    ] = &Catu5_timerb_regif::cb_OCRB0_OCB0;
    mWrCbAPI["TCNTB2"  ]["CNTB2"   ] = &Catu5_timerb_regif::cb_TCNTB2_CNTB2;
    mWrCbAPI["PIMR1"   ]["PIM1"    ] = &Catu5_timerb_regif::cb_PIMR1_PIM1;
    mWrCbAPI["TSEQCRB" ]["EVSEQENB"] = &Catu5_timerb_regif::cb_TSEQCRB_EVSEQENB;
    mWrCbAPI["TCNTB4"  ]["CNTB4"   ] = &Catu5_timerb_regif::cb_TCNTB4_CNTB4;
    mWrCbAPI["TCNTB5"  ]["CNTB5"   ] = &Catu5_timerb_regif::cb_TCNTB5_CNTB5;
    mWrCbAPI["TCCLRB"  ]["CCLRB"   ] = &Catu5_timerb_regif::cb_TCCLRB_CCLRB;

    mRdCbAPI["TCNTB2"  ]["CNTB2"   ] = &Catu5_timerb_regif::cb_TCNTB2_CNTB2;
    mRdCbAPI["TCNTB5"  ]["CNTB5"   ] = &Catu5_timerb_regif::cb_TCNTB5_CNTB5;

    for(uint i = 0; i < emNUM_OCRB; i++) {
        str_tmp.str("");
        str_tmp<<"OCRB"<< mFactorIndexOCRB[i];
        mWrCbAPI[str_tmp.str()]["OCB"] = &Catu5_timerb_regif::cb_OCRB_OCB;
    }
    for(uint i = 0; i < emNUM_TEPCFB; i++) {
        str_tmp.str("");
        str_tmp<<"TEPCFB"<< i;
        mWrCbAPI[str_tmp.str()]["CRFIT2"] = &Catu5_timerb_regif::cb_TEPCFB_CRFIT2;
    }
    InitLocalVal();

    //Construct the list of register whose read callbacks are executed in debug mode
    list_rdcb_dbg.push_back(0x108); // TCNTB2
    list_rdcb_dbg.push_back(0x188); // TCNTB5
}

/// Destructor: delete pointers
/// @return none
Catu5_timerb_regif::~Catu5_timerb_regif()
{
...
Catu5_timerb_regif::uint Catu5_timerb_regif::bit_select(
...
bool Catu5_timerb_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5_timerb_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timerb_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timerb_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timerb_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timerb_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5_timerb_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5_timerb_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Catu5_timerb_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5_timerb_regif::CommandInit()
{
...
/// @return string
std::string Catu5_timerb_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5_timerb_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5_timerb_regif::InitLocalVal()
{
    // Initialize local variables
    TCRB_CKSELB = 0x0;
    TCRB_CLRB1SEL = 0x0;
...
/// @return None
void Catu5_timerb_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Catu5_timerb_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Catu5_timerb_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5_timerb_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5_timerb_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5_timerb_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5_timerb_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5_timerb_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5_timerb_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Catu5_timerb_regif::uint Catu5_timerb_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Catu5_timerb_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5_timerb_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5_timerb_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5_timerb_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Catu5_timerb_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Catu5_timerb_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Catu5_timerb_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
