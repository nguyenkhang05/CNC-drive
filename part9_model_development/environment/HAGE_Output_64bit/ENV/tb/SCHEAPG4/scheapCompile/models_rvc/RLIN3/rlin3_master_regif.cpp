...
//    regif_cpp.skl
//
// Input file : /shsv/sld/ipp/project/2018/rel/ipd2_sld_12006_rlin3/02_Output/DATA/src/rlin3_master_regif.txt
////////////////////////////////////////////////////////////////////////////////
// # ---------------------------------------------------------------------
// # $Id: $
// #
...
//     %%REG      LWBR       LWBR           8|16|32    8       0x01      -       0        TRUE     R|W
//     %%REG      LBRP0      LBRP0          8|16|32    8       0x02      -       0        TRUE     R|W  
//     %%REG      LBRP1      LBRP1          8|16|32    8       0x03      -       0        TRUE     R|W
//     %%REG      LSTC       LSTC           8|16|32    8       0x04      -       0        TRUE     R|W
//     %%REG      LMD        LMD            8|16|32    8       0x08      -       0        TRUE     R|W
//     %%REG      LBFC       LBFC           8|16|32    8       0x09      -       0        TRUE     R|W
//     %%REG      LSC        LSC            8|16|32    8       0x0A      -       0        TRUE     R|W
//     %%REG      LWUP       LWUP           8|16|32    8       0x0B      -       0        TRUE     R|W
//     %%REG      LIE        LIE            8|16|32    8       0x0C      -       0        TRUE     R|W
//     %%REG      LEDE       LEDE           8|16|32    8       0x0D      -       0        TRUE     R|W
//     %%REG      LCUC       LCUC           8|16|32    8       0x0E      -       0        TRUE     R|W
//     %%REG      LTRC       LTRC           8|16|32    8       0x10      -       0        TRUE     R|W
//     %%REG      LMST       LMST           8|16|32    8       0x11      -       0        TRUE     W
//     %%REG      LST        LST            8|16|32    8       0x12      -       0        TRUE     R|W
//     %%REG      LEST       LEST           8|16|32    8       0x13      -       0        TRUE     R|W
//     %%REG      LDFC       LDFC           8|16|32    8       0x14      -       0        TRUE     R|W
//     %%REG      LIDB       LIDB           8|16|32    8       0x15      -       0        TRUE     R|W
//     %%REG      LCBR       LCBR           8|16|32    8       0x16      -       0        TRUE     R|W
//     %%REG      LUDB0      LUDB0          8|16|32    8       0x17      -       0        TRUE     R|W
//     %%REG      LDB1       LDB1           8|16|32    8       0x18      -       0        TRUE     R|W
//     %%REG      LDB2       LDB2           8|16|32    8       0x19      -       0        TRUE     R|W
//     %%REG      LDB3       LDB3           8|16|32    8       0x1A      -       0        TRUE     R|W
//     %%REG      LDB4       LDB4           8|16|32    8       0x1B      -       0        TRUE     R|W
//     %%REG      LDB5       LDB5           8|16|32    8       0x1C      -       0        TRUE     R|W
//     %%REG      LDB6       LDB6           8|16|32    8       0x1D      -       0        TRUE     R|W
//     %%REG      LDB7       LDB7           8|16|32    8       0x1E      -       0        TRUE     R|W
//     %%REG      LDB8       LDB8           8|16|32    8       0x1F      -       0        TRUE     R|W
//     %%REG      LUOER      LUOER          8|16|32    8       0x20      -       0        TRUE     R|W
//     %%REG      LUOR1      LUOR1          8|16|32    8       0x21      -       0        TRUE     R|W
//     %%REG      LUOR2      LUOR2          8|16|32    8       0x22      -       0        FALSE    -
//     %%REG      LUTDCR     LUTDCR         8|16|32    8       0x23      -       0        FALSE    -
//     %%REG      LUTDR      LUTDR          8|16       16      0x24      -       0        TRUE     -
//     %%REG      LURDR      LURDR          8|16       16      0x26      -       0        TRUE     R|W
...
//     %%BIT    LWBR0          0      0      0     R|W     TRUE     R|W   
//     %%BIT    LPRS           3      1      0     R|W     TRUE     -   
//     %%BIT    NSPB           7      4      0     R|W     TRUE     -   
// 
// %REG_NAME LBRP0      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LBRP0          7      0      0     R|W     TRUE     R|W 
// 
// %REG_NAME LBRP1      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LBRP1          7      0      0     R|W     TRUE     R|W 
// 
// %REG_NAME LSTC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LSTM           0      0      0     R|W     TRUE     R|W    
//     %%BIT    LSTME          6      1      0     R|W     TRUE     -   
//     %%BIT    LSFWC          7      7      0     R|W     FALSE    -   
// 
// %REG_NAME LMD      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LMD            1      0      0     R|W     TRUE     R|W    
...
// %REG_NAME LBFC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    BLT            3      0      0     R|W     TRUE     R|W  
//     %%BIT    BDT            5      4      0     R|W     TRUE     -  
// 
// %REG_NAME LSC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    IBHS           2      0      0     R|W     TRUE     R|W    
//     %%BIT    IBS            5      4      0     R|W     TRUE     -    
// 
// %REG_NAME LWUP      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    WUTL           7      4      0     R|W     TRUE     R|W   
// 
// %REG_NAME LIE      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    FTCIE          0      0      0     R|W     TRUE     R|W   
...
// %REG_NAME LEDE      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    BERE           0      0      0     R|W     TRUE     R|W    
//     %%BIT    PBERE          1      1      0     R|W     TRUE     -  
//     %%BIT    FTERE          2      2      0     R|W     TRUE     -   
//     %%BIT    FERE           3      3      0     R|W     TRUE     -     
//     %%BIT    LTES           7      7      0     R|W     TRUE     -   
// 
// %REG_NAME LCUC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    OM0            0      0      0     R|W     TRUE     R|W     
//     %%BIT    OM1            1      1      0     R|W     TRUE     -   
// 
// %REG_NAME LTRC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    FTS            0      0      0     R|W     TRUE     R|W      
//     %%BIT    RTS            1      1      0     R|W     TRUE     -       
// 
// %REG_NAME LMST      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    OMM0           0      0      0     R       TRUE     R|W     
//     %%BIT    OMM1           1      1      0     R       TRUE     -     
// 
// %REG_NAME LST      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    FTC            0      0      0     R|W0    TRUE     R|W        
//     %%BIT    FRC            1      1      0     R|W0    TRUE     -      
//     %%BIT    ERR            3      3      0     R       TRUE     -      
//     %%BIT    D1RC           6      6      0     R|W0    TRUE     -     
//     %%BIT    HTRC           7      7      0     R|W0    TRUE     -     
// 
// %REG_NAME LEST      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    BER            0      0      0     R|W0    TRUE     R|W      
//     %%BIT    PBER           1      1      0     R|W0    TRUE     -     
//     %%BIT    FTER           2      2      0     R|W0    TRUE     -    
//     %%BIT    FER            3      3      0     R|W0    TRUE     -      
//     %%BIT    CSER           5      5      0     R|W0    TRUE     -     
//     %%BIT    RPER           7      7      0     R|W0    TRUE     -     
// 
// %REG_NAME LDFC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    RFDL           3      0      0     R|W     TRUE     R|W      
//     %%BIT    RFT            4      4      0     R|W     TRUE     -     
//     %%BIT    CSM            5      5      0     R|W     TRUE     -     
//     %%BIT    FSM            6      6      0     R|W     TRUE     -     
//     %%BIT    LSS            7      7      0     R|W     TRUE     -      
// 
// %REG_NAME LIDB      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    ID             5      0      0     R|W     TRUE     R|W     
//     %%BIT    IDP0           6      6      0     R|W     TRUE     -    
//     %%BIT    IDP1           7      7      0     R|W     TRUE     -    
// 
// %REG_NAME LCBR      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    CKSM           7      0      0     R|W     TRUE     R|W      
// 
// %REG_NAME LUDB0      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    UDB            7      0      0     R|W     TRUE     R|W    
// 
// %REG_NAME LDB1      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LDB            7      0      0     R|W     TRUE     R|W     
// 
// %REG_NAME LDB2      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    LDB            7      0      0     R|W     TRUE     R|W     
...
// %REG_NAME LUOER      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    UTOE           0      0      0     R|W     TRUE     R|W    
//     %%BIT    UROE           1      1      0     R|W     TRUE     -    
// 
// %REG_NAME LUOR1      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    UEBE           0      0      0     R|W     TRUE     R|W  
...
////////////////////////////////////////////////////////////////////////////////
/// @file rlin3_master_regif.cpp
/// @brief Register IF class of model RLIN3_MASTER
/// $Id$
/// $Date$
/// $Revison$
/// $Author$
...
/// @return none
Crlin3_master_regif::Crlin3_master_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    (*LBRP0   ) ( 7,  0, "LBRP0"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LBRP1   ) ( 7,  0, "LBRP1"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LBFC    ) ( 3,  0, "BLT"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LBFC    ) ( 5,  4, "BDT"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LEDE    ) ( 1,  1, "PBERE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 2,  2, "FTERE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 3,  3, "FERE"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 7,  7, "LTES"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LCUC    ) ( 0,  0, "OM0"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LCUC    ) ( 1,  1, "OM1"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTRC    ) ( 0,  0, "FTS"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTRC    ) ( 1,  1, "RTS"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LMST    ) ( 0,  0, "OMM0"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LMST    ) ( 1,  1, "OMM1"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LST     ) ( 0,  0, "FTC"     , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LST     ) ( 1,  1, "FRC"     , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LST     ) ( 3,  3, "ERR"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LST     ) ( 6,  6, "D1RC"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LST     ) ( 7,  7, "HTRC"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 0,  0, "BER"     , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 1,  1, "PBER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 2,  2, "FTER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 3,  3, "FER"     , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 5,  5, "CSER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 7,  7, "RPER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 3,  0, "RFDL"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 4,  4, "RFT"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 5,  5, "CSM"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 6,  6, "FSM"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 7,  7, "LSS"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LIDB    ) ( 5,  0, "ID"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LIDB    ) ( 6,  6, "IDP0"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LIDB    ) ( 7,  7, "IDP1"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LURDR   ) ( 8,  0, "URD"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["LWBR"]["LWBR0"] = &Crlin3_master_regif::cb_LWBR_LWBR0;
    mWrCbAPI["LBRP0"]["LBRP0"] = &Crlin3_master_regif::cb_LBRP0_LBRP0;
    mWrCbAPI["LBRP1"]["LBRP1"] = &Crlin3_master_regif::cb_LBRP1_LBRP1;
    mWrCbAPI["LSTC"]["LSTM"] = &Crlin3_master_regif::cb_LSTC_LSTM;
    mWrCbAPI["LMD" ]["LMD" ] = &Crlin3_master_regif::cb_LMD_LMD;
    mWrCbAPI["LBFC"]["BLT" ] = &Crlin3_master_regif::cb_LBFC_BLT;
    mWrCbAPI["LSC" ]["IBHS"] = &Crlin3_master_regif::cb_LSC_IBHS;
    mWrCbAPI["LWUP"]["WUTL"] = &Crlin3_master_regif::cb_LWUP_WUTL;
    mWrCbAPI["LIE" ]["FTCIE"] = &Crlin3_master_regif::cb_LIE_FTCIE;
    mWrCbAPI["LEDE"]["BERE"] = &Crlin3_master_regif::cb_LEDE_BERE;
    mWrCbAPI["LCUC"]["OM0" ] = &Crlin3_master_regif::cb_LCUC_OM0;
    mWrCbAPI["LTRC"]["FTS" ] = &Crlin3_master_regif::cb_LTRC_FTS;
    mWrCbAPI["LMST"]["OMM0"] = &Crlin3_master_regif::cb_LMST_OMM0;
    mWrCbAPI["LST" ]["FTC" ] = &Crlin3_master_regif::cb_LST_FTC;
    mWrCbAPI["LEST"]["BER" ] = &Crlin3_master_regif::cb_LEST_BER;
    mWrCbAPI["LDFC"]["RFDL"] = &Crlin3_master_regif::cb_LDFC_RFDL;
    mWrCbAPI["LIDB"]["ID"  ] = &Crlin3_master_regif::cb_LIDB_ID;
    mWrCbAPI["LCBR"]["CKSM"] = &Crlin3_master_regif::cb_LCBR_CKSM;
    mWrCbAPI["LUDB0"]["UDB" ] = &Crlin3_master_regif::cb_LUDB0_UDB;
    mWrCbAPI["LDB1"]["LDB" ] = &Crlin3_master_regif::cb_LDB1_LDB;
    mWrCbAPI["LDB2"]["LDB" ] = &Crlin3_master_regif::cb_LDB2_LDB;
    mWrCbAPI["LDB3"]["LDB" ] = &Crlin3_master_regif::cb_LDB3_LDB;
    mWrCbAPI["LDB4"]["LDB" ] = &Crlin3_master_regif::cb_LDB4_LDB;
    mWrCbAPI["LDB5"]["LDB" ] = &Crlin3_master_regif::cb_LDB5_LDB;
    mWrCbAPI["LDB6"]["LDB" ] = &Crlin3_master_regif::cb_LDB6_LDB;
    mWrCbAPI["LDB7"]["LDB" ] = &Crlin3_master_regif::cb_LDB7_LDB;
    mWrCbAPI["LDB8"]["LDB" ] = &Crlin3_master_regif::cb_LDB8_LDB;
    mWrCbAPI["LUOER"]["UTOE"] = &Crlin3_master_regif::cb_LUOER_UTOE;
    mWrCbAPI["LUOR1"]["UEBE"] = &Crlin3_master_regif::cb_LUOR1_UEBE;
    mWrCbAPI["LUTDR"]["UTD" ] = &Crlin3_master_regif::cb_LUTDR_UTD;
    mWrCbAPI["LURDR"]["URD" ] = &Crlin3_master_regif::cb_LURDR_URD;
    mWrCbAPI["LUWTDR"]["UWTD"] = &Crlin3_master_regif::cb_LUWTDR_UWTD;

    mRdCbAPI["LWBR"]["LWBR0"] = &Crlin3_master_regif::cb_LWBR_LWBR0;
    mRdCbAPI["LBRP0"]["LBRP0"] = &Crlin3_master_regif::cb_LBRP0_LBRP0;
    mRdCbAPI["LBRP1"]["LBRP1"] = &Crlin3_master_regif::cb_LBRP1_LBRP1;
    mRdCbAPI["LSTC"]["LSTM"] = &Crlin3_master_regif::cb_LSTC_LSTM;
    mRdCbAPI["LMD" ]["LMD" ] = &Crlin3_master_regif::cb_LMD_LMD;
    mRdCbAPI["LBFC"]["BLT" ] = &Crlin3_master_regif::cb_LBFC_BLT;
    mRdCbAPI["LSC" ]["IBHS"] = &Crlin3_master_regif::cb_LSC_IBHS;
    mRdCbAPI["LWUP"]["WUTL"] = &Crlin3_master_regif::cb_LWUP_WUTL;
    mRdCbAPI["LIE" ]["FTCIE"] = &Crlin3_master_regif::cb_LIE_FTCIE;
    mRdCbAPI["LEDE"]["BERE"] = &Crlin3_master_regif::cb_LEDE_BERE;
    mRdCbAPI["LCUC"]["OM0" ] = &Crlin3_master_regif::cb_LCUC_OM0;
    mRdCbAPI["LTRC"]["FTS" ] = &Crlin3_master_regif::cb_LTRC_FTS;
    mRdCbAPI["LMST"]["OMM0"] = &Crlin3_master_regif::cb_LMST_OMM0;
    mRdCbAPI["LST" ]["FTC" ] = &Crlin3_master_regif::cb_LST_FTC;
    mRdCbAPI["LEST"]["BER" ] = &Crlin3_master_regif::cb_LEST_BER;
    mRdCbAPI["LDFC"]["RFDL"] = &Crlin3_master_regif::cb_LDFC_RFDL;
    mRdCbAPI["LIDB"]["ID"  ] = &Crlin3_master_regif::cb_LIDB_ID;
    mRdCbAPI["LCBR"]["CKSM"] = &Crlin3_master_regif::cb_LCBR_CKSM;
    mRdCbAPI["LUDB0"]["UDB" ] = &Crlin3_master_regif::cb_LUDB0_UDB;
    mRdCbAPI["LDB1"]["LDB" ] = &Crlin3_master_regif::cb_LDB1_LDB;
    mRdCbAPI["LDB2"]["LDB" ] = &Crlin3_master_regif::cb_LDB2_LDB;
    mRdCbAPI["LDB3"]["LDB" ] = &Crlin3_master_regif::cb_LDB3_LDB;
    mRdCbAPI["LDB4"]["LDB" ] = &Crlin3_master_regif::cb_LDB4_LDB;
    mRdCbAPI["LDB5"]["LDB" ] = &Crlin3_master_regif::cb_LDB5_LDB;
    mRdCbAPI["LDB6"]["LDB" ] = &Crlin3_master_regif::cb_LDB6_LDB;
    mRdCbAPI["LDB7"]["LDB" ] = &Crlin3_master_regif::cb_LDB7_LDB;
    mRdCbAPI["LDB8"]["LDB" ] = &Crlin3_master_regif::cb_LDB8_LDB;
    mRdCbAPI["LUOER"]["UTOE"] = &Crlin3_master_regif::cb_LUOER_UTOE;
    mRdCbAPI["LUOR1"]["UEBE"] = &Crlin3_master_regif::cb_LUOR1_UEBE;
    mRdCbAPI["LURDR"]["URD" ] = &Crlin3_master_regif::cb_LURDR_URD;
    InitLocalVal();
    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Crlin3_master_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Crlin3_master_regif::~Crlin3_master_regif()
{
...
Crlin3_master_regif::uint Crlin3_master_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Crlin3_master_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Crlin3_master_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Crlin3_master_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                     const unsigned char *p_data,   ///< [in] Writing data
                                     cuint size)                    ///< [in] Data size (byte)
{
    if (size == 0) {
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Crlin3_master_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                     unsigned char *p_data,   ///< [out] Reading data
                                     cuint size)              ///< [in]  Data size (byte)
{
    if (size == 0) {
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Crlin3_master_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                         const unsigned char *p_data,  ///< [in] Writing data
                                         cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Crlin3_master_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                         unsigned char *p_data,   ///< [out] Reading data
                                         cuint size,              ///< [in]  Data size (byte)
                                         bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
bool Crlin3_master_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                      unsigned char *p_data,          ///< [out] Reading data
                                      cuint size,                     ///< [in]  Data size (byte)
...
bool Crlin3_master_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                      const unsigned char *p_data,      ///< [in] Writing data
                                      cuint size,                       ///< [in] Data size (byte)
                                      cuint reg_index,                  ///< [in] Register index
...
bool Crlin3_master_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return none
void Crlin3_master_regif::CommandInit()
{
...
/// @return string
std::string Crlin3_master_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Crlin3_master_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Crlin3_master_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Crlin3_master_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Crlin3_master_regif::IssueRegValueID(void)
{//{{{
...
/// @return none
void Crlin3_master_regif::InitLocalVal()
{
    // Initialize local variables
    LWBR_LWBR0 = 0x0;
    LWBR_LPRS = 0x0;
...
/// @return None
void Crlin3_master_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0001) {
    ...
    if (addr == 0x000D) {
        LEDE_BERE                  = (*LEDE  )["BERE"  ];
        LEDE_PBERE                 = (*LEDE  )["PBERE" ];
        LEDE_FTERE                 = (*LEDE  )["FTERE" ];
        LEDE_FERE                  = (*LEDE  )["FERE"  ];
        LEDE_LTES                  = (*LEDE  )["LTES"  ];
        return;
    }
...
/// @return None
void Crlin3_master_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0001) {
    ...
    if (addr == 0x000D) {
        (*LEDE  )["BERE"  ] = LEDE_BERE;
        (*LEDE  )["PBERE" ] = LEDE_PBERE;
        (*LEDE  )["FTERE" ] = LEDE_FTERE;
        (*LEDE  )["FERE"  ] = LEDE_FERE;
        (*LEDE  )["LTES"  ] = LEDE_LTES;
        return;
    }
...
/// @return vector
std::vector<std::string> Crlin3_master_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Crlin3_master_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Crlin3_master_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Crlin3_master_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Crlin3_master_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Crlin3_master_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Crlin3_master_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USE_CWR_SYSTEMC
...
/// @return read data
Crlin3_master_regif::uint Crlin3_master_regif::rd_cb(cuint addr)
{
    #ifdef USE_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Crlin3_master_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Crlin3_master_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Crlin3_master_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Crlin3_master_regif::EnableReset(const bool is_active)
{
...
#ifdef USE_CWR_SYSTEMC
unsigned short Crlin3_master_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Crlin3_master_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Crlin3_master_regif::cw_set_all_callback_reg(void)
{
