// -----------------------------------------------------------------------------
// $Id: mecccap_cfl_regif.cpp,v 1.1 2019/09/26 10:06:59 landang Exp $
//
...
/// @return none
Cmecccap_cfl_regif::Cmecccap_cfl_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    mWrCbAPI["CF_SSTCLR"]["CF_SSTCLR"] = &Cmecccap_cfl_regif::cb_CF_SSTCLR_CF_SSTCLR;
    mWrCbAPI["CF_DSTCLR"]["DSTCLR00"] = &Cmecccap_cfl_regif::cb_CF_DSTCLR_DSTCLR00;
    mWrCbAPI["CF_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_cfl_regif::cb_CF_OVFCLR_SERROVFCLR0;
    mWrCbAPI["CF_ERMSA0"]["ERMSA"   ] = &Cmecccap_cfl_regif::cb_CF_ERMSA0_ERMSA;
    mWrCbAPI["CF_ERMEA0"]["ERMEA"   ] = &Cmecccap_cfl_regif::cb_CF_ERMEA0_ERMEA;
    mWrCbAPI["CF_ERMSA1"]["ERMSA"   ] = &Cmecccap_cfl_regif::cb_CF_ERMSA1_ERMSA;
    mWrCbAPI["CF_ERMEA1"]["ERMEA"   ] = &Cmecccap_cfl_regif::cb_CF_ERMEA1_ERMEA;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_cfl_regif::~Cmecccap_cfl_regif()
{
...
Cmecccap_cfl_regif::uint Cmecccap_cfl_regif::bit_select(
...
bool Cmecccap_cfl_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_cfl_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cfl_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cfl_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cfl_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cfl_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_cfl_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_cfl_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_cfl_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_cfl_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_cfl_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_cfl_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_cfl_regif::InitLocalVal()
{
    // Initialize local variables
...
/// @return None
void Cmecccap_cfl_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Cmecccap_cfl_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Cmecccap_cfl_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_cfl_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_cfl_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_cfl_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_cfl_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_cfl_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_cfl_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_cfl_regif::uint Cmecccap_cfl_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_cfl_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_cfl_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_cfl_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_cfl_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_cfl_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_cfl_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_cfl_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
