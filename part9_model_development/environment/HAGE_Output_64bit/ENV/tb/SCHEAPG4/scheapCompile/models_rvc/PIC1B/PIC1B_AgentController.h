// ---------------------------------------------------------------------
// $Id: PIC1B_AgentController.h,v 1.2 2015/08/19 17:24:11 huepham Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __PIC1B_AGENTCONTROLLER_H__
#define __PIC1B_AGENTCONTROLLER_H__
#include <systemc.h>
#include <iostream>
#include <cstring>
#include <iterator>
...
public:
    ...
    PIC1B_AgentController(void) {;}
    virtual ~PIC1B_AgentController(void) {;}
    virtual bool GetResetStatus (void) = 0;
    virtual bool CheckClockPeriod (const std::string clock_name) = 0;
    virtual void ActiveDelayTSST (void) = 0;
