// -----------------------------------------------------------------------------
// $Id: atu5010_glue_regif.h,v 1.1 2017/09/11 10:15:45 binhnguyen Exp $
//
...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5010_GLUE_REGIF_H__
#define __ATU5010_GLUE_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5010_GLUE model
class Catu5010_glue_regif
...
public:
    Catu5010_glue_regif(std::string name, uint buswidth);
    ~Catu5010_glue_regif();
...
protected:
    ...
    uint ATUP5SSEL_ATU_P5SSEL_TGC0;
    ...
    virtual void cb_ATUP5SSEL_ATU_P5SSEL_TGC0(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Catu5010_glue_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5010_glue_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5010_GLUE_REG_DEF_H__
