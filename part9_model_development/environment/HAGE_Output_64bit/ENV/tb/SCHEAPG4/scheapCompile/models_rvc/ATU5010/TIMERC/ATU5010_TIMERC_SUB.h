// ---------------------------------------------------------------------
// $Id: ATU5010_TIMERC_SUB.h,v 1.1 2017/06/28 10:15:45 binhnguyen Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5010_TIMERC_SUB_H__
#define __ATU5010_TIMERC_SUB_H__
...
class ATU5010_TIMERC_SUB_Func;
class ATU5010_TIMERC_SUB: public sc_module,
              public ATU5010_TIMERC_SUB_AgentController
{
...
public:
    ATU5010_TIMERC_SUB_Func       *mTIC_SUBFunc;//ATU5010_TIMERC_SUB_Func class instance
    ...
    sc_out<bool> INT_OVI;
    sc_out<bool> *INT_GRC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_out<bool> *INT_OCRC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    //Declare target socket

    SC_HAS_PROCESS (ATU5010_TIMERC_SUB);

    ATU5010_TIMERC_SUB (sc_module_name name, 
                    ATU5010_TIMERC *ATU5010_TIMERC_Ptr,
                    unsigned int Sub);
    ~ATU5010_TIMERC_SUB (void);
    ATU5010_Timer      *mFreeRunCnt;
    ATU5010_Timer      *mRunCntGRC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    ATU5010_Timer      *mRunCntOCRC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    ATU5010_NoiseCanceler      *mNoiseCanceler[ATU5010_TIMERC_SUB_AgentController::emChannel];
...
private:
    ...
    double              mTimeCLKStart[4];
    double              mCurCLKCntPeriod[4];
    sc_dt::uint64                   mCLKNOISE_nPeriod[2];      //Frequency value of nc_clk_n (n: 0 -> 1)
    bool                            mIsOvf;
    //varibales
    bool mTIOC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    bool mIsCntGRCWorking[ATU5010_TIMERC_SUB_AgentController::emChannel];
    bool mIsOVFPWM;
    ...
    bool mIA2A;
    bool mIA2B;
    bool mIsGRCWaitOvf[ATU5010_TIMERC_SUB_AgentController::emChannel]; //use for 1shot
    bool mIsUpdateGRC[ATU5010_TIMERC_SUB_AgentController::emChannel]; // use for 1 shot
    bool mIsWaitOCRCMatching[ATU5010_TIMERC_SUB_AgentController::emChannel]; // use for 1 shot
    bool mIsGRCWaitStart[ATU5010_TIMERC_SUB_AgentController::emChannel]; // use for 1 shot
    bool mIsOCRCWaitStart[ATU5010_TIMERC_SUB_AgentController::emChannel]; // use for 1 shot
    bool mIsWaitGRCMatching[ATU5010_TIMERC_SUB_AgentController::emChannel]; // use for 1 shot
    bool mTOCE[ATU5010_TIMERC_SUB_AgentController::emChannel]; //update for TOCE port
    bool mCurTOCE[ATU5010_TIMERC_SUB_AgentController::emChannel]; //update for TOCE port
    unsigned int mLimitValue;
    unsigned int mSub_id;
    unsigned int mPre_OCRC[ATU5010_TIMERC_SUB_AgentController::emChannel];
    double mGRCMatchTime[ATU5010_TIMERC_SUB_AgentController::emChannel];
    double mOCRCMatchTime[ATU5010_TIMERC_SUB_AgentController::emChannel];
    bool mIsGRC1stMatch[ATU5010_TIMERC_SUB_AgentController::emChannel];
    bool mIsOCRC1stMatch[ATU5010_TIMERC_SUB_AgentController::emChannel];

    //event
    sc_event mNoiseCntEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mCaptureOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mCaptureGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mWriteTIOCOutputEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mNoiseCancellationEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mRisingInterruptOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mRisingInterruptGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mFallingInterruptOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mFallingInterruptGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mHandleFlagAndInterruptGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mHandleFlagAndInterruptOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mCompareZeroMatchEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mClkZeroEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mHandleCmpOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mHandleCmpGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mStartCntOCRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mStartCntGRCEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mOneShotProcessEvent[ATU5010_TIMERC_SUB_AgentController::emChannel];
    sc_event mWriteTOCEPortEvent[ATU5010_TIMERC_SUB_AgentController::emChannel]; //update for TOCE port
    ...
    //Declare virtual functions of ATU5010_TIMERC_SUB_AgentController class
