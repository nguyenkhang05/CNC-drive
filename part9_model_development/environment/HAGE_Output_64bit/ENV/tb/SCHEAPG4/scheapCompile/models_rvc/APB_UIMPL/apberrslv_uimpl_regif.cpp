// -----------------------------------------------------------------------------
// $Id: apberrslv_uimpl_regif.cpp,v 1.3 2014/10/02 02:06:40 dungvannguyen Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
/// @file apberrslv_uimpl_regif.cpp
...
/// @return none
Capberrslv_uimpl_regif::Capberrslv_uimpl_regif(std::string name, uint buswidth, uint version)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    (*TYPE  ) ( 4,  1, "STRB"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["CTL"]["CLRE"] = &Capberrslv_uimpl_regif::cb_CTL_CLRE;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Capberrslv_uimpl_regif::~Capberrslv_uimpl_regif()
{
...
Capberrslv_uimpl_regif::uint Capberrslv_uimpl_regif::bit_select(
...
bool Capberrslv_uimpl_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Capberrslv_uimpl_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Capberrslv_uimpl_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                        const unsigned char *p_data,   ///< [in] Writing data
                                        cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Capberrslv_uimpl_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Capberrslv_uimpl_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                            const unsigned char *p_data,  ///< [in] Writing data
                                            cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Capberrslv_uimpl_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size,              ///< [in]  Data size (byte)
                                            bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Capberrslv_uimpl_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                         unsigned char *p_data,          ///< [out] Reading data
                                         cuint size,                     ///< [in]  Data size (byte)
...
bool Capberrslv_uimpl_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                         const unsigned char *p_data,      ///< [in] Writing data
                                         cuint size,                       ///< [in] Data size (byte)
                                         cuint reg_index,                  ///< [in] Register index
...
bool Capberrslv_uimpl_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Capberrslv_uimpl_regif::CommandInit()
{
...
/// @return string
std::string Capberrslv_uimpl_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Capberrslv_uimpl_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Capberrslv_uimpl_regif::InitLocalVal()
{
    // Initialize local variables
    CTL_CLRO = 0x0;
    CTL_CLRE = 0x0;
...
/// @return None
void Capberrslv_uimpl_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CTL_CLRO                 = (*CTL )["CLRO"];
        CTL_CLRE                 = (*CTL )["CLRE"];
...
/// @return None
void Capberrslv_uimpl_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CTL )["CLRO"] = CTL_CLRO;
        (*CTL )["CLRE"] = CTL_CLRE;
...
/// @return vector
std::vector<std::string> Capberrslv_uimpl_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Capberrslv_uimpl_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Capberrslv_uimpl_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Capberrslv_uimpl_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Capberrslv_uimpl_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Capberrslv_uimpl_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Capberrslv_uimpl_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Capberrslv_uimpl_regif::uint Capberrslv_uimpl_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Capberrslv_uimpl_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Capberrslv_uimpl_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Capberrslv_uimpl_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Capberrslv_uimpl_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Capberrslv_uimpl_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Capberrslv_uimpl_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Capberrslv_uimpl_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
