...
/// @return none
Catu5010_timere_regif::Catu5010_timere_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x6/2))
    #endif
{
    CommandInit();
    TSTRE   = new vpcl::re_register(0x0000, this, "TSTRE"  , name.c_str());
    SBRLENE = new vpcl::re_register(0x0004, this, "SBRLENE", name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_TSTRE    , TSTRE->name()  , TSTRE->addr()  );
    cw_instantiate_reg(CW_SBRLENE  , SBRLENE->name(), SBRLENE->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(TSTRE    , mCurReg, 0,  2,    "8|16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(SBRLENE  , mCurReg, 0,  2,    "8|16", "8|16|32");

    mRegList = mCurReg;

    (*TSTRE    ) ( 0,  0, "STRE0"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 1,  1, "STRE1"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 2,  2, "STRE2"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 3,  3, "STRE3"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 4,  4, "STRE4"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 5,  5, "STRE5"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 6,  6, "STRE6"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 7,  7, "STRE7"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 8,  8, "STRE8"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TSTRE    ) ( 9,  9, "STRE9"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 0,  0, "SBRLDENE0", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 1,  1, "SBRLDENE1", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 2,  2, "SBRLDENE2", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 3,  3, "SBRLDENE3", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 4,  4, "SBRLDENE4", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 5,  5, "SBRLDENE5", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 6,  6, "SBRLDENE6", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 7,  7, "SBRLDENE7", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 8,  8, "SBRLDENE8", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    (*SBRLENE  ) ( 9,  9, "SBRLDENE9", 0x1       , "W|R"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["TSTRE"]["STRE0"] = &Catu5010_timere_regif::cb_TSTRE_STRE0;
    mWrCbAPI["SBRLENE"]["SBRLDENE0"] = &Catu5010_timere_regif::cb_SBRLENE_SBRLDENE0;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Catu5010_timere_regif::~Catu5010_timere_regif()
{
...
Catu5010_timere_regif::uint Catu5010_timere_regif::bit_select(
...
bool Catu5010_timere_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5010_timere_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5010_timere_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5010_timere_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5010_timere_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5010_timere_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5010_timere_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5010_timere_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Catu5010_timere_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5010_timere_regif::CommandInit()
{
...
/// @return string
std::string Catu5010_timere_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5010_timere_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5010_timere_regif::InitLocalVal()
{
    // Initialize local variables
    TSTRE_STRE0 = 0x0;
    TSTRE_STRE1 = 0x0;
    ...
    TSTRE_STRE8 = 0x0;
    TSTRE_STRE9 = 0x0;
    SBRLENE_SBRLDENE0 = 0x1;
    SBRLENE_SBRLDENE1 = 0x1;
    SBRLENE_SBRLDENE2 = 0x1;
    SBRLENE_SBRLDENE3 = 0x1;
    SBRLENE_SBRLDENE4 = 0x1;
    SBRLENE_SBRLDENE5 = 0x1;
    SBRLENE_SBRLDENE6 = 0x1;
    SBRLENE_SBRLDENE7 = 0x1;
    SBRLENE_SBRLDENE8 = 0x1;
    SBRLENE_SBRLDENE9 = 0x1;
}

/// Update bit value to local value
/// @return None
void Catu5010_timere_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        TSTRE_STRE0                 = (*TSTRE  )["STRE0"  ];
        TSTRE_STRE1                 = (*TSTRE  )["STRE1"  ];
        TSTRE_STRE2                 = (*TSTRE  )["STRE2"  ];
        TSTRE_STRE3                 = (*TSTRE  )["STRE3"  ];
        TSTRE_STRE4                 = (*TSTRE  )["STRE4"  ];
        TSTRE_STRE5                 = (*TSTRE  )["STRE5"  ];
        TSTRE_STRE6                 = (*TSTRE  )["STRE6"  ];
        TSTRE_STRE7                 = (*TSTRE  )["STRE7"  ];
        TSTRE_STRE8                 = (*TSTRE  )["STRE8"  ];
        TSTRE_STRE9                 = (*TSTRE  )["STRE9"  ];
        return;
    }
    if (addr == 0x0004) {
        SBRLENE_SBRLDENE0           = (*SBRLENE)["SBRLDENE0"];
        SBRLENE_SBRLDENE1           = (*SBRLENE)["SBRLDENE1"];
        SBRLENE_SBRLDENE2           = (*SBRLENE)["SBRLDENE2"];
        SBRLENE_SBRLDENE3           = (*SBRLENE)["SBRLDENE3"];
        SBRLENE_SBRLDENE4           = (*SBRLENE)["SBRLDENE4"];
        SBRLENE_SBRLDENE5           = (*SBRLENE)["SBRLDENE5"];
        SBRLENE_SBRLDENE6           = (*SBRLENE)["SBRLDENE6"];
        SBRLENE_SBRLDENE7           = (*SBRLENE)["SBRLDENE7"];
        SBRLENE_SBRLDENE8           = (*SBRLENE)["SBRLDENE8"];
        SBRLENE_SBRLDENE9           = (*SBRLENE)["SBRLDENE9"];
        return;
    }
}
...
/// @return None
void Catu5010_timere_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*TSTRE  )["STRE0"  ] = TSTRE_STRE0;
        (*TSTRE  )["STRE1"  ] = TSTRE_STRE1;
        (*TSTRE  )["STRE2"  ] = TSTRE_STRE2;
        (*TSTRE  )["STRE3"  ] = TSTRE_STRE3;
        (*TSTRE  )["STRE4"  ] = TSTRE_STRE4;
        (*TSTRE  )["STRE5"  ] = TSTRE_STRE5;
        (*TSTRE  )["STRE6"  ] = TSTRE_STRE6;
        (*TSTRE  )["STRE7"  ] = TSTRE_STRE7;
        (*TSTRE  )["STRE8"  ] = TSTRE_STRE8;
        (*TSTRE  )["STRE9"  ] = TSTRE_STRE9;
        return;
    }
    if (addr == 0x0004) {
        (*SBRLENE)["SBRLDENE0"] = SBRLENE_SBRLDENE0;
        (*SBRLENE)["SBRLDENE1"] = SBRLENE_SBRLDENE1;
        (*SBRLENE)["SBRLDENE2"] = SBRLENE_SBRLDENE2;
        (*SBRLENE)["SBRLDENE3"] = SBRLENE_SBRLDENE3;
        (*SBRLENE)["SBRLDENE4"] = SBRLENE_SBRLDENE4;
        (*SBRLENE)["SBRLDENE5"] = SBRLENE_SBRLDENE5;
        (*SBRLENE)["SBRLDENE6"] = SBRLENE_SBRLDENE6;
        (*SBRLENE)["SBRLDENE7"] = SBRLENE_SBRLDENE7;
        (*SBRLENE)["SBRLDENE8"] = SBRLENE_SBRLDENE8;
        (*SBRLENE)["SBRLDENE9"] = SBRLENE_SBRLDENE9;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Catu5010_timere_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5010_timere_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5010_timere_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5010_timere_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5010_timere_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5010_timere_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5010_timere_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Catu5010_timere_regif::uint Catu5010_timere_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Catu5010_timere_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5010_timere_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5010_timere_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5010_timere_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
unsigned short Catu5010_timere_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Catu5010_timere_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(unsigned short));
    return sizeof(unsigned short);
}
void Catu5010_timere_regif::cw_instantiate_reg(scml2::reg<unsigned short> * reg, std::string reg_name, int offset)
{
