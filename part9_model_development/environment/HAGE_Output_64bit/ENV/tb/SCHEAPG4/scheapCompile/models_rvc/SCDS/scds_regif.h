...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __SCDS_REGIF_H__
#define __SCDS_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of SCDS model
class Cscds_regif
...
public:
    Cscds_regif(std::string name, uint buswidth);
    ~Cscds_regif();

protected:
    vpcl::re_register *GREG     [124];
    vpcl::re_register *Rsv1_GREG[122];
    vpcl::re_register *Rsv2_GREG[128];

    #ifdef CWR_SYSTEMC
    scml2::memory<uint> cwmem;
    scml2::reg<uint> *CW_GREG     [124];
    scml2::reg<uint> *CW_Rsv1_GREG[122];
    scml2::reg<uint> *CW_Rsv2_GREG[128];
    #endif

    uint GREG_GREG    [124];
    uint Rsv1_GREG_Rsv1_GREG[122];
    uint Rsv2_GREG_Rsv2_GREG[128];
    ...
    virtual void cb_GREG_GREG(RegCBstr str) = 0;
    virtual void cb_Rsv2_GREG_Rsv2_GREG(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Cscds_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cscds_regif::*) (RegCBstr)> > mRdCbAPI;
    std::string mFileName;
    std::string mInstName;
    int mLineNum;
    uint mFactorIndexGREG[emNUM_GREG];
    uint mFactorIndexRsv1_GREG[emNUM_Rsv1_GREG];
    uint mFactorIndexRsv2_GREG[emNUM_Rsv2_GREG];
