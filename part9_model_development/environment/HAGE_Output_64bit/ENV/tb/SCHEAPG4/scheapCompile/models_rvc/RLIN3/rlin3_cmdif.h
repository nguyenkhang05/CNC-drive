...
//  %CMD_RW EnableTransInfo <enable:bool=false> @ Enable/disable information display 
//  %CMD_ACTION DumpStatInfo : void @ Dumps statistical information of RLIN3
//  %CMD_ACTION SetCLKfreq <clk_name:std::string> <clk_freq:double> : void @ Set clocks to RLIN3

#ifndef RLIN3_CMDIF_H
#define RLIN3_CMDIF_H
...
#endif // EnableDumpResult
    ret += "    DumpInterrupt <arg>                       Enable/disable interrupt information display when an interrupt is sent ( Default:false  )\n";
    ret += "    EnableTransInfo <arg>                     Enable/disable information display ( Default:false  )\n";
    ret += "    DumpStatInfo                              Dumps statistical information of RLIN3\n";
    ret += "    SetCLKfreq <clk_name> <clk_freq>          Set clocks to RLIN3\n";
