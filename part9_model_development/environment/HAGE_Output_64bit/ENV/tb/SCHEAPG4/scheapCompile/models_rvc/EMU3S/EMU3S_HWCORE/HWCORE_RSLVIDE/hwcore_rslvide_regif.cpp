// -----------------------------------------------------------------------------
// $Id: hwcore_rslvide_regif.cpp,v 1.2 2020/10/22 04:06:16 ngathunguyen Exp $
//
...
// Description:
// Ref: {HWCORE_RSLVIDE_UD_ATT1_008}
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
// Ref: {HWCORE_RSLVIDE_UD_Registers_001, HWCORE_RSLVIDE_UD_Registers_002, HWCORE_RSLVIDE_UD_Registers_003, HWCORE_RSLVIDE_UD_Registers_004, HWCORE_RSLVIDE_UD_Registers_005, HWCORE_RSLVIDE_UD_Registers_006, HWCORE_RSLVIDE_UD_Registers_007, HWCORE_RSLVIDE_UD_Registers_008, HWCORE_RSLVIDE_UD_Registers_009, HWCORE_RSLVIDE_UD_Registers_010, HWCORE_RSLVIDE_UD_Registers_011, HWCORE_RSLVIDE_UD_Registers_012, HWCORE_RSLVIDE_UD_Direction_019, HWCORE_RSLVIDE_UD_Direction_020, HWCORE_RSLVIDE_UD_Direction_024, HWCORE_RSLVIDE_UD_Direction_025, HWCORE_RSLVIDE_UD_Direction_030, HWCORE_RSLVIDE_UD_Direction_031, HWCORE_RSLVIDE_UD_Direction_037, HWCORE_RSLVIDE_UD_Direction_022, HWCORE_RSLVIDE_UD_Direction_023, HWCORE_RSLVIDE_UD_Direction_029, HWCORE_RSLVIDE_UD_Direction_036, HWCORE_RSLVIDE_UD_ATT1_007, HWCORE_RSLVIDE_UD_ATT1_009}
Chwcore_rslvide_regif::Chwcore_rslvide_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", 0x112)
    #endif
{
    CommandInit();
    ANGCTR    = new vpcl::re_register(0x0100, this, "ANGCTR"   , name.c_str());
    CPJUD0    = new vpcl::re_register(0x0102, this, "CPJUD0"   , name.c_str());
    CPJUD1    = new vpcl::re_register(0x0103, this, "CPJUD1"   , name.c_str());
    RESTHSFT  = new vpcl::re_register(0x0104, this, "RESTHSFT" , name.c_str());
    ANGOFS    = new vpcl::re_register(0x0106, this, "ANGOFS"   , name.c_str());
    PXR       = new vpcl::re_register(0x0108, this, "PXR"      , name.c_str());
    RESTHTORG = new vpcl::re_register(0x010A, this, "RESTHTORG", name.c_str());
    THTEFIX   = new vpcl::re_register(0x010C, this, "THTEFIX"  , name.c_str());
    RESRLD    = new vpcl::re_register(0x010E, this, "RESRLD"   , name.c_str());
    RESCNT    = new vpcl::re_register(0x010F, this, "RESCNT"   , name.c_str());
    THTRESFIX = new vpcl::re_register(0x0110, this, "THTRESFIX", name.c_str());
    ...
    index = 0;
#ifdef USR_CWR_SYSTEMC
    mCurReg = mRegArray[index++] = new SRegList(ANGCTR     , mCurReg, 0,  1,       "8", "8|16|32", false, &cwmem);
#else
    mCurReg = mRegArray[index++] = new SRegList(ANGCTR     , mCurReg, 0,  1,       "8", "8|16|32");
#endif
    mCurReg = mRegArray[index++] = new SRegList(CPJUD0     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CPJUD1     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RESTHSFT   , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ANGOFS     , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PXR        , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RESTHTORG  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(THTEFIX    , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RESRLD     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RESCNT     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(THTRESFIX  , mCurReg, 0,  2,      "16", "8|16|32");

    mRegList = mCurReg;

    (*ANGCTR     ) ( 1,  0, "ANGSEL"  , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CPJUD0     ) ( 7,  0, "DATA"    , 0xFF      , "R|W"   , vpcl::SPP_ENABLE);
    (*CPJUD1     ) ( 7,  0, "DATA"    , 0xFF      , "R|W"   , vpcl::SPP_ENABLE);
    (*RESTHSFT   ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ANGOFS     ) (15,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PXR        ) (15,  0, "DATA"    , 0x100     , "R|W"   , vpcl::SPP_ENABLE);
    (*RESTHTORG  ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTEFIX    ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RESRLD     ) ( 2,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RESCNT     ) ( 2,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTRESFIX  ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["ANGCTR" ]["ANGSEL" ] = &Chwcore_rslvide_regif::cb_ANGCTR_ANGSEL;
    mWrCbAPI["RESTHSFT"]["DATA"   ] = &Chwcore_rslvide_regif::cb_RESTHSFT_DATA;
    mWrCbAPI["ANGOFS" ]["DATA"   ] = &Chwcore_rslvide_regif::cb_ANGOFS_DATA;
    mWrCbAPI["THTEFIX"]["DATA"   ] = &Chwcore_rslvide_regif::cb_THTEFIX_DATA;
    mWrCbAPI["THTRESFIX"]["DATA"   ] = &Chwcore_rslvide_regif::cb_THTRESFIX_DATA;

    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Chwcore_rslvide_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Chwcore_rslvide_regif::~Chwcore_rslvide_regif()
{
...
Chwcore_rslvide_regif::uint Chwcore_rslvide_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Chwcore_rslvide_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chwcore_rslvide_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_rslvide_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    assert(size != 0);
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chwcore_rslvide_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    assert(size != 0);
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_rslvide_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chwcore_rslvide_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
bool Chwcore_rslvide_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Chwcore_rslvide_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Chwcore_rslvide_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return none
void Chwcore_rslvide_regif::CommandInit()
{
...
/// @return string
std::string Chwcore_rslvide_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chwcore_rslvide_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chwcore_rslvide_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Chwcore_rslvide_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Chwcore_rslvide_regif::IssueRegValueID(void)
{//{{{
...
/// @return vector
std::vector<std::string> Chwcore_rslvide_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chwcore_rslvide_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chwcore_rslvide_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Chwcore_rslvide_regif::get_reg_index(cuint access_addr)
{
    if (access_addr < (1<<9)) {
...
vpcl::re_register *Chwcore_rslvide_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chwcore_rslvide_regif::next_reg_object()
{
    assert(mCurReg != NULL);
...
/// @return none
void Chwcore_rslvide_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Chwcore_rslvide_regif::uint Chwcore_rslvide_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Chwcore_rslvide_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chwcore_rslvide_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chwcore_rslvide_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Chwcore_rslvide_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
unsigned short Chwcore_rslvide_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Chwcore_rslvide_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Chwcore_rslvide_regif::cw_set_all_callback_reg(void)
{
