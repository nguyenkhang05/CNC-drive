// -----------------------------------------------------------------------------
// $Id: atu5_timere_sub_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
//  
////////////////////////////////////////////////////////////////////////////////
/// @file atu5_timere_sub_regif.cpp
...
/// @return none
Catu5_timere_sub_regif::Catu5_timere_sub_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    mWrCbAPI["SSTRE"]["SSTRE0"] = &Catu5_timere_sub_regif::cb_SSTRE_SSTRE0;
    mWrCbAPI["PSCRE"]["PSCE"] = &Catu5_timere_sub_regif::cb_PSCRE_PSCE;
    mWrCbAPI["TCRE"]["CKSELE"] = &Catu5_timere_sub_regif::cb_TCRE_CKSELE;
    mWrCbAPI["RLDCRE"]["RLDENE0"] = &Catu5_timere_sub_regif::cb_RLDCRE_RLDENE0;
    mWrCbAPI["POECRE"]["POECRKEY"] = &Catu5_timere_sub_regif::cb_POECRE_POECRKEY;
    mWrCbAPI["TSCRE"]["CMFCE0"] = &Catu5_timere_sub_regif::cb_TSCRE_CMFCE0;
    mWrCbAPI["TOCRE"]["TONEE0"] = &Catu5_timere_sub_regif::cb_TOCRE_TONEE0;
    mWrCbAPI["FCTRGE"]["FCMT0"] = &Catu5_timere_sub_regif::cb_FCTRGE_FCMT0;

    for(uint i = 0; i < emNUM_PSCCRE; i++) {
        str_tmp.str("");
        str_tmp<<"PSCCRE"<< i;
        mWrCbAPI[str_tmp.str()]["PSCCE"] = &Catu5_timere_sub_regif::cb_PSCCRE_PSCCE;
    }
    for(uint i = 0; i < emNUM_TCNTE; i++) {
        str_tmp.str("");
        str_tmp<<"TCNTE"<< i;
        mWrCbAPI[str_tmp.str()]["TCNTE"] = &Catu5_timere_sub_regif::cb_TCNTE_TCNTE;
    }
    for(uint i = 0; i < emNUM_CYLRE; i++) {
        str_tmp.str("");
        str_tmp<<"CYLRE"<< i;
        mWrCbAPI[str_tmp.str()]["CYLRE"] = &Catu5_timere_sub_regif::cb_CYLRE_CYLRE;
    }
    for(uint i = 0; i < emNUM_DTRE; i++) {
        str_tmp.str("");
        str_tmp<<"DTRE"<< i;
        mWrCbAPI[str_tmp.str()]["DTRE"] = &Catu5_timere_sub_regif::cb_DTRE_DTRE;
    }
    InitLocalVal();
}
...
/// @return none
Catu5_timere_sub_regif::~Catu5_timere_sub_regif()
{
...
Catu5_timere_sub_regif::uint Catu5_timere_sub_regif::bit_select(
...
bool Catu5_timere_sub_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5_timere_sub_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timere_sub_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                        const unsigned char *p_data,   ///< [in] Writing data
                                        cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timere_sub_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timere_sub_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                            const unsigned char *p_data,  ///< [in] Writing data
                                            cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timere_sub_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size,              ///< [in]  Data size (byte)
                                            bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5_timere_sub_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                         unsigned char *p_data,          ///< [out] Reading data
                                         cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5_timere_sub_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                         const unsigned char *p_data,      ///< [in] Writing data
                                         cuint size,                       ///< [in] Data size (byte)
                                         cuint reg_index,                  ///< [in] Register index
...
bool Catu5_timere_sub_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5_timere_sub_regif::CommandInit()
{
...
/// @return string
std::string Catu5_timere_sub_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5_timere_sub_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5_timere_sub_regif::InitLocalVal()
{
    // Initialize local variables
    SSTRE_SSTRE0 = 0x0;
    SSTRE_SSTRE1 = 0x0;
...
/// @return None
void Catu5_timere_sub_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Catu5_timere_sub_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Catu5_timere_sub_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5_timere_sub_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5_timere_sub_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5_timere_sub_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5_timere_sub_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5_timere_sub_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5_timere_sub_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Catu5_timere_sub_regif::uint Catu5_timere_sub_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Catu5_timere_sub_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5_timere_sub_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5_timere_sub_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5_timere_sub_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Catu5_timere_sub_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Catu5_timere_sub_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Catu5_timere_sub_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
