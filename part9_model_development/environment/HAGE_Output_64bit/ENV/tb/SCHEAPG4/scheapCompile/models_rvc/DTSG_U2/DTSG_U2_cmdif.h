// -----------------------------------------------------------------------------
// $Id: DTSG_U2_cmdif.h,v 1.4 2020/01/07 04:00:23 synguyen Exp $
//
...
#ifndef DTSG_U2_CMDIF_H
#define DTSG_U2_CMDIF_H
...
void CommandInit(std::string name = "") {
  ...
  mMessageLevel.insert(std::pair<std::string, bool>("warning", true));
...
#ifndef print_msg
#define print_msg get_fileline(__FILE__, __LINE__); mDTSG_U2_AgentController->_re_printf
#endif//re_printf
