// -----------------------------------------------------------------------------
// $Id: ahberrslv_regif.h,v 1.3 2014/09/25 09:03:39 dungvannguyen Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
/// @file ahberrslv_regif.h
/// @brief Register IF class of model AHBERRSLV
/// $Id: ahberrslv_regif.h,v 1.3 2014/09/25 09:03:39 dungvannguyen Exp $
/// $Date: 2014/09/25 09:03:39 $
/// $Revison$
/// $Author: dungvannguyen $
////////////////////////////////////////////////////////////////////////////////
#ifndef __AHBERRSLV_REGIF_H__
#define __AHBERRSLV_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of AHBERRSLV model
class Cahberrslv_regif
...
public:
    Cahberrslv_regif(std::string name, uint buswidth, uint version = 0);
    ~Cahberrslv_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Cahberrslv_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cahberrslv_regif::*) (RegCBstr)> > mRdCbAPI;
