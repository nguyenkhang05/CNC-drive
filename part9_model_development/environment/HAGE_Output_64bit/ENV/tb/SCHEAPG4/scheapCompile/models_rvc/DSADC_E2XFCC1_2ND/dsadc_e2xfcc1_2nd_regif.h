// -----------------------------------------------------------------------------
// $Id: dsadc_e2xfcc1_2nd_regif.h 1398 2019-11-26 06:16:27Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
/// @file dsadc_e2xfcc1_2nd_regif.h
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __DSADC_E2XFCC1_2ND_REGIF_H__
#define __DSADC_E2XFCC1_2ND_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of DSADC_E2XFCC1_2ND model
class Cdsadc_e2xfcc1_2nd_regif
...
public:
    Cdsadc_e2xfcc1_2nd_regif(std::string name, uint buswidth);
    ~Cdsadc_e2xfcc1_2nd_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Cdsadc_e2xfcc1_2nd_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cdsadc_e2xfcc1_2nd_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__DSADC_E2XFCC1_2ND_REG_DEF_H__
