// ---------------------------------------------------------------------
// $Id: ATU5_TIMERB_Func.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5_TIMERB_FUNC_H__
#define __ATU5_TIMERB_FUNC_H__

#include "atu5_timerb_regif.h"
#include "OSCI2.h"

class ATU5_TIMERB;
class ATU5_TIMERB_Func: public Catu5_timerb_regif
{
friend class ATU5_TIMERB;
public:
    ATU5_TIMERB_Func(std::string name, ATU5_TIMERB *ATU5_TIB_ptr);
    ~ATU5_TIMERB_Func (void);
...
private:
    ...
    unsigned int GetB5UpperLimit (void);
    void ClearTCNTB5 (void);
    
    bool mIsCMFB6M;
    bool mIsProhibitRewriteOCRB[24];
    bool mIsProhibitRewriteTEPCFB[24];
