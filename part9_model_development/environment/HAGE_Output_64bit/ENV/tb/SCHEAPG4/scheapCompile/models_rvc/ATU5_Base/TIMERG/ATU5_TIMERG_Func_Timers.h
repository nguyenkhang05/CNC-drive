// -----------------------------------------------------------------------------
// $Id: ATU5_TIMERG_Func_Timers.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// -----------------------------------------------------------------------------
#ifndef ATU5_TIMERG_ATU5_TIMERG_FUNC_TIMERS_H_
#define ATU5_TIMERG_ATU5_TIMERG_FUNC_TIMERS_H_
...
class ATU5_TIMERG_Func_Timers: protected Cgeneral_timer {
//------------------------------------------------------------------------------
// public interface
//------------------------------------------------------------------------------
public:
...
private:
    ...
    ATU5_TIMERG_Func_Timers** pChannels; ///< private pointer is only meaningful for channel #0, allows the channel #0 access into the others
    ATU5_TIMERG_Func_Timers*  pChannel0;
    uint8_t                   id;
    // reset input
    bool      isResetActive_preSync;
    // clock inputs
    double*   pClkPeriods_synced;
    uint32_t* pClkDivs_synced;
    sc_time*  pSyncPoints;
    ...
    bool      is_int;
    bool      is_comp;
    bool      isset_flagOvf;		//  Added  for update version 0.080
    bool      isclear_flagOvf;		//  Added  for update version 0.080
    bool      isset_flagCmf;		//  Added  for update version 0.080
    bool      isclear_flagCmf;		//  Added  for update version 0.080

//------------------------------------------------------------------------------
// internal methods
//------------------------------------------------------------------------------
private:
    ATU5_TIMERG_Func_Timers(ATU5_TIMERG_Func_Timers* ipChannel0
...
//------------------------------------------------------------------------------
public:
    SC_HAS_PROCESS(ATU5_TIMERG_Func_Timers);
    ATU5_TIMERG_Func_Timers(const uint8_t&        iChanNum
                           ,const uint8_t&        iClkDivNum
                           ,const uint8_t&        iExtEvtNum
                           ,const sc_module_name& iname);
    virtual ~ATU5_TIMERG_Func_Timers();
...
private:
    ...
    sc_event mPriorityEvent;   //  Added for update version 0.080
    void     prioritymethod(const uint8_t&  channel_id);   // Added for update ver 0.080
...
#endif /* ATU5_TIMERG_ATU5_TIMERG_FUNC_TIMERS_H_ */
//------------------------------------------------------------------------------
// EOF
