// -----------------------------------------------------------------------------
// $Id: ecc_bus_deccctl_regif.cpp,v 1.7 2020/03/30 10:53:33 thunguyen3 Exp $
//
...
//
// Input file : ecc_bus_deccctl_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecc_bus_deccctl
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  7 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name        reg_name      wsize   rsize      length offset   access   init   support  callback
//     %%REG      DECCCTL     DECCCTL       8|16|32 8|16|32    32     0x00     R|W      0x0     TRUE     -
//     %%REG      DECCTSTCTL  DECCTSTCTL    8|16|32 8|16|32    32     0x10     R|W      0x0     FALSE    -
//     %%REG      DECCTSTDIN0 DECCTSTDIN0   8|16|32 8|16|32    32     0x30     R|W      0x0     FALSE    -
//     %%REG      DECCTSTDIN1 DECCTSTDIN1   8|16|32 8|16|32    32     0x34     R|W      0x0     FALSE    -
//     %%REG      DECCTSTEIN  DECCTSTEIN    8|16|32 8|16|32    32     0x40     R|W      0x0     FALSE    -
// 
//     
// %REG_NAME DECCCTL
...
// %REG_NAME DECCTSTCTL
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    ECCTST             1       1       0       R|W     FALSE       -
//     %%BIT    DATSEL             0       0       0       R|W     FALSE       W
// 
// %REG_NAME DECCTSTDIN0
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    DATA               31      0       0       R|W     FALSE       W
// 
// %REG_NAME DECCTSTDIN1
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    DATA               31      0       0       R|W     FALSE       W
// 
// %REG_NAME DECCTSTEIN
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    ECC                7       0       0       R|W     FALSE       W
////////////////////////////////////////////////////////////////////////////////
/// @file ecc_bus_deccctl_regif.cpp
/// @brief Register IF class of model ECC_BUS_DECCTL
/// $Id: ecc_bus_deccctl_regif.cpp,v 1.7 2020/03/30 10:53:33 thunguyen3 Exp $
...
/// @return none
Cecc_bus_deccctl_regif::Cecc_bus_deccctl_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x44/4))
    #endif
{
    CommandInit();
    DECCCTL     = new vpcl::re_register(0x0000, this, "DECCCTL"    , name.c_str());
    DECCTSTCTL  = new vpcl::re_register(0x0010, this, "DECCTSTCTL" , name.c_str());
    DECCTSTDIN0 = new vpcl::re_register(0x0030, this, "DECCTSTDIN0", name.c_str());
    DECCTSTDIN1 = new vpcl::re_register(0x0034, this, "DECCTSTDIN1", name.c_str());
    DECCTSTEIN  = new vpcl::re_register(0x0040, this, "DECCTSTEIN" , name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_DECCCTL      , DECCCTL->name()    , DECCCTL->addr()    );
    cw_instantiate_reg(CW_DECCTSTCTL   , DECCTSTCTL->name() , DECCTSTCTL->addr() );
    cw_instantiate_reg(CW_DECCTSTDIN0  , DECCTSTDIN0->name(), DECCTSTDIN0->addr());
    cw_instantiate_reg(CW_DECCTSTDIN1  , DECCTSTDIN1->name(), DECCTSTDIN1->addr());
    cw_instantiate_reg(CW_DECCTSTEIN   , DECCTSTEIN->name() , DECCTSTEIN->addr() );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DECCCTL      , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DECCTSTCTL   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DECCTSTDIN0  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DECCTSTDIN1  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DECCTSTEIN   , mCurReg, 0,  4, "8|16|32", "8|16|32");

    mRegList = mCurReg;

    (*DECCCTL      ) ( 1,  1, "SECDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DECCCTL      ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DECCTSTCTL   ) ( 1,  1, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*DECCTSTCTL   ) ( 0,  0, "DATSEL"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*DECCTSTDIN0  ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*DECCTSTDIN1  ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*DECCTSTEIN   ) ( 7,  0, "ECC"     , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    ...
    mWrCbAPI["DECCCTL"  ]["ECCDIS"   ] = &Cecc_bus_deccctl_regif::cb_DECCCTL_ECCDIS;
    mWrCbAPI["DECCTSTCTL"]["DATSEL"   ] = &Cecc_bus_deccctl_regif::cb_DECCTSTCTL_DATSEL;
    mWrCbAPI["DECCTSTDIN0"]["DATA"     ] = &Cecc_bus_deccctl_regif::cb_DECCTSTDIN0_DATA;
    mWrCbAPI["DECCTSTDIN1"]["DATA"     ] = &Cecc_bus_deccctl_regif::cb_DECCTSTDIN1_DATA;
    mWrCbAPI["DECCTSTEIN"]["ECC"      ] = &Cecc_bus_deccctl_regif::cb_DECCTSTEIN_ECC;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecc_bus_deccctl_regif::~Cecc_bus_deccctl_regif()
{
...
Cecc_bus_deccctl_regif::uint Cecc_bus_deccctl_regif::bit_select(
...
bool Cecc_bus_deccctl_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecc_bus_deccctl_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_deccctl_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_deccctl_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_deccctl_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_deccctl_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecc_bus_deccctl_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Cecc_bus_deccctl_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Cecc_bus_deccctl_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecc_bus_deccctl_regif::CommandInit()
{
...
/// @return string
std::string Cecc_bus_deccctl_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecc_bus_deccctl_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecc_bus_deccctl_regif::InitLocalVal()
{
    // Initialize local variables
    DECCCTL_SECDIS = 0x0;
    DECCCTL_ECCDIS = 0x0;
    DECCTSTCTL_ECCTST = 0x0;
    DECCTSTCTL_DATSEL = 0x0;
    DECCTSTDIN0_DATA = 0x0;
    DECCTSTDIN1_DATA = 0x0;
    DECCTSTEIN_ECC = 0x0;
}

/// Update bit value to local value
/// @return None
void Cecc_bus_deccctl_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        DECCCTL_SECDIS                  = (*DECCCTL    )["SECDIS"     ];
        DECCCTL_ECCDIS                  = (*DECCCTL    )["ECCDIS"     ];
        return;
    }
    if (addr == 0x0010) {
        DECCTSTCTL_ECCTST               = (*DECCTSTCTL )["ECCTST"     ];
        DECCTSTCTL_DATSEL               = (*DECCTSTCTL )["DATSEL"     ];
        return;
    }
    if (addr == 0x0030) {
        DECCTSTDIN0_DATA                = (*DECCTSTDIN0)["DATA"       ];
        return;
    }
    if (addr == 0x0034) {
        DECCTSTDIN1_DATA                = (*DECCTSTDIN1)["DATA"       ];
        return;
    }
    if (addr == 0x0040) {
        DECCTSTEIN_ECC                  = (*DECCTSTEIN )["ECC"        ];
        return;
    }
}
...
/// @return None
void Cecc_bus_deccctl_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*DECCCTL    )["SECDIS"     ] = DECCCTL_SECDIS;
        (*DECCCTL    )["ECCDIS"     ] = DECCCTL_ECCDIS;
        return;
    }
    if (addr == 0x0010) {
        (*DECCTSTCTL )["ECCTST"     ] = DECCTSTCTL_ECCTST;
        (*DECCTSTCTL )["DATSEL"     ] = DECCTSTCTL_DATSEL;
        return;
    }
    if (addr == 0x0030) {
        (*DECCTSTDIN0)["DATA"       ] = DECCTSTDIN0_DATA;
        return;
    }
    if (addr == 0x0034) {
        (*DECCTSTDIN1)["DATA"       ] = DECCTSTDIN1_DATA;
        return;
    }
    if (addr == 0x0040) {
        (*DECCTSTEIN )["ECC"        ] = DECCTSTEIN_ECC;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecc_bus_deccctl_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecc_bus_deccctl_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecc_bus_deccctl_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecc_bus_deccctl_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecc_bus_deccctl_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecc_bus_deccctl_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecc_bus_deccctl_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Cecc_bus_deccctl_regif::uint Cecc_bus_deccctl_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Cecc_bus_deccctl_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecc_bus_deccctl_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecc_bus_deccctl_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecc_bus_deccctl_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Cecc_bus_deccctl_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecc_bus_deccctl_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecc_bus_deccctl_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
