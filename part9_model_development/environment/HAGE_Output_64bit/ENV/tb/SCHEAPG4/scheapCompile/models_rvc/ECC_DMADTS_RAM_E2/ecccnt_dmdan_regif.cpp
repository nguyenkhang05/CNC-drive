// -----------------------------------------------------------------------------
// $Id: ecccnt_dmdan_regif.cpp,v 1.7 2019/09/11 03:13:33 landang Exp $
//
...
//
// Input file : ./input/DMADTS_RAM/ecccnt_dmdan_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecccnt_dmdan
//     #              name     offset_size
...
//     
////////////////////////////////////////////////////////////////////////////////
/// @file ecccnt_dmdan_regif.cpp
/// @brief Register IF class of model ECCCNT_DMDAN
/// $Id: ecccnt_dmdan_regif.cpp,v 1.7 2019/09/11 03:13:33 landang Exp $
/// $Date: 2019/09/11 03:13:33 $
/// $Revison$
/// $Author: landang $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cecccnt_dmdan_regif::Cecccnt_dmdan_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    DAECCCTL       = new vpcl::re_register(0x0000, this, "DAECCCTL"      , name.c_str());
    DAECCTSTCTL    = new vpcl::re_register(0x0010, this, "DAECCTSTCTL"   , name.c_str());
    DAECCTSTDIN0   = new vpcl::re_register(0x0030, this, "DAECCTSTDIN0"  , name.c_str());
    DAECCTSTDIN1   = new vpcl::re_register(0x0034, this, "DAECCTSTDIN1"  , name.c_str());
    DAECCTSTEIN    = new vpcl::re_register(0x0040, this, "DAECCTSTEIN"   , name.c_str());
    DATDATBFDATAF0 = new vpcl::re_register(0x0050, this, "DATDATBFDATAF0", name.c_str());
    DATDATBFDATAF1 = new vpcl::re_register(0x0054, this, "DATDATBFDATAF1", name.c_str());
    DATDATBFECCF   = new vpcl::re_register(0x0060, this, "DATDATBFECCF"  , name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_DAECCCTL        , DAECCCTL->name()      , DAECCCTL->addr()      );
    cw_instantiate_reg(CW_DAECCTSTCTL     , DAECCTSTCTL->name()   , DAECCTSTCTL->addr()   );
    cw_instantiate_reg(CW_DAECCTSTDIN0    , DAECCTSTDIN0->name()  , DAECCTSTDIN0->addr()  );
    cw_instantiate_reg(CW_DAECCTSTDIN1    , DAECCTSTDIN1->name()  , DAECCTSTDIN1->addr()  );
    cw_instantiate_reg(CW_DAECCTSTEIN     , DAECCTSTEIN->name()   , DAECCTSTEIN->addr()   );
    cw_instantiate_reg(CW_DATDATBFDATAF0  , DATDATBFDATAF0->name(), DATDATBFDATAF0->addr());
    cw_instantiate_reg(CW_DATDATBFDATAF1  , DATDATBFDATAF1->name(), DATDATBFDATAF1->addr());
    cw_instantiate_reg(CW_DATDATBFECCF    , DATDATBFECCF->name()  , DATDATBFECCF->addr()  );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DAECCCTL        , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DAECCTSTCTL     , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DAECCTSTDIN0    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DAECCTSTDIN1    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DAECCTSTEIN     , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DATDATBFDATAF0  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DATDATBFDATAF1  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DATDATBFECCF    , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*DAECCCTL        ) ( 1,  1, "SECDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DAECCCTL        ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DAECCTSTCTL     ) ( 1,  1, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DAECCTSTDIN0    ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DAECCTSTDIN1    ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DAECCTSTEIN     ) ( 7,  0, "ECC"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DATDATBFDATAF0  ) (31,  0, "BFDATA"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DATDATBFDATAF1  ) (31,  0, "BFDATA"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DATDATBFECCF    ) ( 7,  0, "BFECC0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["DAECCCTL"    ]["ECCDIS"      ] = &Cecccnt_dmdan_regif::cb_DAECCCTL_ECCDIS;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecccnt_dmdan_regif::~Cecccnt_dmdan_regif()
{
...
Cecccnt_dmdan_regif::uint Cecccnt_dmdan_regif::bit_select(
...
bool Cecccnt_dmdan_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecccnt_dmdan_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_dmdan_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                     const unsigned char *p_data,   ///< [in] Writing data
                                     cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_dmdan_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                     unsigned char *p_data,   ///< [out] Reading data
                                     cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_dmdan_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                         const unsigned char *p_data,  ///< [in] Writing data
                                         cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_dmdan_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                         unsigned char *p_data,   ///< [out] Reading data
                                         cuint size,              ///< [in]  Data size (byte)
                                         bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecccnt_dmdan_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                      unsigned char *p_data,          ///< [out] Reading data
                                      cuint size,                     ///< [in]  Data size (byte)
...
bool Cecccnt_dmdan_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                      const unsigned char *p_data,      ///< [in] Writing data
                                      cuint size,                       ///< [in] Data size (byte)
                                      cuint reg_index,                  ///< [in] Register index
...
bool Cecccnt_dmdan_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecccnt_dmdan_regif::CommandInit()
{
...
/// @return string
std::string Cecccnt_dmdan_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecccnt_dmdan_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecccnt_dmdan_regif::InitLocalVal()
{
    // Initialize local variables
    DAECCCTL_SECDIS = 0x0;
    DAECCCTL_ECCDIS = 0x0;
    DAECCTSTCTL_ECCTST = 0x0;
    DAECCTSTDIN0_DATA = 0x0;
    DAECCTSTDIN1_DATA = 0x0;
    DAECCTSTEIN_ECC = 0x0;
    DATDATBFDATAF0_BFDATA = 0x0;
    DATDATBFDATAF1_BFDATA = 0x0;
    DATDATBFECCF_BFECC0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cecccnt_dmdan_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        DAECCCTL_SECDIS                    = (*DAECCCTL      )["SECDIS"        ];
        DAECCCTL_ECCDIS                    = (*DAECCCTL      )["ECCDIS"        ];
        return;
    }
    if (addr == 0x0010) {
        DAECCTSTCTL_ECCTST                 = (*DAECCTSTCTL   )["ECCTST"        ];
        return;
    }
    if (addr == 0x0030) {
        DAECCTSTDIN0_DATA                  = (*DAECCTSTDIN0  )["DATA"          ];
        return;
    }
    if (addr == 0x0034) {
        DAECCTSTDIN1_DATA                  = (*DAECCTSTDIN1  )["DATA"          ];
        return;
    }
    if (addr == 0x0040) {
        DAECCTSTEIN_ECC                    = (*DAECCTSTEIN   )["ECC"           ];
        return;
    }
    if (addr == 0x0050) {
        DATDATBFDATAF0_BFDATA              = (*DATDATBFDATAF0)["BFDATA"        ];
        return;
    }
    if (addr == 0x0054) {
        DATDATBFDATAF1_BFDATA              = (*DATDATBFDATAF1)["BFDATA"        ];
        return;
    }
    if (addr == 0x0060) {
        DATDATBFECCF_BFECC0                = (*DATDATBFECCF  )["BFECC0"        ];
        return;
    }
}
...
/// @return None
void Cecccnt_dmdan_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*DAECCCTL      )["SECDIS"        ] = DAECCCTL_SECDIS;
        (*DAECCCTL      )["ECCDIS"        ] = DAECCCTL_ECCDIS;
        return;
    }
    if (addr == 0x0010) {
        (*DAECCTSTCTL   )["ECCTST"        ] = DAECCTSTCTL_ECCTST;
        return;
    }
    if (addr == 0x0030) {
        (*DAECCTSTDIN0  )["DATA"          ] = DAECCTSTDIN0_DATA;
        return;
    }
    if (addr == 0x0034) {
        (*DAECCTSTDIN1  )["DATA"          ] = DAECCTSTDIN1_DATA;
        return;
    }
    if (addr == 0x0040) {
        (*DAECCTSTEIN   )["ECC"           ] = DAECCTSTEIN_ECC;
        return;
    }
    if (addr == 0x0050) {
        (*DATDATBFDATAF0)["BFDATA"        ] = DATDATBFDATAF0_BFDATA;
        return;
    }
    if (addr == 0x0054) {
        (*DATDATBFDATAF1)["BFDATA"        ] = DATDATBFDATAF1_BFDATA;
        return;
    }
    if (addr == 0x0060) {
        (*DATDATBFECCF  )["BFECC0"        ] = DATDATBFECCF_BFECC0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecccnt_dmdan_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecccnt_dmdan_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecccnt_dmdan_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecccnt_dmdan_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecccnt_dmdan_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecccnt_dmdan_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecccnt_dmdan_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cecccnt_dmdan_regif::uint Cecccnt_dmdan_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cecccnt_dmdan_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecccnt_dmdan_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecccnt_dmdan_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecccnt_dmdan_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cecccnt_dmdan_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecccnt_dmdan_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecccnt_dmdan_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
