// -----------------------------------------------------------------------------
// $Id: ecccnt_dts_regif.cpp,v 1.6 2019/09/06 11:37:29 landang Exp $
//
...
//
// Input file : ./input/DMADTS_RAM/ecccnt_dts_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecccnt_dts
//     #              name     offset_size
...
//     
////////////////////////////////////////////////////////////////////////////////
/// @file ecccnt_dts_regif.cpp
/// @brief Register IF class of model ECCCNT_DTS
/// $Id: ecccnt_dts_regif.cpp,v 1.6 2019/09/06 11:37:29 landang Exp $
/// $Date: 2019/09/06 11:37:29 $
/// $Revison$
/// $Author: landang $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cecccnt_dts_regif::Cecccnt_dts_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    DRECCCTL       = new vpcl::re_register(0x0000, this, "DRECCCTL"      , name.c_str());
    DRECCTSTCTL    = new vpcl::re_register(0x0010, this, "DRECCTSTCTL"   , name.c_str());
    DRAFINV        = new vpcl::re_register(0x0020, this, "DRAFINV"       , name.c_str());
    DRECCTSTDIN0   = new vpcl::re_register(0x0030, this, "DRECCTSTDIN0"  , name.c_str());
    DRECCTSTEIN    = new vpcl::re_register(0x0040, this, "DRECCTSTEIN"   , name.c_str());
    DRTDATBFDATAF0 = new vpcl::re_register(0x0050, this, "DRTDATBFDATAF0", name.c_str());
    DRTDATBFECCF   = new vpcl::re_register(0x0060, this, "DRTDATBFECCF"  , name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_DRECCCTL        , DRECCCTL->name()      , DRECCCTL->addr()      );
    cw_instantiate_reg(CW_DRECCTSTCTL     , DRECCTSTCTL->name()   , DRECCTSTCTL->addr()   );
    cw_instantiate_reg(CW_DRAFINV         , DRAFINV->name()       , DRAFINV->addr()       );
    cw_instantiate_reg(CW_DRECCTSTDIN0    , DRECCTSTDIN0->name()  , DRECCTSTDIN0->addr()  );
    cw_instantiate_reg(CW_DRECCTSTEIN     , DRECCTSTEIN->name()   , DRECCTSTEIN->addr()   );
    cw_instantiate_reg(CW_DRTDATBFDATAF0  , DRTDATBFDATAF0->name(), DRTDATBFDATAF0->addr());
    cw_instantiate_reg(CW_DRTDATBFECCF    , DRTDATBFECCF->name()  , DRTDATBFECCF->addr()  );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DRECCCTL        , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRECCTSTCTL     , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRAFINV         , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRECCTSTDIN0    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRECCTSTEIN     , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRTDATBFDATAF0  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DRTDATBFECCF    , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*DRECCCTL        ) ( 3,  3, "AFEDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRECCCTL        ) ( 1,  1, "SECDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRECCCTL        ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRECCTSTCTL     ) ( 1,  1, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRAFINV         ) (11,  2, "AFINV"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRECCTSTDIN0    ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRECCTSTEIN     ) ( 6,  0, "ECC"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DRTDATBFDATAF0  ) (31,  0, "BFDATA"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DRTDATBFECCF    ) ( 6,  0, "BFECC0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["DRECCCTL"    ]["ECCDIS"      ] = &Cecccnt_dts_regif::cb_DRECCCTL_ECCDIS;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecccnt_dts_regif::~Cecccnt_dts_regif()
{
...
Cecccnt_dts_regif::uint Cecccnt_dts_regif::bit_select(
...
bool Cecccnt_dts_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecccnt_dts_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_dts_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                   const unsigned char *p_data,   ///< [in] Writing data
                                   cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_dts_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                   unsigned char *p_data,   ///< [out] Reading data
                                   cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_dts_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                       const unsigned char *p_data,  ///< [in] Writing data
                                       cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_dts_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size,              ///< [in]  Data size (byte)
                                       bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecccnt_dts_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                    unsigned char *p_data,          ///< [out] Reading data
                                    cuint size,                     ///< [in]  Data size (byte)
...
bool Cecccnt_dts_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                    const unsigned char *p_data,      ///< [in] Writing data
                                    cuint size,                       ///< [in] Data size (byte)
                                    cuint reg_index,                  ///< [in] Register index
...
bool Cecccnt_dts_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecccnt_dts_regif::CommandInit()
{
...
/// @return string
std::string Cecccnt_dts_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecccnt_dts_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecccnt_dts_regif::InitLocalVal()
{
    // Initialize local variables
    DRECCCTL_AFEDIS = 0x0;
    DRECCCTL_SECDIS = 0x0;
    DRECCCTL_ECCDIS = 0x0;
    DRECCTSTCTL_ECCTST = 0x0;
    DRAFINV_AFINV  = 0x0;
    DRECCTSTDIN0_DATA = 0x0;
    DRECCTSTEIN_ECC = 0x0;
    DRTDATBFDATAF0_BFDATA = 0x0;
    DRTDATBFECCF_BFECC0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cecccnt_dts_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        DRECCCTL_AFEDIS                    = (*DRECCCTL      )["AFEDIS"        ];
        DRECCCTL_SECDIS                    = (*DRECCCTL      )["SECDIS"        ];
        DRECCCTL_ECCDIS                    = (*DRECCCTL      )["ECCDIS"        ];
        return;
    }
    if (addr == 0x0010) {
        DRECCTSTCTL_ECCTST                 = (*DRECCTSTCTL   )["ECCTST"        ];
        return;
    }
    if (addr == 0x0020) {
        DRAFINV_AFINV                      = (*DRAFINV       )["AFINV"         ];
        return;
    }
    if (addr == 0x0030) {
        DRECCTSTDIN0_DATA                  = (*DRECCTSTDIN0  )["DATA"          ];
        return;
    }
    if (addr == 0x0040) {
        DRECCTSTEIN_ECC                    = (*DRECCTSTEIN   )["ECC"           ];
        return;
    }
    if (addr == 0x0050) {
        DRTDATBFDATAF0_BFDATA              = (*DRTDATBFDATAF0)["BFDATA"        ];
        return;
    }
    if (addr == 0x0060) {
        DRTDATBFECCF_BFECC0                = (*DRTDATBFECCF  )["BFECC0"        ];
        return;
    }
}
...
/// @return None
void Cecccnt_dts_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*DRECCCTL      )["AFEDIS"        ] = DRECCCTL_AFEDIS;
        (*DRECCCTL      )["SECDIS"        ] = DRECCCTL_SECDIS;
        (*DRECCCTL      )["ECCDIS"        ] = DRECCCTL_ECCDIS;
        return;
    }
    if (addr == 0x0010) {
        (*DRECCTSTCTL   )["ECCTST"        ] = DRECCTSTCTL_ECCTST;
        return;
    }
    if (addr == 0x0020) {
        (*DRAFINV       )["AFINV"         ] = DRAFINV_AFINV;
        return;
    }
    if (addr == 0x0030) {
        (*DRECCTSTDIN0  )["DATA"          ] = DRECCTSTDIN0_DATA;
        return;
    }
    if (addr == 0x0040) {
        (*DRECCTSTEIN   )["ECC"           ] = DRECCTSTEIN_ECC;
        return;
    }
    if (addr == 0x0050) {
        (*DRTDATBFDATAF0)["BFDATA"        ] = DRTDATBFDATAF0_BFDATA;
        return;
    }
    if (addr == 0x0060) {
        (*DRTDATBFECCF  )["BFECC0"        ] = DRTDATBFECCF_BFECC0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecccnt_dts_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecccnt_dts_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecccnt_dts_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecccnt_dts_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecccnt_dts_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecccnt_dts_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecccnt_dts_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cecccnt_dts_regif::uint Cecccnt_dts_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cecccnt_dts_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecccnt_dts_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecccnt_dts_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecccnt_dts_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cecccnt_dts_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecccnt_dts_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecccnt_dts_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
