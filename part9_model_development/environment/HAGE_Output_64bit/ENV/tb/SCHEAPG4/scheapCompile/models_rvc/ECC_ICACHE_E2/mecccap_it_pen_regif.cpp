// -----------------------------------------------------------------------------
// $Id: mecccap_it_pen_regif.cpp,v 1.1 2019/09/26 10:07:26 landang Exp $
//
...
//
// Input file : ./input/ICACHE/mecccap_it_pen_regif.txt
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cmecccap_it_pen_regif::Cmecccap_it_pen_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    mWrCbAPI["IT_SSTCLR"]["IT_SSTCLR"] = &Cmecccap_it_pen_regif::cb_IT_SSTCLR_IT_SSTCLR;
    mWrCbAPI["IT_DSTCLR"]["DSTCLR00"] = &Cmecccap_it_pen_regif::cb_IT_DSTCLR_DSTCLR00;
    mWrCbAPI["IT_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_it_pen_regif::cb_IT_OVFCLR_SERROVFCLR0;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_it_pen_regif::~Cmecccap_it_pen_regif()
{
...
Cmecccap_it_pen_regif::uint Cmecccap_it_pen_regif::bit_select(
...
bool Cmecccap_it_pen_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_it_pen_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_it_pen_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_it_pen_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_it_pen_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_it_pen_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_it_pen_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_it_pen_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_it_pen_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_it_pen_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_it_pen_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_it_pen_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_it_pen_regif::InitLocalVal()
{
    // Initialize local variables
    IT_ERRINT_AFEIE = 0x0;
    IT_ERRINT_DEDIE = 0x0;
...
/// @return None
void Cmecccap_it_pen_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Cmecccap_it_pen_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Cmecccap_it_pen_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_it_pen_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_it_pen_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_it_pen_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_it_pen_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_it_pen_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_it_pen_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_it_pen_regif::uint Cmecccap_it_pen_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_it_pen_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_it_pen_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_it_pen_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_it_pen_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_it_pen_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_it_pen_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_it_pen_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
