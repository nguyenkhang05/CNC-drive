// ---------------------------------------------------------------------
// $Id: ECC_BUS_APEC_Reg.h,v 1.4 2020/04/01 06:41:19 thunguyen3 Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_BUS_APEC_REG_H__
#define __ECC_BUS_APEC_REG_H__

#include "ecc_bus_apec_regif.h"
#include "ECC_BUS_MER_AD_AgentController.h"
#include "ECC_def.h"

class ECC_BUS_MER_AD_Func;

class ECC_BUS_APEC_Reg: public Cecc_bus_apec_regif
{
public:
    SC_HAS_PROCESS (ECC_BUS_APEC_Reg);
    ECC_BUS_APEC_Reg(std::string name, ECC_BUS_MER_AD_Func* parent_func, ECC_BUS_MER_AD_AgentController* ECC_BUS_MER_ADAgentController);
    ~ECC_BUS_APEC_Reg();
