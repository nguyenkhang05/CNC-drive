// -----------------------------------------------------------------------------
// $Id: apltsc000_regif.cpp,v 1.3 2020/03/21 06:59:29 chuonghoangle Exp $
//
...
//
// Input file : ../apltsc000_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE apltsc000
//     #              name     offset_size
...
//     
////////////////////////////////////////////////////////////////////////////////
/// @file apltsc000_regif.cpp
/// @brief Register IF class of model APLTSC000
/// $Id: apltsc000_regif.cpp,v 1.3 2020/03/21 06:59:29 chuonghoangle Exp $
/// $Date: 2020/03/21 06:59:29 $
/// $Revison$
...
/// @return none
Capltsc000_regif::Capltsc000_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
...
{
    CommandInit();
    LTSCnTCS  = new vpcl::re_register(0x0010, this, "LTSCnTCS" , name.c_str());
    LTSCnTCT  = new vpcl::re_register(0x0014, this, "LTSCnTCT" , name.c_str());
    LTSCnCSTR = new vpcl::re_register(0x0018, this, "LTSCnCSTR", name.c_str());
    LTSCnRM   = new vpcl::re_register(0x0034, this, "LTSCnRM"  , name.c_str());
    LTSCnEMU  = new vpcl::re_register(0x0038, this, "LTSCnEMU" , name.c_str());
    LTSCnCNTL = new vpcl::re_register(0x0040, this, "LTSCnCNTL", name.c_str());
    LTSCnCNTH = new vpcl::re_register(0x0044, this, "LTSCnCNTH", name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_LTSCnTCS   , LTSCnTCS->name() , LTSCnTCS->addr() );
    cw_instantiate_reg(CW_LTSCnTCT   , LTSCnTCT->name() , LTSCnTCT->addr() );
    cw_instantiate_reg(CW_LTSCnCSTR  , LTSCnCSTR->name(), LTSCnCSTR->addr());
    cw_instantiate_reg(CW_LTSCnRM    , LTSCnRM->name()  , LTSCnRM->addr()  );
    cw_instantiate_reg(CW_LTSCnEMU   , LTSCnEMU->name() , LTSCnEMU->addr() );
    cw_instantiate_reg(CW_LTSCnCNTL  , LTSCnCNTL->name(), LTSCnCNTL->addr());
    cw_instantiate_reg(CW_LTSCnCNTH  , LTSCnCNTH->name(), LTSCnCNTH->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(LTSCnTCS   , mCurReg, 0,  4,    "8|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnTCT   , mCurReg, 0,  4,    "8|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnCSTR  , mCurReg, 0,  4,    "8|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnRM    , mCurReg, 0,  4,    "8|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnEMU   , mCurReg, 0,  4,    "8|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnCNTL  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LTSCnCNTH  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*LTSCnTCS   ) ( 0,  0, "LTSCnTS" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTSCnTCT   ) ( 0,  0, "LTSCnTT" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTSCnCSTR  ) ( 0,  0, "LTSCnCST", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LTSCnRM    ) ( 0,  0, "LTSCnRM" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTSCnEMU   ) ( 7,  7, "LTSCnSVSDIS", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTSCnCNTL  ) (31,  0, "LTSCnCNTL", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LTSCnCNTH  ) (31,  0, "LTSCnCNTH", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["LTSCnTCS"]["LTSCnTS"] = &Capltsc000_regif::cb_LTSCnTCS_LTSCnTS;
    mWrCbAPI["LTSCnTCT"]["LTSCnTT"] = &Capltsc000_regif::cb_LTSCnTCT_LTSCnTT;
    mWrCbAPI["LTSCnRM"]["LTSCnRM"] = &Capltsc000_regif::cb_LTSCnRM_LTSCnRM;
    mWrCbAPI["LTSCnEMU"]["LTSCnSVSDIS"] = &Capltsc000_regif::cb_LTSCnEMU_LTSCnSVSDIS;
    mWrCbAPI["LTSCnCNTL"]["LTSCnCNTL"] = &Capltsc000_regif::cb_LTSCnCNTL_LTSCnCNTL;
    mWrCbAPI["LTSCnCNTH"]["LTSCnCNTH"] = &Capltsc000_regif::cb_LTSCnCNTH_LTSCnCNTH;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Capltsc000_regif::~Capltsc000_regif()
{
...
Capltsc000_regif::uint Capltsc000_regif::bit_select(
...
bool Capltsc000_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Capltsc000_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Capltsc000_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                  const unsigned char *p_data,   ///< [in] Writing data
                                  cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Capltsc000_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                  unsigned char *p_data,   ///< [out] Reading data
                                  cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Capltsc000_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                      const unsigned char *p_data,  ///< [in] Writing data
                                      cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Capltsc000_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size,              ///< [in]  Data size (byte)
                                      bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Capltsc000_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                   unsigned char *p_data,          ///< [out] Reading data
                                   cuint size,                     ///< [in]  Data size (byte)
...
bool Capltsc000_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                   const unsigned char *p_data,      ///< [in] Writing data
                                   cuint size,                       ///< [in] Data size (byte)
                                   cuint reg_index,                  ///< [in] Register index
...
bool Capltsc000_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Capltsc000_regif::CommandInit()
{
...
/// @return string
std::string Capltsc000_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Capltsc000_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Capltsc000_regif::InitLocalVal()
{
    // Initialize local variables
    LTSCnTCS_LTSCnTS = 0x0;
    LTSCnTCT_LTSCnTT = 0x0;
    LTSCnCSTR_LTSCnCST = 0x0;
    LTSCnRM_LTSCnRM = 0x0;
    LTSCnEMU_LTSCnSVSDIS = 0x0;
    LTSCnCNTL_LTSCnCNTL = 0x0;
    LTSCnCNTH_LTSCnCNTH = 0x0;
}

/// Update bit value to local value
/// @return None
void Capltsc000_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0010) {
        LTSCnTCS_LTSCnTS              = (*LTSCnTCS )["LTSCnTS"  ];
        return;
    }
    if (addr == 0x0014) {
        LTSCnTCT_LTSCnTT              = (*LTSCnTCT )["LTSCnTT"  ];
        return;
    }
    if (addr == 0x0018) {
        LTSCnCSTR_LTSCnCST            = (*LTSCnCSTR)["LTSCnCST" ];
        return;
    }
    if (addr == 0x0034) {
        LTSCnRM_LTSCnRM               = (*LTSCnRM  )["LTSCnRM"  ];
        return;
    }
    if (addr == 0x0038) {
        LTSCnEMU_LTSCnSVSDIS          = (*LTSCnEMU )["LTSCnSVSDIS"];
        return;
    }
    if (addr == 0x0040) {
        LTSCnCNTL_LTSCnCNTL           = (*LTSCnCNTL)["LTSCnCNTL"];
        return;
    }
    if (addr == 0x0044) {
        LTSCnCNTH_LTSCnCNTH           = (*LTSCnCNTH)["LTSCnCNTH"];
        return;
    }
}
...
/// @return None
void Capltsc000_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0010) {
        (*LTSCnTCS )["LTSCnTS"  ] = LTSCnTCS_LTSCnTS;
        return;
    }
    if (addr == 0x0014) {
        (*LTSCnTCT )["LTSCnTT"  ] = LTSCnTCT_LTSCnTT;
        return;
    }
    if (addr == 0x0018) {
        (*LTSCnCSTR)["LTSCnCST" ] = LTSCnCSTR_LTSCnCST;
        return;
    }
    if (addr == 0x0034) {
        (*LTSCnRM  )["LTSCnRM"  ] = LTSCnRM_LTSCnRM;
        return;
    }
    if (addr == 0x0038) {
        (*LTSCnEMU )["LTSCnSVSDIS"] = LTSCnEMU_LTSCnSVSDIS;
        return;
    }
    if (addr == 0x0040) {
        (*LTSCnCNTL)["LTSCnCNTL"] = LTSCnCNTL_LTSCnCNTL;
        return;
    }
    if (addr == 0x0044) {
        (*LTSCnCNTH)["LTSCnCNTH"] = LTSCnCNTH_LTSCnCNTH;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Capltsc000_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Capltsc000_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Capltsc000_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Capltsc000_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Capltsc000_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Capltsc000_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Capltsc000_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Capltsc000_regif::uint Capltsc000_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Capltsc000_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Capltsc000_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Capltsc000_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Capltsc000_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Capltsc000_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Capltsc000_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Capltsc000_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
