...
//# $Id$
//#
//# Copyright(c) 2019 Renesas System Design Co., Ltd.
...
#ifndef SARAD_U2A_CMDIF_H
#define SARAD_U2A_CMDIF_H
...
std::string own_handle_command(std::vector<std::string>& args)
{
  ...
  if (args[0] == "help") {
    ...
    ret += "    EVcc0 <EVcc0>                             Reference voltage of EVCC0 ( Default:3.3  )\n";
    ret += "    EVcc1 <EVcc1>                             Reference voltage of EVCC1 ( Default:3.3  )\n";
    ret += "    EVcc2 <EVcc2>                             Reference voltage of EVCC2 ( Default:3.3  )\n";
    ...
    ret += "    ForcedDataPathError0 <enable>             The data path error occurs forcibly into ADCA0 ( Default:false  )\n";
    ret += "    ForcedDataPathError1 <enable>             The data path error occurs forcibly into ADCA1 ( Default:false  )\n";
    ret += "    ForcedDataPathError2 <enable>             The data path error occurs forcibly into ADCA2 ( Default:false  )\n";
    ...
    ret += "    AssertPReset <start_time> <period>        Assert preset_n for ADC0 and ADC2\n";
    ret += "    AssertADReset <start_time> <period>       Assert RESETAD_N for ADC0 and ADC2\n";
    ret += "    AssertPReset2 <start_time> <period>       Assert preset_n for ADC2\n";
    ret += "    AssertADReset2 <start_time> <period>      Assert RESETAD_N for ADC2\n";
...
std::string user_def_command(std::vector<std::string>& args)
{
  ...
  if (0) {}
    ...
    if ((int)args.size() > 2 && (int)args.size() <= 3) {
      ...
      AssertPReset2(start_time, period);
    }
    else {
      ret = err_msg + "wrong number of arguments" + specified_cmd;
    }
  }
  else if (args[0] == "AssertADReset2") {
    if ((int)args.size() > 2 && (int)args.size() <= 3) {
      double start_time;
      if ((int)args.size() >= 2) {
        if (!str2dbl(args[1], start_time)) {
      ...
      AssertADReset2(start_time, period);
    }
    else {
      ret = err_msg + "wrong number of arguments" + specified_cmd;
    }
