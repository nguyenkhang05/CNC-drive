// -----------------------------------------------------------------------------
// $Id: ahberrslv_uimpl_regif.h,v 1.2 2014/10/02 02:19:58 dungvannguyen Exp $
//
...
////////////////////////////////////////////////////////////////////////////////
/// @file ahberrslv_uimpl_regif.h
/// @brief Register IF class of model AHBERRSLV_UIMPL
/// $Id: ahberrslv_uimpl_regif.h,v 1.2 2014/10/02 02:19:58 dungvannguyen Exp $
/// $Date: 2014/10/02 02:19:58 $
/// $Revison$
/// $Author: dungvannguyen $
////////////////////////////////////////////////////////////////////////////////
#ifndef __AHBERRSLV_UIMPL_REGIF_H__
#define __AHBERRSLV_UIMPL_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of AHBERRSLV_UIMPL model
class Cahberrslv_uimpl_regif
...
public:
    Cahberrslv_uimpl_regif(std::string name, uint buswidth, uint version = 0);
    ~Cahberrslv_uimpl_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Cahberrslv_uimpl_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cahberrslv_uimpl_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__AHBERRSLV_UIMPL_REG_DEF_H__
