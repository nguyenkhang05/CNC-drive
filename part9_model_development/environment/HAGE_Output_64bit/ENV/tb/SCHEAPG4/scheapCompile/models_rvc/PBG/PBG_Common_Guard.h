// ---------------------------------------------------------------------
// $Id: PBG_Common_Guard.h,v 1.2 2019/06/16 06:02:16 nhuvo Exp $
//
...
#ifndef __PBG_DATAHANDLER_H__
#define __PBG_DATAHANDLER_H__
#include "BusBridgeCoreBase.h"
#include "global.h"

class PBG_Common_Guard : //public sc_module,
                     public BusBridgeCoreBase<32,32>
{
public:
    PBG_Common_Guard(std::string name,
                   BusBridgeModuleBase<32,32> *Parent,
                   BusBridgeSlaveIf<32> *SlaveIf,
                   BusMasterIf<32> *MasterIf,
                   SIM_MODE_T simmode,
                   unsigned int ch_num);
    virtual ~PBG_Common_Guard(){;}
    ...
    void SetSecOperation(bool isDisable);
...
private:
    ...
    void SettingTransG3m(TlmBasicPayload &inTrans, TlmBasicPayload &outTrans);
