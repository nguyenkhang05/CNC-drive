// -----------------------------------------------------------------------------
// $Id: dfe_fifo_regif.cpp,v 1.2 2018/09/06 10:17:09 huepham Exp $
//
...
// %%REG      DFBFACTLCH   DFBFACTLCH  8|16|32     8|16|32    32        0x0010    0               5             -               0x4            R|W        0x00000000       TRUE        R|W
// %%REG      DFBFADOCH    DFBFADOCH   32          8|16|32    32        0x0050    0               5             -               0x4            R          0x00000000       TRUE        R|W
...
// %REG_NAME  DFBFACST
// %%TITLE    name    upper    lower    init    access    support    callback
// #%%BIT      OVFA0   0        0        0       R         TRUE       R
// #%%BIT      OVFA1   1        1        0       R         TRUE       R
// #%%BIT      OVFA2   2        2        0       R         TRUE       R
// #%%BIT      OVFA3   3        3        0       R         TRUE       R
// #%%BIT      OVFA4   4        4        0       R         TRUE       R
// #%%BIT      OVFA5   5        5        0       R         TRUE       R
// #%%BIT      EMPA0   16       16       1       R         TRUE       R
// #%%BIT      EMPA1   17       17       1       R         TRUE       R
// #%%BIT      EMPA2   18       18       1       R         TRUE       R
// #%%BIT      EMPA3   19       19       1       R         TRUE       R
// #%%BIT      EMPA4   20       20       1       R         TRUE       R
// #%%BIT      EMPA5   21       21       1       R         TRUE       R
// %%BIT      OVFA     5        0        0       R         TRUE       R
// %%BIT      EMPA     21       16       63      R         TRUE       R
// 
// #-------------------------------------------------------------------------------
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file dfe_fifo_regif.cpp
/// @brief Register IF class of model DFE_FIFO
/// $Id: dfe_fifo_regif.cpp,v 1.2 2018/09/06 10:17:09 huepham Exp $
...
/// @return none
Cdfe_fifo_regif::Cdfe_fifo_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    (*DFBFACST    ) ( 5,  0, "OVFA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DFBFACST    ) (21, 16, "EMPA"    , 0x3F      , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["DFBFACCTL"]["AEN"     ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AEN;
    mWrCbAPI["DFBFACCTL"]["AIEO"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AIEO;
    mWrCbAPI["DFBFACCTL"]["AIEE"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AIEE;
    mWrCbAPI["DFBFACCTL"]["AUNE"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AUNE;
    mWrCbAPI["DFBFACLR"]["CLRA"    ] = &Cdfe_fifo_regif::cb_DFBFACLR_CLRA;
    mWrCbAPI["DFBFBCTL"]["BEN"     ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BEN;
    mWrCbAPI["DFBFBCTL"]["BIEO"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BIEO;
    mWrCbAPI["DFBFBCTL"]["BIEE"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BIEE;
    mWrCbAPI["DFBFBCTL"]["BDSL"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BDSL;
    mWrCbAPI["DFBFBCTL"]["BFBCH"   ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BFBCH;
    mWrCbAPI["DFBFBCLR"]["CLRB"    ] = &Cdfe_fifo_regif::cb_DFBFBCLR_CLRB;

    mRdCbAPI["DFBFACCTL"]["AEN"     ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AEN;
    mRdCbAPI["DFBFACCTL"]["AIEO"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AIEO;
    mRdCbAPI["DFBFACCTL"]["AIEE"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AIEE;
    mRdCbAPI["DFBFACCTL"]["AUNE"    ] = &Cdfe_fifo_regif::cb_DFBFACCTL_AUNE;
    mRdCbAPI["DFBFACLR"]["CLRA"    ] = &Cdfe_fifo_regif::cb_DFBFACLR_CLRA;
    mRdCbAPI["DFBFACST"]["OVFA"    ] = &Cdfe_fifo_regif::cb_DFBFACST_OVFA;
    mRdCbAPI["DFBFACST"]["EMPA"    ] = &Cdfe_fifo_regif::cb_DFBFACST_EMPA;
    mRdCbAPI["DFBFBCTL"]["BEN"     ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BEN;
    mRdCbAPI["DFBFBCTL"]["BIEO"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BIEO;
    mRdCbAPI["DFBFBCTL"]["BIEE"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BIEE;
    mRdCbAPI["DFBFBCTL"]["BDSL"    ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BDSL;
    mRdCbAPI["DFBFBCTL"]["BFBCH"   ] = &Cdfe_fifo_regif::cb_DFBFBCTL_BFBCH;
    mRdCbAPI["DFBFBDO" ]["BDO"     ] = &Cdfe_fifo_regif::cb_DFBFBDO_BDO;
    mRdCbAPI["DFBFBCLR"]["CLRB"    ] = &Cdfe_fifo_regif::cb_DFBFBCLR_CLRB;
    mRdCbAPI["DFBFBST" ]["OVFB"    ] = &Cdfe_fifo_regif::cb_DFBFBST_OVFB;
    mRdCbAPI["DFBFBST" ]["EMPB"    ] = &Cdfe_fifo_regif::cb_DFBFBST_EMPB;

    for(uint i = 0; i < emNUM_DFBFACTLCH; i++) {
        str_tmp.str("");
        str_tmp<<"DFBFACTLCH"<< i;
        mWrCbAPI[str_tmp.str()]["CHEN"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_CHEN;
        mWrCbAPI[str_tmp.str()]["ADSL"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_ADSL;
        mWrCbAPI[str_tmp.str()]["BFACH"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_BFACH;
        mRdCbAPI[str_tmp.str()]["CHEN"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_CHEN;
        mRdCbAPI[str_tmp.str()]["ADSL"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_ADSL;
        mRdCbAPI[str_tmp.str()]["BFACH"] = &Cdfe_fifo_regif::cb_DFBFACTLCH_BFACH;
    }
    for(uint i = 0; i < emNUM_DFBFADOCH; i++) {
        str_tmp.str("");
        str_tmp<<"DFBFADOCH"<< i;
        mRdCbAPI[str_tmp.str()]["ADO"] = &Cdfe_fifo_regif::cb_DFBFADOCH_ADO;
    }
    InitLocalVal();
}
...
/// @return none
Cdfe_fifo_regif::~Cdfe_fifo_regif()
{
...
Cdfe_fifo_regif::uint Cdfe_fifo_regif::bit_select(
...
bool Cdfe_fifo_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cdfe_fifo_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdfe_fifo_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                 const unsigned char *p_data,   ///< [in] Writing data
                                 cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdfe_fifo_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                 unsigned char *p_data,   ///< [out] Reading data
                                 cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdfe_fifo_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                     const unsigned char *p_data,  ///< [in] Writing data
                                     cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdfe_fifo_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                     unsigned char *p_data,   ///< [out] Reading data
                                     cuint size,              ///< [in]  Data size (byte)
                                     bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cdfe_fifo_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                  unsigned char *p_data,          ///< [out] Reading data
                                  cuint size,                     ///< [in]  Data size (byte)
...
bool Cdfe_fifo_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                  const unsigned char *p_data,      ///< [in] Writing data
                                  cuint size,                       ///< [in] Data size (byte)
                                  cuint reg_index,                  ///< [in] Register index
...
bool Cdfe_fifo_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cdfe_fifo_regif::CommandInit()
{
...
/// @return string
std::string Cdfe_fifo_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cdfe_fifo_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cdfe_fifo_regif::InitLocalVal()
{
    // Initialize local variables
    DFBFACCTL_AEN = 0x0;
    DFBFACCTL_AIEO = 0x0;
...
/// @return None
void Cdfe_fifo_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
    ...
    if ((0x0010 <= addr) && (addr <= (0x0010)+(4*5)) && ((addr-0x0010)%4 == 0)) {
    ...
    if ((0x0050 <= addr) && (addr <= (0x0050)+(4*5)) && ((addr-0x0050)%4 == 0)) {
...
/// @return None
void Cdfe_fifo_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Cdfe_fifo_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cdfe_fifo_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cdfe_fifo_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cdfe_fifo_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cdfe_fifo_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cdfe_fifo_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cdfe_fifo_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cdfe_fifo_regif::uint Cdfe_fifo_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cdfe_fifo_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cdfe_fifo_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cdfe_fifo_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cdfe_fifo_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cdfe_fifo_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cdfe_fifo_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cdfe_fifo_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
