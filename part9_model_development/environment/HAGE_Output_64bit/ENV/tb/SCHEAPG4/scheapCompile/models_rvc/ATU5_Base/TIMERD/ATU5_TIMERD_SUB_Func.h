// ---------------------------------------------------------------------
// $Id: ATU5_TIMERD_SUB_Func.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5_TIMERD_SUB_FUNC_H__
#define __ATU5_TIMERD_SUB_FUNC_H__
#include "atu5_timerd_sub_regif.h"
#include "ATU5_TIMERD_SUB_AgentController.h"

class ATU5_TIMERD_SUB_Func: public Catu5_timerd_sub_regif
{
public:
    ATU5_TIMERD_SUB_Func (std::string name, 
                ATU5_TIMERD_SUB_AgentController *mTIMERD_SUBAgentPtr);
    ~ATU5_TIMERD_SUB_Func (void);
    ...
    void cb_TSCR2D_FEFCD3(RegCBstr str);  // ducla add
    void Set_TSR2D_REFD(const unsigned int ch_id, unsigned int value);// ducla add
    void Set_TSR2D_FEFD(const unsigned int ch_id, unsigned int value);// ducla add

    bool GetDcntStart(const unsigned int ch_id);
...
private:
    ATU5_TIMERD_SUB_AgentController  *mTIMERD_SUBAgent;
