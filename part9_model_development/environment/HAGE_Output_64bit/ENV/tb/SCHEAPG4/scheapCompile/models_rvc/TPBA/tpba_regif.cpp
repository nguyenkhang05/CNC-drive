...
/// @return none
Ctpba_regif::Ctpba_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USE_CWR_SYSTEMC
    , cwmem("register", 0x206)
    #endif
{
    CommandInit();
    TPBA0CMP0 = new vpcl::re_register(0x0100, this, "TPBA0CMP0", name.c_str());
    TPBA0CMP1 = new vpcl::re_register(0x0104, this, "TPBA0CMP1", name.c_str());
    TPBA0CNT0 = new vpcl::re_register(0x0108, this, "TPBA0CNT0", name.c_str());
    TPBA0CNT1 = new vpcl::re_register(0x010C, this, "TPBA0CNT1", name.c_str());
    TPBA0RSF  = new vpcl::re_register(0x0110, this, "TPBA0RSF" , name.c_str());
    TPBA0RDT  = new vpcl::re_register(0x0114, this, "TPBA0RDT" , name.c_str());
    TPBA0RDM  = new vpcl::re_register(0x0118, this, "TPBA0RDM" , name.c_str());
    TPBA0TO   = new vpcl::re_register(0x011C, this, "TPBA0TO"  , name.c_str());
    TPBA0TOE  = new vpcl::re_register(0x0120, this, "TPBA0TOE" , name.c_str());
    TPBA0TOL  = new vpcl::re_register(0x0124, this, "TPBA0TOL" , name.c_str());
    TPBA0TE   = new vpcl::re_register(0x0128, this, "TPBA0TE"  , name.c_str());
    TPBA0TS   = new vpcl::re_register(0x012C, this, "TPBA0TS"  , name.c_str());
    TPBA0TT   = new vpcl::re_register(0x0130, this, "TPBA0TT"  , name.c_str());
    TPBA0CTL  = new vpcl::re_register(0x0200, this, "TPBA0CTL" , name.c_str());
    TPBA0EMU  = new vpcl::re_register(0x0204, this, "TPBA0EMU" , name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_TPBA0BUF; i++) {
        str_tmp.str("");
        str_tmp<<"TPBA0BUF"<< i;
        TPBA0BUF [i] = new vpcl::re_register((0x0000) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
#ifdef USE_CWR_SYSTEMC
    for(uint i = 0; i < emNUM_TPBA0BUF ; i++) mCurReg = mRegArray[index++] = new SRegList(TPBA0BUF   [i], mCurReg, i,  2,      "16",      "16", false, &cwmem);
#else
    for(uint i = 0; i < emNUM_TPBA0BUF ; i++) mCurReg = mRegArray[index++] = new SRegList(TPBA0BUF   [i], mCurReg, i,  2,      "16",      "16");
#endif
    mCurReg = mRegArray[index++] = new SRegList(TPBA0CMP0  , mCurReg, 0,  2,      "16",      "16");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0CMP1  , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0CNT0  , mCurReg, 0,  2,      "16",      "16");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0CNT1  , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0RSF   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0RDT   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0RDM   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TO    , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TOE   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TOL   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TE    , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TS    , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0TT    , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0CTL   , mCurReg, 0,  1,       "8",       "8");
    mCurReg = mRegArray[index++] = new SRegList(TPBA0EMU   , mCurReg, 0,  1,       "8",       "8");

    mRegList = mCurReg;

    (*TPBA0CMP0  ) (15,  0, "TPBA0CMP0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TPBA0CMP1  ) ( 6,  0, "TPBA0CMP1", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TPBA0CNT0  ) (15,  0, "TPBA0CNT0", 0xFFFF    , "R"     , vpcl::SPP_ENABLE);
    (*TPBA0CNT1  ) ( 6,  0, "TPBA0CNT1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TPBA0RSF   ) ( 0,  0, "TPBA0RSF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TPBA0RSF   ) ( 1,  1, "TPBA0RSF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TPBA0RDT   ) ( 0,  0, "TPBA0RDT0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TPBA0RDT   ) ( 1,  1, "TPBA0RDT1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TPBA0RDM   ) ( 0,  0, "TPBA0RDM0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TPBA0TO    ) ( 0,  0, "TPBA0TO0", 0x0       , "D"     , vpcl::SPP_ENABLE);
    (*TPBA0TOE   ) ( 0,  0, "TPBA0TOE0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TPBA0TOL   ) ( 0,  0, "TPBA0TOL0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*TPBA0TE    ) ( 0,  0, "TPBA0TE0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TPBA0TS    ) ( 0,  0, "TPBA0TS0", 0x0       , "D"     , vpcl::SPP_ENABLE);
    (*TPBA0TT    ) ( 0,  0, "TPBA0TT0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TPBA0CTL   ) ( 0,  0, "TPBA0DPS", 0x0       , "D"     , vpcl::SPP_ENABLE);
    (*TPBA0CTL   ) ( 4,  4, "TPBA0PRS0", 0x0       , "D"     , vpcl::SPP_ENABLE);
    (*TPBA0CTL   ) ( 5,  5, "TPBA0PRS1", 0x0       , "D"     , vpcl::SPP_ENABLE);
    (*TPBA0EMU   ) ( 7,  7, "TPBA0SVSDIS", 0x0       , "W|R"   , vpcl::SPP_DISABLE);
    for(uint i = 0; i < emNUM_TPBA0BUF; i++) {
        (*TPBA0BUF   [i]) (15,  0, "TPBA0BUF", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["TPBA0CMP1"]["TPBA0CMP1"] = &Ctpba_regif::cb_TPBA0CMP1_TPBA0CMP1;
    mWrCbAPI["TPBA0RDT"]["TPBA0RDT0"] = &Ctpba_regif::cb_TPBA0RDT_TPBA0RDT0;
    mWrCbAPI["TPBA0TO"]["TPBA0TO0"] = &Ctpba_regif::cb_TPBA0TO_TPBA0TO0;
    mWrCbAPI["TPBA0TOE"]["TPBA0TOE0"] = &Ctpba_regif::cb_TPBA0TOE_TPBA0TOE0;
    mWrCbAPI["TPBA0TS"]["TPBA0TS0"] = &Ctpba_regif::cb_TPBA0TS_TPBA0TS0;
    mWrCbAPI["TPBA0TT"]["TPBA0TT0"] = &Ctpba_regif::cb_TPBA0TT_TPBA0TT0;

    mRdCbAPI["TPBA0CNT0"]["TPBA0CNT0"] = &Ctpba_regif::cb_TPBA0CNT0_TPBA0CNT0;

    mRdDbgCbAPI["TPBA0CNT0"]["TPBA0CNT0"] = &Ctpba_regif::cbDBG_TPBA0CNT0_TPBA0CNT0;

    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Ctpba_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Ctpba_regif::~Ctpba_regif()
{
...
Ctpba_regif::uint Ctpba_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Ctpba_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Ctpba_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Ctpba_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                             const unsigned char *p_data,   ///< [in] Writing data
                             cuint size)                    ///< [in] Data size (byte)
{
    assert(size != 0);
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Ctpba_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                             unsigned char *p_data,   ///< [out] Reading data
                             cuint size)              ///< [in]  Data size (byte)
{
    assert(size != 0);
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Ctpba_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                 const unsigned char *p_data,  ///< [in] Writing data
                                 cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Ctpba_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                 unsigned char *p_data,   ///< [out] Reading data
                                 cuint size,              ///< [in]  Data size (byte)
                                 bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
bool Ctpba_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                              unsigned char *p_data,          ///< [out] Reading data
                              cuint size,                     ///< [in]  Data size (byte)
...
bool Ctpba_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                              const unsigned char *p_data,      ///< [in] Writing data
                              cuint size,                       ///< [in] Data size (byte)
                              cuint reg_index,                  ///< [in] Register index
...
bool Ctpba_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return string
std::string Ctpba_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Ctpba_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Ctpba_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Ctpba_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Ctpba_regif::IssueRegValueID(void)
{//{{{
...
/// @return vector
std::vector<std::string> Ctpba_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Ctpba_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Ctpba_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
        ...
        str_tmp<<"REG ["<<std::setw(21)<<std::left<<reg_name<<"] ";
        str_tmp<<operation;
        str_tmp<<" Size= "<<size;
...
int Ctpba_regif::get_reg_index(cuint access_addr)
{
    if (access_addr < (1<<10)) {
...
vpcl::re_register *Ctpba_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Ctpba_regif::next_reg_object()
{
    assert(mCurReg != NULL);
...
/// @return none
void Ctpba_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USE_CWR_SYSTEMC
...
/// @return read data
Ctpba_regif::uint Ctpba_regif::rd_cb(cuint addr)
{
    #ifdef USE_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Ctpba_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Ctpba_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Ctpba_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Ctpba_regif::EnableReset(const bool is_active)
{
...
#ifdef USE_CWR_SYSTEMC
unsigned short Ctpba_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Ctpba_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Ctpba_regif::cw_set_all_callback_reg(void)
{
