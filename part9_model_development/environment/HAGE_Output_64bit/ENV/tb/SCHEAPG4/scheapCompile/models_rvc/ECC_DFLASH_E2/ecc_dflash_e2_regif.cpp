// -----------------------------------------------------------------------------
// $Id: ecc_dflash_e2_regif.cpp,v 1.4 2019/09/06 08:48:49 landang Exp $
//
...
/// @return none
Cecc_dflash_e2_regif::Cecc_dflash_e2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    DFKCPROT = new vpcl::re_register(0x0020, this, "DFKCPROT", name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_DFECCCTL  , DFECCCTL->name(), DFECCCTL->addr());
    cw_instantiate_reg(CW_DFERSTR   , DFERSTR->name() , DFERSTR->addr() );
    cw_instantiate_reg(CW_DFERSTC   , DFERSTC->name() , DFERSTC->addr() );
    cw_instantiate_reg(CW_DFOVFSTR  , DFOVFSTR->name(), DFOVFSTR->addr());
    cw_instantiate_reg(CW_DFOVFSTC  , DFOVFSTC->name(), DFOVFSTC->addr());
    cw_instantiate_reg(CW_DFERRINT  , DFERRINT->name(), DFERRINT->addr());
    cw_instantiate_reg(CW_DFEADR    , DFEADR->name()  , DFEADR->addr()  );
    cw_instantiate_reg(CW_DFTSTCTL  , DFTSTCTL->name(), DFTSTCTL->addr());
    cw_instantiate_reg(CW_DFKCPROT  , DFKCPROT->name(), DFKCPROT->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DFECCCTL  , mCurReg, 0,  4,   "16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFERSTR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFERSTC   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFOVFSTR  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFOVFSTC  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFERRINT  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFEADR    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFTSTCTL  , mCurReg, 0,  4,   "16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DFKCPROT  , mCurReg, 0,  4,      "32", "8|16|32");
    ...
    (*DFEADR    ) (20,  2, "DFEADR"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DFTSTCTL  ) ( 0,  0, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DFKCPROT  ) (31,  1, "KCPROT"  , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DFKCPROT  ) ( 0,  0, "KCE"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["DFECCCTL"]["ECCDIS"] = &Cecc_dflash_e2_regif::cb_DFECCCTL_ECCDIS;
    mWrCbAPI["DFERSTC"]["ERRCLR"] = &Cecc_dflash_e2_regif::cb_DFERSTC_ERRCLR;
    mWrCbAPI["DFOVFSTC"]["ERROVFCLR"] = &Cecc_dflash_e2_regif::cb_DFOVFSTC_ERROVFCLR;
    mWrCbAPI["DFKCPROT"]["KCE"   ] = &Cecc_dflash_e2_regif::cb_DFKCPROT_KCE;

    mRdCbAPI["DFERRINT"]["EOVFIE"] = &Cecc_dflash_e2_regif::cb_DFERRINT_EOVFIE;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecc_dflash_e2_regif::~Cecc_dflash_e2_regif()
{
...
Cecc_dflash_e2_regif::uint Cecc_dflash_e2_regif::bit_select(
...
bool Cecc_dflash_e2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecc_dflash_e2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_dflash_e2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                      const unsigned char *p_data,   ///< [in] Writing data
                                      cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_dflash_e2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_dflash_e2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                          const unsigned char *p_data,  ///< [in] Writing data
                                          cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_dflash_e2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                          unsigned char *p_data,   ///< [out] Reading data
                                          cuint size,              ///< [in]  Data size (byte)
                                          bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecc_dflash_e2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                       unsigned char *p_data,          ///< [out] Reading data
                                       cuint size,                     ///< [in]  Data size (byte)
...
bool Cecc_dflash_e2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                       const unsigned char *p_data,      ///< [in] Writing data
                                       cuint size,                       ///< [in] Data size (byte)
                                       cuint reg_index,                  ///< [in] Register index
...
bool Cecc_dflash_e2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecc_dflash_e2_regif::CommandInit()
{
...
/// @return string
std::string Cecc_dflash_e2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecc_dflash_e2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecc_dflash_e2_regif::InitLocalVal()
{
    // Initialize local variables
    DFECCCTL_SEDDIS = 0x0;
    DFECCCTL_ECCDIS = 0x0;
...
/// @return None
void Cecc_dflash_e2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
    ...
    if (addr == 0x0020) {
        DFKCPROT_KCPROT              = (*DFKCPROT)["KCPROT"  ];
        DFKCPROT_KCE                 = (*DFKCPROT)["KCE"     ];
        return;
    }
}
...
/// @return None
void Cecc_dflash_e2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
    ...
    if (addr == 0x0020) {
        (*DFKCPROT)["KCPROT"  ] = DFKCPROT_KCPROT;
        (*DFKCPROT)["KCE"     ] = DFKCPROT_KCE;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecc_dflash_e2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecc_dflash_e2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecc_dflash_e2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecc_dflash_e2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecc_dflash_e2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecc_dflash_e2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecc_dflash_e2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cecc_dflash_e2_regif::uint Cecc_dflash_e2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cecc_dflash_e2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecc_dflash_e2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecc_dflash_e2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecc_dflash_e2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cecc_dflash_e2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecc_dflash_e2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecc_dflash_e2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
