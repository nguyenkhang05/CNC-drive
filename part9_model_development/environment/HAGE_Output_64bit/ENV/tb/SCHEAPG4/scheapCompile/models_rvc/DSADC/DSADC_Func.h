// ---------------------------------------------------------------------
// $Id: DSADC_Func.h 1398 2019-11-26 06:16:27Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __DSADC_FUNC_H__
#define __DSADC_FUNC_H__
#include "BusSlaveFuncIf.h"
#include "dsadc_regif.h"

class DSADC_AgentController;

class DSADC_Func: public Cdsadc_regif,
                 public BusSlaveFuncIf
{
public:
    DSADC_Func (std::string name, DSADC_AgentController *DSADC_AgentControllerPtr);
    ~DSADC_Func (void);
...
private:
    ...
    DSADC_AgentController *mDSADC_AgentController;
    std::string mModuleName;                            /// Module name

    /// Declare virtual functions of dsadc_regif class
