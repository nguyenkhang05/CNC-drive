// ---------------------------------------------------------------------
// $Id: G4_PEG_U2A_Reg.h,v 1.5 2020/01/14 02:39:30 nhutminhdang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __G4_PEG_U2A_Reg_H__
#define __G4_PEG_U2A_Reg_H__

#include "g4_peg_u2a_regif.h"

class G4_PEG_U2A_Reg: public Cg4_peg_u2a_regif
{
public:
    SC_HAS_PROCESS(G4_PEG_U2A_Reg);
    /// Constructor & Destructor
    G4_PEG_U2A_Reg(std::string name);
    ~G4_PEG_U2A_Reg();
...
private:
    ...
    /// Overwrite virtual functions of Cg4_peg_u2a_regif class
