// -----------------------------------------------------------------------------
// $Id: hwcore_input_regif.cpp,v 1.5 2020/10/21 04:27:23 quynhnhunguyen Exp $
//
...
/// @return none
// Description: CHWCORE_INPUT_regif
// Ref: {HWCORE_INPUT_UD_Registers_001, HWCORE_INPUT_UD_Registers_002, HWCORE_INPUT_UD_Registers_003, HWCORE_INPUT_UD_Registers_004, HWCORE_INPUT_UD_Registers_005}
// Ref: {HWCORE_INPUT_UD_Registers_006, HWCORE_INPUT_UD_Registers_007, HWCORE_INPUT_UD_Registers_008, HWCORE_INPUT_UD_Registers_009, HWCORE_INPUT_UD_Registers_010}
// Ref: {HWCORE_INPUT_UD_Registers_011, HWCORE_INPUT_UD_Registers_012, HWCORE_INPUT_UD_Registers_013, HWCORE_INPUT_UD_Registers_014, HWCORE_INPUT_UD_Registers_015}
// Ref: {HWCORE_INPUT_UD_Registers_016, HWCORE_INPUT_UD_Registers_017, HWCORE_INPUT_UD_Registers_018, HWCORE_INPUT_UD_Registers_019, HWCORE_INPUT_UD_Registers_020}
// Ref: {HWCORE_INPUT_UD_Registers_021, HWCORE_INPUT_UD_Registers_022, HWCORE_INPUT_UD_Registers_023, HWCORE_INPUT_UD_Registers_024, HWCORE_INPUT_UD_Registers_025}
// Ref: {HWCORE_INPUT_UD_Registers_026, HWCORE_INPUT_UD_Registers_027, HWCORE_INPUT_UD_Registers_028, HWCORE_INPUT_UD_Registers_029, HWCORE_INPUT_UD_Registers_030}
// Ref: {HWCORE_INPUT_UD_ATT1_001, HWCORE_INPUT_UD_ATT1_006, HWCORE_INPUT_UD_ATT1_007, HWCORE_INPUT_UD_ATT1_008}
Chwcore_input_regif::Chwcore_input_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", 0x258)
    #endif
{
    CommandInit();
    CTRINMD     = new vpcl::re_register(0x0200, this, "CTRINMD"    , name.c_str());
    THTESFT     = new vpcl::re_register(0x0204, this, "THTESFT"    , name.c_str());
    THTEIBUF    = new vpcl::re_register(0x0206, this, "THTEIBUF"   , name.c_str());
    EARD        = new vpcl::re_register(0x0208, this, "EARD"       , name.c_str());
    THTESEL     = new vpcl::re_register(0x020A, this, "THTESEL"    , name.c_str());
    AD0IBUF     = new vpcl::re_register(0x020C, this, "AD0IBUF"    , name.c_str());
    AD1IBUF     = new vpcl::re_register(0x020E, this, "AD1IBUF"    , name.c_str());
    AD2IBUF     = new vpcl::re_register(0x0210, this, "AD2IBUF"    , name.c_str());
    AD0OFS      = new vpcl::re_register(0x0212, this, "AD0OFS"     , name.c_str());
    AD1OFS      = new vpcl::re_register(0x0214, this, "AD1OFS"     , name.c_str());
    AD2OFS      = new vpcl::re_register(0x0216, this, "AD2OFS"     , name.c_str());
    DIVLSB      = new vpcl::re_register(0x0218, this, "DIVLSB"     , name.c_str());
    IUFIX       = new vpcl::re_register(0x021C, this, "IUFIX"      , name.c_str());
    IVFIX       = new vpcl::re_register(0x0220, this, "IVFIX"      , name.c_str());
    IWFIX       = new vpcl::re_register(0x0224, this, "IWFIX"      , name.c_str());
    KCLCTR      = new vpcl::re_register(0x0228, this, "KCLCTR"     , name.c_str());
    KCLJUD      = new vpcl::re_register(0x022C, this, "KCLJUD"     , name.c_str());
    KCLSTAT     = new vpcl::re_register(0x0230, this, "KCLSTAT"    , name.c_str());
    KCLSTATC    = new vpcl::re_register(0x0231, this, "KCLSTATC"   , name.c_str());
    KCLCNT      = new vpcl::re_register(0x0232, this, "KCLCNT"     , name.c_str());
    SR2         = new vpcl::re_register(0x0234, this, "SR2"        , name.c_str());
    IDFIX       = new vpcl::re_register(0x0238, this, "IDFIX"      , name.c_str());
    IQFIX       = new vpcl::re_register(0x023C, this, "IQFIX"      , name.c_str());
    IUFIXOBUF   = new vpcl::re_register(0x0240, this, "IUFIXOBUF"  , name.c_str());
    IVFIXOBUF   = new vpcl::re_register(0x0244, this, "IVFIXOBUF"  , name.c_str());
    IWFIXOBUF   = new vpcl::re_register(0x0248, this, "IWFIXOBUF"  , name.c_str());
    IDFIXOBUF   = new vpcl::re_register(0x024C, this, "IDFIXOBUF"  , name.c_str());
    IQFIXOBUF   = new vpcl::re_register(0x0250, this, "IQFIXOBUF"  , name.c_str());
    THTRESFIXIN = new vpcl::re_register(0x0254, this, "THTRESFIXIN", name.c_str());
    ...
    mRegMap[0x0206]     = index;
    mRegMap[0x0206 + 1] = index++;
    mRegMap[0x0208]     = index;
    mRegMap[0x0208 + 1] = index++;
    mRegMap[0x020A]     = index;
    mRegMap[0x020A + 1] = index++;
    mRegMap[0x020C]     = index;
    mRegMap[0x020C + 1] = index++;
    mRegMap[0x020E]     = index;
    mRegMap[0x020E + 1] = index++;
    mRegMap[0x0210]     = index;
    mRegMap[0x0210 + 1] = index++;
    mRegMap[0x0212]     = index;
    mRegMap[0x0212 + 1] = index++;
    mRegMap[0x0214]     = index;
    mRegMap[0x0214 + 1] = index++;
    mRegMap[0x0216]     = index;
    mRegMap[0x0216 + 1] = index++;
    mRegMap[0x0218]     = index;
    mRegMap[0x0218 + 1] = index;
    mRegMap[0x0218 + 2] = index;
    mRegMap[0x0218 + 3] = index++;
    mRegMap[0x021C]     = index;
    mRegMap[0x021C + 1] = index;
    mRegMap[0x021C + 2] = index;
    mRegMap[0x021C + 3] = index++;
    mRegMap[0x0220]     = index;
    mRegMap[0x0220 + 1] = index;
    mRegMap[0x0220 + 2] = index;
    mRegMap[0x0220 + 3] = index++;
    mRegMap[0x0224]     = index;
    mRegMap[0x0224 + 1] = index;
    mRegMap[0x0224 + 2] = index;
    mRegMap[0x0224 + 3] = index++;
    ...
    mRegMap[0x0231]     = index++;
    mRegMap[0x0232]     = index++;
    mRegMap[0x0234]     = index;
    mRegMap[0x0234 + 1] = index;
    mRegMap[0x0234 + 2] = index;
    mRegMap[0x0234 + 3] = index++;
    mRegMap[0x0238]     = index;
    mRegMap[0x0238 + 1] = index;
    mRegMap[0x0238 + 2] = index;
    mRegMap[0x0238 + 3] = index++;
    mRegMap[0x023C]     = index;
    mRegMap[0x023C + 1] = index;
    mRegMap[0x023C + 2] = index;
    mRegMap[0x023C + 3] = index++;
    mRegMap[0x0240]     = index;
    mRegMap[0x0240 + 1] = index;
    mRegMap[0x0240 + 2] = index;
    mRegMap[0x0240 + 3] = index++;
    mRegMap[0x0244]     = index;
    mRegMap[0x0244 + 1] = index;
    mRegMap[0x0244 + 2] = index;
    mRegMap[0x0244 + 3] = index++;
    mRegMap[0x0248]     = index;
    mRegMap[0x0248 + 1] = index;
    mRegMap[0x0248 + 2] = index;
    mRegMap[0x0248 + 3] = index++;
    mRegMap[0x024C]     = index;
    mRegMap[0x024C + 1] = index;
    mRegMap[0x024C + 2] = index;
    mRegMap[0x024C + 3] = index++;
    ...
    index = 0;
#ifdef USR_CWR_SYSTEMC
    mCurReg = mRegArray[index++] = new SRegList(CTRINMD      , mCurReg, 0,  2,      "16", "8|16|32", false, &cwmem);
#else
    mCurReg = mRegArray[index++] = new SRegList(CTRINMD      , mCurReg, 0,  2,      "16", "8|16|32");
#endif
    mCurReg = mRegArray[index++] = new SRegList(THTESFT      , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(THTEIBUF     , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(EARD         , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(THTESEL      , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD0IBUF      , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD1IBUF      , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD2IBUF      , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD0OFS       , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD1OFS       , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AD2OFS       , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DIVLSB       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IUFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IVFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IWFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCLCTR       , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCLJUD       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCLSTAT      , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCLSTATC     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCLCNT       , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(SR2          , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IDFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IQFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IUFIXOBUF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IVFIXOBUF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IWFIXOBUF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IDFIXOBUF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IQFIXOBUF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(THTRESFIXIN  , mCurReg, 0,  2,      "16", "8|16|32");

    mRegList = mCurReg;

    (*CTRINMD      ) (12, 12, "IIRDQ"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CTRINMD      ) ( 7,  6, "INSTCTR" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CTRINMD      ) ( 5,  3, "CMUVW"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CTRINMD      ) ( 2,  2, "CMES"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CTRINMD      ) ( 1,  1, "KCL"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CTRINMD      ) ( 0,  0, "FREGIN"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTESFT      ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTEIBUF     ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EARD         ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTESEL      ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*AD0IBUF      ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*AD1IBUF      ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*AD2IBUF      ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*AD0OFS       ) (15,  0, "DATA"    , 0x800     , "R|W"   , vpcl::SPP_ENABLE);
    (*AD1OFS       ) (15,  0, "DATA"    , 0x800     , "R|W"   , vpcl::SPP_ENABLE);
    (*AD2OFS       ) (15,  0, "DATA"    , 0x800     , "R|W"   , vpcl::SPP_ENABLE);
    (*DIVLSB       ) (31,  0, "DATA"    , 0x10000    , "R|W"   , vpcl::SPP_ENABLE);
    (*IUFIX        ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IVFIX        ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IWFIX        ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCLCTR       ) ( 8,  8, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCLCTR       ) ( 7,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCLJUD       ) (30,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCLSTAT      ) ( 0,  0, "ST"      , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*KCLSTATC     ) ( 0,  0, "CLR"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCLCNT       ) ( 7,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*SR2          ) (31,  0, "DATA"    , 0xD106    , "R|W"   , vpcl::SPP_ENABLE);
    (*IDFIX        ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IQFIX        ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IUFIXOBUF    ) (31,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IVFIXOBUF    ) (31,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IWFIXOBUF    ) (31,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*IDFIXOBUF    ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*IQFIXOBUF    ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*THTRESFIXIN  ) (11,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["CTRINMD"  ]["INSTCTR"  ] = &Chwcore_input_regif::cb_CTRINMD_INSTCTR;
    mWrCbAPI["THTESEL"  ]["DATA"     ] = &Chwcore_input_regif::cb_THTESEL_DATA;
    mWrCbAPI["AD0IBUF"  ]["DATA"     ] = &Chwcore_input_regif::cb_AD0IBUF_DATA;
    mWrCbAPI["AD1IBUF"  ]["DATA"     ] = &Chwcore_input_regif::cb_AD1IBUF_DATA;
    mWrCbAPI["AD2IBUF"  ]["DATA"     ] = &Chwcore_input_regif::cb_AD2IBUF_DATA;
    mWrCbAPI["IUFIX"    ]["DATA"     ] = &Chwcore_input_regif::cb_IUFIX_DATA;
    mWrCbAPI["IVFIX"    ]["DATA"     ] = &Chwcore_input_regif::cb_IVFIX_DATA;
    mWrCbAPI["IWFIX"    ]["DATA"     ] = &Chwcore_input_regif::cb_IWFIX_DATA;
    mWrCbAPI["KCLSTATC" ]["CLR"      ] = &Chwcore_input_regif::cb_KCLSTATC_CLR;
    mWrCbAPI["IDFIXOBUF"]["DATA"     ] = &Chwcore_input_regif::cb_IDFIXOBUF_DATA;
    mWrCbAPI["IQFIXOBUF"]["DATA"     ] = &Chwcore_input_regif::cb_IQFIXOBUF_DATA;

    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Chwcore_input_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Chwcore_input_regif::~Chwcore_input_regif()
{
...
Chwcore_input_regif::uint Chwcore_input_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Chwcore_input_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chwcore_input_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_input_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                     const unsigned char *p_data,   ///< [in] Writing data
                                     cuint size)                    ///< [in] Data size (byte)
{
    assert(size != 0);
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chwcore_input_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                     unsigned char *p_data,   ///< [out] Reading data
                                     cuint size)              ///< [in]  Data size (byte)
{
    assert(size != 0);
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
// Ref: {HWCORE_INPUT_UD_Direction_034, HWCORE_INPUT_UD_Direction_025, HWCORE_INPUT_UD_Direction_020}
bool Chwcore_input_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                         const unsigned char *p_data,  ///< [in] Writing data
                                         cuint size,                   ///< [in] Data size (byte)
...
// Ref: {HWCORE_INPUT_UD_Direction_024, HWCORE_INPUT_UD_Direction_020}
bool Chwcore_input_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                         unsigned char *p_data,   ///< [out] Reading data
                                         cuint size,              ///< [in]  Data size (byte)
                                         bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
// Ref: {HWCORE_INPUT_UD_Direction_030}
bool Chwcore_input_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                      unsigned char *p_data,          ///< [out] Reading data
                                      cuint size,                     ///< [in]  Data size (byte)
...
// Ref: {HWCORE_INPUT_UD_Direction_035, HWCORE_INPUT_UD_Direction_030}
bool Chwcore_input_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                      const unsigned char *p_data,      ///< [in] Writing data
                                      cuint size,                       ///< [in] Data size (byte)
                                      cuint reg_index,                  ///< [in] Register index
...
// Description: ChkSize
// Ref: {HWCORE_INPUT_UD_Direction_019, HWCORE_INPUT_UD_Direction_020}
bool Chwcore_input_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return none
void Chwcore_input_regif::CommandInit()
{
...
// Ref: {HWCORE_INPUT_UD_Direction_022, HWCORE_INPUT_UD_Direction_023, HWCORE_INPUT_UD_Direction_029}
std::string Chwcore_input_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chwcore_input_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chwcore_input_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Chwcore_input_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Chwcore_input_regif::IssueRegValueID(void)
{//{{{
...
/// @return vector
std::vector<std::string> Chwcore_input_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chwcore_input_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chwcore_input_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Chwcore_input_regif::get_reg_index(cuint access_addr)
{
    if (access_addr < (1<<11)) {
...
vpcl::re_register *Chwcore_input_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chwcore_input_regif::next_reg_object()
{
    assert(mCurReg != NULL);
...
/// @return none
void Chwcore_input_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Chwcore_input_regif::uint Chwcore_input_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Chwcore_input_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chwcore_input_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chwcore_input_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
// Ref: {HWCORE_INPUT_UD_Direction_040}
void Chwcore_input_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Chwcore_input_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Chwcore_input_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Chwcore_input_regif::cw_set_all_callback_reg(void)
{
