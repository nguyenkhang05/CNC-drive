// -----------------------------------------------------------------------------
// $Id: mecccap_cfl_fcc2_regif.cpp,v 1.3 2019/08/20 11:55:08 tientran2 Exp $
//
...
//
// Input file : mecccap_cfl_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE mecccap_cfl
//     #              name     offset_size
...
////////////////////////////////////////////////////////////////////////////////
/// @file mecccap_cfl_fcc2_regif.cpp
/// @brief Register IF class of model MECCCAP_CFL
/// $Id: mecccap_cfl_fcc2_regif.cpp,v 1.3 2019/08/20 11:55:08 tientran2 Exp $
/// $Date: 2019/08/20 11:55:08 $
/// $Revison$
/// $Author: tientran2 $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cmecccap_cfl_fcc2_regif::Cmecccap_cfl_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    CF_ERRINT  = new vpcl::re_register(0x0000, this, "CF_ERRINT" , name.c_str());
    CF_SSTCLR  = new vpcl::re_register(0x0010, this, "CF_SSTCLR" , name.c_str());
    CF_DSTCLR  = new vpcl::re_register(0x0014, this, "CF_DSTCLR" , name.c_str());
    CF_OVFCLR  = new vpcl::re_register(0x0018, this, "CF_OVFCLR" , name.c_str());
    CF_SERSTR  = new vpcl::re_register(0x0020, this, "CF_SERSTR" , name.c_str());
    CF_DERSTR  = new vpcl::re_register(0x0024, this, "CF_DERSTR" , name.c_str());
    CF_OVFSTR  = new vpcl::re_register(0x0028, this, "CF_OVFSTR" , name.c_str());
    CF_SERINF  = new vpcl::re_register(0x0030, this, "CF_SERINF" , name.c_str());
    CF_ERMSA0  = new vpcl::re_register(0x0060, this, "CF_ERMSA0" , name.c_str());
    CF_ERMEA0  = new vpcl::re_register(0x0064, this, "CF_ERMEA0" , name.c_str());
    CF_ERMSA1  = new vpcl::re_register(0x0068, this, "CF_ERMSA1" , name.c_str());
    CF_ERMEA1  = new vpcl::re_register(0x006C, this, "CF_ERMEA1" , name.c_str());
    CF_00DEADR = new vpcl::re_register(0x00F0, this, "CF_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_CF_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"CF_nSEADR"<< i;
        CF_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_CF_ERRINT   , CF_ERRINT->name() , CF_ERRINT->addr() );
    cw_instantiate_reg(CW_CF_SSTCLR   , CF_SSTCLR->name() , CF_SSTCLR->addr() );
    cw_instantiate_reg(CW_CF_DSTCLR   , CF_DSTCLR->name() , CF_DSTCLR->addr() );
    cw_instantiate_reg(CW_CF_OVFCLR   , CF_OVFCLR->name() , CF_OVFCLR->addr() );
    cw_instantiate_reg(CW_CF_SERSTR   , CF_SERSTR->name() , CF_SERSTR->addr() );
    cw_instantiate_reg(CW_CF_DERSTR   , CF_DERSTR->name() , CF_DERSTR->addr() );
    cw_instantiate_reg(CW_CF_OVFSTR   , CF_OVFSTR->name() , CF_OVFSTR->addr() );
    cw_instantiate_reg(CW_CF_SERINF   , CF_SERINF->name() , CF_SERINF->addr() );
    cw_instantiate_reg(CW_CF_ERMSA0   , CF_ERMSA0->name() , CF_ERMSA0->addr() );
    cw_instantiate_reg(CW_CF_ERMEA0   , CF_ERMEA0->name() , CF_ERMEA0->addr() );
    cw_instantiate_reg(CW_CF_ERMSA1   , CF_ERMSA1->name() , CF_ERMSA1->addr() );
    cw_instantiate_reg(CW_CF_ERMEA1   , CF_ERMEA1->name() , CF_ERMEA1->addr() );
    for(uint i = 0; i < emNUM_CF_nSEADR ; i++) cw_instantiate_reg(CW_CF_nSEADR   [i], CF_nSEADR [i]->name(), CF_nSEADR [i]->addr());
    cw_instantiate_reg(CW_CF_00DEADR  , CF_00DEADR->name(), CF_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(CF_ERRINT   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_SSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_DSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_OVFCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_SERSTR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_DERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_OVFSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_SERINF   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_ERMSA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_ERMEA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_ERMSA1   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_ERMEA1   , mCurReg, 0,  4,      "32", "8|16|32");
    for(uint i = 0; i < emNUM_CF_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(CF_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CF_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*CF_ERRINT   ) ( 7,  7, "SEOVFIE" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERRINT   ) ( 2,  2, "APEIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERRINT   ) ( 1,  1, "DEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERRINT   ) ( 0,  0, "SEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_SSTCLR   ) (31,  0, "CF_SSTCLR", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CF_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CF_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CF_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CF_SERSTR   ) (31,  0, "CF_SERSTR", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_DERSTR   ) ( 2,  2, "APEF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_SERINF   ) (16,  0, "SEDLINF" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_ERMSA0   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERMSA0   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERMEA0   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERMSA1   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERMSA1   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_ERMEA1   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CF_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CF_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_CF_nSEADR; i++) {
        (*CF_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*CF_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["CF_SSTCLR"]["CF_SSTCLR"] = &Cmecccap_cfl_fcc2_regif::cb_CF_SSTCLR_CF_SSTCLR;
    mWrCbAPI["CF_DSTCLR"]["DSTCLR00"] = &Cmecccap_cfl_fcc2_regif::cb_CF_DSTCLR_DSTCLR00;
    mWrCbAPI["CF_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_cfl_fcc2_regif::cb_CF_OVFCLR_SERROVFCLR0;
    mWrCbAPI["CF_ERMSA0"]["ERMSA"   ] = &Cmecccap_cfl_fcc2_regif::cb_CF_ERMSA0_ERMSA;
    mWrCbAPI["CF_ERMEA0"]["ERMEA"   ] = &Cmecccap_cfl_fcc2_regif::cb_CF_ERMEA0_ERMEA;
    mWrCbAPI["CF_ERMSA1"]["ERMSA"   ] = &Cmecccap_cfl_fcc2_regif::cb_CF_ERMSA1_ERMSA;
    mWrCbAPI["CF_ERMEA1"]["ERMEA"   ] = &Cmecccap_cfl_fcc2_regif::cb_CF_ERMEA1_ERMEA;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_cfl_fcc2_regif::~Cmecccap_cfl_fcc2_regif()
{
...
Cmecccap_cfl_fcc2_regif::uint Cmecccap_cfl_fcc2_regif::bit_select(
...
bool Cmecccap_cfl_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_cfl_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cfl_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cfl_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cfl_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cfl_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_cfl_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_cfl_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_cfl_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_cfl_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_cfl_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_cfl_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_cfl_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    CF_ERRINT_SEOVFIE = 0x1;
    CF_ERRINT_APEIE = 0x1;
    CF_ERRINT_DEDIE = 0x1;
    CF_ERRINT_SEDIE = 0x1;
    CF_SSTCLR_CF_SSTCLR = 0x0;
    CF_DSTCLR_DSTCLR00 = 0x0;
    CF_OVFCLR_SERROVFCLR1 = 0x0;
    CF_OVFCLR_SERROVFCLR0 = 0x0;
    CF_SERSTR_CF_SERSTR = 0x0;
    CF_DERSTR_APEF00 = 0x0;
    CF_DERSTR_DEDF00 = 0x0;
    CF_OVFSTR_SERROVF1 = 0x0;
    CF_OVFSTR_SERROVF0 = 0x0;
    CF_SERINF_SEDLINF = 0x0;
    CF_ERMSA0_ERMSA = 0x0;
    CF_ERMSA0_EN  = 0x0;
    CF_ERMEA0_ERMEA = 0x0;
    CF_ERMSA1_ERMSA = 0x0;
    ...
    CF_ERMEA1_ERMEA = 0x0;
    for(uint i = 0; i < emNUM_CF_nSEADR; i++) {
        CF_nSEADR_SEDL[i] = 0x0;
        CF_nSEADR_SEADR0[i] = 0x0;
    }
    CF_00DEADR_DEDL = 0x0;
    CF_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_cfl_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CF_ERRINT_SEOVFIE              = (*CF_ERRINT )["SEOVFIE"   ];
        CF_ERRINT_APEIE                = (*CF_ERRINT )["APEIE"     ];
        CF_ERRINT_DEDIE                = (*CF_ERRINT )["DEDIE"     ];
        CF_ERRINT_SEDIE                = (*CF_ERRINT )["SEDIE"     ];
        return;
    }
    if (addr == 0x0010) {
        CF_SSTCLR_CF_SSTCLR            = (*CF_SSTCLR )["CF_SSTCLR" ];
        return;
    }
    if (addr == 0x0014) {
        CF_DSTCLR_DSTCLR00             = (*CF_DSTCLR )["DSTCLR00"  ];
        return;
    }
    if (addr == 0x0018) {
        CF_OVFCLR_SERROVFCLR1          = (*CF_OVFCLR )["SERROVFCLR1"];
        CF_OVFCLR_SERROVFCLR0          = (*CF_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        CF_SERSTR_CF_SERSTR            = (*CF_SERSTR )["CF_SERSTR" ];
        return;
    }
    if (addr == 0x0024) {
        CF_DERSTR_APEF00               = (*CF_DERSTR )["APEF00"    ];
        CF_DERSTR_DEDF00               = (*CF_DERSTR )["DEDF00"    ];
        return;
    }
    if (addr == 0x0028) {
        CF_OVFSTR_SERROVF1             = (*CF_OVFSTR )["SERROVF1"  ];
        CF_OVFSTR_SERROVF0             = (*CF_OVFSTR )["SERROVF0"  ];
        return;
    }
    if (addr == 0x0030) {
        CF_SERINF_SEDLINF              = (*CF_SERINF )["SEDLINF"   ];
        return;
    }
    if (addr == 0x0060) {
        CF_ERMSA0_ERMSA                = (*CF_ERMSA0 )["ERMSA"     ];
        CF_ERMSA0_EN                   = (*CF_ERMSA0 )["EN"        ];
        return;
    }
    if (addr == 0x0064) {
        CF_ERMEA0_ERMEA                = (*CF_ERMEA0 )["ERMEA"     ];
        return;
    }
    if (addr == 0x0068) {
        CF_ERMSA1_ERMSA                = (*CF_ERMSA1 )["ERMSA"     ];
        CF_ERMSA1_EN                   = (*CF_ERMSA1 )["EN"        ];
        return;
    }
    if (addr == 0x006C) {
        CF_ERMEA1_ERMEA                = (*CF_ERMEA1 )["ERMEA"     ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        CF_nSEADR_SEDL                [i] = (*(CF_nSEADR [i]))["SEDL"      ];
        CF_nSEADR_SEADR0              [i] = (*(CF_nSEADR [i]))["SEADR0"    ];
        return;
    }
    if (addr == 0x00F0) {
        CF_00DEADR_DEDL                = (*CF_00DEADR)["DEDL"      ];
        CF_00DEADR_DEADR0              = (*CF_00DEADR)["DEADR0"    ];
        return;
    }
}
...
/// @return None
void Cmecccap_cfl_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CF_ERRINT )["SEOVFIE"   ] = CF_ERRINT_SEOVFIE;
        (*CF_ERRINT )["APEIE"     ] = CF_ERRINT_APEIE;
        (*CF_ERRINT )["DEDIE"     ] = CF_ERRINT_DEDIE;
        (*CF_ERRINT )["SEDIE"     ] = CF_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*CF_SSTCLR )["CF_SSTCLR" ] = CF_SSTCLR_CF_SSTCLR;
        return;
    }
    if (addr == 0x0014) {
        (*CF_DSTCLR )["DSTCLR00"  ] = CF_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*CF_OVFCLR )["SERROVFCLR1"] = CF_OVFCLR_SERROVFCLR1;
        (*CF_OVFCLR )["SERROVFCLR0"] = CF_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*CF_SERSTR )["CF_SERSTR" ] = CF_SERSTR_CF_SERSTR;
        return;
    }
    if (addr == 0x0024) {
        (*CF_DERSTR )["APEF00"    ] = CF_DERSTR_APEF00;
        (*CF_DERSTR )["DEDF00"    ] = CF_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*CF_OVFSTR )["SERROVF1"  ] = CF_OVFSTR_SERROVF1;
        (*CF_OVFSTR )["SERROVF0"  ] = CF_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*CF_SERINF )["SEDLINF"   ] = CF_SERINF_SEDLINF;
        return;
    }
    if (addr == 0x0060) {
        (*CF_ERMSA0 )["ERMSA"     ] = CF_ERMSA0_ERMSA;
        (*CF_ERMSA0 )["EN"        ] = CF_ERMSA0_EN;
        return;
    }
    if (addr == 0x0064) {
        (*CF_ERMEA0 )["ERMEA"     ] = CF_ERMEA0_ERMEA;
        return;
    }
    if (addr == 0x0068) {
        (*CF_ERMSA1 )["ERMSA"     ] = CF_ERMSA1_ERMSA;
        (*CF_ERMSA1 )["EN"        ] = CF_ERMSA1_EN;
        return;
    }
    if (addr == 0x006C) {
        (*CF_ERMEA1 )["ERMEA"     ] = CF_ERMEA1_ERMEA;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(CF_nSEADR [i]))["SEDL"      ] = CF_nSEADR_SEDL[i];
        (*(CF_nSEADR [i]))["SEADR0"    ] = CF_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*CF_00DEADR)["DEDL"      ] = CF_00DEADR_DEDL;
        (*CF_00DEADR)["DEADR0"    ] = CF_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_cfl_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_cfl_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_cfl_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_cfl_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_cfl_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_cfl_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_cfl_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_cfl_fcc2_regif::uint Cmecccap_cfl_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_cfl_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_cfl_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_cfl_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_cfl_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_cfl_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_cfl_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_cfl_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
