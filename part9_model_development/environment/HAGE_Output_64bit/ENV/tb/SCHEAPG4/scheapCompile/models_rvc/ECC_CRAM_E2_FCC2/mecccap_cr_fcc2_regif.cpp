// -----------------------------------------------------------------------------
// $Id: mecccap_cr_fcc2_regif.cpp,v 1.3 2019/03/05 04:30:03 synguyen Exp $
//
...
//
// Input file : mecccap_cr_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE mecccap_cr_fcc2
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  8 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name                           reg_name                     wsize   rsize      length offset  factor_start    factor_end  factor_index    factor_step access   init   support  callback
//     %%REG      CR_ERRINT                     CR_ERRINT                   8|16|32 8|16|32      32     0x00    -               -           -               -           R/W      0x0     TRUE     -
...
////////////////////////////////////////////////////////////////////////////////
/// @file mecccap_cr_fcc2_regif.cpp
/// @brief Register IF class of model MECCCAP_CR
/// $Id: mecccap_cr_fcc2_regif.cpp,v 1.3 2019/03/05 04:30:03 synguyen Exp $
/// $Date: 2019/03/05 04:30:03 $
/// $Revison$
/// $Author: synguyen $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cmecccap_cr_fcc2_regif::Cmecccap_cr_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    CR_ERRINT  = new vpcl::re_register(0x0000, this, "CR_ERRINT" , name.c_str());
    CR_SSTCLR  = new vpcl::re_register(0x0010, this, "CR_SSTCLR" , name.c_str());
    CR_DSTCLR  = new vpcl::re_register(0x0014, this, "CR_DSTCLR" , name.c_str());
    CR_OVFCLR  = new vpcl::re_register(0x0018, this, "CR_OVFCLR" , name.c_str());
    CR_SERSTR  = new vpcl::re_register(0x0020, this, "CR_SERSTR" , name.c_str());
    CR_DERSTR  = new vpcl::re_register(0x0024, this, "CR_DERSTR" , name.c_str());
    CR_OVFSTR  = new vpcl::re_register(0x0028, this, "CR_OVFSTR" , name.c_str());
    CR_SERINF  = new vpcl::re_register(0x0030, this, "CR_SERINF" , name.c_str());
    CR_ERMSA0  = new vpcl::re_register(0x0060, this, "CR_ERMSA0" , name.c_str());
    CR_ERMEA0  = new vpcl::re_register(0x0064, this, "CR_ERMEA0" , name.c_str());
    CR_ERMSA1  = new vpcl::re_register(0x0068, this, "CR_ERMSA1" , name.c_str());
    CR_ERMEA1  = new vpcl::re_register(0x006C, this, "CR_ERMEA1" , name.c_str());
    CR_00DEADR = new vpcl::re_register(0x00F0, this, "CR_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_CR_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"CR_nSEADR"<< i;
        CR_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_CR_ERRINT   , CR_ERRINT->name() , CR_ERRINT->addr() );
    cw_instantiate_reg(CW_CR_SSTCLR   , CR_SSTCLR->name() , CR_SSTCLR->addr() );
    cw_instantiate_reg(CW_CR_DSTCLR   , CR_DSTCLR->name() , CR_DSTCLR->addr() );
    cw_instantiate_reg(CW_CR_OVFCLR   , CR_OVFCLR->name() , CR_OVFCLR->addr() );
    cw_instantiate_reg(CW_CR_SERSTR   , CR_SERSTR->name() , CR_SERSTR->addr() );
    cw_instantiate_reg(CW_CR_DERSTR   , CR_DERSTR->name() , CR_DERSTR->addr() );
    cw_instantiate_reg(CW_CR_OVFSTR   , CR_OVFSTR->name() , CR_OVFSTR->addr() );
    cw_instantiate_reg(CW_CR_SERINF   , CR_SERINF->name() , CR_SERINF->addr() );
    cw_instantiate_reg(CW_CR_ERMSA0   , CR_ERMSA0->name() , CR_ERMSA0->addr() );
    cw_instantiate_reg(CW_CR_ERMEA0   , CR_ERMEA0->name() , CR_ERMEA0->addr() );
    cw_instantiate_reg(CW_CR_ERMSA1   , CR_ERMSA1->name() , CR_ERMSA1->addr() );
    cw_instantiate_reg(CW_CR_ERMEA1   , CR_ERMEA1->name() , CR_ERMEA1->addr() );
    for(uint i = 0; i < emNUM_CR_nSEADR ; i++) cw_instantiate_reg(CW_CR_nSEADR   [i], CR_nSEADR [i]->name(), CR_nSEADR [i]->addr());
    cw_instantiate_reg(CW_CR_00DEADR  , CR_00DEADR->name(), CR_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(CR_ERRINT   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_SSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_DSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_OVFCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_SERSTR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_DERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_OVFSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_SERINF   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_ERMSA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_ERMEA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_ERMSA1   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_ERMEA1   , mCurReg, 0,  4,      "32", "8|16|32");
    for(uint i = 0; i < emNUM_CR_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(CR_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CR_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*CR_ERRINT   ) ( 7,  7, "SEOVFIE" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERRINT   ) ( 3,  3, "AFEIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERRINT   ) ( 1,  1, "DEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERRINT   ) ( 0,  0, "SEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_SSTCLR   ) (31,  0, "CR_SSTCLR", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CR_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CR_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CR_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*CR_SERSTR   ) (31,  0, "CR_SERSTR", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_DERSTR   ) ( 3,  3, "AFEF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_SERINF   ) (31,  0, "SEDLINF" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_ERMSA0   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERMSA0   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERMEA0   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERMSA1   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERMSA1   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_ERMEA1   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CR_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CR_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_CR_nSEADR; i++) {
        (*CR_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*CR_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["CR_SSTCLR"]["CR_SSTCLR"] = &Cmecccap_cr_fcc2_regif::cb_CR_SSTCLR_CR_SSTCLR;
    mWrCbAPI["CR_DSTCLR"]["DSTCLR00"] = &Cmecccap_cr_fcc2_regif::cb_CR_DSTCLR_DSTCLR00;
    mWrCbAPI["CR_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_cr_fcc2_regif::cb_CR_OVFCLR_SERROVFCLR0;
    mWrCbAPI["CR_ERMSA0"]["ERMSA"   ] = &Cmecccap_cr_fcc2_regif::cb_CR_ERMSA0_ERMSA;
    mWrCbAPI["CR_ERMEA0"]["ERMEA"   ] = &Cmecccap_cr_fcc2_regif::cb_CR_ERMEA0_ERMEA;
    mWrCbAPI["CR_ERMSA1"]["ERMSA"   ] = &Cmecccap_cr_fcc2_regif::cb_CR_ERMSA1_ERMSA;
    mWrCbAPI["CR_ERMEA1"]["ERMEA"   ] = &Cmecccap_cr_fcc2_regif::cb_CR_ERMEA1_ERMEA;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_cr_fcc2_regif::~Cmecccap_cr_fcc2_regif()
{
...
Cmecccap_cr_fcc2_regif::uint Cmecccap_cr_fcc2_regif::bit_select(
...
bool Cmecccap_cr_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_cr_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cr_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                   const unsigned char *p_data,   ///< [in] Writing data
                                   cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cr_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                   unsigned char *p_data,   ///< [out] Reading data
                                   cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cr_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                       const unsigned char *p_data,  ///< [in] Writing data
                                       cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cr_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size,              ///< [in]  Data size (byte)
                                       bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_cr_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                    unsigned char *p_data,          ///< [out] Reading data
                                    cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_cr_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                    const unsigned char *p_data,      ///< [in] Writing data
                                    cuint size,                       ///< [in] Data size (byte)
                                    cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_cr_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_cr_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_cr_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_cr_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_cr_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    CR_ERRINT_SEOVFIE = 0x1;
    CR_ERRINT_AFEIE = 0x1;
    CR_ERRINT_DEDIE = 0x1;
    CR_ERRINT_SEDIE = 0x1;
    CR_SSTCLR_CR_SSTCLR = 0x0;
    CR_DSTCLR_DSTCLR00 = 0x0;
    CR_OVFCLR_SERROVFCLR1 = 0x0;
    CR_OVFCLR_SERROVFCLR0 = 0x0;
    CR_SERSTR_CR_SERSTR = 0x0;
    CR_DERSTR_AFEF00 = 0x0;
    CR_DERSTR_DEDF00 = 0x0;
    CR_OVFSTR_SERROVF1 = 0x0;
    CR_OVFSTR_SERROVF0 = 0x0;
    CR_SERINF_SEDLINF = 0x0;
    CR_ERMSA0_ERMSA = 0x0;
    CR_ERMSA0_EN  = 0x0;
    CR_ERMEA0_ERMEA = 0x0;
    CR_ERMSA1_ERMSA = 0x0;
    ...
    CR_ERMEA1_ERMEA = 0x0;
    for(uint i = 0; i < emNUM_CR_nSEADR; i++) {
        CR_nSEADR_SEDL[i] = 0x0;
        CR_nSEADR_SEADR0[i] = 0x0;
    }
    CR_00DEADR_DEDL = 0x0;
    CR_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_cr_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CR_ERRINT_SEOVFIE              = (*CR_ERRINT )["SEOVFIE"   ];
        CR_ERRINT_AFEIE                = (*CR_ERRINT )["AFEIE"     ];
        CR_ERRINT_DEDIE                = (*CR_ERRINT )["DEDIE"     ];
        CR_ERRINT_SEDIE                = (*CR_ERRINT )["SEDIE"     ];
        return;
    }
    if (addr == 0x0010) {
        CR_SSTCLR_CR_SSTCLR            = (*CR_SSTCLR )["CR_SSTCLR" ];
        return;
    }
    if (addr == 0x0014) {
        CR_DSTCLR_DSTCLR00             = (*CR_DSTCLR )["DSTCLR00"  ];
        return;
    }
    if (addr == 0x0018) {
        CR_OVFCLR_SERROVFCLR1          = (*CR_OVFCLR )["SERROVFCLR1"];
        CR_OVFCLR_SERROVFCLR0          = (*CR_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        CR_SERSTR_CR_SERSTR            = (*CR_SERSTR )["CR_SERSTR" ];
        return;
    }
    if (addr == 0x0024) {
        CR_DERSTR_AFEF00               = (*CR_DERSTR )["AFEF00"    ];
        CR_DERSTR_DEDF00               = (*CR_DERSTR )["DEDF00"    ];
        return;
    }
    if (addr == 0x0028) {
        CR_OVFSTR_SERROVF1             = (*CR_OVFSTR )["SERROVF1"  ];
        CR_OVFSTR_SERROVF0             = (*CR_OVFSTR )["SERROVF0"  ];
        return;
    }
    if (addr == 0x0030) {
        CR_SERINF_SEDLINF              = (*CR_SERINF )["SEDLINF"   ];
        return;
    }
    if (addr == 0x0060) {
        CR_ERMSA0_ERMSA                = (*CR_ERMSA0 )["ERMSA"     ];
        CR_ERMSA0_EN                   = (*CR_ERMSA0 )["EN"        ];
        return;
    }
    if (addr == 0x0064) {
        CR_ERMEA0_ERMEA                = (*CR_ERMEA0 )["ERMEA"     ];
        return;
    }
    if (addr == 0x0068) {
        CR_ERMSA1_ERMSA                = (*CR_ERMSA1 )["ERMSA"     ];
        CR_ERMSA1_EN                   = (*CR_ERMSA1 )["EN"        ];
        return;
    }
    if (addr == 0x006C) {
        CR_ERMEA1_ERMEA                = (*CR_ERMEA1 )["ERMEA"     ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        CR_nSEADR_SEDL                [i] = (*(CR_nSEADR [i]))["SEDL"      ];
        CR_nSEADR_SEADR0              [i] = (*(CR_nSEADR [i]))["SEADR0"    ];
        return;
    }
    if (addr == 0x00F0) {
        CR_00DEADR_DEDL                = (*CR_00DEADR)["DEDL"      ];
        CR_00DEADR_DEADR0              = (*CR_00DEADR)["DEADR0"    ];
        return;
    }
}
...
/// @return None
void Cmecccap_cr_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CR_ERRINT )["SEOVFIE"   ] = CR_ERRINT_SEOVFIE;
        (*CR_ERRINT )["AFEIE"     ] = CR_ERRINT_AFEIE;
        (*CR_ERRINT )["DEDIE"     ] = CR_ERRINT_DEDIE;
        (*CR_ERRINT )["SEDIE"     ] = CR_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*CR_SSTCLR )["CR_SSTCLR" ] = CR_SSTCLR_CR_SSTCLR;
        return;
    }
    if (addr == 0x0014) {
        (*CR_DSTCLR )["DSTCLR00"  ] = CR_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*CR_OVFCLR )["SERROVFCLR1"] = CR_OVFCLR_SERROVFCLR1;
        (*CR_OVFCLR )["SERROVFCLR0"] = CR_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*CR_SERSTR )["CR_SERSTR" ] = CR_SERSTR_CR_SERSTR;
        return;
    }
    if (addr == 0x0024) {
        (*CR_DERSTR )["AFEF00"    ] = CR_DERSTR_AFEF00;
        (*CR_DERSTR )["DEDF00"    ] = CR_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*CR_OVFSTR )["SERROVF1"  ] = CR_OVFSTR_SERROVF1;
        (*CR_OVFSTR )["SERROVF0"  ] = CR_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*CR_SERINF )["SEDLINF"   ] = CR_SERINF_SEDLINF;
        return;
    }
    if (addr == 0x0060) {
        (*CR_ERMSA0 )["ERMSA"     ] = CR_ERMSA0_ERMSA;
        (*CR_ERMSA0 )["EN"        ] = CR_ERMSA0_EN;
        return;
    }
    if (addr == 0x0064) {
        (*CR_ERMEA0 )["ERMEA"     ] = CR_ERMEA0_ERMEA;
        return;
    }
    if (addr == 0x0068) {
        (*CR_ERMSA1 )["ERMSA"     ] = CR_ERMSA1_ERMSA;
        (*CR_ERMSA1 )["EN"        ] = CR_ERMSA1_EN;
        return;
    }
    if (addr == 0x006C) {
        (*CR_ERMEA1 )["ERMEA"     ] = CR_ERMEA1_ERMEA;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(CR_nSEADR [i]))["SEDL"      ] = CR_nSEADR_SEDL[i];
        (*(CR_nSEADR [i]))["SEADR0"    ] = CR_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*CR_00DEADR)["DEDL"      ] = CR_00DEADR_DEDL;
        (*CR_00DEADR)["DEADR0"    ] = CR_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_cr_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_cr_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_cr_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_cr_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_cr_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_cr_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_cr_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_cr_fcc2_regif::uint Cmecccap_cr_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_cr_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_cr_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_cr_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_cr_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_cr_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_cr_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_cr_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
