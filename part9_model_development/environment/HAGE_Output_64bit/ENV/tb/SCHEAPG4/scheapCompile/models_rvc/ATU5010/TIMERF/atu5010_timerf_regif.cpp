...
/// @return none
Catu5010_timerf_regif::Catu5010_timerf_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x5014/4))
    #endif
{
    CommandInit();
    TSTRF   = new vpcl::re_register(0x5000, this, "TSTRF"  , name.c_str());
    NCMCR1F = new vpcl::re_register(0x5004, this, "NCMCR1F", name.c_str());
    NCMCR2F = new vpcl::re_register(0x5008, this, "NCMCR2F", name.c_str());
    NCCRF   = new vpcl::re_register(0x500C, this, "NCCRF"  , name.c_str());
    PVFCRF  = new vpcl::re_register(0x5010, this, "PVFCRF" , name.c_str());

    // Construct the register pointer list
    mCurReg = NULL;

    uint index = 0;
    mRegMap = new uint [1<<15];
    for (uint i = 0; i < (1<<15); i++) {
        mRegMap[i] = (1<<15);
    }

    mRegMap[0x5000]     = index;
    mRegMap[0x5000 + 1] = index;
    mRegMap[0x5000 + 2] = index;
    mRegMap[0x5000 + 3] = index++;
    mRegMap[0x5004]     = index;
    mRegMap[0x5004 + 1] = index;
    mRegMap[0x5004 + 2] = index;
    mRegMap[0x5004 + 3] = index++;
    mRegMap[0x5008]     = index;
    mRegMap[0x5008 + 1] = index;
    mRegMap[0x5008 + 2] = index;
    mRegMap[0x5008 + 3] = index++;
    mRegMap[0x500C]     = index;
    mRegMap[0x500C + 1] = index;
    mRegMap[0x500C + 2] = index;
    mRegMap[0x500C + 3] = index++;
    mRegMap[0x5010]     = index;
    mRegMap[0x5010 + 1] = index++;
    mTotalRegNum = index;
    mRegArray = new SRegList* [mTotalRegNum];
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_PVFCRF_, "PVFCRF_", 0x5010);
    CW_PVFCRF  = new scml2::bitfield<uint>(PVFCRF->name() , CW_PVFCRF_       ,  0, 16);
    cw_instantiate_reg(CW_TSTRF    , TSTRF->name()  , TSTRF->addr()  );
    cw_instantiate_reg(CW_NCMCR1F  , NCMCR1F->name(), NCMCR1F->addr());
    cw_instantiate_reg(CW_NCMCR2F  , NCMCR2F->name(), NCMCR2F->addr());
    cw_instantiate_reg(CW_NCCRF    , NCCRF->name()  , NCCRF->addr()  );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(TSTRF    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCMCR1F  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCMCR2F  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCCRF    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PVFCRF   , mCurReg, 0,  2,      "16", "8|16|32");

    mRegList = mCurReg;

    (*TSTRF    ) ( 0,  0, "STRF0"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 1,  1, "STRF1"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 2,  2, "STRF2"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 3,  3, "STRF3"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 4,  4, "STRF4"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 5,  5, "STRF5"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 6,  6, "STRF6"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 7,  7, "STRF7"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 8,  8, "STRF8"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) ( 9,  9, "STRF9"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (10, 10, "STRF10"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (11, 11, "STRF11"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (12, 12, "STRF12"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (13, 13, "STRF13"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (14, 14, "STRF14"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (15, 15, "STRF15"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (16, 16, "STRF16"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (17, 17, "STRF17"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (18, 18, "STRF18"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSTRF    ) (19, 19, "STRF19"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCMCR1F  ) (19,  0, "NCM1F"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCMCR2F  ) (19,  0, "NCM2F"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCCRF    ) (19,  0, "NCEF"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PVFCRF   ) (15,  8, "PVFCRKEY", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PVFCRF   ) ( 1,  1, "GRDFCMEN", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PVFCRF   ) ( 0,  0, "BKCRWEN" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["TSTRF"]["STRF0"] = &Catu5010_timerf_regif::cb_TSTRF_STRF0;
    mWrCbAPI["TSTRF"]["STRF1"] = &Catu5010_timerf_regif::cb_TSTRF_STRF1;
    mWrCbAPI["TSTRF"]["STRF2"] = &Catu5010_timerf_regif::cb_TSTRF_STRF2;
    mWrCbAPI["TSTRF"]["STRF3"] = &Catu5010_timerf_regif::cb_TSTRF_STRF3;
    mWrCbAPI["TSTRF"]["STRF4"] = &Catu5010_timerf_regif::cb_TSTRF_STRF4;
    mWrCbAPI["TSTRF"]["STRF5"] = &Catu5010_timerf_regif::cb_TSTRF_STRF5;
    mWrCbAPI["TSTRF"]["STRF6"] = &Catu5010_timerf_regif::cb_TSTRF_STRF6;
    mWrCbAPI["TSTRF"]["STRF7"] = &Catu5010_timerf_regif::cb_TSTRF_STRF7;
    mWrCbAPI["TSTRF"]["STRF8"] = &Catu5010_timerf_regif::cb_TSTRF_STRF8;
    mWrCbAPI["TSTRF"]["STRF9"] = &Catu5010_timerf_regif::cb_TSTRF_STRF9;
    mWrCbAPI["TSTRF"]["STRF10"] = &Catu5010_timerf_regif::cb_TSTRF_STRF10;
    mWrCbAPI["TSTRF"]["STRF11"] = &Catu5010_timerf_regif::cb_TSTRF_STRF11;
    mWrCbAPI["TSTRF"]["STRF12"] = &Catu5010_timerf_regif::cb_TSTRF_STRF12;
    mWrCbAPI["TSTRF"]["STRF13"] = &Catu5010_timerf_regif::cb_TSTRF_STRF13;
    mWrCbAPI["TSTRF"]["STRF14"] = &Catu5010_timerf_regif::cb_TSTRF_STRF14;
    mWrCbAPI["TSTRF"]["STRF15"] = &Catu5010_timerf_regif::cb_TSTRF_STRF15;
    mWrCbAPI["TSTRF"]["STRF16"] = &Catu5010_timerf_regif::cb_TSTRF_STRF16;
    mWrCbAPI["TSTRF"]["STRF17"] = &Catu5010_timerf_regif::cb_TSTRF_STRF17;
    mWrCbAPI["TSTRF"]["STRF18"] = &Catu5010_timerf_regif::cb_TSTRF_STRF18;
    mWrCbAPI["TSTRF"]["STRF19"] = &Catu5010_timerf_regif::cb_TSTRF_STRF19;
    mWrCbAPI["PVFCRF"]["PVFCRKEY"] = &Catu5010_timerf_regif::cb_PVFCRF_PVFCRKEY;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Catu5010_timerf_regif::~Catu5010_timerf_regif()
{
...
Catu5010_timerf_regif::uint Catu5010_timerf_regif::bit_select(
...
bool Catu5010_timerf_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5010_timerf_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5010_timerf_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5010_timerf_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5010_timerf_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
                                           bool IsDbgFunc)               ///< [in] flag indicate reg_rd or reg_rd_dbg
{
    ...
    uint masked_addr = bit_select(tmp_addr, 0, 15-1);
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5010_timerf_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5010_timerf_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5010_timerf_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Catu5010_timerf_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5010_timerf_regif::CommandInit()
{
...
/// @return string
std::string Catu5010_timerf_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5010_timerf_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5010_timerf_regif::InitLocalVal()
{
    // Initialize local variables
    TSTRF_STRF0 = 0x0;
    TSTRF_STRF1 = 0x0;
...
/// @return None
void Catu5010_timerf_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x5000) {
        TSTRF_STRF0                 = (*TSTRF  )["STRF0"  ];
        TSTRF_STRF1                 = (*TSTRF  )["STRF1"  ];
        TSTRF_STRF2                 = (*TSTRF  )["STRF2"  ];
        TSTRF_STRF3                 = (*TSTRF  )["STRF3"  ];
        TSTRF_STRF4                 = (*TSTRF  )["STRF4"  ];
        TSTRF_STRF5                 = (*TSTRF  )["STRF5"  ];
        TSTRF_STRF6                 = (*TSTRF  )["STRF6"  ];
        TSTRF_STRF7                 = (*TSTRF  )["STRF7"  ];
        TSTRF_STRF8                 = (*TSTRF  )["STRF8"  ];
        TSTRF_STRF9                 = (*TSTRF  )["STRF9"  ];
        TSTRF_STRF10                = (*TSTRF  )["STRF10" ];
        TSTRF_STRF11                = (*TSTRF  )["STRF11" ];
        TSTRF_STRF12                = (*TSTRF  )["STRF12" ];
        TSTRF_STRF13                = (*TSTRF  )["STRF13" ];
        TSTRF_STRF14                = (*TSTRF  )["STRF14" ];
        TSTRF_STRF15                = (*TSTRF  )["STRF15" ];
        TSTRF_STRF16                = (*TSTRF  )["STRF16" ];
        TSTRF_STRF17                = (*TSTRF  )["STRF17" ];
        TSTRF_STRF18                = (*TSTRF  )["STRF18" ];
        TSTRF_STRF19                = (*TSTRF  )["STRF19" ];
        return;
    }
    if (addr == 0x5004) {
        NCMCR1F_NCM1F               = (*NCMCR1F)["NCM1F"  ];
        return;
    }
    if (addr == 0x5008) {
        NCMCR2F_NCM2F               = (*NCMCR2F)["NCM2F"  ];
        return;
    }
    if (addr == 0x500C) {
        NCCRF_NCEF                  = (*NCCRF  )["NCEF"   ];
        return;
    }
    if (addr == 0x5010) {
        PVFCRF_PVFCRKEY             = (*PVFCRF )["PVFCRKEY"];
        PVFCRF_GRDFCMEN             = (*PVFCRF )["GRDFCMEN"];
        PVFCRF_BKCRWEN              = (*PVFCRF )["BKCRWEN"];
        return;
    }
}
...
/// @return None
void Catu5010_timerf_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x5000) {
        (*TSTRF  )["STRF0"  ] = TSTRF_STRF0;
        (*TSTRF  )["STRF1"  ] = TSTRF_STRF1;
        (*TSTRF  )["STRF2"  ] = TSTRF_STRF2;
        (*TSTRF  )["STRF3"  ] = TSTRF_STRF3;
        (*TSTRF  )["STRF4"  ] = TSTRF_STRF4;
        (*TSTRF  )["STRF5"  ] = TSTRF_STRF5;
        (*TSTRF  )["STRF6"  ] = TSTRF_STRF6;
        (*TSTRF  )["STRF7"  ] = TSTRF_STRF7;
        (*TSTRF  )["STRF8"  ] = TSTRF_STRF8;
        (*TSTRF  )["STRF9"  ] = TSTRF_STRF9;
        (*TSTRF  )["STRF10" ] = TSTRF_STRF10;
        (*TSTRF  )["STRF11" ] = TSTRF_STRF11;
        (*TSTRF  )["STRF12" ] = TSTRF_STRF12;
        (*TSTRF  )["STRF13" ] = TSTRF_STRF13;
        (*TSTRF  )["STRF14" ] = TSTRF_STRF14;
        (*TSTRF  )["STRF15" ] = TSTRF_STRF15;
        (*TSTRF  )["STRF16" ] = TSTRF_STRF16;
        (*TSTRF  )["STRF17" ] = TSTRF_STRF17;
        (*TSTRF  )["STRF18" ] = TSTRF_STRF18;
        (*TSTRF  )["STRF19" ] = TSTRF_STRF19;
        return;
    }
    if (addr == 0x5004) {
        (*NCMCR1F)["NCM1F"  ] = NCMCR1F_NCM1F;
        return;
    }
    if (addr == 0x5008) {
        (*NCMCR2F)["NCM2F"  ] = NCMCR2F_NCM2F;
        return;
    }
    if (addr == 0x500C) {
        (*NCCRF  )["NCEF"   ] = NCCRF_NCEF;
        return;
    }
    if (addr == 0x5010) {
        (*PVFCRF )["PVFCRKEY"] = PVFCRF_PVFCRKEY;
        (*PVFCRF )["GRDFCMEN"] = PVFCRF_GRDFCMEN;
        (*PVFCRF )["BKCRWEN"] = PVFCRF_BKCRWEN;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Catu5010_timerf_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5010_timerf_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5010_timerf_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if(mDumpRegisterRW == true) {
        ...
        str_tmp<<operation;
        str_tmp<<" Size= "<<size;
        str_tmp<<" Addr= "<<Num2HexStr(addr,15, false);
        if (operation == "R") {
...
int Catu5010_timerf_regif::get_reg_index(cuint access_addr)
{
    if (mRegMap[access_addr] != (1<<15)) {
...
vpcl::re_register *Catu5010_timerf_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5010_timerf_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5010_timerf_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Catu5010_timerf_regif::uint Catu5010_timerf_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Catu5010_timerf_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5010_timerf_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5010_timerf_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5010_timerf_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Catu5010_timerf_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Catu5010_timerf_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Catu5010_timerf_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
