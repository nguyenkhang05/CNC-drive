// ---------------------------------------------------------------------
// $Id: ATU5011_AgentController.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5011_AGENTCONTROLLER_H__
#define __ATU5011_AGENTCONTROLLER_H__

#include "ATU5_Base.h"

class ATU5_Base;

class ATU5011_AgentController : public ATU5_Base
{
#include "ATU5011_cmdif.h"
public:
    ...
    ATU5011_AgentController(void) {;}
    virtual ~ATU5011_AgentController(void) {;}
};
#endif
