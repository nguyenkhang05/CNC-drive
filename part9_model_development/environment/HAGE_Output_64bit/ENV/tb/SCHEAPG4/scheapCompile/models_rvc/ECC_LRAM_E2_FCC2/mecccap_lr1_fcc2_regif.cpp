// -----------------------------------------------------------------------------
// $Id: mecccap_lr1_fcc2_regif.cpp,v 1.3 2019/03/05 04:30:08 synguyen Exp $
//
...
//
// Input file : mecccap_lr1_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE mecccap_lr1_fcc2
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  8 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name                           reg_name                     wsize   rsize      length offset  factor_start    factor_end  factor_index    factor_step access   init   support  callback
//     %%REG      LR1_ERRINT                     LR1_ERRINT                   8|16|32 8|16|32      32     0x00    -               -           -               -           R/W      0x0     TRUE     -
...
////////////////////////////////////////////////////////////////////////////////
/// @file mecccap_lr1_fcc2_regif.cpp
/// @brief Register IF class of model MECCCAP_LR1
/// $Id: mecccap_lr1_fcc2_regif.cpp,v 1.3 2019/03/05 04:30:08 synguyen Exp $
...
/// @return none
Cmecccap_lr1_fcc2_regif::Cmecccap_lr1_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    LR1_ERRINT  = new vpcl::re_register(0x0000, this, "LR1_ERRINT" , name.c_str());
    LR1_SSTCLR  = new vpcl::re_register(0x0010, this, "LR1_SSTCLR" , name.c_str());
    LR1_DSTCLR  = new vpcl::re_register(0x0014, this, "LR1_DSTCLR" , name.c_str());
    LR1_OVFCLR  = new vpcl::re_register(0x0018, this, "LR1_OVFCLR" , name.c_str());
    LR1_SERSTR  = new vpcl::re_register(0x0020, this, "LR1_SERSTR" , name.c_str());
    LR1_DERSTR  = new vpcl::re_register(0x0024, this, "LR1_DERSTR" , name.c_str());
    LR1_OVFSTR  = new vpcl::re_register(0x0028, this, "LR1_OVFSTR" , name.c_str());
    LR1_SERINF  = new vpcl::re_register(0x0030, this, "LR1_SERINF" , name.c_str());
    LR1_ERMSA0  = new vpcl::re_register(0x0060, this, "LR1_ERMSA0" , name.c_str());
    LR1_ERMEA0  = new vpcl::re_register(0x0064, this, "LR1_ERMEA0" , name.c_str());
    LR1_ERMSA1  = new vpcl::re_register(0x0068, this, "LR1_ERMSA1" , name.c_str());
    LR1_ERMEA1  = new vpcl::re_register(0x006C, this, "LR1_ERMEA1" , name.c_str());
    LR1_00DEADR = new vpcl::re_register(0x00F0, this, "LR1_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_LR1_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"LR1_nSEADR"<< i;
        LR1_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_LR1_ERRINT   , LR1_ERRINT->name() , LR1_ERRINT->addr() );
    cw_instantiate_reg(CW_LR1_SSTCLR   , LR1_SSTCLR->name() , LR1_SSTCLR->addr() );
    cw_instantiate_reg(CW_LR1_DSTCLR   , LR1_DSTCLR->name() , LR1_DSTCLR->addr() );
    cw_instantiate_reg(CW_LR1_OVFCLR   , LR1_OVFCLR->name() , LR1_OVFCLR->addr() );
    cw_instantiate_reg(CW_LR1_SERSTR   , LR1_SERSTR->name() , LR1_SERSTR->addr() );
    cw_instantiate_reg(CW_LR1_DERSTR   , LR1_DERSTR->name() , LR1_DERSTR->addr() );
    cw_instantiate_reg(CW_LR1_OVFSTR   , LR1_OVFSTR->name() , LR1_OVFSTR->addr() );
    cw_instantiate_reg(CW_LR1_SERINF   , LR1_SERINF->name() , LR1_SERINF->addr() );
    cw_instantiate_reg(CW_LR1_ERMSA0   , LR1_ERMSA0->name() , LR1_ERMSA0->addr() );
    cw_instantiate_reg(CW_LR1_ERMEA0   , LR1_ERMEA0->name() , LR1_ERMEA0->addr() );
    cw_instantiate_reg(CW_LR1_ERMSA1   , LR1_ERMSA1->name() , LR1_ERMSA1->addr() );
    cw_instantiate_reg(CW_LR1_ERMEA1   , LR1_ERMEA1->name() , LR1_ERMEA1->addr() );
    for(uint i = 0; i < emNUM_LR1_nSEADR ; i++) cw_instantiate_reg(CW_LR1_nSEADR   [i], LR1_nSEADR [i]->name(), LR1_nSEADR [i]->addr());
    cw_instantiate_reg(CW_LR1_00DEADR  , LR1_00DEADR->name(), LR1_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(LR1_ERRINT   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_SSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_DSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_OVFCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_SERSTR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_DERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_OVFSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_SERINF   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_ERMSA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_ERMEA0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_ERMSA1   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_ERMEA1   , mCurReg, 0,  4,      "32", "8|16|32");
    for(uint i = 0; i < emNUM_LR1_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(LR1_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LR1_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*LR1_ERRINT   ) ( 7,  7, "SEOVFIE" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERRINT   ) ( 1,  1, "DEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERRINT   ) ( 0,  0, "SEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_SSTCLR   ) (31,  0, "LR1_SSTCLR", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*LR1_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*LR1_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*LR1_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*LR1_SERSTR   ) (31,  0, "LR1_SERSTR", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_SERINF   ) ( 7,  0, "SEDLINF" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_ERMSA0   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERMSA0   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERMEA0   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERMSA1   ) (26, 12, "ERMSA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERMSA1   ) ( 0,  0, "EN"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_ERMEA1   ) (26, 12, "ERMEA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LR1_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LR1_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_LR1_nSEADR; i++) {
        (*LR1_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*LR1_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["LR1_SSTCLR"]["LR1_SSTCLR"] = &Cmecccap_lr1_fcc2_regif::cb_LR1_SSTCLR_LR1_SSTCLR;
    mWrCbAPI["LR1_DSTCLR"]["DSTCLR00" ] = &Cmecccap_lr1_fcc2_regif::cb_LR1_DSTCLR_DSTCLR00;
    mWrCbAPI["LR1_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_lr1_fcc2_regif::cb_LR1_OVFCLR_SERROVFCLR0;
    mWrCbAPI["LR1_ERMSA0"]["ERMSA"    ] = &Cmecccap_lr1_fcc2_regif::cb_LR1_ERMSA0_ERMSA;
    mWrCbAPI["LR1_ERMEA0"]["ERMEA"    ] = &Cmecccap_lr1_fcc2_regif::cb_LR1_ERMEA0_ERMEA;
    mWrCbAPI["LR1_ERMSA1"]["ERMSA"    ] = &Cmecccap_lr1_fcc2_regif::cb_LR1_ERMSA1_ERMSA;
    mWrCbAPI["LR1_ERMEA1"]["ERMEA"    ] = &Cmecccap_lr1_fcc2_regif::cb_LR1_ERMEA1_ERMEA;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_lr1_fcc2_regif::~Cmecccap_lr1_fcc2_regif()
{
...
Cmecccap_lr1_fcc2_regif::uint Cmecccap_lr1_fcc2_regif::bit_select(
...
bool Cmecccap_lr1_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_lr1_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_lr1_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_lr1_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_lr1_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_lr1_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_lr1_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_lr1_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_lr1_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_lr1_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_lr1_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_lr1_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_lr1_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    LR1_ERRINT_SEOVFIE = 0x1;
    LR1_ERRINT_DEDIE = 0x1;
    LR1_ERRINT_SEDIE = 0x1;
    LR1_SSTCLR_LR1_SSTCLR = 0x0;
    LR1_DSTCLR_DSTCLR00 = 0x0;
    LR1_OVFCLR_SERROVFCLR1 = 0x0;
    LR1_OVFCLR_SERROVFCLR0 = 0x0;
    LR1_SERSTR_LR1_SERSTR = 0x0;
    LR1_DERSTR_DEDF00 = 0x0;
    LR1_OVFSTR_SERROVF1 = 0x0;
    LR1_OVFSTR_SERROVF0 = 0x0;
    LR1_SERINF_SEDLINF = 0x0;
    LR1_ERMSA0_ERMSA = 0x0;
    LR1_ERMSA0_EN  = 0x0;
    LR1_ERMEA0_ERMEA = 0x0;
    LR1_ERMSA1_ERMSA = 0x0;
    LR1_ERMSA1_EN  = 0x0;
    LR1_ERMEA1_ERMEA = 0x0;
    for(uint i = 0; i < emNUM_LR1_nSEADR; i++) {
        LR1_nSEADR_SEDL[i] = 0x0;
        LR1_nSEADR_SEADR0[i] = 0x0;
    }
    LR1_00DEADR_DEDL = 0x0;
    LR1_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_lr1_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        LR1_ERRINT_SEOVFIE              = (*LR1_ERRINT )["SEOVFIE"    ];
        LR1_ERRINT_DEDIE                = (*LR1_ERRINT )["DEDIE"      ];
        LR1_ERRINT_SEDIE                = (*LR1_ERRINT )["SEDIE"      ];
        return;
    }
    if (addr == 0x0010) {
        LR1_SSTCLR_LR1_SSTCLR           = (*LR1_SSTCLR )["LR1_SSTCLR" ];
        return;
    }
    if (addr == 0x0014) {
        LR1_DSTCLR_DSTCLR00             = (*LR1_DSTCLR )["DSTCLR00"   ];
        return;
    }
    if (addr == 0x0018) {
        LR1_OVFCLR_SERROVFCLR1          = (*LR1_OVFCLR )["SERROVFCLR1"];
        LR1_OVFCLR_SERROVFCLR0          = (*LR1_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        LR1_SERSTR_LR1_SERSTR           = (*LR1_SERSTR )["LR1_SERSTR" ];
        return;
    }
    if (addr == 0x0024) {
        LR1_DERSTR_DEDF00               = (*LR1_DERSTR )["DEDF00"     ];
        return;
    }
    if (addr == 0x0028) {
        LR1_OVFSTR_SERROVF1             = (*LR1_OVFSTR )["SERROVF1"   ];
        LR1_OVFSTR_SERROVF0             = (*LR1_OVFSTR )["SERROVF0"   ];
        return;
    }
    if (addr == 0x0030) {
        LR1_SERINF_SEDLINF              = (*LR1_SERINF )["SEDLINF"    ];
        return;
    }
    if (addr == 0x0060) {
        LR1_ERMSA0_ERMSA                = (*LR1_ERMSA0 )["ERMSA"      ];
        LR1_ERMSA0_EN                   = (*LR1_ERMSA0 )["EN"         ];
        return;
    }
    if (addr == 0x0064) {
        LR1_ERMEA0_ERMEA                = (*LR1_ERMEA0 )["ERMEA"      ];
        return;
    }
    if (addr == 0x0068) {
        LR1_ERMSA1_ERMSA                = (*LR1_ERMSA1 )["ERMSA"      ];
        LR1_ERMSA1_EN                   = (*LR1_ERMSA1 )["EN"         ];
        return;
    }
    if (addr == 0x006C) {
        LR1_ERMEA1_ERMEA                = (*LR1_ERMEA1 )["ERMEA"      ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        LR1_nSEADR_SEDL                [i] = (*(LR1_nSEADR [i]))["SEDL"       ];
        LR1_nSEADR_SEADR0              [i] = (*(LR1_nSEADR [i]))["SEADR0"     ];
        return;
    }
    if (addr == 0x00F0) {
        LR1_00DEADR_DEDL                = (*LR1_00DEADR)["DEDL"       ];
        LR1_00DEADR_DEADR0              = (*LR1_00DEADR)["DEADR0"     ];
        return;
    }
}
...
/// @return None
void Cmecccap_lr1_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*LR1_ERRINT )["SEOVFIE"    ] = LR1_ERRINT_SEOVFIE;
        (*LR1_ERRINT )["DEDIE"      ] = LR1_ERRINT_DEDIE;
        (*LR1_ERRINT )["SEDIE"      ] = LR1_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*LR1_SSTCLR )["LR1_SSTCLR" ] = LR1_SSTCLR_LR1_SSTCLR;
        return;
    }
    if (addr == 0x0014) {
        (*LR1_DSTCLR )["DSTCLR00"   ] = LR1_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*LR1_OVFCLR )["SERROVFCLR1"] = LR1_OVFCLR_SERROVFCLR1;
        (*LR1_OVFCLR )["SERROVFCLR0"] = LR1_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*LR1_SERSTR )["LR1_SERSTR" ] = LR1_SERSTR_LR1_SERSTR;
        return;
    }
    if (addr == 0x0024) {
        (*LR1_DERSTR )["DEDF00"     ] = LR1_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*LR1_OVFSTR )["SERROVF1"   ] = LR1_OVFSTR_SERROVF1;
        (*LR1_OVFSTR )["SERROVF0"   ] = LR1_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*LR1_SERINF )["SEDLINF"    ] = LR1_SERINF_SEDLINF;
        return;
    }
    if (addr == 0x0060) {
        (*LR1_ERMSA0 )["ERMSA"      ] = LR1_ERMSA0_ERMSA;
        (*LR1_ERMSA0 )["EN"         ] = LR1_ERMSA0_EN;
        return;
    }
    if (addr == 0x0064) {
        (*LR1_ERMEA0 )["ERMEA"      ] = LR1_ERMEA0_ERMEA;
        return;
    }
    if (addr == 0x0068) {
        (*LR1_ERMSA1 )["ERMSA"      ] = LR1_ERMSA1_ERMSA;
        (*LR1_ERMSA1 )["EN"         ] = LR1_ERMSA1_EN;
        return;
    }
    if (addr == 0x006C) {
        (*LR1_ERMEA1 )["ERMEA"      ] = LR1_ERMEA1_ERMEA;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(LR1_nSEADR [i]))["SEDL"       ] = LR1_nSEADR_SEDL[i];
        (*(LR1_nSEADR [i]))["SEADR0"     ] = LR1_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*LR1_00DEADR)["DEDL"       ] = LR1_00DEADR_DEDL;
        (*LR1_00DEADR)["DEADR0"     ] = LR1_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_lr1_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_lr1_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_lr1_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_lr1_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_lr1_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_lr1_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_lr1_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_lr1_fcc2_regif::uint Cmecccap_lr1_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_lr1_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_lr1_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_lr1_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_lr1_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_lr1_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_lr1_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_lr1_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
