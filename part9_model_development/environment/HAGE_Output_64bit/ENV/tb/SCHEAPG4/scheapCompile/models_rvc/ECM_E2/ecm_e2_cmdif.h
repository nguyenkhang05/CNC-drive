...
//
//// ----------------------------------------------------------------------
//// $Id: ecm_e2_cmdif.txt,v 1.6 2012/09/19 04:07:47 lamdangpham Exp $
//// 
...
#ifndef ECM_E2_CMDIF_H
#define ECM_E2_CMDIF_H
...
#endif // EnableDumpResult
    ret += "    port <value>                              Set bool value to a specified port. Hierarchy name must be added \".mMaster\" or \".mChecker\"; ( Default:false  )\n";
...
std::string user_def_command(std::vector<std::string>& args)
{
  ...
  if (0) {}
    ...
    if (((int)args.size() == 2) || ((int)args.size() == 3)){
        bool port_in_list = false;
        bool write_success = false;
        //If the port name in port list
        for (unsigned int port_index = 0; port_index < this->mForcedPortArray.size(); port_index++){
            if (args[1] == this->mForcedPortArray[port_index]->basename()){
                port_in_list = true;
                //read mode
                if ((int)args.size() == 2){
                    std::ostringstream stream;
                    if (this->mForcedPortArray[port_index]->read()){
                        stream << "true";
                    }else{
                        stream << "false";
                    }
                ...
                //write mode
                    ...
                    if (mStartSimulation){
                        ...
                        if (args[1] == "sgati_pe1"){
                            if (args[2] == "true"){
                                mSGATIPEArray[0] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[0] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                                ret = err_msg + "wrong argument: " + (std::string)args[2] + specified_cmd;
                            }
                        }else if (args[1] == "sgati_pe2"){
                            if (args[2] == "true"){
                                mSGATIPEArray[1] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[1] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe3"){
                            if (args[2] == "true"){
                                mSGATIPEArray[2] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[2] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe4"){
                            if (args[2] == "true"){
                                mSGATIPEArray[3] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[3] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe5"){
                            if (args[2] == "true"){
                                mSGATIPEArray[4] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[4] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe6"){
                            if (args[2] == "true"){
                                mSGATIPEArray[5] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[5] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe7"){
                            if (args[2] == "true"){
                                mSGATIPEArray[6] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[6] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        }else if (args[1] == "sgati_pe8"){
                            if (args[2] == "true"){
                                mSGATIPEArray[7] = true;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else if (args[2] == "false") {
                                mSGATIPEArray[7] = false;
                                mWriteSGATIPEPortEvent.notify();
                            }
                            else{
                                write_success = false;
                        ...
                        printf("warning [%20s] (%s) Port %s is forced value %s before initialize. Ignore force action!.\n",sc_time_stamp().to_string().c_str(), this->name(), mForcedPortArray[port_index]->basename(), args[2].c_str());
                    }
                }
                //combine output signal of Cecm_e2_wp if force port successfully
                if (write_success){
                    printf("info [%20s] (%s) Port %s is forced value %s.\n",sc_time_stamp().to_string().c_str(), this->name(), mForcedPortArray[port_index]->basename(), args[2].c_str());
                    mCombineSignalEvent.notify();
                }
                break;
            }
        }
        //port name is not in list
        if (port_in_list == false){
            ret = err_msg + "The port should be among sgati_pe1..8, sgatnmi, sgaterroz, sgatresz, errout_pe1..8, dtmtrgout" + specified_cmd;
        }
    }else{
        ret = err_msg + "wrong number of arguments" + specified_cmd;
    }
