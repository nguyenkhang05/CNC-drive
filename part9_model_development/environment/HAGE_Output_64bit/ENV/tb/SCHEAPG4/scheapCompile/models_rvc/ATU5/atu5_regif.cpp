// -----------------------------------------------------------------------------
// $Id: atu5_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
/// @file atu5_regif.cpp
/// @brief Register IF class of model ATU5
/// $Id: atu5_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
...
/// @return none
Catu5_regif::Catu5_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    mWrCbAPI["ATUENR"  ]["PSCE"    ] = &Catu5_regif::cb_ATUENR_PSCE;
    mWrCbAPI["CBCNT"   ]["CB5EG"   ] = &Catu5_regif::cb_CBCNT_CB5EG;
    mWrCbAPI["NCMR"    ]["NCMA"    ] = &Catu5_regif::cb_NCMR_NCMA;
    mWrCbAPI["TRGSELAD"]["INSELAD" ] = &Catu5_regif::cb_TRGSELAD_INSELAD;

    for(uint i = 0; i < emNUM_PSCR; i++) {
        str_tmp.str("");
        str_tmp<<"PSCR"<< i;
        mWrCbAPI[str_tmp.str()]["PSC"] = &Catu5_regif::cb_PSCR_PSC;
    }
    for(uint i = 0; i < emNUM_TRGSELDMA0; i++) {
        str_tmp.str("");
        str_tmp<<"TRGSELDMA0"<< i;
        mWrCbAPI[str_tmp.str()]["INSELDMA0"] = &Catu5_regif::cb_TRGSELDMA0_INSELDMA0;
    }
    for(uint i = 0; i < emNUM_TRGSELDMA1; i++) {
        str_tmp.str("");
        str_tmp<<"TRGSELDMA1"<< i;
        mWrCbAPI[str_tmp.str()]["INSELDMA1"] = &Catu5_regif::cb_TRGSELDMA1_INSELDMA1;
    }
    InitLocalVal();
}
...
Catu5_regif::uint Catu5_regif::bit_select(
...
bool Catu5_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                             const unsigned char *p_data,   ///< [in] Writing data
                             cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                             unsigned char *p_data,   ///< [out] Reading data
                             cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                 const unsigned char *p_data,  ///< [in] Writing data
                                 cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                 unsigned char *p_data,   ///< [out] Reading data
                                 cuint size,              ///< [in]  Data size (byte)
                                 bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                              unsigned char *p_data,          ///< [out] Reading data
                              cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                              const unsigned char *p_data,      ///< [in] Writing data
                              cuint size,                       ///< [in] Data size (byte)
                              cuint reg_index,                  ///< [in] Register index
...
bool Catu5_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return string
std::string Catu5_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return None
void Catu5_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Catu5_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Catu5_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Catu5_regif::uint Catu5_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Catu5_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
unsigned short Catu5_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Catu5_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(unsigned short));
    return sizeof(unsigned short);
}
void Catu5_regif::cw_instantiate_reg(scml2::reg<unsigned short> * reg, std::string reg_name, int offset)
{
