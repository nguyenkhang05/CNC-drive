// ---------------------------------------------------------------------
// $Id: ECC_ICACHE_E2_FCC2.h,v 1.9 2019/09/11 03:13:52 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_ICACHE_E2_FCC2_H__
#define __ECC_ICACHE_E2_FCC2_H__
...
#define DEFAULT_AWIDTH_MSB_IT 12
...
#define DEFAULT_AWIDTH_MSB_ID 12
...
class ECCCNT_IT_PEn_FCC2_Func;
class ECCCNT_ID_PEn_FCC2_Func;
class MECCCAP_IT_PEn_FCC2_Func;
class MECCCAP_ID_PEn_FCC2_Func;


class ECC_ICACHE_E2_FCC2: public sc_module
            ,public ECC_ICACHE_E2_FCC2_AgentController
...
public:
    ...
    ECCCNT_IT_PEn_FCC2_Func      **mpECCCNT_ITFunc;   // Pointer of ECCCNT IT PEn Func
    ECCCNT_ID_PEn_FCC2_Func      **mpECCCNT_IDFunc;   // Pointer of ECCCNT ID PEn Func
    MECCCAP_IT_PEn_FCC2_Func     **mpMECCCAP_ITFunc;  // Pointer of MECCCAP IT PEn Func
    MECCCAP_ID_PEn_FCC2_Func     **mpMECCCAP_IDFunc;  // Pointer of MECCCAP ID PEn Func
...
private:
    ...
    // Overwrite firtual functions of ECC_ICACHE_E2_FCC2_AgentController
...
public:
    SC_HAS_PROCESS (ECC_ICACHE_E2_FCC2);
    ECC_ICACHE_E2_FCC2 (sc_module_name name,const uint8_t iPE_NUM, const unsigned int rLatency, const unsigned int wLatency);
    ~ECC_ICACHE_E2_FCC2 ();
...
#endif //__ECC_ICACHE_E2_FCC2_H__
