// ---------------------------------------------------------------------
// $Id: G4_PEG_E2x_Reg.cpp,v 1.7 2020/01/14 02:39:30 nhutminhdang Exp $
//
...
/*********************************
// Function     : G4_PEG_E2x_Reg
// Description  : Constructor of G4_PEG_E2x_Reg class
// Parameter    : None
// Return value : None
**********************************/
G4_PEG_E2x_Reg::G4_PEG_E2x_Reg (std::string name)
                                :Cg4_peg_e2x_regif(name, 32)
{//{{{
    mModuleName = name;
    Cg4_peg_e2x_regif::set_instance_name(name);
}//}}}

/*********************************
// Function     : ~G4_PEG_E2x_Reg
// Description  : Destructor of G4_PEG_E2x_Reg class
// Parameter    : None
// Return value : None
**********************************/
G4_PEG_E2x_Reg::~G4_PEG_E2x_Reg()
{//{{{
}//}}}
...
// Return value : None
**********************************/
void G4_PEG_E2x_Reg::EnableReset(const bool is_active)
{//{{{
    Cg4_peg_e2x_regif::EnableReset(is_active);
}//}}}
...
// Return value : None
**********************************/
void G4_PEG_E2x_Reg::read (unsigned int address, unsigned char *p_data, unsigned int size, bool debug)
{//{{{
    if (p_data == NULL) {
        return;
    }
...
// Return value : None
**********************************/
void G4_PEG_E2x_Reg::write (unsigned int address, unsigned char *p_data, unsigned int size, bool debug)
{//{{{
    if (p_data == NULL) {
        return;
    }
...
// Return value : None
**********************************/
void G4_PEG_E2x_Reg::RegisterHandler (const std::vector<std::string> &args)
{//{{{
     ...
     if (args.size() == 1) { // Dump registers name
        ...
        if (args[1] == "*") { // Set message level for each register
            ...
            while (reg_p != NULL) {
                ...
                msg_return = Cg4_peg_e2x_regif::reg_handle_command(cmd);
                if (msg_return != "") {
            ...
            msg_return = Cg4_peg_e2x_regif::reg_handle_command(args);
            if (msg_return != "") {
                SC_REPORT_INFO(mModuleName.c_str(), msg_return.c_str());
            } else {
...
// Return value : None
**********************************/
unsigned int G4_PEG_E2x_Reg::getPEGSPID_SPID(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
bool G4_PEG_E2x_Reg::getPEGROT_GEN(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
bool G4_PEG_E2x_Reg::getPEGROT_DBG(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
bool G4_PEG_E2x_Reg::getPEGROT_UM(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
bool G4_PEG_E2x_Reg::getPEGROT_WG(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
bool G4_PEG_E2x_Reg::getPEGROT_RG(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
unsigned int G4_PEG_E2x_Reg::getPEGBAD_BAD(unsigned int channel_id)
{//{{{
...
// Return value : None
**********************************/
unsigned int G4_PEG_E2x_Reg::getPEGADV_ADV(unsigned int channel_id)
{//{{{
...
// Return value : 
**********************************/
void G4_PEG_E2x_Reg::cb_PEGKCPROT_KCPROT(RegCBstr str)
{//{{{
...
// Return value : 
**********************************/
void G4_PEG_E2x_Reg::cb_PEGPROT_GEN(RegCBstr str)
{//{{{
...
// Return value : 
**********************************/
void G4_PEG_E2x_Reg::cb_PEGSPID_SPID(RegCBstr str)
{//{{{
    if((unsigned int)((*PEGKCPROT)["KCE"]) != 0x1) {
...
// Return value : 
**********************************/
void G4_PEG_E2x_Reg::cb_PEGBAD_BAD(RegCBstr str)
{//{{{
...
// Return value : 
**********************************/
void G4_PEG_E2x_Reg::cb_PEGADV_ADV(RegCBstr str)
{//{{{
    if((unsigned int)((*PEGKCPROT)["KCE"]) != 0x1) {
