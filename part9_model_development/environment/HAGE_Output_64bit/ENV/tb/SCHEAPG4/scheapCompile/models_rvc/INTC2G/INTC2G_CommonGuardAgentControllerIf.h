// ---------------------------------------------------------------------
// $Id: INTC2G_CommonGuardAgentControllerIf.h,v 1.1 2019/07/08 10:00:59 tientran2 Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef INTC2G_INTC2G_COMMONGUARDAGENTCONTROLLERIF_H_
#define INTC2G_INTC2G_COMMONGUARDAGENTCONTROLLERIF_H_
 ...
 */
class INTC2G_CommonGuardAgentControllerIf {
public:
    virtual ~INTC2G_CommonGuardAgentControllerIf () {};
     ...
     */
    virtual bool SetAreaAddr(const uint32_t    channelId
     ...
     */
    virtual void TransferErrInfo (const uint32_t     channelId
                                 ,const uint32_t     addr
                                 ,const bool         isDebug
     ...
     */
    virtual bool GetGuardSettings(const uint32_t     channelId
                                 ,bool&              GEN
                                 ,bool&              DBG
                                 ,bool&              UM
                                 ,bool&              WG
...
#endif /* INTC2G_INTC2G_COMMONGUARDAGENTCONTROLLERIF_H_ */
