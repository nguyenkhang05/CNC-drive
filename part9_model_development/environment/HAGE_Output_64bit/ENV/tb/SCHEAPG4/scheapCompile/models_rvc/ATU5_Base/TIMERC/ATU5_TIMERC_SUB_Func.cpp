// ---------------------------------------------------------------------
// $Id: ATU5_TIMERC_SUB_Func.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
/// Description  : Constructor of ATU5_TIMERC_SUB_Func class
///*********************************
ATU5_TIMERC_SUB_Func::ATU5_TIMERC_SUB_Func (std::string name, 
                       ATU5_TIMERC_SUB_AgentController *TIMERC_SUBAgentPtr, unsigned int sub_id):
                       Catu5_timerc_sub_regif(name, 32, sub_id)
{//{{{ 
    assert(TIMERC_SUBAgentPtr != NULL);
    mTIMERC_SUBAgent = TIMERC_SUBAgentPtr;
    mTIMERC_SUBAgent->CommandInit(name);
    Catu5_timerc_sub_regif::set_instance_name(name);
    mModuleName = name;
...
///*********************************
/// Function     : ~ATU5_TIMERC_SUB_Func
/// Description  : Destructor of ATU5_TIMERC_SUB_Func class
///*********************************
ATU5_TIMERC_SUB_Func::~ATU5_TIMERC_SUB_Func (void)
{//{{{
}//}}}
...
///*********************************
void ATU5_TIMERC_SUB_Func::read (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
...
/// Description  : Virtual function of BusSlaveFuncIf class
///*********************************
void ATU5_TIMERC_SUB_Func::write (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
    unsigned int addr = (unsigned int )(trans.get_address() & 0xFF);
    if (!debug) {
...
///*********************************
void ATU5_TIMERC_SUB_Func::RegisterHandler (const std::vector<std::string>& args)
{//{{{ 
    ...
    if (args.size() == 1) {
        ...
        if (args[1] == "*") {//Set message level for each register
            ...
            while (reg_p != NULL) {
                ...
                msg_return = Catu5_timerc_sub_regif::reg_handle_command(cmd);
                if (msg_return != "") {
            ...
            msg_return = Catu5_timerc_sub_regif::reg_handle_command(args);
            if (msg_return != "") {
                SC_REPORT_INFO(mModuleName.c_str(), msg_return.c_str());
            }
        }
...
///*********************************
void ATU5_TIMERC_SUB_Func::SetTCNTC(const unsigned int value)
{//{{{
    (*TCNTC) = value;
}//}}}
...
///*********************************
unsigned int ATU5_TIMERC_SUB_Func::GetTCNTC(void)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::SetCounterStatus(const bool flag)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::EnableReset (const bool is_active)
{//{{{ 
    Catu5_timerc_sub_regif::EnableReset(is_active);
}//}}}
...
///*********************************
void ATU5_TIMERC_SUB_Func::UpdateGRCReg(const unsigned int value, const unsigned int channel)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::UpdateOCRCReg(const unsigned int value, const unsigned int channel)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::TurnOVFFlag(void)
{//{{{
   (*TSRC)["OVFC"] = 1;
}//}}}
...
///*********************************
void ATU5_TIMERC_SUB_Func::TurnGRCFlag(const unsigned int channel, const unsigned int value)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::TurnOCRCFlag(const unsigned int channel, const unsigned int value)
{//{{{
    std::ostringstream bit_name;
...
///*********************************
bool ATU5_TIMERC_SUB_Func::IsInterruptOVF(void)
{//{{{
...
/// Description  : Check the interrupt setting
///*********************************
bool ATU5_TIMERC_SUB_Func::IsInterruptGRC(const unsigned int channel)
{//{{{
    std::ostringstream bit_name;
...
/// Description  : Check the interrupt setting
///*********************************
bool ATU5_TIMERC_SUB_Func::IsInterruptOCRC(const unsigned int channel)
{//{{{
    std::ostringstream bit_name;
...
///*********************************
void ATU5_TIMERC_SUB_Func::CheckPWM(void)
{//{{{
    if ((*TCRC)["PWM0"] == 1) {
        if ((mTIMERC_SUBAgent->mChannelMode[0] != ATU5_TIMERC_SUB_AgentController::emCapture) &&
             (mTIMERC_SUBAgent->mChannelMode[1] != ATU5_TIMERC_SUB_AgentController::emCapture) &&
             (mTIMERC_SUBAgent->mChannelMode[2] != ATU5_TIMERC_SUB_AgentController::emCapture) &&
             (mTIMERC_SUBAgent->mChannelMode[3] != ATU5_TIMERC_SUB_AgentController::emCapture)) {
            mTIMERC_SUBAgent->mChannelMode[0] = ATU5_TIMERC_SUB_AgentController::emPWM;
            mTIMERC_SUBAgent->mChannelMode[1] = ATU5_TIMERC_SUB_AgentController::emPWM;
            mTIMERC_SUBAgent->mChannelMode[2] = ATU5_TIMERC_SUB_AgentController::emPWM;
            mTIMERC_SUBAgent->mChannelMode[3] = ATU5_TIMERC_SUB_AgentController::emPWM;
        ...
        if (mTIMERC_SUBAgent->mChannelMode[0] == ATU5_TIMERC_SUB_AgentController::emPWM) { //edit 0818
            for (unsigned int i = 0; i < 4; i++) {
                if ((0 <=  mTIMERC_SUBAgent->mChannelValue[i]) && (mTIMERC_SUBAgent->mChannelValue[i] <= 3)) {
                    mTIMERC_SUBAgent->mChannelMode[i] = ATU5_TIMERC_SUB_AgentController::emComp;
                } else {
                    mTIMERC_SUBAgent->mChannelMode[i] = ATU5_TIMERC_SUB_AgentController::emOneshot;
                }
            }
...
///*********************************
bool ATU5_TIMERC_SUB_Func::TimingClearCounter(void)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::SetModeChannel(const unsigned int channel, const unsigned int value)
{//{{{
    if (((value >= 4)&&(value <8)) ||
        ((value > 11)&&(value < 16))) {
        mTIMERC_SUBAgent->mChannelMode[channel] = ATU5_TIMERC_SUB_AgentController::emCapture;
        ...
        mTIMERC_SUBAgent->mChannelMode[channel] = ATU5_TIMERC_SUB_AgentController::emComp;
        ...
        mTIMERC_SUBAgent->mChannelMode[channel] = ATU5_TIMERC_SUB_AgentController::emOneshot;
...
///*********************************
void ATU5_TIMERC_SUB_Func::SetModeInRunning(const bool mode_ch0, const bool mode_ch1, const bool mode_ch2, const bool mode_ch3)
{//{{{
    if (mode_ch0) {
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_TSCRC(void)
{//{{{
    ...
    for (unsigned int index = 0; index <= 3; index++) {
        ...
        if (((unsigned int)(*TSCRC)[bit_name1.str().c_str()] == 1)) {  // Modified ver 0.080 
	    TurnOCRCFlag(index,0); 
            mTIMERC_SUBAgent->SetPriority(index,0); // added for ver 0.080
            mTIMERC_SUBAgent->print_msg("info","Clear output compare flag.\n");  
        }
        if ((unsigned int)(*TSCRC)[bit_name2.str().c_str()] == 1) {
            TurnGRCFlag(index,0);
            mTIMERC_SUBAgent->SetPriority(index,1); // added for ver 0.080
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_TCRC(void)
{//{{{
    ...
    for (unsigned int channel = 0; channel <= 3; channel++) {
		...
		//ForceCompare
        if (((*TCRC)[bit_name1.str().c_str()] == 1) || ((*TCRC)[bit_name2.str().c_str()] == 1)) {
    ...
    if ((mPre_TCRC_CLRC != mTIMERC_SUBAgent->mIs_Upper_Limit) && (mTIMERC_SUBAgent->mChannelMode[0] != ATU5_TIMERC_SUB_AgentController::emPWM)) {
        ...
        if ((bool)(mTIMERC_SUBAgent->mIs_Upper_Limit)) {
            ...
            } else if (((unsigned int)(*CUCRC) < GetTCNTC())) {  // added ver 0.080 if writing value of CUCRC < TCNTC the Upper limit setting equal 0xFFFFFFFF
                mTIMERC_SUBAgent->SetUpperLimit(0xFFFFFFFF);
            } else {  
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_NCNTCn(const unsigned int channel)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_NCRCn(const unsigned int channel)
{//{{{
...
///*********************************
void ATU5_TIMERC_SUB_Func::cb_TIORC_IOC3(RegCBstr str)
{//{{{
    std::ostringstream bit_name;
        ...
        if (mTIMERC_SUBAgent->mIsTSTRCTrue) {
            if ((unsigned int)((temp_pre_data >> 2)&0x3) != (unsigned int)((cur_data >> 2)&0x3)) {
                ...
                if (((unsigned int)(cur_data >> 2) == 1) || ((unsigned int)(cur_data >> 2) == 3)) {
                    ...
                    if (((unsigned int)(temp_pre_data & 0x3) != (unsigned int)(cur_data & 0x3)) && (mTIMERC_SUBAgent->mChannelMode[index] == ATU5_TIMERC_SUB_AgentController::emOneshot)) {
...
///*********************************
void ATU5_TIMERC_SUB_Func::cb_TCNTC_CNTC(RegCBstr str)
{//{{{
    if (!mTIMERC_SUBAgent->mIsTSTRCTrue) {
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_GRC(const unsigned int channel)
{//{{{
    if (!mTIMERC_SUBAgent->mIsTSTRCTrue) {
    ...
    if (mTIMERC_SUBAgent->mChannelMode[channel] == ATU5_TIMERC_SUB_AgentController::emPWM) {
        ...
        if (((unsigned int)(*GRCn[channel]) == (unsigned int)(*GRCn[0])) && (channel != 0)) {
            mTIMERC_SUBAgent->print_msg("warning","Do not set GRC%i equals GRC0, the output is duty cycle of 100%c or 0%c",channel,'%','%');
        }
        //modify at ver 0.080 for check if writing GRC1->3 > GRC0 dump warning. 
        if (((unsigned int)(*GRCn[0]) < (unsigned int)(*GRCn[channel])) && (channel != 0)) {    
            mTIMERC_SUBAgent->print_msg("warning","Do not set GRC%i larger than GRC0, the output is duty cycle of 100%c or 0%c",channel,'%','%'); 
        }
    }
    if (mTIMERC_SUBAgent->mChannelMode[channel] == ATU5_TIMERC_SUB_AgentController::emOneshot) {
        //Start One-shot
        if (mTIMERC_SUBAgent->mIsTSTRCTrue) {
    ...
    if (range_cmp_val != 0) {
        mTIMERC_SUBAgent->mRangeR2C[channel] = (unsigned int)(pow((double)2,(int)range_cmp_val) + 0.5) - 1; // Modified for ticket #78186
...
///*********************************
void ATU5_TIMERC_SUB_Func::Callback_OCRC(const unsigned int channel)
{//{{{
    ...
    if (range_cmp_val != 0) {
        mTIMERC_SUBAgent->mRangeR1C[channel] = (unsigned int)(pow((double)2,(int)range_cmp_val) + 0.5) - 1; // Modified for ticket #78186
...
///*********************************
unsigned int ATU5_TIMERC_SUB_Func::GetNCNTC(const unsigned int channel)
{//{{{
...
///*********************************
unsigned int ATU5_TIMERC_SUB_Func::GetCLKBusSel(void)
{//{{{
...
/// Description  : Return the value of NCNTC
///*********************************
void ATU5_TIMERC_SUB_Func::SetNCNTC(const unsigned int channel,const unsigned int value)
{//{{{
...
///*********************************
unsigned int ATU5_TIMERC_SUB_Func::GetCUCRC(void)
{//{{{
