// -----------------------------------------------------------------------------
// $Id: ATU5_TIMERG_Func.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// -----------------------------------------------------------------------------
#ifndef ATU5_TIMERG_ATU5_TIMERG_FUNC_H_
#define ATU5_TIMERG_ATU5_TIMERG_FUNC_H_
...
/**@brief ATU5_TIMERG_Func is a core, a function model, a register block,
 *        a bus-slave-FUNCTION model
 *
 */
class ATU5_TIMERG_Func: public Catu5_timerg_regif {
//------------------------------------------------------------------------------
// public attributes
//------------------------------------------------------------------------------
public:
    ...
    ATU5_TIMERG_Func_Timers multi_timer;         ///< instance of the multi-timer
//------------------------------------------------------------------------------
// internal attributes
//------------------------------------------------------------------------------
private:
    ATU5_TIMERG* pWrapper;   ///< implement relationship between the core (a function model, a register block, a bus-slave-FUNCTION model) and the wrapper (a Command Agent Controller, a Python Interface,
...
//------------------------------------------------------------------------------
public:
    ATU5_TIMERG_Func(string       iname
                    ,ATU5_TIMERG* pWrapper);
    virtual ~ATU5_TIMERG_Func();
...
#endif /* ATU5_TIMERG_ATU5_TIMERG_FUNC_H_ */
//------------------------------------------------------------------------------
// EOF
