// ---------------------------------------------------------------------
// $Id: ATU5011_GLUE_Func.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5011_GLUE_FUNC_H__
#define __ATU5011_GLUE_FUNC_H__
#include "BusSlaveFuncIf.h"
#include "atu5011_glue_regif.h"

class ATU5011_GLUE_AgentController;

class ATU5011_GLUE_Func: public Catu5011_glue_regif,
                 public BusSlaveFuncIf
{
public:
    ATU5011_GLUE_Func (std::string name, ATU5011_GLUE_AgentController *ATU5011_GLUE_AgentControllerPtr);
    ~ATU5011_GLUE_Func (void);
...
private:
    ATU5011_GLUE_AgentController *mATU5011_GLUE_AgentController;
    std::string mModuleName;        //Module name

    /// Declare virtual functions of atu5011_glue_regif class
