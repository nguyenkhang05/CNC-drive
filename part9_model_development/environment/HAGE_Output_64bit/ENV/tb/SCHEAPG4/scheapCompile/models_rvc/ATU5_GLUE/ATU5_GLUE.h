// ---------------------------------------------------------------------
// $Id: ATU5_GLUE.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5_GLUE_H__
#define __ATU5_GLUE_H__

#include "BusSlaveBase.h"
#include "ATU5_GLUE_AgentController.h"

class ATU5_GLUE_Func;

class ATU5_GLUE: public sc_module,
            public ATU5_GLUE_AgentController,
...
private:
    ...
    ATU5_GLUE_Func *mATU5_GLUE_Func;            // ATU5_GLUE_Func class instance
    ...
    sc_event mINTSELDregChangeEvent[5];
...
public:
    ...
    /// Socket declaration
    TlmTargetSocket<32> *ts;            // For ATU5_GLUE's registers

    SC_HAS_PROCESS (ATU5_GLUE);
    ATU5_GLUE (sc_module_name name,
...
private:
    ...
    /// Virtual functions of ATU5_GLUE_AgentController class
