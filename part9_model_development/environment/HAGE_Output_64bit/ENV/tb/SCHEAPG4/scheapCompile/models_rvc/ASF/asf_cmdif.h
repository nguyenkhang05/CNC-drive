...
//  %CMD_RW DumpINTCNTInfo <enable:bool=true> @ Enable/disable dumping interrupt and counter information
//  %CMD_ACTION DumpStatInfo : void @ Dumps statistical information of ASF
...
#endif // EnableDumpResult
    ret += "    DumpINTCNTInfo <enable>                   Enable/disable dumping interrupt and counter information ( Default:true  )\n";
    ret += "    DumpStatInfo                              Dumps statistical information of ASF\n";
