// ---------------------------------------------------------------------
// $Id: HWCORE_VRFBUF_Func.h,v 1.1 2020/10/27 04:49:12 huyquocpham Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
// Description: Copyright of HWCORE_VRFBUF_Func.h
// Ref: {EMU3S_HWCORE_UD_Copyright_001}
#ifndef __HWCORE_VRFBUF_FUNC_H__
#define __HWCORE_VRFBUF_FUNC_H__
#include "hwcore_vrfbuf_regif.h"
#include "HWCORE_INT_AgentController.h"

// Description: Declaration of HWCORE_VRFBUF_Func class
// Ref: {EMU3S_HWCORE_UD_ATT1_003, EMU3S_HWCORE_UD_ATT1_006, EMU3S_HWCORE_UD_ATT1_008}
class HWCORE_VRFBUF_Func : public Chwcore_vrfbuf_regif
{
public:
    SC_HAS_PROCESS(HWCORE_VRFBUF_Func);
    HWCORE_VRFBUF_Func(std::string name, HWCORE_INT_AgentController* HWCORE_INTAgentControllerPtr);
    ~HWCORE_VRFBUF_Func();
...
private:
    ...
    // Callback
    void cb_CBCTR0_CBEN0(RegCBstr str);
    
};

#endif // __HWCORE_VRFBUF_FUNC_H__
