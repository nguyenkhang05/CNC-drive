// -----------------------------------------------------------------------------
// $Id: hwcore_rctg_regif.cpp,v 1.4 2020/11/03 08:33:20 quanganhtran Exp $
//
...
//    regif_cpp.skl
//
// Input file : hwcore_rctg_regif.txt
////////////////////////////////////////////////////////////////////////////////
//  %MODULE HWCORE_RCTG
//      #              name     offset_size
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file hwcore_rctg_regif.cpp
/// @brief Register IF class of model HWCORE_RCTG
/// $Id: hwcore_rctg_regif.cpp,v 1.4 2020/11/03 08:33:20 quanganhtran Exp $
/// $Date: 2020/11/03 08:33:20 $
/// $Revison$
/// $Author: quanganhtran $
////////////////////////////////////////////////////////////////////////////////
...
/// Ref: {HWCORE_RCTG_UD_Direction_031, HWCORE_RCTG_UD_Direction_032, HWCORE_RCTG_UD_Direction_035, HWCORE_RCTG_UD_ATT1_005, HWCORE_RCTG_UD_ATT1_006}
/// Ref: {HWCORE_RCTG_UD_ATT1_007, HWCORE_RCTG_UD_ATT1_010, HWCORE_RCTG_UD_ATT1_011}
/// Constructor of Register IF class: define registers and bits
/// @return none
Chwcore_rctg_regif::Chwcore_rctg_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", 0x4D2)
    #endif
{
    CommandInit();
    RECCTR = new vpcl::re_register(0x04C0, this, "RECCTR", name.c_str());
    PTNN   = new vpcl::re_register(0x04C4, this, "PTNN"  , name.c_str());
    PTNAB  = new vpcl::re_register(0x04C5, this, "PTNAB" , name.c_str());
    PTNCD  = new vpcl::re_register(0x04C6, this, "PTNCD" , name.c_str());
    PTNEF  = new vpcl::re_register(0x04C7, this, "PTNEF" , name.c_str());
    CMP0   = new vpcl::re_register(0x04C8, this, "CMP0"  , name.c_str());
    CMP1   = new vpcl::re_register(0x04CA, this, "CMP1"  , name.c_str());
    PHQSFT = new vpcl::re_register(0x04CC, this, "PHQSFT", name.c_str());
    PSWSFT = new vpcl::re_register(0x04CE, this, "PSWSFT", name.c_str());
    PSW    = new vpcl::re_register(0x04CF, this, "PSW"   , name.c_str());
    IPCMP0 = new vpcl::re_register(0x04D0, this, "IPCMP0", name.c_str());
    ...
    mRegMap[0x04C0]     = index++;
    mRegMap[0x04C4]     = index++;
    mRegMap[0x04C5]     = index++;
    mRegMap[0x04C6]     = index++;
    mRegMap[0x04C7]     = index++;
    mRegMap[0x04C8]     = index;
    mRegMap[0x04C8 + 1] = index++;
    mRegMap[0x04CA]     = index;
    mRegMap[0x04CA + 1] = index++;
    mRegMap[0x04CC]     = index;
    mRegMap[0x04CC + 1] = index++;
    mRegMap[0x04CE]     = index++;
    mRegMap[0x04CF]     = index++;
    mRegMap[0x04D0]     = index;
    mRegMap[0x04D0 + 1] = index++;
    mTotalRegNum = index;
    mRegArray = new SRegList* [mTotalRegNum];
    index = 0;
#ifdef USR_CWR_SYSTEMC
    mCurReg = mRegArray[index++] = new SRegList(RECCTR  , mCurReg, 0,  1,       "8", "8|16|32", false, &cwmem);
#else
    mCurReg = mRegArray[index++] = new SRegList(RECCTR  , mCurReg, 0,  1,       "8", "8|16|32");
#endif
    mCurReg = mRegArray[index++] = new SRegList(PTNN    , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PTNAB   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PTNCD   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PTNEF   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CMP0    , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CMP1    , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PHQSFT  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PSWSFT  , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PSW     , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(IPCMP0  , mCurReg, 0,  2,      "16", "8|16|32");

    mRegList = mCurReg;
    ///Ref: {HWCORE_RCTG_UD_Registers_001}
    (*RECCTR  ) ( 7,  7, "FDRCT"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RECCTR  ) ( 2,  2, "FIPPOSI" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*RECCTR  ) ( 1,  1, "SLCTCMP0", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RECCTR  ) ( 0,  0, "SETREC"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_002}
    (*PTNN    ) ( 2,  2, "WPTN"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNN    ) ( 1,  1, "VPTN"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNN    ) ( 0,  0, "UPTN"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_003}
    (*PTNAB   ) ( 5,  5, "WPTNB"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNAB   ) ( 4,  4, "VPTNB"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNAB   ) ( 3,  3, "UPTNB"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNAB   ) ( 2,  2, "WPTNA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNAB   ) ( 1,  1, "VPTNA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNAB   ) ( 0,  0, "UPTNA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_004}
    (*PTNCD   ) ( 5,  5, "WPTND"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNCD   ) ( 4,  4, "VPTND"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNCD   ) ( 3,  3, "UPTND"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNCD   ) ( 2,  2, "WPTNC"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNCD   ) ( 1,  1, "VPTNC"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNCD   ) ( 0,  0, "UPTNC"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_005}
    (*PTNEF   ) ( 5,  5, "WPTNF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNEF   ) ( 4,  4, "VPTNF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNEF   ) ( 3,  3, "UPTNF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNEF   ) ( 2,  2, "WPTNE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNEF   ) ( 1,  1, "VPTNE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PTNEF   ) ( 0,  0, "UPTNE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_006}
    (*CMP0    ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_007}
    (*CMP1    ) (11,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_008}
    (*PHQSFT  ) (15,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_009}
    (*PSWSFT  ) ( 2,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_010}
    (*PSW     ) ( 2,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ///Ref: {HWCORE_RCTG_UD_Registers_011}
    (*IPCMP0  ) (11,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["RECCTR"]["SLCTCMP0"] = &Chwcore_rctg_regif::cb_RECCTR_SLCTCMP0;
    mWrCbAPI["CMP0"]["DATA"] = &Chwcore_rctg_regif::cb_CMP0_DATA;
    mWrCbAPI["CMP1"]["DATA"] = &Chwcore_rctg_regif::cb_CMP1_DATA;
    mWrCbAPI["PHQSFT"]["DATA"] = &Chwcore_rctg_regif::cb_PHQSFT_DATA;
    mWrCbAPI["PSWSFT"]["DATA"] = &Chwcore_rctg_regif::cb_PSWSFT_DATA;

    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Chwcore_rctg_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Chwcore_rctg_regif::~Chwcore_rctg_regif()
{
...
Chwcore_rctg_regif::uint Chwcore_rctg_regif::bit_select(cuint val,    ///< [in] Writting address
...
/// Ref: {HWCORE_RCTG_UD_Direction_020}
/// @return true if writing transaction is finished normally
bool Chwcore_rctg_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chwcore_rctg_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_rctg_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    assert(size != 0);
...
/// Read the register value of requested module
// Ref: {HWCORE_RCTG_UD_Direction_026}
/// @return true if reading transaction is finished normally
bool Chwcore_rctg_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    assert(size != 0);
...
/// Write the value to requested module register
/// Ref: {HWCORE_RCTG_UD_Direction_021, HWCORE_RCTG_UD_Direction_036}
/// @return true if writing transaction is finished normally
bool Chwcore_rctg_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
// Ref: {HWCORE_RCTG_UD_Direction_025}
/// @return true if reading transaction is finished normally
bool Chwcore_rctg_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
/// Ref: {HWCORE_RCTG_UD_Direction_031}
/// @return true if reading successfully
bool Chwcore_rctg_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
/// Ref: {HWCORE_RCTG_UD_Direction_037}
/// @return true if writing successfully
bool Chwcore_rctg_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Chwcore_rctg_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
// Ref: {HWCORE_RCTG_UD_Direction_023}
/// @return none
void Chwcore_rctg_regif::CommandInit()
{
...
// Ref: {HWCORE_RCTG_UD_Direction_024}
/// @return string
std::string Chwcore_rctg_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chwcore_rctg_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chwcore_rctg_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Chwcore_rctg_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Chwcore_rctg_regif::IssueRegValueID(void)
{//{{{
...
/// @return vector
std::vector<std::string> Chwcore_rctg_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chwcore_rctg_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chwcore_rctg_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Chwcore_rctg_regif::get_reg_index(cuint access_addr)
{
    if (access_addr < (1<<11)) {
...
vpcl::re_register *Chwcore_rctg_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chwcore_rctg_regif::next_reg_object()
{
    assert(mCurReg != NULL);
...
/// @return none
void Chwcore_rctg_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Chwcore_rctg_regif::uint Chwcore_rctg_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Chwcore_rctg_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chwcore_rctg_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chwcore_rctg_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}

/// Method to change value of mIsReset
/// Ref: {HWCORE_RCTG_UD_Direction_042}
/// @return none
void Chwcore_rctg_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
unsigned short Chwcore_rctg_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Chwcore_rctg_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Chwcore_rctg_regif::cw_set_all_callback_reg(void)
{
