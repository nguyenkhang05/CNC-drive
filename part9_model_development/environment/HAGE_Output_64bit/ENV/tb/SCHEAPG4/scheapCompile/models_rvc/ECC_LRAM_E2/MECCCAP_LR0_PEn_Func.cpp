// ---------------------------------------------------------------------
// $Id: MECCCAP_LR0_PEn_Func.cpp,v 1.1 2019/09/26 10:07:33 landang Exp $
//
...
//========================================================
/// Constructor
MECCCAP_LR0_PEn_Func::MECCCAP_LR0_PEn_Func (std::string name, unsigned int pe_id, ECC_LRAM_E2_AgentController* LRAMAgentController):
                Cmecccap_lr0_pen_regif(name, 32)
                ,BusSlaveFuncIf()
{//{{{
    ...
    Cmecccap_lr0_pen_regif::set_instance_name(name);
}//}}}

/// Destructor
MECCCAP_LR0_PEn_Func::~MECCCAP_LR0_PEn_Func()
{//{{{
}//}}}

/// Reset Func and registers
void MECCCAP_LR0_PEn_Func::EnableReset(const std::string reset_name, const bool is_active)
{//{{{
    if (reset_name == "sys_resetz"){
        Cmecccap_lr0_pen_regif::EnableReset(is_active);
    }
}//}}}

/// Read API (target socket)
void MECCCAP_LR0_PEn_Func::read (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
...
void MECCCAP_LR0_PEn_Func::write (unsigned int offsetAddress, TlmBasicPayload& trans, BusTime_t* t, bool debug)
{//{{{
...
void MECCCAP_LR0_PEn_Func::RegisterHandler (const std::vector<std::string> &args)
{//{{{
    ...
    if (args.size() == 1) {//Dump registers name
        ...
        if (args[1] == "*") {//Set message level for each register
            ...
            while (reg_p != NULL) {
                ...
                msg_return = Cmecccap_lr0_pen_regif::reg_handle_command(cmd);
                if (msg_return != "") {
            ...
            msg_return = Cmecccap_lr0_pen_regif::reg_handle_command(args);
            if (msg_return != "") {
                SC_REPORT_INFO(mModuleName.c_str(), msg_return.c_str());
            }
        }
...
bool MECCCAP_LR0_PEn_Func::Set1bitStatusAndAddress(unsigned int edl_code, unsigned int mod_address)
{//{{{
    unsigned int cap_depth = mpLRAMAgentController->GetCapDepth("LR0");
...
void MECCCAP_LR0_PEn_Func::SetFlagAddressBufferOverflow()
{//{{{
...
bool MECCCAP_LR0_PEn_Func::CheckHasRoomFor1bit()
{//{{{
    unsigned int cap_depth = mpLRAMAgentController->GetCapDepth("LR0");
    unsigned int status = (unsigned int)(*LR0_SERSTR);
    bool is_find_room = false;
...
/// Set FIFO overflow
void MECCCAP_LR0_PEn_Func::SetFIFOOverflow ()
{//{{{
...
/// Get SEDL bit
unsigned int MECCCAP_LR0_PEn_Func::GetSEDLBit(unsigned int index)
{//{{{
    return (unsigned int)(*LR0_nSEADR[index])["SEDL"];
}//}}}

/// Get SEADR bit
unsigned int MECCCAP_LR0_PEn_Func::GetSEADRBit(unsigned int index)
{//{{{
    return (unsigned int)(*LR0_nSEADR[index])["SEADR0"];
}//}}}

/// Get DEDL bit
unsigned int MECCCAP_LR0_PEn_Func::GetDEDLBit()
{//{{{
    return (unsigned int)(*LR0_00DEADR)["DEDL"];
}//}}}

/// Get DEADR bit
unsigned int MECCCAP_LR0_PEn_Func::GetDEADRBit()
{//{{{
    return (unsigned int)(*LR0_00DEADR)["DEADR0"];
}//}}}

/// Get Start mask address
unsigned int MECCCAP_LR0_PEn_Func::GetERMSA(unsigned int index)
{//{{{
...
unsigned int MECCCAP_LR0_PEn_Func::GetERMEA(unsigned int index)
{//{{{
    unsigned int ret_val = 0;
    if (index == 0){
...
unsigned int MECCCAP_LR0_PEn_Func::GetERM_EN(unsigned int index)
{//{{{
    unsigned int ret_val = 0;
    if (index == 0){
...
bool MECCCAP_LR0_PEn_Func::CheckNoFatalStatus()
{//{{{
    return ((unsigned int)(*LR0_DERSTR) == 0);
}//}}}

/// Set 2bit error status
void MECCCAP_LR0_PEn_Func::Set2bitErrorStatus()
{//{{{
    (*LR0_DERSTR)["DEDF00"] = 1;
}//}}}

/// Set address feedback error status
void MECCCAP_LR0_PEn_Func::SetAddrFeedbackErrorStatus()
{//{{{
    (*LR0_DERSTR)["AFEF00"] = 1;
}//}}}

/// Set EDL and error address of fatal
void MECCCAP_LR0_PEn_Func::SetFatalAddress(unsigned int edl_code, unsigned int mod_address)
{//{{{
...
unsigned int MECCCAP_LR0_PEn_Func::GetLR0_SERSTR()
{//{{{
    return (unsigned int)(*LR0_SERSTR);
}//}}}

/// Get value of LR0_DERSTR register
unsigned int MECCCAP_LR0_PEn_Func::GetLR0_DERSTR()
{//{{{
    return (unsigned int)(*LR0_DERSTR);
}//}}}

/// Get value of LR0_OVFSTR register
unsigned int MECCCAP_LR0_PEn_Func::GetLR0_OVFSTR()
{//{{{
    return (unsigned int)(*LR0_OVFSTR);
}//}}}

/// Write ERRINT_INIT to ERRINT reg after reset
void MECCCAP_LR0_PEn_Func::WriteERRINT_INIT(unsigned int value)
{//{{{
...
/// Get ERRINT register
unsigned int MECCCAP_LR0_PEn_Func::GetERRINT()
{//{{{
...
void MECCCAP_LR0_PEn_Func::cb_LR0_SSTCLR_LR0_SSTCLR(RegCBstr str)
{//{{{ 
...
void MECCCAP_LR0_PEn_Func::cb_LR0_DSTCLR_DSTCLR00(RegCBstr str)
{//{{{
    // clear DED.
...
void MECCCAP_LR0_PEn_Func::cb_LR0_OVFCLR_SERROVFCLR0(RegCBstr str)
{//{{{ 
...
void MECCCAP_LR0_PEn_Func::cb_LR0_ERMSA0_ERMSA(RegCBstr str)
{//{{{ 
...
void MECCCAP_LR0_PEn_Func::cb_LR0_ERMEA0_ERMEA(RegCBstr str)
{//{{{ 
...
void MECCCAP_LR0_PEn_Func::cb_LR0_ERMSA1_ERMSA(RegCBstr str)
{//{{{ 
...
void MECCCAP_LR0_PEn_Func::cb_LR0_ERMEA1_ERMEA(RegCBstr str)
{//{{{ 
