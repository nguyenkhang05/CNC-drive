// -----------------------------------------------------------------------------
// $Id: crc64apbv01_regif.cpp,v 1.6 2019/12/07 10:28:36 ngathunguyen Exp $
//
...
/// @return none
Ccrc64apbv01_regif::Ccrc64apbv01_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0xB8/4))
    #endif
{
    CommandInit();
    CRCDIN   = new vpcl::re_register(0x0000, this, "CRCDIN"  , name.c_str());
    CRCDOUT0 = new vpcl::re_register(0x0080, this, "CRCDOUT0", name.c_str());
    CRCDOUT1 = new vpcl::re_register(0x0084, this, "CRCDOUT1", name.c_str());
    CRCCTL   = new vpcl::re_register(0x0090, this, "CRCCTL"  , name.c_str());
    CRCPOLY0 = new vpcl::re_register(0x00A0, this, "CRCPOLY0", name.c_str());
    CRCPOLY1 = new vpcl::re_register(0x00A4, this, "CRCPOLY1", name.c_str());
    CRCXOR0  = new vpcl::re_register(0x00B0, this, "CRCXOR0" , name.c_str());
    CRCXOR1  = new vpcl::re_register(0x00B4, this, "CRCXOR1" , name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_CRCDIN    , CRCDIN->name()  , CRCDIN->addr()  );
    cw_instantiate_reg(CW_CRCDOUT0  , CRCDOUT0->name(), CRCDOUT0->addr());
    cw_instantiate_reg(CW_CRCDOUT1  , CRCDOUT1->name(), CRCDOUT1->addr());
    cw_instantiate_reg(CW_CRCCTL    , CRCCTL->name()  , CRCCTL->addr()  );
    cw_instantiate_reg(CW_CRCPOLY0  , CRCPOLY0->name(), CRCPOLY0->addr());
    cw_instantiate_reg(CW_CRCPOLY1  , CRCPOLY1->name(), CRCPOLY1->addr());
    cw_instantiate_reg(CW_CRCXOR0   , CRCXOR0->name() , CRCXOR0->addr() );
    cw_instantiate_reg(CW_CRCXOR1   , CRCXOR1->name() , CRCXOR1->addr() );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(CRCDIN    , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCDOUT0  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCDOUT1  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCCTL    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCPOLY0  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCPOLY1  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCXOR0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CRCXOR1   , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*CRCDIN    ) (31,  0, "DIN"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCDOUT0  ) (31,  0, "DOUT"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCDOUT1  ) (31,  0, "DOUT"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCCTL    ) (21, 16, "PSIZE"   , 0x1F      , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCCTL    ) ( 8,  8, "CMD0"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCCTL    ) ( 5,  5, "CMD1"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCCTL    ) ( 4,  4, "CMD2"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCCTL    ) ( 2,  0, "DW"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCPOLY0  ) (31,  0, "POLY"    , 0x4C11DB7 , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCPOLY1  ) (31,  0, "POLY"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CRCXOR0   ) (31,  0, "XOR"     , 0xFFFFFFFF, "R|W"   , vpcl::SPP_ENABLE);
    (*CRCXOR1   ) (31,  0, "XOR"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["CRCDIN"]["DIN"   ] = &Ccrc64apbv01_regif::cb_CRCDIN_DIN;
    mWrCbAPI["CRCDOUT0"]["DOUT"  ] = &Ccrc64apbv01_regif::cb_CRCDOUT0_DOUT;
    mWrCbAPI["CRCDOUT1"]["DOUT"  ] = &Ccrc64apbv01_regif::cb_CRCDOUT1_DOUT;
    mWrCbAPI["CRCCTL"]["PSIZE" ] = &Ccrc64apbv01_regif::cb_CRCCTL_PSIZE;
    mWrCbAPI["CRCCTL"]["DW"    ] = &Ccrc64apbv01_regif::cb_CRCCTL_DW;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Ccrc64apbv01_regif::~Ccrc64apbv01_regif()
{
...
Ccrc64apbv01_regif::uint Ccrc64apbv01_regif::bit_select(
...
bool Ccrc64apbv01_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Ccrc64apbv01_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Ccrc64apbv01_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Ccrc64apbv01_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Ccrc64apbv01_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Ccrc64apbv01_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Ccrc64apbv01_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Ccrc64apbv01_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Ccrc64apbv01_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Ccrc64apbv01_regif::CommandInit()
{
...
/// @return string
std::string Ccrc64apbv01_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Ccrc64apbv01_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Ccrc64apbv01_regif::InitLocalVal()
{
    // Initialize local variables
    CRCDIN_DIN = 0x0;
    CRCDOUT0_DOUT = 0x0;
    ...
    CRCCTL_CMD2 = 0x0;
    CRCCTL_DW = 0x0;
    CRCPOLY0_POLY = 0x4C11DB7;
    CRCPOLY1_POLY = 0x0;
    CRCXOR0_XOR = 0xFFFFFFFF;
    CRCXOR1_XOR = 0x0;
}

/// Update bit value to local value
/// @return None
void Ccrc64apbv01_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CRCDIN_DIN                   = (*CRCDIN  )["DIN"     ];
        return;
    }
    if (addr == 0x0080) {
        CRCDOUT0_DOUT                = (*CRCDOUT0)["DOUT"    ];
        return;
    }
    if (addr == 0x0084) {
        CRCDOUT1_DOUT                = (*CRCDOUT1)["DOUT"    ];
        return;
    }
    if (addr == 0x0090) {
        CRCCTL_PSIZE                 = (*CRCCTL  )["PSIZE"   ];
        CRCCTL_CMD0                  = (*CRCCTL  )["CMD0"    ];
        CRCCTL_CMD1                  = (*CRCCTL  )["CMD1"    ];
        CRCCTL_CMD2                  = (*CRCCTL  )["CMD2"    ];
        CRCCTL_DW                    = (*CRCCTL  )["DW"      ];
        return;
    }
    if (addr == 0x00A0) {
        CRCPOLY0_POLY                = (*CRCPOLY0)["POLY"    ];
        return;
    }
    if (addr == 0x00A4) {
        CRCPOLY1_POLY                = (*CRCPOLY1)["POLY"    ];
        return;
    }
    if (addr == 0x00B0) {
        CRCXOR0_XOR                  = (*CRCXOR0 )["XOR"     ];
        return;
    }
    if (addr == 0x00B4) {
        CRCXOR1_XOR                  = (*CRCXOR1 )["XOR"     ];
        return;
    }
}
...
/// @return None
void Ccrc64apbv01_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CRCDIN  )["DIN"     ] = CRCDIN_DIN;
        return;
    }
    if (addr == 0x0080) {
        (*CRCDOUT0)["DOUT"    ] = CRCDOUT0_DOUT;
        return;
    }
    if (addr == 0x0084) {
        (*CRCDOUT1)["DOUT"    ] = CRCDOUT1_DOUT;
        return;
    }
    if (addr == 0x0090) {
        (*CRCCTL  )["PSIZE"   ] = CRCCTL_PSIZE;
        (*CRCCTL  )["CMD0"    ] = CRCCTL_CMD0;
        (*CRCCTL  )["CMD1"    ] = CRCCTL_CMD1;
        (*CRCCTL  )["CMD2"    ] = CRCCTL_CMD2;
        (*CRCCTL  )["DW"      ] = CRCCTL_DW;
        return;
    }
    if (addr == 0x00A0) {
        (*CRCPOLY0)["POLY"    ] = CRCPOLY0_POLY;
        return;
    }
    if (addr == 0x00A4) {
        (*CRCPOLY1)["POLY"    ] = CRCPOLY1_POLY;
        return;
    }
    if (addr == 0x00B0) {
        (*CRCXOR0 )["XOR"     ] = CRCXOR0_XOR;
        return;
    }
    if (addr == 0x00B4) {
        (*CRCXOR1 )["XOR"     ] = CRCXOR1_XOR;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Ccrc64apbv01_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Ccrc64apbv01_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Ccrc64apbv01_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Ccrc64apbv01_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Ccrc64apbv01_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Ccrc64apbv01_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Ccrc64apbv01_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Ccrc64apbv01_regif::uint Ccrc64apbv01_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Ccrc64apbv01_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Ccrc64apbv01_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Ccrc64apbv01_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Ccrc64apbv01_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Ccrc64apbv01_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Ccrc64apbv01_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Ccrc64apbv01_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
