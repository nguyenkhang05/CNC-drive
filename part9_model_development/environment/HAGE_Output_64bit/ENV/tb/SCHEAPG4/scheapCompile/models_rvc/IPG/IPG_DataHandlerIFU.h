// ---------------------------------------------------------------------
// $Id: IPG_DataHandlerIFU.h,v 1.2 2014/04/04 07:56:58 duymai Exp $
//
...
#ifndef __IPG_DataHandlerIFU_H__
#define __IPG_DataHandlerIFU_H__
#include "BusBridgeCoreBase.h"
#include "IPG_LT.h"

class IPG_DataHandlerIFU: public BusBridgeCoreBase<32,32>
{
public:
    IPG_DataHandlerIFU(std::string name,
