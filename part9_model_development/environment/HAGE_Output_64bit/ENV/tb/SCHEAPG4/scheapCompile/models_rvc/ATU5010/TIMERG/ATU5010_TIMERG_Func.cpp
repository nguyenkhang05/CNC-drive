// -----------------------------------------------------------------------------
// $Id: ATU5010_TIMERG_Func.cpp,v 1.0 621 2016-06-15 10:51:02Z CuongPH8 $
//
 ...
 */
ATU5010_TIMERG_Func::ATU5010_TIMERG_Func(string       iname
                                  ,ATU5010_TIMERG* pWrapper)
: Catu5010_timerg_regif(iname, 32)
// public attributes
              ...
              ,"multi_timer")
{
    ...
    Catu5010_timerg_regif::set_instance_name(string(pWrapper->basename()));
 ...
 * Detailed steps as follows:
 */
ATU5010_TIMERG_Func::~ATU5010_TIMERG_Func() {}
//------------------------------------------------------------------------------
 ...
 *          Catu5010_timerg_regifforwards reset status.
 * Detailed steps as follow:
 */
void ATU5010_TIMERG_Func::EnableReset (const bool is_active) {
    ...
    if (mReset && !InResetState()) {
        Catu5010_timerg_regif::EnableReset(true);
    } else if (!is_active && InResetState()) {
        Catu5010_timerg_regif::EnableReset(false);
    }
...
//------------------------------------------------------------------------------
/// @todo: comment me
void ATU5010_TIMERG_Func::Initialize () {
 ...
 */
void ATU5010_TIMERG_Func::RegisterHandler (const bool                      is_com_reg
    ...
    if (args_mod.size() == 1) {
        ...
        if (args[1] == "*") {
            ...
            while (reg_p != NULL) {
                ...
                msg_return = Catu5010_timerg_regif::reg_handle_command(cmd);
                if (msg_return != "") {
            ...
            msg_return = Catu5010_timerg_regif::reg_handle_command(args_mod);
            if (msg_return != "") {
                SC_REPORT_INFO(mModuleName.c_str(), msg_return.c_str());
            }
        } // end-if-else
 ...
 */
void ATU5010_TIMERG_Func::read (uint32_t         offsetAddress ///< [in]    offset address
 ...
 */
void ATU5010_TIMERG_Func::write(uint32_t          offsetAddress ///< [in] offset address
                            ,TlmBasicPayload&  trans         ///< [inout] transaction
                            ,BusTime_t*        t             ///< [inout] time
                            ,bool              debug         ///< [in] debug access
                            )
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mWrCbAPI["TSTRG"]["STRG"] = &Catu5010_timerg_regif::cb_TSTRG_STRG;
 */
void ATU5010_TIMERG_Func::cb_TSTRG_STRG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        if (!InResetState() && !InNoClkState()) {
            for (uint8_t channel_id = 0; channel_id < CONFIG::SUBBLOCK_NUM; ++channel_id) {
                multi_timer.set_str_async(((*TSTRG)["STRG"] & (1 << channel_id)) != 0
                                         ,channel_id);
            }
            state = CONFIG::OPERATING;
        }
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["EVSYMG"] = &Catu5010_timerg_regif::cb_TCRG_EVSYMG;
 */
void ATU5010_TIMERG_Func::cb_TCRG_EVSYMG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        multi_timer.set_ext_event_start_mode((*TCRG[str.channel])["EVSYMG"]
                                           ,str.channel);
        if ((*TCRG[str.channel])["EVSYMG"] && ((*TCRG[str.channel])["CKSELG"] != 0x05)) {
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *         mWrCbAPI[str_tmp.str()]["CKSELG"] = &Catu5010_timerg_regif::cb_TCRG_CKSELG;
 */
void ATU5010_TIMERG_Func::cb_TCRG_CKSELG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# mirror value of compare-match register inside functional model
        ///    to the register block
        multi_timer.set_clk_div_sel((*TCRG[str.channel])["CKSELG"]
                                   ,str.channel);
    }
};
//------------------------------------------------------------------------------
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mRdCbAPI[str_tmp.str()]["CMFG"] = &Catu5010_timerg_regif::cb_TSRG_CMFG;
 */
void ATU5010_TIMERG_Func::cb_TSRG_CMFG (RegCBstr str) {
    if (!str.is_wr) {
        /// proceed read access
        /// -# mirror value of compare-match register inside functional model
        ///    to the register block
 ...
 *        of *Timer status register*
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mRdCbAPI[str_tmp.str()]["OVFG"] = &Catu5010_timerg_regif::cb_TSRG_OVFG;
 */
void ATU5010_TIMERG_Func::cb_TSRG_OVFG (RegCBstr str) {
    if (!str.is_wr) {
        /// proceed read access
        /// -# mirror value of compare-match register inside functional model
        ///    to the register block
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mRdCbAPI[str_tmp.str()]["EVDTFG"] = &Catu5010_timerg_regif::cb_TSRG_EVDTFG;
 */
void ATU5010_TIMERG_Func::cb_TSRG_EVDTFG (RegCBstr str) {
    if (!str.is_wr) {
        /// proceed read access
 ...
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["CMFCG"] = &Catu5010_timerg_regif::cb_TSCRG_CMFCG;
 */
void ATU5010_TIMERG_Func::cb_TSCRG_CMFCG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
 ...
 *        field of *Timer status clear register*
 * @details see this line in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["OVFCG"] = &Catu5010_timerg_regif::cb_TSCRG_OVFCG;
 */
void ATU5010_TIMERG_Func::cb_TSCRG_OVFCG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# firstly, stop the timer
 ...
 * @details see these lines in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["TCNTG"] = &Catu5010_timerg_regif::cb_TCNTG_TCNTG;
 *          mRdCbAPI[str_tmp.str()]["TCNTG"] = &Catu5010_timerg_regif::cb_TCNTG_TCNTG;
 *
 * Detailed steps as follow:
 */
void ATU5010_TIMERG_Func::cb_TCNTG_TCNTG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# firstly, stop the timer
 ...
 * @details see these lines in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["OCRG"] = &Catu5010_timerg_regif::cb_OCRG_OCRG;
 *          mRdCbAPI[str_tmp.str()]["OCRG"] = &Catu5010_timerg_regif::cb_OCRG_OCRG;
 *
 * Detailed steps as follow:
 */
void ATU5010_TIMERG_Func::cb_OCRG_OCRG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# firstly, stop the timer
 ...
 * @details see these lines in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["RLDG"] = &Catu5010_timerg_regif::cb_RLDG_RLDG;
 * Detailed steps as follow:
 */
void ATU5010_TIMERG_Func::cb_RLDG_RLDG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# firstly, stop the timer
        /// -# set value of compare-match register
 ...
 * @details see these lines in Catu5010_timerg_regif.cpp
 *          mWrCbAPI[str_tmp.str()]["RLENG"] = &Catu5010_timerg_regif::cb_RLDCRG_RLDCRG;
 * Detailed steps as follow:
 */
void ATU5010_TIMERG_Func::cb_RLDCRG_RLENG (RegCBstr str) {
    if (str.is_wr) {
        /// proceed write access
        /// -# firstly, stop the timer
        /// -# set value of compare-match register
        /// -# and finally, set start/stop status of the timer to the status
        ///    stored inside *timer start registers*
        multi_timer.set_rl_en((*RLDCRG)["RLENG"] &&  (1 << str.channel)
                             ,str.channel);
    }
};
