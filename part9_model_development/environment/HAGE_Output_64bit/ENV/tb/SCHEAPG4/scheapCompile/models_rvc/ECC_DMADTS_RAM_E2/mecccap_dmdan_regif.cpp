// -----------------------------------------------------------------------------
// $Id: mecccap_dmdan_regif.cpp,v 1.2 2019/03/05 04:17:12 synguyen Exp $
//
...
/// @return none
Cmecccap_dmdan_regif::Cmecccap_dmdan_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    DA_ERRINT  = new vpcl::re_register(0x0000, this, "DA_ERRINT" , name.c_str());
    DA_SSTCLR  = new vpcl::re_register(0x0010, this, "DA_SSTCLR" , name.c_str());
    DA_DSTCLR  = new vpcl::re_register(0x0014, this, "DA_DSTCLR" , name.c_str());
    DA_OVFCLR  = new vpcl::re_register(0x0018, this, "DA_OVFCLR" , name.c_str());
    DA_SERSTR  = new vpcl::re_register(0x0020, this, "DA_SERSTR" , name.c_str());
    DA_DERSTR  = new vpcl::re_register(0x0024, this, "DA_DERSTR" , name.c_str());
    DA_OVFSTR  = new vpcl::re_register(0x0028, this, "DA_OVFSTR" , name.c_str());
    DA_SERINF  = new vpcl::re_register(0x0030, this, "DA_SERINF" , name.c_str());
    DA_00DEADR = new vpcl::re_register(0x00F0, this, "DA_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_DA_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"DA_nSEADR"<< i;
        DA_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_DA_ERRINT_, "DA_ERRINT_", 0x0000);
    CW_DA_ERRINT  = new scml2::bitfield<uint>(DA_ERRINT->name() , CW_DA_ERRINT_          ,  0,  8);
    cw_instantiate_reg(CW_DA_SSTCLR_, "DA_SSTCLR_", 0x0010);
    CW_DA_SSTCLR  = new scml2::bitfield<uint>(DA_SSTCLR->name() , CW_DA_SSTCLR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_DSTCLR_, "DA_DSTCLR_", 0x0014);
    CW_DA_DSTCLR  = new scml2::bitfield<uint>(DA_DSTCLR->name() , CW_DA_DSTCLR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_OVFCLR_, "DA_OVFCLR_", 0x0018);
    CW_DA_OVFCLR  = new scml2::bitfield<uint>(DA_OVFCLR->name() , CW_DA_OVFCLR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_SERSTR_, "DA_SERSTR_", 0x0020);
    CW_DA_SERSTR  = new scml2::bitfield<uint>(DA_SERSTR->name() , CW_DA_SERSTR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_DERSTR_, "DA_DERSTR_", 0x0024);
    CW_DA_DERSTR  = new scml2::bitfield<uint>(DA_DERSTR->name() , CW_DA_DERSTR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_OVFSTR_, "DA_OVFSTR_", 0x0028);
    CW_DA_OVFSTR  = new scml2::bitfield<uint>(DA_OVFSTR->name() , CW_DA_OVFSTR_          ,  0,  8);
    cw_instantiate_reg(CW_DA_SERINF_, "DA_SERINF_", 0x0030);
    CW_DA_SERINF  = new scml2::bitfield<uint>(DA_SERINF->name() , CW_DA_SERINF_          ,  0,  8);
    for(uint i = 0; i < emNUM_DA_nSEADR ; i++) cw_instantiate_reg(CW_DA_nSEADR   [i], DA_nSEADR [i]->name(), DA_nSEADR [i]->addr());
    cw_instantiate_reg(CW_DA_00DEADR  , DA_00DEADR->name(), DA_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DA_ERRINT   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_SSTCLR   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_DSTCLR   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_OVFCLR   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_SERSTR   , mCurReg, 0,  1,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_DERSTR   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_OVFSTR   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_SERINF   , mCurReg, 0,  1, "8|16|32", "8|16|32");
    for(uint i = 0; i < emNUM_DA_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(DA_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DA_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*DA_ERRINT   ) ( 7,  7, "SEOVFIE" , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*DA_ERRINT   ) ( 1,  1, "DEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*DA_ERRINT   ) ( 0,  0, "SEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*DA_SSTCLR   ) ( 0,  0, "SSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DA_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DA_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DA_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DA_SERSTR   ) ( 0,  0, "SEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_SERINF   ) ( 0,  0, "SEDLINF00", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*DA_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_DA_nSEADR; i++) {
        (*DA_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*DA_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["DA_SSTCLR"]["SSTCLR00"] = &Cmecccap_dmdan_regif::cb_DA_SSTCLR_SSTCLR00;
    mWrCbAPI["DA_DSTCLR"]["DSTCLR00"] = &Cmecccap_dmdan_regif::cb_DA_DSTCLR_DSTCLR00;
    mWrCbAPI["DA_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_dmdan_regif::cb_DA_OVFCLR_SERROVFCLR0;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_dmdan_regif::~Cmecccap_dmdan_regif()
{
...
Cmecccap_dmdan_regif::uint Cmecccap_dmdan_regif::bit_select(
...
bool Cmecccap_dmdan_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_dmdan_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_dmdan_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                      const unsigned char *p_data,   ///< [in] Writing data
                                      cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_dmdan_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_dmdan_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                          const unsigned char *p_data,  ///< [in] Writing data
                                          cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_dmdan_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                          unsigned char *p_data,   ///< [out] Reading data
                                          cuint size,              ///< [in]  Data size (byte)
                                          bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_dmdan_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                       unsigned char *p_data,          ///< [out] Reading data
                                       cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_dmdan_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                       const unsigned char *p_data,      ///< [in] Writing data
                                       cuint size,                       ///< [in] Data size (byte)
                                       cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_dmdan_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_dmdan_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_dmdan_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_dmdan_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_dmdan_regif::InitLocalVal()
{
    // Initialize local variables
    DA_ERRINT_SEOVFIE = 0x1;
    DA_ERRINT_DEDIE = 0x1;
    DA_ERRINT_SEDIE = 0x1;
    DA_SSTCLR_SSTCLR00 = 0x0;
    DA_DSTCLR_DSTCLR00 = 0x0;
    DA_OVFCLR_SERROVFCLR1 = 0x0;
    DA_OVFCLR_SERROVFCLR0 = 0x0;
    DA_SERSTR_SEDF00 = 0x0;
    DA_DERSTR_DEDF00 = 0x0;
    DA_OVFSTR_SERROVF1 = 0x0;
    DA_OVFSTR_SERROVF0 = 0x0;
    DA_SERINF_SEDLINF00 = 0x0;
    for(uint i = 0; i < emNUM_DA_nSEADR; i++) {
        DA_nSEADR_SEDL[i] = 0x0;
        DA_nSEADR_SEADR0[i] = 0x0;
    }
    DA_00DEADR_DEDL = 0x0;
    DA_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_dmdan_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        DA_ERRINT_SEOVFIE              = (*DA_ERRINT )["SEOVFIE"   ];
        DA_ERRINT_DEDIE                = (*DA_ERRINT )["DEDIE"     ];
        DA_ERRINT_SEDIE                = (*DA_ERRINT )["SEDIE"     ];
        return;
    }
    if (addr == 0x0010) {
        DA_SSTCLR_SSTCLR00             = (*DA_SSTCLR )["SSTCLR00"  ];
        return;
    }
    if (addr == 0x0014) {
        DA_DSTCLR_DSTCLR00             = (*DA_DSTCLR )["DSTCLR00"  ];
        return;
    }
    if (addr == 0x0018) {
        DA_OVFCLR_SERROVFCLR1          = (*DA_OVFCLR )["SERROVFCLR1"];
        DA_OVFCLR_SERROVFCLR0          = (*DA_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        DA_SERSTR_SEDF00               = (*DA_SERSTR )["SEDF00"    ];
        return;
    }
    if (addr == 0x0024) {
        DA_DERSTR_DEDF00               = (*DA_DERSTR )["DEDF00"    ];
        return;
    }
    if (addr == 0x0028) {
        DA_OVFSTR_SERROVF1             = (*DA_OVFSTR )["SERROVF1"  ];
        DA_OVFSTR_SERROVF0             = (*DA_OVFSTR )["SERROVF0"  ];
        return;
    }
    if (addr == 0x0030) {
        DA_SERINF_SEDLINF00            = (*DA_SERINF )["SEDLINF00" ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        DA_nSEADR_SEDL                [i] = (*(DA_nSEADR [i]))["SEDL"      ];
        DA_nSEADR_SEADR0              [i] = (*(DA_nSEADR [i]))["SEADR0"    ];
        return;
    }
    if (addr == 0x00F0) {
        DA_00DEADR_DEDL                = (*DA_00DEADR)["DEDL"      ];
        DA_00DEADR_DEADR0              = (*DA_00DEADR)["DEADR0"    ];
        return;
    }
}
...
/// @return None
void Cmecccap_dmdan_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*DA_ERRINT )["SEOVFIE"   ] = DA_ERRINT_SEOVFIE;
        (*DA_ERRINT )["DEDIE"     ] = DA_ERRINT_DEDIE;
        (*DA_ERRINT )["SEDIE"     ] = DA_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*DA_SSTCLR )["SSTCLR00"  ] = DA_SSTCLR_SSTCLR00;
        return;
    }
    if (addr == 0x0014) {
        (*DA_DSTCLR )["DSTCLR00"  ] = DA_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*DA_OVFCLR )["SERROVFCLR1"] = DA_OVFCLR_SERROVFCLR1;
        (*DA_OVFCLR )["SERROVFCLR0"] = DA_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*DA_SERSTR )["SEDF00"    ] = DA_SERSTR_SEDF00;
        return;
    }
    if (addr == 0x0024) {
        (*DA_DERSTR )["DEDF00"    ] = DA_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*DA_OVFSTR )["SERROVF1"  ] = DA_OVFSTR_SERROVF1;
        (*DA_OVFSTR )["SERROVF0"  ] = DA_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*DA_SERINF )["SEDLINF00" ] = DA_SERINF_SEDLINF00;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(DA_nSEADR [i]))["SEDL"      ] = DA_nSEADR_SEDL[i];
        (*(DA_nSEADR [i]))["SEADR0"    ] = DA_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*DA_00DEADR)["DEDL"      ] = DA_00DEADR_DEDL;
        (*DA_00DEADR)["DEADR0"    ] = DA_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_dmdan_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_dmdan_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_dmdan_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_dmdan_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_dmdan_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_dmdan_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_dmdan_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_dmdan_regif::uint Cmecccap_dmdan_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_dmdan_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_dmdan_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_dmdan_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_dmdan_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_dmdan_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_dmdan_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_dmdan_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
