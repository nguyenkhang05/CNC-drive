// -----------------------------------------------------------------------------
// $Id: atu5011_glue_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
/// @return none
Catu5011_glue_regif::Catu5011_glue_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    mWrCbAPI["ATUINTSELA"]["ATU_INTSEL_A0"] = &Catu5011_glue_regif::cb_ATUINTSELA_ATU_INTSEL_A0;
    mWrCbAPI["ATUINTSELD7"]["ATU_INTSEL_D00"] = &Catu5011_glue_regif::cb_ATUINTSELD7_ATU_INTSEL_D00;
    mWrCbAPI["ATUDMASELB"]["ATU_DMASEL_B0"] = &Catu5011_glue_regif::cb_ATUDMASELB_ATU_DMASEL_B0;
    mWrCbAPI["ATUDMASELE"]["ATU_DMASEL_E"] = &Catu5011_glue_regif::cb_ATUDMASELE_ATU_DMASEL_E;
    mWrCbAPI["ATUDFESELD1T"]["ATU_DFESEL_D1T"] = &Catu5011_glue_regif::cb_ATUDFESELD1T_ATU_DFESEL_D1T;
    mWrCbAPI["ATUDSSELDSTS"]["ATU_DSSEL_DSTS0"] = &Catu5011_glue_regif::cb_ATUDSSELDSTS_ATU_DSSEL_DSTS0;
    mWrCbAPI["ATUCASELCATS"]["ATU_CASEL_CATS0"] = &Catu5011_glue_regif::cb_ATUCASELCATS_ATU_CASEL_CATS0;
    mWrCbAPI["ATUP5SSEL" ]["ATU_P5SSEL_TGC1"] = &Catu5011_glue_regif::cb_ATUP5SSEL_ATU_P5SSEL_TGC1;

    for(uint i = 0; i < emNUM_ATUINTSELD; i++) {
        str_tmp.str("");
        str_tmp<<"ATUINTSELD"<< i;
        mWrCbAPI[str_tmp.str()]["ATU_INTSEL_D00"] = &Catu5011_glue_regif::cb_ATUINTSELD_ATU_INTSEL_D00;
    }
    for(uint i = 0; i < emNUM_ATUDMASELCD; i++) {
        str_tmp.str("");
        str_tmp<<"ATUDMASELCD"<< i;
        mWrCbAPI[str_tmp.str()]["ATU_DMASEL_CD0"] = &Catu5011_glue_regif::cb_ATUDMASELCD_ATU_DMASEL_CD0;
    }
    for(uint i = 0; i < emNUM_ATUDFEENTQ; i++) {
        str_tmp.str("");
        str_tmp<<"ATUDFEENTQ"<< i;
        mWrCbAPI[str_tmp.str()]["ATU_DFEEN_TQ"] = &Catu5011_glue_regif::cb_ATUDFEENTQ_ATU_DFEEN_TQ;
    }
    for(uint i = 0; i < emNUM_ATUDFESEL; i++) {
        str_tmp.str("");
        str_tmp<<"ATUDFESEL"<< i;
        mWrCbAPI[str_tmp.str()]["ATU_DFESEL_D00"] = &Catu5011_glue_regif::cb_ATUDFESEL_ATU_DFESEL_D00;
    }
    InitLocalVal();
}
...
/// @return none
Catu5011_glue_regif::~Catu5011_glue_regif()
{
...
Catu5011_glue_regif::uint Catu5011_glue_regif::bit_select(
...
bool Catu5011_glue_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5011_glue_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5011_glue_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                  const unsigned char *p_data,   ///< [in] Writing data
                                  cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5011_glue_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                  unsigned char *p_data,   ///< [out] Reading data
                                  cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5011_glue_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                      const unsigned char *p_data,  ///< [in] Writing data
                                      cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5011_glue_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size,              ///< [in]  Data size (byte)
                                      bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5011_glue_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                   unsigned char *p_data,          ///< [out] Reading data
                                   cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5011_glue_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                   const unsigned char *p_data,      ///< [in] Writing data
                                   cuint size,                       ///< [in] Data size (byte)
                                   cuint reg_index,                  ///< [in] Register index
...
bool Catu5011_glue_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5011_glue_regif::CommandInit()
{
...
/// @return string
std::string Catu5011_glue_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5011_glue_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5011_glue_regif::InitLocalVal()
{
    // Initialize local variables
...
/// @return None
void Catu5011_glue_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return None
void Catu5011_glue_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
...
/// @return vector
std::vector<std::string> Catu5011_glue_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5011_glue_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5011_glue_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5011_glue_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5011_glue_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5011_glue_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5011_glue_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Catu5011_glue_regif::uint Catu5011_glue_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Catu5011_glue_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5011_glue_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5011_glue_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5011_glue_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Catu5011_glue_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Catu5011_glue_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Catu5011_glue_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
