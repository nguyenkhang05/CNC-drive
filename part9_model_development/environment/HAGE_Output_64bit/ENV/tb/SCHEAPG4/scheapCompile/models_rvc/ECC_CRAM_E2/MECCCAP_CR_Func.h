// ---------------------------------------------------------------------
// $Id: MECCCAP_CR_Func.h,v 1.1 2019/09/26 10:07:06 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __MECCCAP_CR_FUNC_H__
#define __MECCCAP_CR_FUNC_H__

#include "BusSlaveFuncIf.h"
#include "mecccap_cr_regif.h"
#include "ECC_CRAM_E2_AgentController.h"
#include "global.h"

class MECCCAP_CR_Func: public Cmecccap_cr_regif
                ,public BusSlaveFuncIf
{
public:
    SC_HAS_PROCESS (MECCCAP_CR_Func);
    MECCCAP_CR_Func(std::string name, ECC_CRAM_E2_AgentController* CRAMAgentController);
    ~MECCCAP_CR_Func();
