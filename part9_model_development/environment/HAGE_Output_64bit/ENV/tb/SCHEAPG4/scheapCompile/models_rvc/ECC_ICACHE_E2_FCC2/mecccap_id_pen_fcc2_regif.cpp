// -----------------------------------------------------------------------------
// $Id: mecccap_id_pen_fcc2_regif.cpp,v 1.4 2019/03/05 04:44:48 synguyen Exp $
//
...
//
// Input file : mecccap_id_pen_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @file mecccap_id_pen_fcc2_regif.cpp
/// @brief Register IF class of model MECCCAP_ID_PEN_FCC2
/// $Id: mecccap_id_pen_fcc2_regif.cpp,v 1.4 2019/03/05 04:44:48 synguyen Exp $
/// $Date: 2019/03/05 04:44:48 $
/// $Revison$
/// $Author: synguyen $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cmecccap_id_pen_fcc2_regif::Cmecccap_id_pen_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    ID_ERRINT  = new vpcl::re_register(0x0000, this, "ID_ERRINT" , name.c_str());
    ID_SSTCLR  = new vpcl::re_register(0x0010, this, "ID_SSTCLR" , name.c_str());
    ID_DSTCLR  = new vpcl::re_register(0x0014, this, "ID_DSTCLR" , name.c_str());
    ID_OVFCLR  = new vpcl::re_register(0x0018, this, "ID_OVFCLR" , name.c_str());
    ID_SERSTR  = new vpcl::re_register(0x0020, this, "ID_SERSTR" , name.c_str());
    ID_DERSTR  = new vpcl::re_register(0x0024, this, "ID_DERSTR" , name.c_str());
    ID_OVFSTR  = new vpcl::re_register(0x0028, this, "ID_OVFSTR" , name.c_str());
    ID_SERINF  = new vpcl::re_register(0x0030, this, "ID_SERINF" , name.c_str());
    ID_00DEADR = new vpcl::re_register(0x00F0, this, "ID_00DEADR", name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_ID_nSEADR; i++) {
        str_tmp.str("");
        str_tmp<<"ID_nSEADR"<< i;
        ID_nSEADR [i] = new vpcl::re_register((0x0070) + 4*i, this, str_tmp.str(), name.c_str());
    }
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_ID_ERRINT   , ID_ERRINT->name() , ID_ERRINT->addr() );
    cw_instantiate_reg(CW_ID_SSTCLR   , ID_SSTCLR->name() , ID_SSTCLR->addr() );
    cw_instantiate_reg(CW_ID_DSTCLR   , ID_DSTCLR->name() , ID_DSTCLR->addr() );
    cw_instantiate_reg(CW_ID_OVFCLR   , ID_OVFCLR->name() , ID_OVFCLR->addr() );
    cw_instantiate_reg(CW_ID_SERSTR   , ID_SERSTR->name() , ID_SERSTR->addr() );
    cw_instantiate_reg(CW_ID_DERSTR   , ID_DERSTR->name() , ID_DERSTR->addr() );
    cw_instantiate_reg(CW_ID_OVFSTR   , ID_OVFSTR->name() , ID_OVFSTR->addr() );
    cw_instantiate_reg(CW_ID_SERINF   , ID_SERINF->name() , ID_SERINF->addr() );
    for(uint i = 0; i < emNUM_ID_nSEADR ; i++) cw_instantiate_reg(CW_ID_nSEADR   [i], ID_nSEADR [i]->name(), ID_nSEADR [i]->addr());
    cw_instantiate_reg(CW_ID_00DEADR  , ID_00DEADR->name(), ID_00DEADR->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(ID_ERRINT   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_SSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_DSTCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_OVFCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_SERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_DERSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_OVFSTR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_SERINF   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    for(uint i = 0; i < emNUM_ID_nSEADR ; i++) mCurReg = mRegArray[index++] = new SRegList(ID_nSEADR   [i], mCurReg, i,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ID_00DEADR  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*ID_ERRINT   ) ( 3,  3, "AFEIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ID_ERRINT   ) ( 1,  1, "DEDIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ID_ERRINT   ) ( 0,  0, "SEDIE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ID_SSTCLR   ) (31,  0, "ID_SSTCLR", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*ID_DSTCLR   ) ( 0,  0, "DSTCLR00", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*ID_OVFCLR   ) ( 1,  1, "SERROVFCLR1", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*ID_OVFCLR   ) ( 0,  0, "SERROVFCLR0", 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*ID_SERSTR   ) (31,  0, "ID_SERSTR", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_DERSTR   ) ( 3,  3, "AFEF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_DERSTR   ) ( 1,  1, "DEDF00"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_OVFSTR   ) ( 1,  1, "SERROVF1", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_OVFSTR   ) ( 0,  0, "SERROVF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_SERINF   ) ( 3,  0, "SEDLINF" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_00DEADR  ) (31, 27, "DEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ID_00DEADR  ) (26,  2, "DEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_ID_nSEADR; i++) {
        (*ID_nSEADR   [i]) (31, 27, "SEDL"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
        (*ID_nSEADR   [i]) (26,  2, "SEADR0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["ID_SSTCLR"]["ID_SSTCLR"] = &Cmecccap_id_pen_fcc2_regif::cb_ID_SSTCLR_ID_SSTCLR;
    mWrCbAPI["ID_DSTCLR"]["DSTCLR00"] = &Cmecccap_id_pen_fcc2_regif::cb_ID_DSTCLR_DSTCLR00;
    mWrCbAPI["ID_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_id_pen_fcc2_regif::cb_ID_OVFCLR_SERROVFCLR0;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_id_pen_fcc2_regif::~Cmecccap_id_pen_fcc2_regif()
{
...
Cmecccap_id_pen_fcc2_regif::uint Cmecccap_id_pen_fcc2_regif::bit_select(
...
bool Cmecccap_id_pen_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_id_pen_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_id_pen_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                            const unsigned char *p_data,   ///< [in] Writing data
                                            cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_id_pen_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_id_pen_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                                const unsigned char *p_data,  ///< [in] Writing data
                                                cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_id_pen_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                                unsigned char *p_data,   ///< [out] Reading data
                                                cuint size,              ///< [in]  Data size (byte)
                                                bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_id_pen_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                             unsigned char *p_data,          ///< [out] Reading data
                                             cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_id_pen_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                             const unsigned char *p_data,      ///< [in] Writing data
                                             cuint size,                       ///< [in] Data size (byte)
                                             cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_id_pen_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_id_pen_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_id_pen_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    ID_ERRINT_AFEIE = 0x0;
    ID_ERRINT_DEDIE = 0x0;
    ID_ERRINT_SEDIE = 0x0;
    ID_SSTCLR_ID_SSTCLR = 0x0;
    ID_DSTCLR_DSTCLR00 = 0x0;
    ID_OVFCLR_SERROVFCLR1 = 0x0;
    ID_OVFCLR_SERROVFCLR0 = 0x0;
    ID_SERSTR_ID_SERSTR = 0x0;
    ID_DERSTR_AFEF00 = 0x0;
    ID_DERSTR_DEDF00 = 0x0;
    ID_OVFSTR_SERROVF1 = 0x0;
    ID_OVFSTR_SERROVF0 = 0x0;
    ID_SERINF_SEDLINF = 0x0;
    for(uint i = 0; i < emNUM_ID_nSEADR; i++) {
        ID_nSEADR_SEDL[i] = 0x0;
        ID_nSEADR_SEADR0[i] = 0x0;
    }
    ID_00DEADR_DEDL = 0x0;
    ID_00DEADR_DEADR0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cmecccap_id_pen_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        ID_ERRINT_AFEIE                = (*ID_ERRINT )["AFEIE"     ];
        ID_ERRINT_DEDIE                = (*ID_ERRINT )["DEDIE"     ];
        ID_ERRINT_SEDIE                = (*ID_ERRINT )["SEDIE"     ];
        return;
    }
    if (addr == 0x0010) {
        ID_SSTCLR_ID_SSTCLR            = (*ID_SSTCLR )["ID_SSTCLR" ];
        return;
    }
    if (addr == 0x0014) {
        ID_DSTCLR_DSTCLR00             = (*ID_DSTCLR )["DSTCLR00"  ];
        return;
    }
    if (addr == 0x0018) {
        ID_OVFCLR_SERROVFCLR1          = (*ID_OVFCLR )["SERROVFCLR1"];
        ID_OVFCLR_SERROVFCLR0          = (*ID_OVFCLR )["SERROVFCLR0"];
        return;
    }
    if (addr == 0x0020) {
        ID_SERSTR_ID_SERSTR            = (*ID_SERSTR )["ID_SERSTR" ];
        return;
    }
    if (addr == 0x0024) {
        ID_DERSTR_AFEF00               = (*ID_DERSTR )["AFEF00"    ];
        ID_DERSTR_DEDF00               = (*ID_DERSTR )["DEDF00"    ];
        return;
    }
    if (addr == 0x0028) {
        ID_OVFSTR_SERROVF1             = (*ID_OVFSTR )["SERROVF1"  ];
        ID_OVFSTR_SERROVF0             = (*ID_OVFSTR )["SERROVF0"  ];
        return;
    }
    if (addr == 0x0030) {
        ID_SERINF_SEDLINF              = (*ID_SERINF )["SEDLINF"   ];
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        ID_nSEADR_SEDL                [i] = (*(ID_nSEADR [i]))["SEDL"      ];
        ID_nSEADR_SEADR0              [i] = (*(ID_nSEADR [i]))["SEADR0"    ];
        return;
    }
    if (addr == 0x00F0) {
        ID_00DEADR_DEDL                = (*ID_00DEADR)["DEDL"      ];
        ID_00DEADR_DEADR0              = (*ID_00DEADR)["DEADR0"    ];
        return;
    }
}
...
/// @return None
void Cmecccap_id_pen_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*ID_ERRINT )["AFEIE"     ] = ID_ERRINT_AFEIE;
        (*ID_ERRINT )["DEDIE"     ] = ID_ERRINT_DEDIE;
        (*ID_ERRINT )["SEDIE"     ] = ID_ERRINT_SEDIE;
        return;
    }
    if (addr == 0x0010) {
        (*ID_SSTCLR )["ID_SSTCLR" ] = ID_SSTCLR_ID_SSTCLR;
        return;
    }
    if (addr == 0x0014) {
        (*ID_DSTCLR )["DSTCLR00"  ] = ID_DSTCLR_DSTCLR00;
        return;
    }
    if (addr == 0x0018) {
        (*ID_OVFCLR )["SERROVFCLR1"] = ID_OVFCLR_SERROVFCLR1;
        (*ID_OVFCLR )["SERROVFCLR0"] = ID_OVFCLR_SERROVFCLR0;
        return;
    }
    if (addr == 0x0020) {
        (*ID_SERSTR )["ID_SERSTR" ] = ID_SERSTR_ID_SERSTR;
        return;
    }
    if (addr == 0x0024) {
        (*ID_DERSTR )["AFEF00"    ] = ID_DERSTR_AFEF00;
        (*ID_DERSTR )["DEDF00"    ] = ID_DERSTR_DEDF00;
        return;
    }
    if (addr == 0x0028) {
        (*ID_OVFSTR )["SERROVF1"  ] = ID_OVFSTR_SERROVF1;
        (*ID_OVFSTR )["SERROVF0"  ] = ID_OVFSTR_SERROVF0;
        return;
    }
    if (addr == 0x0030) {
        (*ID_SERINF )["SEDLINF"   ] = ID_SERINF_SEDLINF;
        return;
    }
    if ((0x0070 <= addr) && (addr <= (0x0070)+(4*31)) && ((addr-0x0070)%4 == 0)) {
        uint i = (addr - 0x0070)/4;
        (*(ID_nSEADR [i]))["SEDL"      ] = ID_nSEADR_SEDL[i];
        (*(ID_nSEADR [i]))["SEADR0"    ] = ID_nSEADR_SEADR0[i];
        return;
    }
    if (addr == 0x00F0) {
        (*ID_00DEADR)["DEDL"      ] = ID_00DEADR_DEDL;
        (*ID_00DEADR)["DEADR0"    ] = ID_00DEADR_DEADR0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cmecccap_id_pen_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_id_pen_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_id_pen_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_id_pen_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_id_pen_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_id_pen_fcc2_regif::uint Cmecccap_id_pen_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_id_pen_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_id_pen_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_id_pen_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_id_pen_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
