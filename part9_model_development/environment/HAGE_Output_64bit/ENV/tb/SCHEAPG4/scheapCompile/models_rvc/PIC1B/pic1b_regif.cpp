// -----------------------------------------------------------------------------
// $Id: pic1b_regif.cpp,v 1.1 2015/08/14 12:23:30 huepham Exp $
//
...
//
// Input file : input/pic1b_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE PIC1B
//     #                   name            offset_size
...
//     %%REG    PIC0SSTSGSEL    PIC0SSTSGSEL    8|16|32  8|16|32  8       0x08    -             -           -             -            W|R     0     TRUE     W
//     %%REG    PIC0SSTOUTEN    PIC0SSTOUTEN    8|16|32  8|16|32  8       0x0C    -             -           -             -            W|R     0     TRUE     W
...
// 
// %REG_NAME PIC0SSTSGSEL
//     %%TITLE  name            upper  lower  init  access  support  callback
//     %%BIT    PIC0SSTSGSEL1   1      1      0     W|R     TRUE     -
//     %%BIT    PIC0SSTSGSEL0   0      0      0     W|R     TRUE     -
// 
// %REG_NAME PIC0SSTOUTEN
//     %%TITLE  name              upper  lower  init  access  support  callback
//     %%BIT    PIC0SSTOUTEN0     0      0      0     W|R     TRUE     W
// 
// %REG_NAME PIC0SSER0
//     %%TITLE  name        upper  lower  init  access  support  callback
...
////////////////////////////////////////////////////////////////////////////////
/// @file pic1b_regif.cpp
/// @brief Register IF class of model PIC1B
/// $Id: pic1b_regif.cpp,v 1.1 2015/08/14 12:23:30 huepham Exp $
/// $Date: 2015/08/14 12:23:30 $
/// $Revison$
/// $Author: huepham $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cpic1b_regif::Cpic1b_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    PIC0SSTSGSEL   = new vpcl::re_register(0x0008, this, "PIC0SSTSGSEL"  , name.c_str());
    PIC0SSTOUTEN   = new vpcl::re_register(0x000C, this, "PIC0SSTOUTEN"  , name.c_str());
    ...
    cw_instantiate_reg(CW_PIC0SSTSGSEL_, "PIC0SSTSGSEL_", 0x0008);
    CW_PIC0SSTSGSEL   = new scml2::bitfield<uint>(PIC0SSTSGSEL->name()  , CW_PIC0SSTSGSEL_               ,  0,  8);
    cw_instantiate_reg(CW_PIC0SSTOUTEN_, "PIC0SSTOUTEN_", 0x000C);
    CW_PIC0SSTOUTEN   = new scml2::bitfield<uint>(PIC0SSTOUTEN->name()  , CW_PIC0SSTOUTEN_               ,  0,  8);
    ...
    mCurReg = mRegArray[index++] = new SRegList(PIC0SSTSGSEL    , mCurReg, 0,  1, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PIC0SSTOUTEN    , mCurReg, 0,  1, "8|16|32", "8|16|32");
    ...
    (*PIC0SSTSGSEL    ) ( 1,  1, "PIC0SSTSGSEL1", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*PIC0SSTSGSEL    ) ( 0,  0, "PIC0SSTSGSEL0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*PIC0SSTOUTEN    ) ( 0,  0, "PIC0SSTOUTEN0", 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["PIC0EN"      ]["PIC0EN0"     ] = &Cpic1b_regif::cb_PIC0EN_PIC0EN0;
    mWrCbAPI["PIC0SST"     ]["SYNCTRG"     ] = &Cpic1b_regif::cb_PIC0SST_SYNCTRG;
    mWrCbAPI["PIC0SSTOUTEN"]["PIC0SSTOUTEN0"] = &Cpic1b_regif::cb_PIC0SSTOUTEN_PIC0SSTOUTEN0;
    mWrCbAPI["PIC0HALLSEL" ]["PIC0HALLSEL0"] = &Cpic1b_regif::cb_PIC0HALLSEL_PIC0HALLSEL0;
    mWrCbAPI["PIC0REG30"   ]["PIC0REG3000" ] = &Cpic1b_regif::cb_PIC0REG30_PIC0REG3000;
    mWrCbAPI["PIC0REG31"   ]["PIC0REG3100" ] = &Cpic1b_regif::cb_PIC0REG31_PIC0REG3100;
    mWrCbAPI["PIC0REG32"   ]["PIC0REG3200" ] = &Cpic1b_regif::cb_PIC0REG32_PIC0REG3200;
    mWrCbAPI["PIC0REG33"   ]["PIC0REG3300" ] = &Cpic1b_regif::cb_PIC0REG33_PIC0REG3300;

    for(uint i = 0; i < emNUM_PIC0INI0; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0INI0"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0INI00"] = &Cpic1b_regif::cb_PIC0INI0_PIC0INI00;
    }
    for(uint i = 0; i < emNUM_PIC0INI1; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0INI1"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0INI100"] = &Cpic1b_regif::cb_PIC0INI1_PIC0INI100;
    }
    for(uint i = 0; i < emNUM_PIC0INI2; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0INI2"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0INI20"] = &Cpic1b_regif::cb_PIC0INI2_PIC0INI20;
    }
    for(uint i = 0; i < emNUM_PIC0WNGMK; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0WNGMK"<< i;
        mWrCbAPI[str_tmp.str()]["WNGMK0"] = &Cpic1b_regif::cb_PIC0WNGMK_WNGMK0;
    }
    for(uint i = 0; i < emNUM_PIC0WNGS; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0WNGS"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0WNGS0"] = &Cpic1b_regif::cb_PIC0WNGS_PIC0WNGS0;
    }
    for(uint i = 0; i < emNUM_PIC0WNGFCLR; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0WNGFCLR"<< i;
        mWrCbAPI[str_tmp.str()]["WNGFCLR0"] = &Cpic1b_regif::cb_PIC0WNGFCLR_WNGFCLR0;
    }
    for(uint i = 0; i < emNUM_PIC0LHSEL; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0LHSEL"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0LHSEL1"] = &Cpic1b_regif::cb_PIC0LHSEL_PIC0LHSEL1;
    }
    for(uint i = 0; i < emNUM_PIC0TSGOUTCTR; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0TSGOUTCTR"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0TSGOUTCTR0"] = &Cpic1b_regif::cb_PIC0TSGOUTCTR_PIC0TSGOUTCTR0;
    }
    for(uint i = 0; i < emNUM_PIC0TAUDSEL; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0TAUDSEL"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0TAUDIN00"] = &Cpic1b_regif::cb_PIC0TAUDSEL_PIC0TAUDIN00;
    }
    for(uint i = 0; i < emNUM_PIC0HIZCEN; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0HIZCEN"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0HIZCEN0"] = &Cpic1b_regif::cb_PIC0HIZCEN_PIC0HIZCEN0;
    }
    for(uint i = 0; i < emNUM_PIC0ENCSEL40; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0ENCSEL40"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0ENCSEL403_0"] = &Cpic1b_regif::cb_PIC0ENCSEL40_PIC0ENCSEL403_0;
    }
    for(uint i = 0; i < emNUM_PIC0REG20; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG20"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG2000"] = &Cpic1b_regif::cb_PIC0REG20_PIC0REG2000;
    }
    for(uint i = 0; i < emNUM_PIC0REG21; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG21"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG2101_00"] = &Cpic1b_regif::cb_PIC0REG21_PIC0REG2101_00;
    }
    for(uint i = 0; i < emNUM_PIC0REG22; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG22"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG2200"] = &Cpic1b_regif::cb_PIC0REG22_PIC0REG2200;
    }
    for(uint i = 0; i < emNUM_PIC0REG23; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG23"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG2302_00"] = &Cpic1b_regif::cb_PIC0REG23_PIC0REG2302_00;
    }
    for(uint i = 0; i < emNUM_PIC0REG24; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG24"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG2400"] = &Cpic1b_regif::cb_PIC0REG24_PIC0REG2400;
    }
    for(uint i = 0; i < emNUM_PIC0REG5; i++) {
        str_tmp.str("");
        str_tmp<<"PIC0REG5"<< i;
        mWrCbAPI[str_tmp.str()]["PIC0REG500"] = &Cpic1b_regif::cb_PIC0REG5_PIC0REG500;
    }
    InitLocalVal();
}
...
Cpic1b_regif::uint Cpic1b_regif::bit_select(
...
bool Cpic1b_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cpic1b_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cpic1b_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                              const unsigned char *p_data,   ///< [in] Writing data
                              cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cpic1b_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                              unsigned char *p_data,   ///< [out] Reading data
                              cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cpic1b_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                  const unsigned char *p_data,  ///< [in] Writing data
                                  cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cpic1b_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                  unsigned char *p_data,   ///< [out] Reading data
                                  cuint size,              ///< [in]  Data size (byte)
                                  bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cpic1b_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                               unsigned char *p_data,          ///< [out] Reading data
                               cuint size,                     ///< [in]  Data size (byte)
...
bool Cpic1b_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                               const unsigned char *p_data,      ///< [in] Writing data
                               cuint size,                       ///< [in] Data size (byte)
                               cuint reg_index,                  ///< [in] Register index
...
bool Cpic1b_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return string
std::string Cpic1b_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cpic1b_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cpic1b_regif::InitLocalVal()
{
    // Initialize local variables
    PIC0EN_PIC0EN0    = 0x0;
    PIC0SST_SYNCTRG   = 0x0;
    PIC0SSTSGSEL_PIC0SSTSGSEL1 = 0x0;
    PIC0SSTSGSEL_PIC0SSTSGSEL0 = 0x0;
    PIC0SSTOUTEN_PIC0SSTOUTEN0 = 0x0;
...
/// @return None
void Cpic1b_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
    ...
    if (addr == 0x0008) {
        PIC0SSTSGSEL_PIC0SSTSGSEL1         = (*PIC0SSTSGSEL  )["PIC0SSTSGSEL1" ];
        PIC0SSTSGSEL_PIC0SSTSGSEL0         = (*PIC0SSTSGSEL  )["PIC0SSTSGSEL0" ];
        return;
    }
    if (addr == 0x000C) {
        PIC0SSTOUTEN_PIC0SSTOUTEN0         = (*PIC0SSTOUTEN  )["PIC0SSTOUTEN0" ];
        return;
    }
    if (addr == 0x0010) {
...
/// @return None
void Cpic1b_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
    ...
    if (addr == 0x0008) {
        (*PIC0SSTSGSEL  )["PIC0SSTSGSEL1" ] = PIC0SSTSGSEL_PIC0SSTSGSEL1;
        (*PIC0SSTSGSEL  )["PIC0SSTSGSEL0" ] = PIC0SSTSGSEL_PIC0SSTSGSEL0;
        return;
    }
    if (addr == 0x000C) {
        (*PIC0SSTOUTEN  )["PIC0SSTOUTEN0" ] = PIC0SSTOUTEN_PIC0SSTOUTEN0;
        return;
    }
    if (addr == 0x0010) {
...
/// @return vector
std::vector<std::string> Cpic1b_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cpic1b_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cpic1b_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cpic1b_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cpic1b_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cpic1b_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cpic1b_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cpic1b_regif::uint Cpic1b_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cpic1b_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cpic1b_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cpic1b_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cpic1b_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cpic1b_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cpic1b_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cpic1b_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
