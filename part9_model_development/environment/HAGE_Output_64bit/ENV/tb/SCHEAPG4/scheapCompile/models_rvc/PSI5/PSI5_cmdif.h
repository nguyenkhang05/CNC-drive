// -----------------------------------------------------------------------------
// $Id: PSI5_cmdif.h,v 1.2 2020/04/03 11:08:05 ducla Exp $
//
...
#endif // ClearProfile
#if 0 // AssertReset
    ret += "    AssertReset <start_time> <period>         Assert and de-assert reset signal to a target model\n";
#endif // AssertReset
#if 0 // EnableDumpResult
...
#ifndef print_msg
#define print_msg get_fileline(__FILE__, __LINE__); mPSI5_Agent->_re_printf
#endif//re_printf
