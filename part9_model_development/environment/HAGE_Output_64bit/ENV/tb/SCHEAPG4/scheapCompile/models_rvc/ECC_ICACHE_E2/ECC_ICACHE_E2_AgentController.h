// ---------------------------------------------------------------------
// $Id: ECC_ICACHE_E2_AgentController.h,v 1.1 2019/09/26 10:07:26 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ECC_ICACHE_E2_AGENT_CONTROLLER_H__
#define __ECC_ICACHE_E2_AGENT_CONTROLLER_H__
#include <systemc.h>
#include <iostream>
#include <cstring>
#include <iterator>
...
// Class ECC_ICACHE_E2_AgentController
class ECC_ICACHE_E2_AgentController
{
#include "ECC_ICACHE_E2_cmdif.h"
public:
    // Constructor/Destructor
    ECC_ICACHE_E2_AgentController(void) {;}
    virtual ~ECC_ICACHE_E2_AgentController(void) {;}
...
#endif //__ECC_ICACHE_E2_AGENT_CONTROLLER_H__
