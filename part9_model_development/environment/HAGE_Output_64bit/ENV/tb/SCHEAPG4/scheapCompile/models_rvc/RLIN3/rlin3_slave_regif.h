...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __RLIN3_SLAVE_REGIF_H__
#define __RLIN3_SLAVE_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of RLIN3_SLAVE model
class Crlin3_slave_regif
...
protected:
    ...
    typedef void (Crlin3_slave_regif::* ptrRegValueIDFunc) (std::string);
    ptrRegValueIDFunc mNotifyRegValueIDAPI;
    virtual void NotifyRegValueID(const std::string reg_val_id) = 0;
#endif

public:
    Crlin3_slave_regif(std::string name, uint buswidth);
    ~Crlin3_slave_regif();
...
protected:
    ...
    virtual void cb_LBFC_LBLT(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Crlin3_slave_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Crlin3_slave_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__RLIN3_SLAVE_REG_DEF_H__
