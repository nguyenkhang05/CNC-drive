// -----------------------------------------------------------------------------
// $Id: atu5_timera_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERA_REGIF_H__
#define __ATU5_TIMERA_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERA model
class Catu5_timera_regif
...
public:
    Catu5_timera_regif(std::string name, uint buswidth);
    ~Catu5_timera_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timera_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timera_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5_TIMERA_REG_DEF_H__
