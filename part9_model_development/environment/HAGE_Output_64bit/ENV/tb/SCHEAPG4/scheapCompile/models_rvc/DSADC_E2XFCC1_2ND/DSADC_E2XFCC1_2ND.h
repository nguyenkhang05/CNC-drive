// ---------------------------------------------------------------------
// $Id: DSADC_E2XFCC1_2ND.h 1398 2019-11-26 06:16:27Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __DSADC_E2XFCC1_2ND_H__
#define __DSADC_E2XFCC1_2ND_H__
...
class DSADC_E2XFCC1_2ND_Func;

class DSADC_E2XFCC1_2ND: public sc_module,
            public DSADC_E2XFCC1_2ND_AgentController,
            public rvc_common_model,
            public BusSlaveBase<32,1>
{
private:
    
    DSADC_E2XFCC1_2ND_Func *mDSADC_E2XFCC1_2ND_Func;           /// DSADC_E2XFCC1_2ND_Func class instance
    ...
    double mCLK_FosSyncTPoint;                                 /// The time point at which active edge of cloc
...
public:
    ...
    /// Socket declaration
    TlmTargetSocket<32> *ts;        /// For DSADC_E2XFCC1_2ND's registers
    /// add by trong
    ...
    SC_HAS_PROCESS (DSADC_E2XFCC1_2ND);
    DSADC_E2XFCC1_2ND (sc_module_name name,
          unsigned int rLatency,
          unsigned int wLatency);
    ~DSADC_E2XFCC1_2ND (void);
...
private:
    ...
    /// Virtual functions of DSADC_E2XFCC1_2ND_AgentController class
