// -----------------------------------------------------------------------------
// $Id: mecccap_cr_regif.cpp,v 1.2 2019/10/15 06:48:32 landang Exp $
//
...
/// @return none
Cmecccap_cr_regif::Cmecccap_cr_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    ...
    #endif
{
    ...
    (*CR_ERRINT   ) ( 2,  2, "RESERVED", 0x1       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["CR_SSTCLR"]["CR_SSTCLR"] = &Cmecccap_cr_regif::cb_CR_SSTCLR_CR_SSTCLR;
    mWrCbAPI["CR_DSTCLR"]["DSTCLR00"] = &Cmecccap_cr_regif::cb_CR_DSTCLR_DSTCLR00;
    mWrCbAPI["CR_OVFCLR"]["SERROVFCLR0"] = &Cmecccap_cr_regif::cb_CR_OVFCLR_SERROVFCLR0;
    mWrCbAPI["CR_ERMSA0"]["ERMSA"   ] = &Cmecccap_cr_regif::cb_CR_ERMSA0_ERMSA;
    mWrCbAPI["CR_ERMEA0"]["ERMEA"   ] = &Cmecccap_cr_regif::cb_CR_ERMEA0_ERMEA;
    mWrCbAPI["CR_ERMSA1"]["ERMSA"   ] = &Cmecccap_cr_regif::cb_CR_ERMSA1_ERMSA;
    mWrCbAPI["CR_ERMEA1"]["ERMEA"   ] = &Cmecccap_cr_regif::cb_CR_ERMEA1_ERMEA;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cmecccap_cr_regif::~Cmecccap_cr_regif()
{
...
Cmecccap_cr_regif::uint Cmecccap_cr_regif::bit_select(
...
bool Cmecccap_cr_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cmecccap_cr_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cr_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                   const unsigned char *p_data,   ///< [in] Writing data
                                   cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cr_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                   unsigned char *p_data,   ///< [out] Reading data
                                   cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cmecccap_cr_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                       const unsigned char *p_data,  ///< [in] Writing data
                                       cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cmecccap_cr_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size,              ///< [in]  Data size (byte)
                                       bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cmecccap_cr_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                    unsigned char *p_data,          ///< [out] Reading data
                                    cuint size,                     ///< [in]  Data size (byte)
...
bool Cmecccap_cr_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                    const unsigned char *p_data,      ///< [in] Writing data
                                    cuint size,                       ///< [in] Data size (byte)
                                    cuint reg_index,                  ///< [in] Register index
...
bool Cmecccap_cr_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cmecccap_cr_regif::CommandInit()
{
...
/// @return string
std::string Cmecccap_cr_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cmecccap_cr_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cmecccap_cr_regif::InitLocalVal()
{
    // Initialize local variables
    CR_ERRINT_SEOVFIE = 0x1;
    CR_ERRINT_AFEIE = 0x1;
    CR_ERRINT_RESERVED = 0x1;
    CR_ERRINT_DEDIE = 0x1;
    CR_ERRINT_SEDIE = 0x1;
...
/// @return None
void Cmecccap_cr_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CR_ERRINT_SEOVFIE              = (*CR_ERRINT )["SEOVFIE"   ];
        CR_ERRINT_AFEIE                = (*CR_ERRINT )["AFEIE"     ];
        CR_ERRINT_RESERVED             = (*CR_ERRINT )["RESERVED"  ];
...
/// @return None
void Cmecccap_cr_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CR_ERRINT )["SEOVFIE"   ] = CR_ERRINT_SEOVFIE;
        (*CR_ERRINT )["AFEIE"     ] = CR_ERRINT_AFEIE;
        (*CR_ERRINT )["RESERVED"  ] = CR_ERRINT_RESERVED;
...
/// @return vector
std::vector<std::string> Cmecccap_cr_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cmecccap_cr_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cmecccap_cr_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cmecccap_cr_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cmecccap_cr_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cmecccap_cr_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cmecccap_cr_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cmecccap_cr_regif::uint Cmecccap_cr_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cmecccap_cr_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cmecccap_cr_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cmecccap_cr_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cmecccap_cr_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cmecccap_cr_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cmecccap_cr_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cmecccap_cr_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
