// -----------------------------------------------------------------------------
// $Id: ecc_bus_mer_ad_regif.cpp,v 1.11 2020/04/01 06:41:19 thunguyen3 Exp $
//
...
//
// Input file : ecc_bus_mer_ad_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecc_bus_mer_ad
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  9 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name        reg_name      wsize   rsize      length offset   access   init   support  callback
//     %%REG      ECCCTL      ECCCTL        8|16|32 8|16|32    32     0x00     R|W      0x8     TRUE     -
//     %%REG      ERRINT      ERRINT        8|16|32 8|16|32    32     0x04     R|W      0x33    TRUE     -
//     %%REG      STCLR       STCLR         8|16|32 8|16|32    32     0x08     R|W      0x0     TRUE     -
//     %%REG      ERSTR       1STERSTR      -       8|16|32    32     0x10     R        0x0     TRUE     -
//     %%REG      KCPROT      KCPROT        32      8|16|32    32     0x15C    R|W      0x0     TRUE     -
// 
//     
// %REG_NAME ECCCTL
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    RESERVED           3       3       1       R       TRUE        -
...
//     %%BIT    SEDIE              0       0       1       R|W     TRUE        W
// 
// %REG_NAME STCLR
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    STCLR0             0       0       0       R|W   TRUE        W
// 
// %REG_NAME ERSTR
//     %%TITLE  name               upper   lower   init    access  support     callback
...
////////////////////////////////////////////////////////////////////////////////
/// @file ecc_bus_mer_ad_regif.cpp
/// @brief Register IF class of model ECC_BUS_MER_AD
/// $Id: ecc_bus_mer_ad_regif.cpp,v 1.11 2020/04/01 06:41:19 thunguyen3 Exp $
...
/// @return none
Cecc_bus_mer_ad_regif::Cecc_bus_mer_ad_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x160/4))
    #endif
{
    CommandInit();
    ...
    ERSTR  = new vpcl::re_register(0x0010, this, "1STERSTR", name.c_str());
    KCPROT = new vpcl::re_register(0x015C, this, "KCPROT", name.c_str());
    ...
    cw_instantiate_reg(CW_ERSTR   , ERSTR->name() , ERSTR->addr() );
    cw_instantiate_reg(CW_KCPROT  , KCPROT->name(), KCPROT->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(ECCCTL  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ERRINT  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(STCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ERSTR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(KCPROT  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*ECCCTL  ) ( 3,  3, "RESERVED", 0x1       , "R"     , vpcl::SPP_ENABLE);
    (*ECCCTL  ) ( 2,  2, "AECCDIS" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ECCCTL  ) ( 1,  1, "SECDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ECCCTL  ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ERRINT  ) ( 5,  5, "ADEDIE"  , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*ERRINT  ) ( 4,  4, "ASEDIE"  , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*ERRINT  ) ( 1,  1, "DEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*ERRINT  ) ( 0,  0, "SEDIE"   , 0x1       , "R|W"   , vpcl::SPP_ENABLE);
    (*STCLR   ) ( 0,  0, "STCLR0"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ERSTR   ) ( 7,  7, "AECDEDF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ERSTR   ) ( 6,  6, "AECSEDF0", 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ERSTR   ) ( 1,  1, "DEDF0"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*ERSTR   ) ( 0,  0, "SEDF0"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*KCPROT  ) (31,  1, "KCPROT"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*KCPROT  ) ( 0,  0, "KCE"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["ECCCTL"]["ECCDIS"] = &Cecc_bus_mer_ad_regif::cb_ECCCTL_ECCDIS;
    mWrCbAPI["ERRINT"]["SEDIE"] = &Cecc_bus_mer_ad_regif::cb_ERRINT_SEDIE;
    mWrCbAPI["STCLR"]["STCLR0"] = &Cecc_bus_mer_ad_regif::cb_STCLR_STCLR0;
    mWrCbAPI["KCPROT"]["KCE" ] = &Cecc_bus_mer_ad_regif::cb_KCPROT_KCE;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecc_bus_mer_ad_regif::~Cecc_bus_mer_ad_regif()
{
...
Cecc_bus_mer_ad_regif::uint Cecc_bus_mer_ad_regif::bit_select(
...
bool Cecc_bus_mer_ad_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecc_bus_mer_ad_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_mer_ad_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_mer_ad_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_mer_ad_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_mer_ad_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecc_bus_mer_ad_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Cecc_bus_mer_ad_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Cecc_bus_mer_ad_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecc_bus_mer_ad_regif::CommandInit()
{
...
/// @return string
std::string Cecc_bus_mer_ad_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecc_bus_mer_ad_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecc_bus_mer_ad_regif::InitLocalVal()
{
    // Initialize local variables
    ECCCTL_RESERVED = 0x1;
    ECCCTL_AECCDIS = 0x0;
...
/// @return None
void Cecc_bus_mer_ad_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        ECCCTL_RESERVED            = (*ECCCTL)["RESERVED"];
    ...
    if (addr == 0x0010) {
        ERSTR_AECDEDF0             = (*ERSTR )["AECDEDF0"];
        ERSTR_AECSEDF0             = (*ERSTR )["AECSEDF0"];
        ERSTR_DEDF0                = (*ERSTR )["DEDF0" ];
        ERSTR_SEDF0                = (*ERSTR )["SEDF0" ];
        return;
    }
    if (addr == 0x015C) {
        KCPROT_KCPROT              = (*KCPROT)["KCPROT"];
        KCPROT_KCE                 = (*KCPROT)["KCE"   ];
        return;
    }
}
...
/// @return None
void Cecc_bus_mer_ad_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*ECCCTL)["RESERVED"] = ECCCTL_RESERVED;
    ...
    if (addr == 0x0010) {
        (*ERSTR )["AECDEDF0"] = ERSTR_AECDEDF0;
        (*ERSTR )["AECSEDF0"] = ERSTR_AECSEDF0;
        (*ERSTR )["DEDF0" ] = ERSTR_DEDF0;
        (*ERSTR )["SEDF0" ] = ERSTR_SEDF0;
        return;
    }
    if (addr == 0x015C) {
        (*KCPROT)["KCPROT"] = KCPROT_KCPROT;
        (*KCPROT)["KCE"   ] = KCPROT_KCE;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecc_bus_mer_ad_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecc_bus_mer_ad_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecc_bus_mer_ad_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecc_bus_mer_ad_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecc_bus_mer_ad_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecc_bus_mer_ad_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecc_bus_mer_ad_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Cecc_bus_mer_ad_regif::uint Cecc_bus_mer_ad_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Cecc_bus_mer_ad_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecc_bus_mer_ad_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecc_bus_mer_ad_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecc_bus_mer_ad_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Cecc_bus_mer_ad_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecc_bus_mer_ad_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecc_bus_mer_ad_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
