// -----------------------------------------------------------------------------
// $Id: g4_pegcap_u2a_regif.cpp,v 1.6 2020/01/14 02:39:30 nhutminhdang Exp $
//
...
//
// Input file : ../../input/g4_peg/g4_pegcap_u2a_regif.txt
////////////////////////////////////////////////////////////////////////////////
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file g4_pegcap_u2a_regif.cpp
/// @brief Register IF class of model G4_PEGCAP_U2A
/// $Id: g4_pegcap_u2a_regif.cpp,v 1.6 2020/01/14 02:39:30 nhutminhdang Exp $
...
/// @return none
Cg4_pegcap_u2a_regif::Cg4_pegcap_u2a_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x18/4))
    #endif
{
    CommandInit();
    PEGOVFCLR      = new vpcl::re_register(0x0000, this, "PEGOVFCLR"     , name.c_str());
    PEGOVFSTAT     = new vpcl::re_register(0x0004, this, "PEGOVFSTAT"    , name.c_str());
    PEGERRADDR     = new vpcl::re_register(0x0008, this, "PEGERRADDR"    , name.c_str());
    PEGERRTYPE     = new vpcl::re_register(0x000C, this, "PEGERRTYPE"    , name.c_str());
    PEGSPIDERRCLR  = new vpcl::re_register(0x0010, this, "PEGSPIDERRCLR" , name.c_str());
    PEGSPIDERRSTAT = new vpcl::re_register(0x0014, this, "PEGSPIDERRSTAT", name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_PEGOVFCLR       , PEGOVFCLR->name()     , PEGOVFCLR->addr()     );
    cw_instantiate_reg(CW_PEGOVFSTAT      , PEGOVFSTAT->name()    , PEGOVFSTAT->addr()    );
    cw_instantiate_reg(CW_PEGERRADDR      , PEGERRADDR->name()    , PEGERRADDR->addr()    );
    cw_instantiate_reg(CW_PEGERRTYPE      , PEGERRTYPE->name()    , PEGERRTYPE->addr()    );
    cw_instantiate_reg(CW_PEGSPIDERRCLR   , PEGSPIDERRCLR->name() , PEGSPIDERRCLR->addr() );
    cw_instantiate_reg(CW_PEGSPIDERRSTAT  , PEGSPIDERRSTAT->name(), PEGSPIDERRSTAT->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(PEGOVFCLR       , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PEGOVFSTAT      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PEGERRADDR      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PEGERRTYPE      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PEGSPIDERRCLR   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PEGSPIDERRSTAT  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*PEGOVFCLR       ) ( 1,  1, "CLRO"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PEGOVFSTAT      ) ( 1,  1, "OVF"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRADDR      ) (31,  0, "ADDR"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRTYPE      ) (13, 13, "SEC"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRTYPE      ) (12, 12, "DBG"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRTYPE      ) (11, 11, "UM"      , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRTYPE      ) (10,  6, "SPID"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGERRTYPE      ) ( 0,  0, "WRITE"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PEGSPIDERRCLR   ) (31,  0, "SPIDCLR" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PEGSPIDERRSTAT  ) (31,  0, "SPIDERR" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["PEGOVFCLR"   ]["CLRO"        ] = &Cg4_pegcap_u2a_regif::cb_PEGOVFCLR_CLRO;
    mWrCbAPI["PEGSPIDERRCLR"]["SPIDCLR"     ] = &Cg4_pegcap_u2a_regif::cb_PEGSPIDERRCLR_SPIDCLR;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cg4_pegcap_u2a_regif::~Cg4_pegcap_u2a_regif()
{
...
Cg4_pegcap_u2a_regif::uint Cg4_pegcap_u2a_regif::bit_select(
...
bool Cg4_pegcap_u2a_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cg4_pegcap_u2a_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cg4_pegcap_u2a_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                      const unsigned char *p_data,   ///< [in] Writing data
                                      cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cg4_pegcap_u2a_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cg4_pegcap_u2a_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                          const unsigned char *p_data,  ///< [in] Writing data
                                          cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cg4_pegcap_u2a_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                          unsigned char *p_data,   ///< [out] Reading data
                                          cuint size,              ///< [in]  Data size (byte)
                                          bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cg4_pegcap_u2a_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                       unsigned char *p_data,          ///< [out] Reading data
                                       cuint size,                     ///< [in]  Data size (byte)
...
bool Cg4_pegcap_u2a_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                       const unsigned char *p_data,      ///< [in] Writing data
                                       cuint size,                       ///< [in] Data size (byte)
                                       cuint reg_index,                  ///< [in] Register index
...
bool Cg4_pegcap_u2a_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cg4_pegcap_u2a_regif::CommandInit()
{
...
/// @return string
std::string Cg4_pegcap_u2a_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cg4_pegcap_u2a_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cg4_pegcap_u2a_regif::InitLocalVal()
{
    // Initialize local variables
    PEGOVFCLR_CLRO = 0x0;
    PEGOVFSTAT_OVF = 0x0;
    ...
    PEGERRTYPE_UM  = 0x0;
    PEGERRTYPE_SPID = 0x0;
    PEGERRTYPE_WRITE = 0x0;
    PEGSPIDERRCLR_SPIDCLR = 0x0;
    PEGSPIDERRSTAT_SPIDERR = 0x0;
}

/// Update bit value to local value
/// @return None
void Cg4_pegcap_u2a_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        PEGOVFCLR_CLRO                     = (*PEGOVFCLR     )["CLRO"          ];
        return;
    }
    if (addr == 0x0004) {
        PEGOVFSTAT_OVF                     = (*PEGOVFSTAT    )["OVF"           ];
        return;
    }
    if (addr == 0x0008) {
        PEGERRADDR_ADDR                    = (*PEGERRADDR    )["ADDR"          ];
        return;
    }
    if (addr == 0x000C) {
        PEGERRTYPE_SEC                     = (*PEGERRTYPE    )["SEC"           ];
        PEGERRTYPE_DBG                     = (*PEGERRTYPE    )["DBG"           ];
        PEGERRTYPE_UM                      = (*PEGERRTYPE    )["UM"            ];
        PEGERRTYPE_SPID                    = (*PEGERRTYPE    )["SPID"          ];
        PEGERRTYPE_WRITE                   = (*PEGERRTYPE    )["WRITE"         ];
        return;
    }
    if (addr == 0x0010) {
        PEGSPIDERRCLR_SPIDCLR              = (*PEGSPIDERRCLR )["SPIDCLR"       ];
        return;
    }
    if (addr == 0x0014) {
        PEGSPIDERRSTAT_SPIDERR             = (*PEGSPIDERRSTAT)["SPIDERR"       ];
        return;
    }
}
...
/// @return None
void Cg4_pegcap_u2a_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*PEGOVFCLR     )["CLRO"          ] = PEGOVFCLR_CLRO;
        return;
    }
    if (addr == 0x0004) {
        (*PEGOVFSTAT    )["OVF"           ] = PEGOVFSTAT_OVF;
        return;
    }
    if (addr == 0x0008) {
        (*PEGERRADDR    )["ADDR"          ] = PEGERRADDR_ADDR;
        return;
    }
    if (addr == 0x000C) {
        (*PEGERRTYPE    )["SEC"           ] = PEGERRTYPE_SEC;
        (*PEGERRTYPE    )["DBG"           ] = PEGERRTYPE_DBG;
        (*PEGERRTYPE    )["UM"            ] = PEGERRTYPE_UM;
        (*PEGERRTYPE    )["SPID"          ] = PEGERRTYPE_SPID;
        (*PEGERRTYPE    )["WRITE"         ] = PEGERRTYPE_WRITE;
        return;
    }
    if (addr == 0x0010) {
        (*PEGSPIDERRCLR )["SPIDCLR"       ] = PEGSPIDERRCLR_SPIDCLR;
        return;
    }
    if (addr == 0x0014) {
        (*PEGSPIDERRSTAT)["SPIDERR"       ] = PEGSPIDERRSTAT_SPIDERR;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cg4_pegcap_u2a_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cg4_pegcap_u2a_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cg4_pegcap_u2a_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cg4_pegcap_u2a_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cg4_pegcap_u2a_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cg4_pegcap_u2a_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cg4_pegcap_u2a_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Cg4_pegcap_u2a_regif::uint Cg4_pegcap_u2a_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Cg4_pegcap_u2a_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cg4_pegcap_u2a_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cg4_pegcap_u2a_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cg4_pegcap_u2a_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Cg4_pegcap_u2a_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cg4_pegcap_u2a_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cg4_pegcap_u2a_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
