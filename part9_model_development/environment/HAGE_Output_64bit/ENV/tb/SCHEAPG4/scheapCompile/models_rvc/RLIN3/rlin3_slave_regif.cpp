...
//    regif_cpp.skl
//
// Input file : /shsv/sld/ipp/project/2018/rel/ipd2_sld_12006_rlin3/02_Output/DATA/src/rlin3_slave_regif.txt
////////////////////////////////////////////////////////////////////////////////
// # ---------------------------------------------------------------------
// # $Id: $
// #
...
//     %%BIT    TERE           2      2      0     R|W     TRUE     -   
//     %%BIT    FERE           3      3      0     R|W     TRUE     -     
//     %%BIT    LTES           7      7      0     R|W     TRUE     -   
//     %%BIT    SFERE          4      4      0     R|W     TRUE     -  
//     %%BIT    IPERE          6      6      0     R|W     TRUE     -  
// 
// %REG_NAME LCUC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
...
//     %%BIT    TER            2      2      0     R|W0    TRUE     -    
//     %%BIT    SFER           4      4      0     R|W0    TRUE     -    
//     %%BIT    IPER           6      6      0     R|W0    TRUE     -    
// 
// %REG_NAME LDFC      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    RFDL           3      0      0     R|W     TRUE     R|W      
//     %%BIT    LSS            7      7      0     R|W     TRUE     -      
//     %%BIT    RCDS           4      4      0     R|W     TRUE     -     
//     %%BIT    LCS            5      5      0     R|W     TRUE     -     
// 
// %REG_NAME LIDB      
//     %%TITLE  name           upper  lower  init  access  support  callback    
...
// %REG_NAME LBSS      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    BRKC           0      0      0     R|W0    TRUE     -    
//     %%BIT    SYCC           1      1      0     R|W0    TRUE     -    
// 
// %REG_NAME LRSS      
//     %%TITLE  name           upper  lower  init  access  support  callback    
//     %%BIT    RSDD           0      0      0     R       TRUE     -    
////////////////////////////////////////////////////////////////////////////////
/// @file rlin3_slave_regif.cpp
/// @brief Register IF class of model RLIN3_SLAVE
/// $Id$
/// $Date$
/// $Revison$
/// $Author$
...
/// @return none
Crlin3_slave_regif::Crlin3_slave_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    ...
    #endif
{
    ...
    (*LBFC    ) ( 0,  0, "LBLT"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LEDE    ) ( 2,  2, "TERE"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 3,  3, "FERE"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 7,  7, "LTES"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 4,  4, "SFERE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LEDE    ) ( 6,  6, "IPERE"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LTRC    ) ( 2,  2, "LNRR"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LEST    ) ( 2,  2, "TER"     , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 4,  4, "SFER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LEST    ) ( 6,  6, "IPER"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 3,  0, "RFDL"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 7,  7, "LSS"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 4,  4, "RCDS"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LDFC    ) ( 5,  5, "LCS"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    (*LBSS    ) ( 0,  0, "BRKC"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    (*LBSS    ) ( 1,  1, "SYCC"    , 0x0       , "R|W0"  , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["LWBR"]["LWBR0"] = &Crlin3_slave_regif::cb_LWBR_LWBR0;
    mWrCbAPI["LBRP0"]["BRP" ] = &Crlin3_slave_regif::cb_LBRP0_BRP;
    mWrCbAPI["LBRP1"]["BRP" ] = &Crlin3_slave_regif::cb_LBRP1_BRP;
    mWrCbAPI["LSTC"]["LSTM"] = &Crlin3_slave_regif::cb_LSTC_LSTM;
    mWrCbAPI["LMD" ]["LMD" ] = &Crlin3_slave_regif::cb_LMD_LMD;
    mWrCbAPI["LBFC"]["LBLT"] = &Crlin3_slave_regif::cb_LBFC_LBLT;
    mWrCbAPI["LSC" ]["IBHS"] = &Crlin3_slave_regif::cb_LSC_IBHS;
    mWrCbAPI["LWUP"]["WUTL"] = &Crlin3_slave_regif::cb_LWUP_WUTL;
    mWrCbAPI["LIE" ]["FTCIE"] = &Crlin3_slave_regif::cb_LIE_FTCIE;
    mWrCbAPI["LEDE"]["BERE"] = &Crlin3_slave_regif::cb_LEDE_BERE;
    mWrCbAPI["LCUC"]["OM0" ] = &Crlin3_slave_regif::cb_LCUC_OM0;
    mWrCbAPI["LTRC"]["FTS" ] = &Crlin3_slave_regif::cb_LTRC_FTS;
    mWrCbAPI["LMST"]["OMM0"] = &Crlin3_slave_regif::cb_LMST_OMM0;
    mWrCbAPI["LST" ]["FTC" ] = &Crlin3_slave_regif::cb_LST_FTC;
    mWrCbAPI["LEST"]["BER" ] = &Crlin3_slave_regif::cb_LEST_BER;
    mWrCbAPI["LDFC"]["RFDL"] = &Crlin3_slave_regif::cb_LDFC_RFDL;
    mWrCbAPI["LIDB"]["ID"  ] = &Crlin3_slave_regif::cb_LIDB_ID;
    mWrCbAPI["LCBR"]["CKSM"] = &Crlin3_slave_regif::cb_LCBR_CKSM;
    mWrCbAPI["LUDB0"]["UDB" ] = &Crlin3_slave_regif::cb_LUDB0_UDB;
    mWrCbAPI["LDB1"]["LDB" ] = &Crlin3_slave_regif::cb_LDB1_LDB;
    mWrCbAPI["LDB2"]["LDB" ] = &Crlin3_slave_regif::cb_LDB2_LDB;
    mWrCbAPI["LDB3"]["LDB" ] = &Crlin3_slave_regif::cb_LDB3_LDB;
    mWrCbAPI["LDB4"]["LDB" ] = &Crlin3_slave_regif::cb_LDB4_LDB;
    mWrCbAPI["LDB5"]["LDB" ] = &Crlin3_slave_regif::cb_LDB5_LDB;
    mWrCbAPI["LDB6"]["LDB" ] = &Crlin3_slave_regif::cb_LDB6_LDB;
    mWrCbAPI["LDB7"]["LDB" ] = &Crlin3_slave_regif::cb_LDB7_LDB;
    mWrCbAPI["LDB8"]["LDB" ] = &Crlin3_slave_regif::cb_LDB8_LDB;
    mWrCbAPI["LUOER"]["UTOE"] = &Crlin3_slave_regif::cb_LUOER_UTOE;
    mWrCbAPI["LUOR1"]["UEBE"] = &Crlin3_slave_regif::cb_LUOR1_UEBE;
    mWrCbAPI["LUTDR"]["UTD" ] = &Crlin3_slave_regif::cb_LUTDR_UTD;
    mWrCbAPI["LURDR"]["URD" ] = &Crlin3_slave_regif::cb_LURDR_URD;
    mWrCbAPI["LUWTDR"]["UWTD"] = &Crlin3_slave_regif::cb_LUWTDR_UWTD;

    mRdCbAPI["LWBR"]["LWBR0"] = &Crlin3_slave_regif::cb_LWBR_LWBR0;
    mRdCbAPI["LBRP0"]["BRP" ] = &Crlin3_slave_regif::cb_LBRP0_BRP;
    mRdCbAPI["LBRP1"]["BRP" ] = &Crlin3_slave_regif::cb_LBRP1_BRP;
    mRdCbAPI["LSTC"]["LSTM"] = &Crlin3_slave_regif::cb_LSTC_LSTM;
    mRdCbAPI["LMD" ]["LMD" ] = &Crlin3_slave_regif::cb_LMD_LMD;
    mRdCbAPI["LBFC"]["LBLT"] = &Crlin3_slave_regif::cb_LBFC_LBLT;
    mRdCbAPI["LSC" ]["IBHS"] = &Crlin3_slave_regif::cb_LSC_IBHS;
    mRdCbAPI["LWUP"]["WUTL"] = &Crlin3_slave_regif::cb_LWUP_WUTL;
    mRdCbAPI["LIE" ]["FTCIE"] = &Crlin3_slave_regif::cb_LIE_FTCIE;
    mRdCbAPI["LEDE"]["BERE"] = &Crlin3_slave_regif::cb_LEDE_BERE;
    mRdCbAPI["LCUC"]["OM0" ] = &Crlin3_slave_regif::cb_LCUC_OM0;
    mRdCbAPI["LTRC"]["FTS" ] = &Crlin3_slave_regif::cb_LTRC_FTS;
    mRdCbAPI["LMST"]["OMM0"] = &Crlin3_slave_regif::cb_LMST_OMM0;
    mRdCbAPI["LST" ]["FTC" ] = &Crlin3_slave_regif::cb_LST_FTC;
    mRdCbAPI["LEST"]["BER" ] = &Crlin3_slave_regif::cb_LEST_BER;
    mRdCbAPI["LDFC"]["RFDL"] = &Crlin3_slave_regif::cb_LDFC_RFDL;
    mRdCbAPI["LIDB"]["ID"  ] = &Crlin3_slave_regif::cb_LIDB_ID;
    mRdCbAPI["LCBR"]["CKSM"] = &Crlin3_slave_regif::cb_LCBR_CKSM;
    mRdCbAPI["LUDB0"]["UDB" ] = &Crlin3_slave_regif::cb_LUDB0_UDB;
    mRdCbAPI["LDB1"]["LDB" ] = &Crlin3_slave_regif::cb_LDB1_LDB;
    mRdCbAPI["LDB2"]["LDB" ] = &Crlin3_slave_regif::cb_LDB2_LDB;
    mRdCbAPI["LDB3"]["LDB" ] = &Crlin3_slave_regif::cb_LDB3_LDB;
    mRdCbAPI["LDB4"]["LDB" ] = &Crlin3_slave_regif::cb_LDB4_LDB;
    mRdCbAPI["LDB5"]["LDB" ] = &Crlin3_slave_regif::cb_LDB5_LDB;
    mRdCbAPI["LDB6"]["LDB" ] = &Crlin3_slave_regif::cb_LDB6_LDB;
    mRdCbAPI["LDB7"]["LDB" ] = &Crlin3_slave_regif::cb_LDB7_LDB;
    mRdCbAPI["LDB8"]["LDB" ] = &Crlin3_slave_regif::cb_LDB8_LDB;
    mRdCbAPI["LUOER"]["UTOE"] = &Crlin3_slave_regif::cb_LUOER_UTOE;
    mRdCbAPI["LUOR1"]["UEBE"] = &Crlin3_slave_regif::cb_LUOR1_UEBE;
    mRdCbAPI["LURDR"]["URD" ] = &Crlin3_slave_regif::cb_LURDR_URD;
    InitLocalVal();
    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Crlin3_slave_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Crlin3_slave_regif::~Crlin3_slave_regif()
{
...
Crlin3_slave_regif::uint Crlin3_slave_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Crlin3_slave_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Crlin3_slave_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Crlin3_slave_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                    const unsigned char *p_data,   ///< [in] Writing data
                                    cuint size)                    ///< [in] Data size (byte)
{
    if (size == 0) {
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Crlin3_slave_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                    unsigned char *p_data,   ///< [out] Reading data
                                    cuint size)              ///< [in]  Data size (byte)
{
    if (size == 0) {
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Crlin3_slave_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                        const unsigned char *p_data,  ///< [in] Writing data
                                        cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Crlin3_slave_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size,              ///< [in]  Data size (byte)
                                        bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
bool Crlin3_slave_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                     unsigned char *p_data,          ///< [out] Reading data
                                     cuint size,                     ///< [in]  Data size (byte)
...
bool Crlin3_slave_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                     const unsigned char *p_data,      ///< [in] Writing data
                                     cuint size,                       ///< [in] Data size (byte)
                                     cuint reg_index,                  ///< [in] Register index
...
bool Crlin3_slave_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return none
void Crlin3_slave_regif::CommandInit()
{
...
/// @return string
std::string Crlin3_slave_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Crlin3_slave_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Crlin3_slave_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Crlin3_slave_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Crlin3_slave_regif::IssueRegValueID(void)
{//{{{
...
/// @return none
void Crlin3_slave_regif::InitLocalVal()
{
    // Initialize local variables
    LWBR_LWBR0 = 0x0;
    LWBR_LPRS = 0x0;
...
/// @return None
void Crlin3_slave_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0001) {
    ...
    if (addr == 0x000D) {
        ...
        LEDE_FERE                  = (*LEDE  )["FERE"  ];
        LEDE_LTES                  = (*LEDE  )["LTES"  ];
        LEDE_SFERE                 = (*LEDE  )["SFERE" ];
        LEDE_IPERE                 = (*LEDE  )["IPERE" ];
        return;
    }
    if (addr == 0x000E) {
        LCUC_OM0                   = (*LCUC  )["OM0"   ];
...
/// @return None
void Crlin3_slave_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0001) {
    ...
    if (addr == 0x000D) {
        ...
        (*LEDE  )["FERE"  ] = LEDE_FERE;
        (*LEDE  )["LTES"  ] = LEDE_LTES;
        (*LEDE  )["SFERE" ] = LEDE_SFERE;
        (*LEDE  )["IPERE" ] = LEDE_IPERE;
        return;
    }
    if (addr == 0x000E) {
        (*LCUC  )["OM0"   ] = LCUC_OM0;
...
/// @return vector
std::vector<std::string> Crlin3_slave_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Crlin3_slave_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Crlin3_slave_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Crlin3_slave_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Crlin3_slave_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Crlin3_slave_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Crlin3_slave_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USE_CWR_SYSTEMC
...
/// @return read data
Crlin3_slave_regif::uint Crlin3_slave_regif::rd_cb(cuint addr)
{
    #ifdef USE_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Crlin3_slave_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Crlin3_slave_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Crlin3_slave_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Crlin3_slave_regif::EnableReset(const bool is_active)
{
...
#ifdef USE_CWR_SYSTEMC
unsigned short Crlin3_slave_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned short Crlin3_slave_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Crlin3_slave_regif::cw_set_all_callback_reg(void)
{
