// -----------------------------------------------------------------------------
// $Id: ecc_bus_aeccctl_regif.cpp,v 1.6 2020/04/01 06:49:31 thunguyen3 Exp $
//
...
//
// Input file : ecc_bus_aeccctl_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecc_bus_aeccctl
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  7 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name        reg_name      wsize   rsize      length offset   access   init   support  callback
//     %%REG      AECCCTL     AECCCTL       8|16|32 8|16|32    32     0x00     R|W      0x0     TRUE     -
//     %%REG      AECCTSTCTL  AECCTSTCTL    8|16|32 8|16|32    32     0x10     R|W      0x0     FALSE    -
//     %%REG      AECCTSTDIN0 AECCTSTDIN0   8|16|32 8|16|32    32     0x30     R|W      0x0     FALSE    -
//     %%REG      AECCTSTEIN  AECCTSTEIN    8|16|32 8|16|32    32     0x40     R|W      0x0     FALSE    -
// 
//     
// %REG_NAME AECCCTL
...
// %REG_NAME AECCTSTCTL
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    ECCTST             1       1       0       R|W     FALSE       W
// 
// %REG_NAME AECCTSTDIN0
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    DATA               31      0       0       R|W     FALSE       W
// 
// %REG_NAME AECCTSTEIN
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    ECC                6       0       0       R|W     FALSE       W
////////////////////////////////////////////////////////////////////////////////
/// @file ecc_bus_aeccctl_regif.cpp
/// @brief Register IF class of model ECC_BUS_AECCTL
/// $Id: ecc_bus_aeccctl_regif.cpp,v 1.6 2020/04/01 06:49:31 thunguyen3 Exp $
/// $Date: 2020/04/01 06:49:31 $
/// $Revison$
/// $Author: thunguyen3 $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cecc_bus_aeccctl_regif::Cecc_bus_aeccctl_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
...
{
    CommandInit();
    AECCCTL     = new vpcl::re_register(0x0000, this, "AECCCTL"    , name.c_str());
    AECCTSTCTL  = new vpcl::re_register(0x0010, this, "AECCTSTCTL" , name.c_str());
    AECCTSTDIN0 = new vpcl::re_register(0x0030, this, "AECCTSTDIN0", name.c_str());
    AECCTSTEIN  = new vpcl::re_register(0x0040, this, "AECCTSTEIN" , name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_AECCCTL      , AECCCTL->name()    , AECCCTL->addr()    );
    cw_instantiate_reg(CW_AECCTSTCTL   , AECCTSTCTL->name() , AECCTSTCTL->addr() );
    cw_instantiate_reg(CW_AECCTSTDIN0  , AECCTSTDIN0->name(), AECCTSTDIN0->addr());
    cw_instantiate_reg(CW_AECCTSTEIN   , AECCTSTEIN->name() , AECCTSTEIN->addr() );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(AECCCTL      , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AECCTSTCTL   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AECCTSTDIN0  , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(AECCTSTEIN   , mCurReg, 0,  4, "8|16|32", "8|16|32");

    mRegList = mCurReg;

    (*AECCCTL      ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*AECCTSTCTL   ) ( 1,  1, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*AECCTSTDIN0  ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    (*AECCTSTEIN   ) ( 6,  0, "ECC"     , 0x0       , "R|W"   , vpcl::SPP_DISABLE);
    ...
    mWrCbAPI["AECCCTL"  ]["ECCDIS"   ] = &Cecc_bus_aeccctl_regif::cb_AECCCTL_ECCDIS;
    mWrCbAPI["AECCTSTCTL"]["ECCTST"   ] = &Cecc_bus_aeccctl_regif::cb_AECCTSTCTL_ECCTST;
    mWrCbAPI["AECCTSTDIN0"]["DATA"     ] = &Cecc_bus_aeccctl_regif::cb_AECCTSTDIN0_DATA;
    mWrCbAPI["AECCTSTEIN"]["ECC"      ] = &Cecc_bus_aeccctl_regif::cb_AECCTSTEIN_ECC;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecc_bus_aeccctl_regif::~Cecc_bus_aeccctl_regif()
{
...
Cecc_bus_aeccctl_regif::uint Cecc_bus_aeccctl_regif::bit_select(
...
bool Cecc_bus_aeccctl_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecc_bus_aeccctl_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_aeccctl_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_aeccctl_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecc_bus_aeccctl_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecc_bus_aeccctl_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecc_bus_aeccctl_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Cecc_bus_aeccctl_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Cecc_bus_aeccctl_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecc_bus_aeccctl_regif::CommandInit()
{
...
/// @return string
std::string Cecc_bus_aeccctl_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecc_bus_aeccctl_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecc_bus_aeccctl_regif::InitLocalVal()
{
    // Initialize local variables
    AECCCTL_ECCDIS = 0x0;
    AECCTSTCTL_ECCTST = 0x0;
    AECCTSTDIN0_DATA = 0x0;
    AECCTSTEIN_ECC = 0x0;
}

/// Update bit value to local value
/// @return None
void Cecc_bus_aeccctl_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        AECCCTL_ECCDIS                  = (*AECCCTL    )["ECCDIS"     ];
        return;
    }
    if (addr == 0x0010) {
        AECCTSTCTL_ECCTST               = (*AECCTSTCTL )["ECCTST"     ];
        return;
    }
    if (addr == 0x0030) {
        AECCTSTDIN0_DATA                = (*AECCTSTDIN0)["DATA"       ];
        return;
    }
    if (addr == 0x0040) {
        AECCTSTEIN_ECC                  = (*AECCTSTEIN )["ECC"        ];
        return;
    }
}
...
/// @return None
void Cecc_bus_aeccctl_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*AECCCTL    )["ECCDIS"     ] = AECCCTL_ECCDIS;
        return;
    }
    if (addr == 0x0010) {
        (*AECCTSTCTL )["ECCTST"     ] = AECCTSTCTL_ECCTST;
        return;
    }
    if (addr == 0x0030) {
        (*AECCTSTDIN0)["DATA"       ] = AECCTSTDIN0_DATA;
        return;
    }
    if (addr == 0x0040) {
        (*AECCTSTEIN )["ECC"        ] = AECCTSTEIN_ECC;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecc_bus_aeccctl_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecc_bus_aeccctl_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecc_bus_aeccctl_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecc_bus_aeccctl_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecc_bus_aeccctl_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecc_bus_aeccctl_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecc_bus_aeccctl_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Cecc_bus_aeccctl_regif::uint Cecc_bus_aeccctl_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Cecc_bus_aeccctl_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecc_bus_aeccctl_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecc_bus_aeccctl_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecc_bus_aeccctl_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Cecc_bus_aeccctl_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecc_bus_aeccctl_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecc_bus_aeccctl_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
