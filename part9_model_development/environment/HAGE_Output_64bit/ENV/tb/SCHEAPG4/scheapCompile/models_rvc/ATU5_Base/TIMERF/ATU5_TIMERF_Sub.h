// ---------------------------------------------------------------------
// $Id: ATU5_TIMERF_Sub.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5_TIMERF_SUB_H__
#define __ATU5_TIMERF_SUB_H__
...
class ATU5_TIMERF_Sub_Func;
class ATU5_Timer;
class ATU5_NoiseCanceler;

class ATU5_TIMERF_Sub: public sc_module,
            public ATU5_TIMERF_Sub_AgentController
{
...
private:
    ATU5_TIMERF_Sub_Func *mATU5_TIMERF_Sub_Func;      // ATU5_TIMERF_Sub_Func class instance
...
public:
    ...
    SC_HAS_PROCESS (ATU5_TIMERF_Sub);
    ATU5_TIMERF_Sub (sc_module_name name,
                ATU5_TIMERF *ATU5_TIMERF_Ptr,
                unsigned int ad_id);
    ~ATU5_TIMERF_Sub (void);

    void EnableReset(const bool is_active);
    ///Noise canceller
    ATU5_NoiseCanceler      *mNoiseCancelerA;
    ATU5_NoiseCanceler      *mNoiseCancelerB;
