// ---------------------------------------------------------------------
// $Id: ATU5011_GLUE.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
// Corporation.
// ---------------------------------------------------------------------
#include "ATU5011_GLUE.h"
#include "ATU5011_GLUE_Func.h"

///Constructor of ATU5011_GLUE class
ATU5011_GLUE::ATU5011_GLUE (sc_module_name name, 
            unsigned int rLatency,
            unsigned int wLatency):
            sc_module(name),
            ATU5011_GLUE_AgentController(),
            BusSlaveBase<32,1>(),
            PCLK("PCLK"),
            PRESETZ("PRESETZ"),
            // Input ports
			...
			INTATUECMIE90("INTATUECMIE90"),
			INTATUECMIE91("INTATUECMIE91"),
			INTATUECMIE92("INTATUECMIE92"),
			INTATUECMIE93("INTATUECMIE93"),
            // TOExy
            TOE00("TOE00"),
            TOE01("TOE01"),
            TOE02("TOE02"),
...
{//{{{
    ...
    mATU5011_GLUE_Func = new ATU5011_GLUE_Func((std::string)name, this);
    sc_assert(mATU5011_GLUE_Func != NULL);
    mBusSlaveIf32[0]->setFuncModulePtr(mATU5011_GLUE_Func);
	...
	CMIE90.initialize(false);
	CMIE91.initialize(false);
	CMIE92.initialize(false);
	CMIE93.initialize(false);
    // TimerF
	...
	ICIF16.initialize(false);
	ICIF17.initialize(false);
	ICIF18.initialize(false);
	ICIF19.initialize(false);
    // TimerG
	...
	SLIC110.initialize(false);
	SLIC111.initialize(false);
	SLIC112.initialize(false);
	SLIC113.initialize(false);
	SLIC120.initialize(false);
	SLIC121.initialize(false);
	SLIC122.initialize(false);
	SLIC123.initialize(false);
	SLIC130.initialize(false);
	SLIC131.initialize(false);
	SLIC132.initialize(false);
	SLIC133.initialize(false);
    // TimerD - select
	...
	SLID90.initialize(false);
	SLID91.initialize(false);
	SLID92.initialize(false);
	SLID93.initialize(false);
	SLID100.initialize(false);
	SLID101.initialize(false);
	SLID102.initialize(false);
	SLID103.initialize(false);
	SLID110.initialize(false);
	SLID111.initialize(false);
	SLID112.initialize(false);
	SLID113.initialize(false);
	SLID120.initialize(false);
	SLID121.initialize(false);
	SLID122.initialize(false);
	SLID123.initialize(false);
	SLID130.initialize(false);
	SLID131.initialize(false);
	SLID132.initialize(false);
	SLID133.initialize(false);
	SLID140.initialize(false);
	SLID141.initialize(false);
	SLID142.initialize(false);
	SLID143.initialize(false);
    // TimerC-D - select
    ...
    for (unsigned int i = 0; i < emSLICNum; i++) {
        ...
        switch (i) {
			...
			case 43:
                ...
                break;
			case 44:
				opt.set_sensitivity(&IMIGC110);
				opt.set_sensitivity(&IMIOC110);
				break;
			case 45:
				opt.set_sensitivity(&IMIGC111);
				opt.set_sensitivity(&IMIOC111);
				break;
			case 46:
				opt.set_sensitivity(&IMIGC112);
				opt.set_sensitivity(&IMIOC112);
				break;
			case 47:
				opt.set_sensitivity(&IMIGC113);
				opt.set_sensitivity(&IMIOC113);
				break;
			case 48:
				opt.set_sensitivity(&IMIGC120);
				opt.set_sensitivity(&IMIOC120);
				break;
			case 49:
				opt.set_sensitivity(&IMIGC121);
				opt.set_sensitivity(&IMIOC121);
				break;
			case 50:
				opt.set_sensitivity(&IMIGC122);
				opt.set_sensitivity(&IMIOC122);
				break;
			case 51:
				opt.set_sensitivity(&IMIGC123);
				opt.set_sensitivity(&IMIOC123);
				break;
			case 52:
				opt.set_sensitivity(&IMIGC130);
				opt.set_sensitivity(&IMIOC130);
				break;
			case 53:
				opt.set_sensitivity(&IMIGC131);
				opt.set_sensitivity(&IMIOC131);
				break;
			case 54:
				opt.set_sensitivity(&IMIGC132);
				opt.set_sensitivity(&IMIOC132);
				break;
			default:
				opt.set_sensitivity(&IMIGC133);
				opt.set_sensitivity(&IMIOC133);
				break;
        }
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteSLICxMethod, this, i),
    ...
    for (unsigned int i = 0; i < emSLIDNum; i++) {
        ...
        switch (i) {
			...
			case 35:
                ...
                break;
			case 36:
				opt.set_sensitivity(&CMIAD90);
				opt.set_sensitivity(&CMIBD90);
				opt.set_sensitivity(&PREID90);
				opt.set_sensitivity(&PFEID90);
				opt.set_sensitivity(&UDID90);
				break;
			case 37:
				opt.set_sensitivity(&CMIAD91);
				opt.set_sensitivity(&CMIBD91);
				opt.set_sensitivity(&PREID91);
				opt.set_sensitivity(&PFEID91);
				opt.set_sensitivity(&UDID91);
				break;
			case 38:
				opt.set_sensitivity(&CMIAD92);
				opt.set_sensitivity(&CMIBD92);
				opt.set_sensitivity(&PREID92);
				opt.set_sensitivity(&PFEID92);
				opt.set_sensitivity(&UDID92);
				break;
			case 39:
				opt.set_sensitivity(&CMIAD93);
				opt.set_sensitivity(&CMIBD93);
				opt.set_sensitivity(&PREID93);
				opt.set_sensitivity(&PFEID93);
				opt.set_sensitivity(&UDID93);
				break;
			case 40:
				opt.set_sensitivity(&CMIAD100);
				opt.set_sensitivity(&CMIBD100);
				opt.set_sensitivity(&PREID100);
				opt.set_sensitivity(&PFEID100);
				opt.set_sensitivity(&UDID100);
				break;
			case 41:
				opt.set_sensitivity(&CMIAD101);
				opt.set_sensitivity(&CMIBD101);
				opt.set_sensitivity(&PREID101);
				opt.set_sensitivity(&PFEID101);
				opt.set_sensitivity(&UDID101);
				break;
			case 42:
				opt.set_sensitivity(&CMIAD102);
				opt.set_sensitivity(&CMIBD102);
				opt.set_sensitivity(&PREID102);
				opt.set_sensitivity(&PFEID102);
				opt.set_sensitivity(&UDID102);
				break;
			case 43:
				opt.set_sensitivity(&CMIAD103);
				opt.set_sensitivity(&CMIBD103);
				opt.set_sensitivity(&PREID103);
				opt.set_sensitivity(&PFEID103);
				opt.set_sensitivity(&UDID103);
				break;
			case 44:
				opt.set_sensitivity(&CMIAD110);
				opt.set_sensitivity(&CMIBD110);
				opt.set_sensitivity(&PREID110);
				opt.set_sensitivity(&PFEID110);
				opt.set_sensitivity(&UDID110);
				break;
			case 45:
				opt.set_sensitivity(&CMIAD111);
				opt.set_sensitivity(&CMIBD111);
				opt.set_sensitivity(&PREID111);
				opt.set_sensitivity(&PFEID111);
				opt.set_sensitivity(&UDID111);
				break;
			case 46:
				opt.set_sensitivity(&CMIAD112);
				opt.set_sensitivity(&CMIBD112);
				opt.set_sensitivity(&PREID112);
				opt.set_sensitivity(&PFEID112);
				opt.set_sensitivity(&UDID112);
				break;
			case 47:
				opt.set_sensitivity(&CMIAD113);
				opt.set_sensitivity(&CMIBD113);
				opt.set_sensitivity(&PREID113);
				opt.set_sensitivity(&PFEID113);
				opt.set_sensitivity(&UDID113);
				break;
			case 48:
				opt.set_sensitivity(&CMIAD120);
				opt.set_sensitivity(&CMIBD120);
				opt.set_sensitivity(&PREID120);
				opt.set_sensitivity(&PFEID120);
				opt.set_sensitivity(&UDID120);
				break;
			case 49:
				opt.set_sensitivity(&CMIAD121);
				opt.set_sensitivity(&CMIBD121);
				opt.set_sensitivity(&PREID121);
				opt.set_sensitivity(&PFEID121);
				opt.set_sensitivity(&UDID121);
				break;
			case 50:
				opt.set_sensitivity(&CMIAD122);
				opt.set_sensitivity(&CMIBD122);
				opt.set_sensitivity(&PREID122);
				opt.set_sensitivity(&PFEID122);
				opt.set_sensitivity(&UDID122);
				break;
			case 51:
				opt.set_sensitivity(&CMIAD123);
				opt.set_sensitivity(&CMIBD123);
				opt.set_sensitivity(&PREID123);
				opt.set_sensitivity(&PFEID123);
				opt.set_sensitivity(&UDID123);
				break;
			case 52:
				opt.set_sensitivity(&CMIAD130);
				opt.set_sensitivity(&CMIBD130);
				opt.set_sensitivity(&PREID130);
				opt.set_sensitivity(&PFEID130);
				opt.set_sensitivity(&UDID130);
				break;
			case 53:
				opt.set_sensitivity(&CMIAD131);
				opt.set_sensitivity(&CMIBD131);
				opt.set_sensitivity(&PREID131);
				opt.set_sensitivity(&PFEID131);
				opt.set_sensitivity(&UDID131);
				break;
			case 54:
				opt.set_sensitivity(&CMIAD132);
				opt.set_sensitivity(&CMIBD132);
				opt.set_sensitivity(&PREID132);
				opt.set_sensitivity(&PFEID132);
				opt.set_sensitivity(&UDID132);
				break;
			case 55:
				opt.set_sensitivity(&CMIAD133);
				opt.set_sensitivity(&CMIBD133);
				opt.set_sensitivity(&PREID133);
				opt.set_sensitivity(&PFEID133);
				opt.set_sensitivity(&UDID133);
				break;
			case 56:
				opt.set_sensitivity(&CMIAD140);
				opt.set_sensitivity(&CMIBD140);
				opt.set_sensitivity(&PREID140);
				opt.set_sensitivity(&PFEID140);
				opt.set_sensitivity(&UDID140);
				break;
			case 57:
				opt.set_sensitivity(&CMIAD141);
				opt.set_sensitivity(&CMIBD141);
				opt.set_sensitivity(&PREID141);
				opt.set_sensitivity(&PFEID141);
				opt.set_sensitivity(&UDID141);
				break;
			case 58:
				opt.set_sensitivity(&CMIAD142);
				opt.set_sensitivity(&CMIBD142);
				opt.set_sensitivity(&PREID142);
				opt.set_sensitivity(&PFEID142);
				opt.set_sensitivity(&UDID142);
				break;
			default:
				opt.set_sensitivity(&CMIAD143);
				opt.set_sensitivity(&CMIBD143);
				opt.set_sensitivity(&PREID143);
				opt.set_sensitivity(&PFEID143);
				opt.set_sensitivity(&UDID143);
				break;
			
        }
        opt.set_sensitivity(&mINTSELDregChangeEvent[i >> 3]);
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteSLIDxMethod, this, i),
    ...
    for (unsigned int i = 0; i < emSLDCDNum; i++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteSLDCDxMethod, this, i),
	...
	sensitive << INTATUECMIE90;
	sensitive << INTATUECMIE91;
	sensitive << INTATUECMIE92;
	sensitive << INTATUECMIE93;
    ...
    for (unsigned int i = 0; i < emTQNum; i++) {
        for (unsigned int j = 0; j < emDFEFactorNum; j++) {
            ...
            opt.dont_initialize();
            sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteDFxMethod, this, i * emDFEFactorNum + j),
    ...
    for (unsigned int i = 0; i < emDSTSNum; i++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteDSTSxMethod, this, i),
    ...
    for (unsigned int i = 1; i < emP5Num; i++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5011_GLUE::WriteP5xMethod, this, i),
	...
	sensitive << INTATUFICIF16;
	sensitive << INTATUFICIF17;
	sensitive << INTATUFICIF18;
	sensitive << INTATUFICIF19;
...
///Destructor of ATU5011_GLUE class
ATU5011_GLUE::~ATU5011_GLUE (void)
{//{{{
    delete mATU5011_GLUE_Func;
}//}}}

///Assert reset by software
void ATU5011_GLUE::AssertReset (const std::string reset_name, const double start_time, const double period)
{//{{{
...
void ATU5011_GLUE::SetCLKFreq (const std::string clock_name, const sc_dt::uint64 freq, const std::string unit)
{//{{{
...
///Get clock value
void ATU5011_GLUE::GetCLKFreq (const std::string clock_name)
{//{{{
    std::vector<std::string> word_vector;
    SeparateString(word_vector, clock_name);
    if (word_vector.size() == 1) {
...
void ATU5011_GLUE::ForceRegister (const std::string reg_name, const unsigned int reg_value)
{//{{{
    std::vector<std::string> word_vector;
    ...
    if (reg_name != "") {
        ...
        if (word_vector.size() == 1) {
            ...
            mATU5011_GLUE_Func->RegisterHandler(cmd);
        } else {
...
void ATU5011_GLUE::ReleaseRegister (const std::string reg_name)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ATU5011_GLUE::WriteRegister (const std::string reg_name, const unsigned int reg_value)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ATU5011_GLUE::ReadRegister (const std::string reg_name)
{//{{{
    std::vector<std::string> word_vector;
    std::vector<std::string> cmd;
    if (reg_name != "") {
...
void ATU5011_GLUE::ListRegister (void)
{//{{{
    std::vector<std::string> cmd;
    cmd.push_back("reg");
    mATU5011_GLUE_Func->RegisterHandler(cmd);
...
void ATU5011_GLUE::Help (const std::string type)
{//{{{
    std::vector<std::string> word_vector;
    SeparateString(word_vector, type);
    if (word_vector.size() == 1) {
        if (word_vector[0] == "parameters") {
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_MessageLevel (fatal|error|warning|info)          Set debug message level (Default: fatal|error).");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_DumpRegisterRW (true/false)                      Enable/disable dumping access register (Default: false).");
        } else if (word_vector[0] == "commands") {
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_AssertReset (reset_name, start_time, period)     Assert and de-assert reset signal.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_SetCLKFreq (clock_name, freq, unit)              Set clock frequency value of model.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_GetCLKFreq (clock_name)                          Get clock frequency value of model.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_ForceRegister (reg_name, reg_value)              Force ATU5011_GLUE’s register with setting value.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_ReleaseRegister (reg_name)                       Release ATU5011_GLUE’s register from force value.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_WriteRegister (reg_name, reg_value)              Write a value to a ATU5011_GLUE’s register.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_ReadRegister (reg_name)                          Read a value from a ATU5011_GLUE’s register.");
            SC_REPORT_INFO(this->basename(),"ATU5011_GLUE_ListRegister ()                                  Dump name of model's registers.");
        } else {
            re_printf("warning","The name (%s) of ATU5011_GLUE_Help argument is wrong (commands or parameters)\n", type.c_str());
        }
    } else {
        re_printf("warning","The name (%s) of ATU5011_GLUE_Help argument is wrong (commands or parameters)\n", type.c_str());
    }
...
void ATU5011_GLUE::SetMessageLevel (const std::string msg_lv)
{//{{{
    std::vector<std::string> cmd;
...
void ATU5011_GLUE::DumpRegisterRW (const std::string is_enable)
{//{{{
    std::vector<std::string> cmd;
    cmd.push_back("reg");
...
void ATU5011_GLUE::ConvertClockFreq (sc_dt::uint64 &freq_out, std::string &unit_out,
...
void ATU5011_GLUE::SeparateString (std::vector<std::string> &vtr, const std::string msg)
{//{{{
...
///Get time resolution
void ATU5011_GLUE::GetTimeResolution (sc_dt::uint64 &resolution_value, sc_time_unit &resolution_unit)
{//{{{
...
///Check reset status
bool ATU5011_GLUE::GetResetStatus (const std::string reset_name)
{//{{{
...
bool ATU5011_GLUE::CheckClockPeriod (const std::string clock_name)
{//{{{
...
///Handle PCLK signal
void ATU5011_GLUE::HandlePCLKSignalMethod (void)
{//{{{
...
void ATU5011_GLUE::HandlePRESETZSignalMethod (void)
{//{{{
...
void ATU5011_GLUE::HandleResetHardMethod (void)
{//{{{
...
void ATU5011_GLUE::HandleResetCmdMethod (void)
{//{{{
...
void ATU5011_GLUE::CancelResetCmdMethod (void)
{//{{{
    std::string reset_name = "PRESETZ";
    mIsResetCmdActive = false;
    mIsResetCmdReceive = false;
...
void ATU5011_GLUE::EnableReset (const std::string reset_name, const bool is_active)
{//{{{
    mATU5011_GLUE_Func->Reset(is_active);
    if (is_active) {
...
void ATU5011_GLUE::WriteSLIAxMethod (void)
{//{{{
    bool value[8];
    ...
    unsigned int int_sel_a = mATU5011_GLUE_Func->GetRegSelectSetting(emINTSELA);
...
void ATU5011_GLUE::WriteSLDBxMethod (void)
{//{{{
    bool value[9];
    ...
    unsigned int dma_sel_b = mATU5011_GLUE_Func->GetRegSelectSetting(emDMASELB);
    unsigned int temp[4];
...
void ATU5011_GLUE::WriteSLICxMethod (unsigned int id)
{//{{{
    switch (id) {
            case 0:
			...
			case 43:
                ...
                break;
			case 44:
				SLIC110.write(IMIGC110.read() | IMIOC110.read());
				break;
			case 45:
				SLIC111.write(IMIGC111.read() | IMIOC111.read());
				break;
			case 46:
				SLIC112.write(IMIGC112.read() | IMIOC112.read());
				break;
			case 47:
				SLIC113.write(IMIGC113.read() | IMIOC113.read());
				break;
			case 48:
				SLIC120.write(IMIGC120.read() | IMIOC120.read());
				break;
			case 49:
				SLIC121.write(IMIGC121.read() | IMIOC121.read());
				break;
			case 50:
				SLIC122.write(IMIGC122.read() | IMIOC122.read());
				break;
			case 51:
				SLIC123.write(IMIGC123.read() | IMIOC123.read());
				break;
			case 52:
				SLIC130.write(IMIGC130.read() | IMIOC130.read());
				break;
			case 53:
				SLIC131.write(IMIGC131.read() | IMIOC131.read());
				break;
			case 54:
				SLIC132.write(IMIGC132.read() | IMIOC132.read());
				break;
			default:
				SLIC133.write(IMIGC133.read() | IMIOC133.read());
				break;
        }
}//}}}

void ATU5011_GLUE::WriteSLIDxMethod (unsigned int id)
{//{{{
    bool value[6];
    switch (id) {
        case 0:
		...
		case 35:
            ...
            break;
		case 36:
			value[0] = CMIAD90.read();
			value[1] = CMIBD90.read();
			value[2] = PREID90.read();
			value[3] = PFEID90.read();
			value[4] = UDID90.read();
			value[5] = CMIAD90.read() | CMIBD90.read() | PREID90.read() | PFEID90.read() | UDID90.read();
			break;
		case 37:
			value[0] = CMIAD91.read();
			value[1] = CMIBD91.read();
			value[2] = PREID91.read();
			value[3] = PFEID91.read();
			value[4] = UDID91.read();
			value[5] = CMIAD91.read() | CMIBD91.read() | PREID91.read() | PFEID91.read() | UDID91.read();
			break;
		case 38:
			value[0] = CMIAD92.read();
			value[1] = CMIBD92.read();
			value[2] = PREID92.read();
			value[3] = PFEID92.read();
			value[4] = UDID92.read();
			value[5] = CMIAD92.read() | CMIBD92.read() | PREID92.read() | PFEID92.read() | UDID92.read();
			break;
		case 39:
			value[0] = CMIAD93.read();
			value[1] = CMIBD93.read();
			value[2] = PREID93.read();
			value[3] = PFEID93.read();
			value[4] = UDID93.read();
			value[5] = CMIAD93.read() | CMIBD93.read() | PREID93.read() | PFEID93.read() | UDID93.read();
			break;
		case 40:
			value[0] = CMIAD100.read();
			value[1] = CMIBD100.read();
			value[2] = PREID100.read();
			value[3] = PFEID100.read();
			value[4] = UDID100.read();
			value[5] = CMIAD100.read() | CMIBD100.read() | PREID100.read() | PFEID100.read() | UDID100.read();
			break;
		case 41:
			value[0] = CMIAD101.read();
			value[1] = CMIBD101.read();
			value[2] = PREID101.read();
			value[3] = PFEID101.read();
			value[4] = UDID101.read();
			value[5] = CMIAD101.read() | CMIBD101.read() | PREID101.read() | PFEID101.read() | UDID101.read();
			break;
		case 42:
			value[0] = CMIAD102.read();
			value[1] = CMIBD102.read();
			value[2] = PREID102.read();
			value[3] = PFEID102.read();
			value[4] = UDID102.read();
			value[5] = CMIAD102.read() | CMIBD102.read() | PREID102.read() | PFEID102.read() | UDID102.read();
			break;
		case 43:
			value[0] = CMIAD103.read();
			value[1] = CMIBD103.read();
			value[2] = PREID103.read();
			value[3] = PFEID103.read();
			value[4] = UDID103.read();
			value[5] = CMIAD103.read() | CMIBD103.read() | PREID103.read() | PFEID103.read() | UDID103.read();
			break;
		case 44:
			value[0] = CMIAD110.read();
			value[1] = CMIBD110.read();
			value[2] = PREID110.read();
			value[3] = PFEID110.read();
			value[4] = UDID110.read();
			value[5] = CMIAD110.read() | CMIBD110.read() | PREID110.read() | PFEID110.read() | UDID110.read();
			break;
		case 45:
			value[0] = CMIAD111.read();
			value[1] = CMIBD111.read();
			value[2] = PREID111.read();
			value[3] = PFEID111.read();
			value[4] = UDID111.read();
			value[5] = CMIAD111.read() | CMIBD111.read() | PREID111.read() | PFEID111.read() | UDID111.read();
			break;
		case 46:
			value[0] = CMIAD112.read();
			value[1] = CMIBD112.read();
			value[2] = PREID112.read();
			value[3] = PFEID112.read();
			value[4] = UDID112.read();
			value[5] = CMIAD112.read() | CMIBD112.read() | PREID112.read() | PFEID112.read() | UDID112.read();
			break;
		case 47:
			value[0] = CMIAD113.read();
			value[1] = CMIBD113.read();
			value[2] = PREID113.read();
			value[3] = PFEID113.read();
			value[4] = UDID113.read();
			value[5] = CMIAD113.read() | CMIBD113.read() | PREID113.read() | PFEID113.read() | UDID113.read();
			break;
		case 48:
			value[0] = CMIAD120.read();
			value[1] = CMIBD120.read();
			value[2] = PREID120.read();
			value[3] = PFEID120.read();
			value[4] = UDID120.read();
			value[5] = CMIAD120.read() | CMIBD120.read() | PREID120.read() | PFEID120.read() | UDID120.read();
			break;
		case 49:
			value[0] = CMIAD121.read();
			value[1] = CMIBD121.read();
			value[2] = PREID121.read();
			value[3] = PFEID121.read();
			value[4] = UDID121.read();
			value[5] = CMIAD121.read() | CMIBD121.read() | PREID121.read() | PFEID121.read() | UDID121.read();
			break;
		case 50:
			value[0] = CMIAD122.read();
			value[1] = CMIBD122.read();
			value[2] = PREID122.read();
			value[3] = PFEID122.read();
			value[4] = UDID122.read();
			value[5] = CMIAD122.read() | CMIBD122.read() | PREID122.read() | PFEID122.read() | UDID122.read();
			break;
		case 51:
			value[0] = CMIAD123.read();
			value[1] = CMIBD123.read();
			value[2] = PREID123.read();
			value[3] = PFEID123.read();
			value[4] = UDID123.read();
			value[5] = CMIAD123.read() | CMIBD123.read() | PREID123.read() | PFEID123.read() | UDID123.read();
			break;
		case 52:
			value[0] = CMIAD130.read();
			value[1] = CMIBD130.read();
			value[2] = PREID130.read();
			value[3] = PFEID130.read();
			value[4] = UDID130.read();
			value[5] = CMIAD130.read() | CMIBD130.read() | PREID130.read() | PFEID130.read() | UDID130.read();
			break;
		case 53:
			value[0] = CMIAD131.read();
			value[1] = CMIBD131.read();
			value[2] = PREID131.read();
			value[3] = PFEID131.read();
			value[4] = UDID131.read();
			value[5] = CMIAD131.read() | CMIBD131.read() | PREID131.read() | PFEID131.read() | UDID131.read();
			break;
		case 54:
			value[0] = CMIAD132.read();
			value[1] = CMIBD132.read();
			value[2] = PREID132.read();
			value[3] = PFEID132.read();
			value[4] = UDID132.read();
			value[5] = CMIAD132.read() | CMIBD132.read() | PREID132.read() | PFEID132.read() | UDID132.read();
			break;
		case 55:
			value[0] = CMIAD133.read();
			value[1] = CMIBD133.read();
			value[2] = PREID133.read();
			value[3] = PFEID133.read();
			value[4] = UDID133.read();
			value[5] = CMIAD133.read() | CMIBD133.read() | PREID133.read() | PFEID133.read() | UDID133.read();
			break;
		case 56:
			value[0] = CMIAD140.read();
			value[1] = CMIBD140.read();
			value[2] = PREID140.read();
			value[3] = PFEID140.read();
			value[4] = UDID140.read();
			value[5] = CMIAD140.read() | CMIBD140.read() | PREID140.read() | PFEID140.read() | UDID140.read();
			break;
		case 57:
			value[0] = CMIAD141.read();
			value[1] = CMIBD141.read();
			value[2] = PREID141.read();
			value[3] = PFEID141.read();
			value[4] = UDID141.read();
			value[5] = CMIAD141.read() | CMIBD141.read() | PREID141.read() | PFEID141.read() | UDID141.read();
			break;
		case 58:
			value[0] = CMIAD142.read();
			value[1] = CMIBD142.read();
			value[2] = PREID142.read();
			value[3] = PFEID142.read();
			value[4] = UDID142.read();
			value[5] = CMIAD142.read() | CMIBD142.read() | PREID142.read() | PFEID142.read() | UDID142.read();
			break;
		default:
			value[0] = CMIAD143.read();
			value[1] = CMIBD143.read();
			value[2] = PREID143.read();
			value[3] = PFEID143.read();
			value[4] = UDID143.read();
			value[5] = CMIAD143.read() | CMIBD143.read() | PREID143.read() | PFEID143.read() | UDID143.read();
			break;
    }
    
    unsigned int int_sel_d = mATU5011_GLUE_Func->GetRegSelectSetting(emINTSELD0 + (id >> 3));
    ...
    if (invalid) {
        ...
        switch (id) {
			...
			case 35:
                ...
                break;
			case 36:
				SLID90.write(value[bit_val]);
				break;
			case 37:
				SLID91.write(value[bit_val]);
				break;
			case 38:
				SLID92.write(value[bit_val]);
				break;
			case 39:
				SLID93.write(value[bit_val]);
				break;
			case 40:
				SLID100.write(value[bit_val]);
				break;
			case 41:
				SLID101.write(value[bit_val]);
				break;
			case 42:
				SLID102.write(value[bit_val]);
				break;
			case 43:
				SLID103.write(value[bit_val]);
				break;
			case 44:
				SLID110.write(value[bit_val]);
				break;
			case 45:
				SLID111.write(value[bit_val]);
				break;
			case 46:
				SLID112.write(value[bit_val]);
				break;
			case 47:
				SLID113.write(value[bit_val]);
				break;
			case 48:
				SLID120.write(value[bit_val]);
				break;
			case 49:
				SLID121.write(value[bit_val]);
				break;
			case 50:
				SLID122.write(value[bit_val]);
				break;
			case 51:
				SLID123.write(value[bit_val]);
				break;
			case 52:
				SLID130.write(value[bit_val]);
				break;
			case 53:
				SLID131.write(value[bit_val]);
				break;
			case 54:
				SLID132.write(value[bit_val]);
				break;
			case 55:
				SLID133.write(value[bit_val]);
				break;
			case 56:
				SLID140.write(value[bit_val]);
				break;
			case 57:
				SLID141.write(value[bit_val]);
				break;
			case 58:
				SLID142.write(value[bit_val]);
				break;
			default:
				SLID143.write(value[bit_val]);
				break;
        }
    }
}//}}}

void ATU5011_GLUE::WriteSLDCDxMethod (unsigned int id)
{//{{{
    bool value[7];
    switch (id) {
        case 0:
        ...
        case 4:
			...
			value[2] = CMIAD90.read();
			value[3] = CMIBD90.read();
			value[4] = PREID90.read();
			value[5] = PFEID90.read();
			value[6] = UDID90.read();
            break;
        case 5:
            value[0] = IMIGC11.read();
            value[1] = IMIOC11.read();
			value[2] = CMIAD91.read();
			value[3] = CMIBD91.read();
			value[4] = PREID91.read();
			value[5] = PFEID91.read();
			value[6] = UDID91.read();
            break;
        case 6:
            value[0] = IMIGC12.read();
            value[1] = IMIOC12.read();
			value[2] = CMIAD92.read();
			value[3] = CMIBD92.read();
			value[4] = PREID92.read();
			value[5] = PFEID92.read();
			value[6] = UDID92.read();
            break;
        case 7:
            value[0] = IMIGC13.read();
            value[1] = IMIOC13.read();
			value[2] = CMIAD93.read();
			value[3] = CMIBD93.read();
			value[4] = PREID93.read();
			value[5] = PFEID93.read();
			value[6] = UDID93.read();
            break;
        case 8:
            value[0] = IMIGC20.read();
            value[1] = IMIOC20.read();
			value[2] = CMIAD100.read();
			value[3] = CMIBD100.read();
			value[4] = PREID100.read();
			value[5] = PFEID100.read();
			value[6] = UDID100.read();
            break;
        case 9:
            value[0] = IMIGC21.read();
            value[1] = IMIOC21.read();
			value[2] = CMIAD101.read();
			value[3] = CMIBD101.read();
			value[4] = PREID101.read();
			value[5] = PFEID101.read();
			value[6] = UDID101.read();
            break;
        case 10:
            value[0] = IMIGC22.read();
            value[1] = IMIOC22.read();
			value[2] = CMIAD102.read();
			value[3] = CMIBD102.read();
			value[4] = PREID102.read();
			value[5] = PFEID102.read();
			value[6] = UDID102.read();
            break;
        case 11:
            value[0] = IMIGC23.read();
            value[1] = IMIOC23.read();
			value[2] = CMIAD103.read();
			value[3] = CMIBD103.read();
			value[4] = PREID103.read();
			value[5] = PFEID103.read();
			value[6] = UDID103.read();
            break;
        case 12:
            value[0] = IMIGC30.read();
            value[1] = IMIOC30.read();
			value[2] = CMIAD110.read();
			value[3] = CMIBD110.read();
			value[4] = PREID110.read();
			value[5] = PFEID110.read();
			value[6] = UDID110.read();
            break;
        case 13:
            value[0] = IMIGC31.read();
            value[1] = IMIOC31.read();
			value[2] = CMIAD111.read();
			value[3] = CMIBD111.read();
			value[4] = PREID111.read();
			value[5] = PFEID111.read();
			value[6] = UDID111.read();
            break;
        case 14:
            value[0] = IMIGC32.read();
            value[1] = IMIOC32.read();
			value[2] = CMIAD112.read();
			value[3] = CMIBD112.read();
			value[4] = PREID112.read();
			value[5] = PFEID112.read();
			value[6] = UDID112.read();
            break;
        case 15:
            value[0] = IMIGC33.read();
            value[1] = IMIOC33.read();
			value[2] = CMIAD113.read();
			value[3] = CMIBD113.read();
			value[4] = PREID113.read();
			value[5] = PFEID113.read();
			value[6] = UDID113.read();
            break;
        case 16:
            value[0] = IMIGC40.read();
            value[1] = IMIOC40.read();
			value[2] = CMIAD120.read();
			value[3] = CMIBD120.read();
			value[4] = PREID120.read();
			value[5] = PFEID120.read();
			value[6] = UDID120.read();
            break;
        case 17:
            value[0] = IMIGC41.read();
            value[1] = IMIOC41.read();
			value[2] = CMIAD121.read();
			value[3] = CMIBD121.read();
			value[4] = PREID121.read();
			value[5] = PFEID121.read();
			value[6] = UDID121.read();
            break;
        case 18:
            value[0] = IMIGC42.read();
            value[1] = IMIOC42.read();
			value[2] = CMIAD122.read();
			value[3] = CMIBD122.read();
			value[4] = PREID122.read();
			value[5] = PFEID122.read();
			value[6] = UDID122.read();
            break;
        case 19:
            value[0] = IMIGC43.read();
            value[1] = IMIOC43.read();
			value[2] = CMIAD123.read();
			value[3] = CMIBD123.read();
			value[4] = PREID123.read();
			value[5] = PFEID123.read();
			value[6] = UDID123.read();
            break;
        case 20:
            value[0] = IMIGC50.read();
            value[1] = IMIOC50.read();
			value[2] = CMIAD130.read();
			value[3] = CMIBD130.read();
			value[4] = PREID130.read();
			value[5] = PFEID130.read();
			value[6] = UDID130.read();
            break;
        case 21:
            value[0] = IMIGC51.read();
            value[1] = IMIOC51.read();
			value[2] = CMIAD131.read();
			value[3] = CMIBD131.read();
			value[4] = PREID131.read();
			value[5] = PFEID131.read();
			value[6] = UDID131.read();
            break;
        case 22:
            value[0] = IMIGC52.read();
            value[1] = IMIOC52.read();
			value[2] = CMIAD132.read();
			value[3] = CMIBD132.read();
			value[4] = PREID132.read();
			value[5] = PFEID132.read();
			value[6] = UDID132.read();
            break;
        case 23:
            value[0] = IMIGC53.read();
            value[1] = IMIOC53.read();
			value[2] = CMIAD133.read();
			value[3] = CMIBD133.read();
			value[4] = PREID133.read();
			value[5] = PFEID133.read();
			value[6] = UDID133.read();
            break;
        case 24:
            value[0] = IMIGC60.read();
            value[1] = IMIOC60.read();
			value[2] = CMIAD140.read();
			value[3] = CMIBD140.read();
			value[4] = PREID140.read();
			value[5] = PFEID140.read();
			value[6] = UDID140.read();
            break;
        case 25:
            value[0] = IMIGC61.read();
            value[1] = IMIOC61.read();
			value[2] = CMIAD141.read();
			value[3] = CMIBD141.read();
			value[4] = PREID141.read();
			value[5] = PFEID141.read();
			value[6] = UDID141.read();
            break;
        case 26:
            value[0] = IMIGC62.read();
            value[1] = IMIOC62.read();
			value[2] = CMIAD142.read();
			value[3] = CMIBD142.read();
			value[4] = PREID142.read();
			value[5] = PFEID142.read();
			value[6] = UDID142.read();
            break;
        case 27:
            value[0] = IMIGC63.read();
            value[1] = IMIOC63.read();
			value[2] = CMIAD143.read();
			value[3] = CMIBD143.read();
			value[4] = PREID143.read();
			value[5] = PFEID143.read();
			value[6] = UDID143.read();
            break;
        case 28:
        ...
        case 43:
            ...
            break;
        case 44:
			value[0] = IMIGC110.read();
			value[1] = IMIOC110.read();
            ...
            break;
        case 45:
			value[0] = IMIGC111.read();
			value[1] = IMIOC111.read();
            ...
            break;
        case 46:
			value[0] = IMIGC112.read();
			value[1] = IMIOC112.read();
            ...
            break;
        case 47:
			value[0] = IMIGC113.read();
			value[1] = IMIOC113.read();
            ...
            break;
        case 48:
			value[0] = IMIGC120.read();
			value[1] = IMIOC120.read();
            ...
            break;
        case 49:
			value[0] = IMIGC121.read();
			value[1] = IMIOC121.read();
            ...
            break;
        case 50:
			value[0] = IMIGC122.read();
			value[1] = IMIOC122.read();
            ...
            break;
        case 51:
			value[0] = IMIGC123.read();
			value[1] = IMIOC123.read();
            ...
            break;
        case 52:
			value[0] = IMIGC130.read();
			value[1] = IMIOC130.read();
            ...
            break;
        case 53:
			value[0] = IMIGC131.read();
			value[1] = IMIOC131.read();
            ...
            break;
        case 54:
			value[0] = IMIGC132.read();
			value[1] = IMIOC132.read();
            ...
            break;
        case 55:
			value[0] = IMIGC133.read();
			value[1] = IMIOC133.read();
    ...
    unsigned int int_sel_cd = mATU5011_GLUE_Func->GetRegSelectSetting(emDMASELCD0 + (id >> 3));
    unsigned bit_val = (int_sel_cd >> ((id % 8) * 4)) & 0x7;
    
    bool invalid = false;
    if (((id < 28) && (bit_val > 6)) ||
        ((28 <= id) && (id < 32) && (bit_val > 1)) ||
        ((32 <= id) && (id < 56) && (bit_val > 6)) ||
        ((56 <= id) && ((bit_val < 2) || (bit_val > 6))))
    {
        invalid = true;
    }
...
void ATU5011_GLUE::WriteSLDExMethod (void)
{//{{{
    bool value[10][4];
	...
	value[9][0] = INTATUECMIE90.read();
	value[9][1] = INTATUECMIE91.read();
	value[9][2] = INTATUECMIE92.read();
	value[9][3] = INTATUECMIE93.read();

    unsigned int dma_sel_e = mATU5011_GLUE_Func->GetRegSelectSetting(emDMASELE);
	...
	SLDE9.write(value[9][(dma_sel_e >> 18) & 0x3]);
}//}}}

void ATU5011_GLUE::WriteOVFMethod (void)
{//{{{
	...
	value |= (bool) OVIC11.read();
	value |= (bool) OVIC12.read();
	value |= (bool) OVIC13.read();
	...
	value |= (bool) OVI1D9.read();
	value |= (bool) OVI1D10.read();
	value |= (bool) OVI1D11.read();
	value |= (bool) OVI1D12.read();
	value |= (bool) OVI1D13.read();
	value |= (bool) OVI1D14.read();
	...
	value |= (bool) OVI2D9.read();
	value |= (bool) OVI2D10.read();
	value |= (bool) OVI2D11.read();
	value |= (bool) OVI2D12.read();
	value |= (bool) OVI2D13.read();
	value |= (bool) OVI2D14.read();
	...
	value |= (bool) OVIF16.read();
	value |= (bool) OVIF17.read();
	value |= (bool) OVIF18.read();
	value |= (bool) OVIF19.read();

    OVF.write(value);
}//}}}

void ATU5011_GLUE::WriteDFxMethod (unsigned int id)
{//{{{
    ...
    unsigned int dfe_sel = mATU5011_GLUE_Func->GetRegSelectSetting(emDFESEL0 + reg_id);
    bool int_en = (bool)((mATU5011_GLUE_Func->GetRegSelectSetting(emDFEENTQ0 + reg_id) >> id_mod) & 0x1);
    unsigned bit_val = 0;
    if (id_mod < 6) {
        // DFDx
...
void ATU5011_GLUE::WriteDEG1TRGMethod (void)
{//{{{
    bool value[8];
    ...
    unsigned int bit_val = mATU5011_GLUE_Func->GetRegSelectSetting(emDFESELD1T) & 0x7;
    DEG1TRG.write(value[bit_val]);
}//}}}

void ATU5011_GLUE::WriteDSTSxMethod (unsigned int id)
{//{{{
    bool value[4];
    switch (id) {
        case 0:
    ...
    unsigned int ds_sel_dsts = mATU5011_GLUE_Func->GetRegSelectSetting(emDSSELDSTS);
...
void ATU5011_GLUE::WriteCATSMethod (void)
{//{{{
    bool value[4];
    value[0] = TOC22.read();
    value[1] = TOD22A.read();
    ...
    unsigned int bit_val = mATU5011_GLUE_Func->GetRegSelectSetting(emCASELCATS) & 0x3;
    CATS.write(value[bit_val]);
}//}}}

void ATU5011_GLUE::WriteP5xMethod (unsigned int id)
{//{{{
    bool value[4];
    ...
    unsigned int p5s_sel = mATU5011_GLUE_Func->GetRegSelectSetting(emP5SSEL);
...
void ATU5011_GLUE::WriteICIAxMethod (void)
{//{{{
...
void ATU5011_GLUE::WriteCIBxMethod (void)
{//{{{
...
void ATU5011_GLUE::WriteCMIExMethod (void)
{//{{{
	...
	CMIE90.write(INTATUECMIE90.read());
	CMIE91.write(INTATUECMIE91.read());
	CMIE92.write(INTATUECMIE92.read());
	CMIE93.write(INTATUECMIE93.read());
}//}}}

void ATU5011_GLUE::WriteICIFxMethod (void)
{//{{{
	...
	ICIF16.write(INTATUFICIF16.read());
	ICIF17.write(INTATUFICIF17.read());
	ICIF18.write(INTATUFICIF18.read());
	ICIF19.write(INTATUFICIF19.read());
}//}}}

void ATU5011_GLUE::WriteCMIGxMethod (void)
{//{{{
...
void ATU5011_GLUE::WriteDMAREQxMethod (void)
{//{{{
...
void ATU5011_GLUE::NotifyEvent (const unsigned int event, const unsigned int channel)
{//{{{
    switch (event) {
        case emINTSELA :
