...
#ifndef SARAD113x_CMDIF_H
#define SARAD113x_CMDIF_H
...
std::string own_handle_command(std::vector<std::string>& args)
{
  ...
  if (args[0] == "help") {
    ...
    ret += "    Avrefh <Avrefh>                           Reference voltage of AVREFH ( Default:3.3  )\n";
    ret += "    AVcc <AVcc>                               Reference voltage of AVCC ( Default:3.3  )\n";
    ret += "    AVss <AVss>                               Reference voltage of AVSS ( Default:0  )\n";
    ret += "    EX_HLD_CDT <EX_HLD_CDT>                   Number of ADCLK cycle from starting to hold an analog input until starting AD conversion ( Default:18  )\n";
    ret += "    EX_CNVT <EX_CNVT>                         Number of ADCLK cycle for successive approximation AD conversion ( Default:22  )\n";
    ret += "    tD <tD>                                   Delay time until starting scan group for SW trigger (ns) ( Default:0  )\n";
    ret += "    tPWDD <tPWDD>                             Delay time until starting scan group for PVCR_TRG (ns) ( Default:0  )\n";
    ret += "    tED <tED>                                 Delay time until ending scan group (ns) ( Default:0  )\n";
...
double AVcc;
double AVss;
unsigned int EX_HLD_CDT;
unsigned int EX_CNVT;
double tD;
double tPWDD;
double tED;
bool EnableTimeCalculation;

#endif//SARAD113x_CMDIF_H
