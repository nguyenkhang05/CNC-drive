// -----------------------------------------------------------------------------
// $Id: ecccnt_lr0_pen_fcc2_regif.cpp,v 1.5 2019/09/06 08:49:33 landang Exp $
//
...
//
// Input file : input/LRAM/ecccnt_lr0_pen_fcc2_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE ecccnt_lr0_pen_fcc2
//     #              name     offset_size
//     %%REG_INSTANCE reg_def  7 
// 
// %REG_CHANNEL reg_def                                                       
//     %%TITLE    name                         reg_name                    wsize   rsize        length offset  factor_start    factor_end  factor_index    factor_step access   init   support  callback
//     %%REG      LRECCCTL                     LRECCCTL                    8|16|32 8|16|32      32      0x00    -               -           -               -           R/W      0x0     TRUE     -
//     %%REG      LRECCTSTCTL                  LRECCTSTCTL                 8|16|32 8|16|32      32      0x10    -               -           -               -           R/W      0x0     TRUE     -
//     %%REG      LRAFINV                      LRAFINV                     8|16|32 8|16|32      32      0x20    -               -           -               -           R/W      0x0     TRUE     -
//     %%REG      LRTDATBFECCF                 LRTDATBFECCF                -       8|16|32      32      0x60    -               -           -               -           R        0x0     TRUE     -
//     
// %REG_NAME LRECCCTL                                                            
...
// %REG_NAME LRAFINV                                                            
//     %%TITLE  name               upper   lower   init    access  support     callback
//     %%BIT    AFINV              20       4      0       R|W     TRUE        -
// 
// %REG_NAME LRTDATBFECCF                                                       
//     %%TITLE  name               upper   lower   init    access  support     callback
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file ecccnt_lr0_pen_fcc2_regif.cpp
/// @brief Register IF class of model ECCCNT_LR0_PEN_FCC2
/// $Id: ecccnt_lr0_pen_fcc2_regif.cpp,v 1.5 2019/09/06 08:49:33 landang Exp $
/// $Date: 2019/09/06 08:49:33 $
/// $Revison$
/// $Author: landang $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Cecccnt_lr0_pen_fcc2_regif::Cecccnt_lr0_pen_fcc2_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    LRECCCTL     = new vpcl::re_register(0x0000, this, "LRECCCTL"    , name.c_str());
    LRECCTSTCTL  = new vpcl::re_register(0x0010, this, "LRECCTSTCTL" , name.c_str());
    LRAFINV      = new vpcl::re_register(0x0020, this, "LRAFINV"     , name.c_str());
    LRTDATBFECCF = new vpcl::re_register(0x0060, this, "LRTDATBFECCF", name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_LRECCCTL      , LRECCCTL->name()    , LRECCCTL->addr()    );
    cw_instantiate_reg(CW_LRECCTSTCTL   , LRECCTSTCTL->name() , LRECCTSTCTL->addr() );
    cw_instantiate_reg(CW_LRAFINV       , LRAFINV->name()     , LRAFINV->addr()     );
    cw_instantiate_reg(CW_LRTDATBFECCF  , LRTDATBFECCF->name(), LRTDATBFECCF->addr());
    #endif
    mCurReg = mRegArray[index++] = new SRegList(LRECCCTL      , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LRECCTSTCTL   , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LRAFINV       , mCurReg, 0,  4, "8|16|32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(LRTDATBFECCF  , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*LRECCCTL      ) ( 3,  3, "AFEDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRECCCTL      ) ( 1,  1, "SECDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRECCCTL      ) ( 0,  0, "ECCDIS"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRECCTSTCTL   ) ( 1,  1, "ECCTST"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRECCTSTCTL   ) ( 0,  0, "DATSEL"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRAFINV       ) (20,  4, "AFINV"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*LRTDATBFECCF  ) (30, 24, "BFECC3"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LRTDATBFECCF  ) (22, 16, "BFECC2"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LRTDATBFECCF  ) (14,  8, "BFECC1"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*LRTDATBFECCF  ) ( 6,  0, "BFECC0"  , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["LRECCCTL"  ]["ECCDIS"    ] = &Cecccnt_lr0_pen_fcc2_regif::cb_LRECCCTL_ECCDIS;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cecccnt_lr0_pen_fcc2_regif::~Cecccnt_lr0_pen_fcc2_regif()
{
...
Cecccnt_lr0_pen_fcc2_regif::uint Cecccnt_lr0_pen_fcc2_regif::bit_select(
...
bool Cecccnt_lr0_pen_fcc2_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cecccnt_lr0_pen_fcc2_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_lr0_pen_fcc2_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                            const unsigned char *p_data,   ///< [in] Writing data
                                            cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_lr0_pen_fcc2_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cecccnt_lr0_pen_fcc2_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                                const unsigned char *p_data,  ///< [in] Writing data
                                                cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cecccnt_lr0_pen_fcc2_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                                unsigned char *p_data,   ///< [out] Reading data
                                                cuint size,              ///< [in]  Data size (byte)
                                                bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cecccnt_lr0_pen_fcc2_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                             unsigned char *p_data,          ///< [out] Reading data
                                             cuint size,                     ///< [in]  Data size (byte)
...
bool Cecccnt_lr0_pen_fcc2_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                             const unsigned char *p_data,      ///< [in] Writing data
                                             cuint size,                       ///< [in] Data size (byte)
                                             cuint reg_index,                  ///< [in] Register index
...
bool Cecccnt_lr0_pen_fcc2_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::CommandInit()
{
...
/// @return string
std::string Cecccnt_lr0_pen_fcc2_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cecccnt_lr0_pen_fcc2_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::InitLocalVal()
{
    // Initialize local variables
    LRECCCTL_AFEDIS = 0x0;
    LRECCCTL_SECDIS = 0x0;
    LRECCCTL_ECCDIS = 0x0;
    LRECCTSTCTL_ECCTST = 0x0;
    LRECCTSTCTL_DATSEL = 0x0;
    LRAFINV_AFINV = 0x0;
    LRTDATBFECCF_BFECC3 = 0x0;
    LRTDATBFECCF_BFECC2 = 0x0;
    LRTDATBFECCF_BFECC1 = 0x0;
    LRTDATBFECCF_BFECC0 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cecccnt_lr0_pen_fcc2_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        LRECCCTL_AFEDIS                  = (*LRECCCTL    )["AFEDIS"      ];
        LRECCCTL_SECDIS                  = (*LRECCCTL    )["SECDIS"      ];
        LRECCCTL_ECCDIS                  = (*LRECCCTL    )["ECCDIS"      ];
        return;
    }
    if (addr == 0x0010) {
        LRECCTSTCTL_ECCTST               = (*LRECCTSTCTL )["ECCTST"      ];
        LRECCTSTCTL_DATSEL               = (*LRECCTSTCTL )["DATSEL"      ];
        return;
    }
    if (addr == 0x0020) {
        LRAFINV_AFINV                    = (*LRAFINV     )["AFINV"       ];
        return;
    }
    if (addr == 0x0060) {
        LRTDATBFECCF_BFECC3              = (*LRTDATBFECCF)["BFECC3"      ];
        LRTDATBFECCF_BFECC2              = (*LRTDATBFECCF)["BFECC2"      ];
        LRTDATBFECCF_BFECC1              = (*LRTDATBFECCF)["BFECC1"      ];
        LRTDATBFECCF_BFECC0              = (*LRTDATBFECCF)["BFECC0"      ];
        return;
    }
}
...
/// @return None
void Cecccnt_lr0_pen_fcc2_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*LRECCCTL    )["AFEDIS"      ] = LRECCCTL_AFEDIS;
        (*LRECCCTL    )["SECDIS"      ] = LRECCCTL_SECDIS;
        (*LRECCCTL    )["ECCDIS"      ] = LRECCCTL_ECCDIS;
        return;
    }
    if (addr == 0x0010) {
        (*LRECCTSTCTL )["ECCTST"      ] = LRECCTSTCTL_ECCTST;
        (*LRECCTSTCTL )["DATSEL"      ] = LRECCTSTCTL_DATSEL;
        return;
    }
    if (addr == 0x0020) {
        (*LRAFINV     )["AFINV"       ] = LRAFINV_AFINV;
        return;
    }
    if (addr == 0x0060) {
        (*LRTDATBFECCF)["BFECC3"      ] = LRTDATBFECCF_BFECC3;
        (*LRTDATBFECCF)["BFECC2"      ] = LRTDATBFECCF_BFECC2;
        (*LRTDATBFECCF)["BFECC1"      ] = LRTDATBFECCF_BFECC1;
        (*LRTDATBFECCF)["BFECC0"      ] = LRTDATBFECCF_BFECC0;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cecccnt_lr0_pen_fcc2_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cecccnt_lr0_pen_fcc2_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cecccnt_lr0_pen_fcc2_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cecccnt_lr0_pen_fcc2_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cecccnt_lr0_pen_fcc2_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cecccnt_lr0_pen_fcc2_regif::uint Cecccnt_lr0_pen_fcc2_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cecccnt_lr0_pen_fcc2_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cecccnt_lr0_pen_fcc2_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cecccnt_lr0_pen_fcc2_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cecccnt_lr0_pen_fcc2_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
