// -----------------------------------------------------------------------------
// $Id: atu5_timerf_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_TIMERF_REGIF_H__
#define __ATU5_TIMERF_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_TIMERF model
class Catu5_timerf_regif
...
public:
    Catu5_timerf_regif(std::string name, uint buswidth , unsigned int subblock);
    ~Catu5_timerf_regif();
...
protected:
    ...
    virtual void cb_TSTRF_STRF(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Catu5_timerf_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_timerf_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__ATU5_TIMERF_REG_DEF_H__
