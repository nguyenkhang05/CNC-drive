// ---------------------------------------------------------------------
// $Id: MECCCAP_IT_PEn_Func.h,v 1.1 2019/09/26 10:07:26 landang Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __MECCCAP_IT_PEN_FUNC_H__
#define __MECCCAP_IT_PEN_FUNC_H__

#include "BusSlaveFuncIf.h"
#include "mecccap_it_pen_regif.h"
#include "ECC_ICACHE_E2_AgentController.h"
#include "global.h"

class MECCCAP_IT_PEn_Func: public Cmecccap_it_pen_regif
                ,public BusSlaveFuncIf
{
public:
    SC_HAS_PROCESS (MECCCAP_IT_PEn_Func);
    MECCCAP_IT_PEn_Func(std::string name, unsigned int pe_id, ECC_ICACHE_E2_AgentController* ICACHEAgentController);
    ~MECCCAP_IT_PEn_Func();
...
#endif //__MECCCAP_IT_PEN_FUNC_H__
