// -----------------------------------------------------------------------------
// $Id: atu5_timerf_sub_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
//
// Input file : atu5_timerf_sub_regif.txt
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @file atu5_timerf_sub_regif.cpp
/// @brief Register IF class of model ATU5_TIMERF_SUB
/// $Id: atu5_timerf_sub_regif.cpp 1196 2019-10-17 05:33:04Z chuonghoangle $
...
/// @return none
Catu5_timerf_sub_regif::Catu5_timerf_sub_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x10/4))
    #endif
{
    CommandInit();
    TCR1F  = new vpcl::re_register(0x0000, this, "TCR1F" , name.c_str());
    TCR2F  = new vpcl::re_register(0x0002, this, "TCR2F" , name.c_str());
    TIERF  = new vpcl::re_register(0x0007, this, "TIERF" , name.c_str());
    BKCRF  = new vpcl::re_register(0x0004, this, "BKCRF" , name.c_str());
    TSRF   = new vpcl::re_register(0x0005, this, "TSRF"  , name.c_str());
    TSCRF  = new vpcl::re_register(0x0006, this, "TSCRF" , name.c_str());
    ECNTAF = new vpcl::re_register(0x0010, this, "ECNTAF", name.c_str());
    ECNTBF = new vpcl::re_register(0x0018, this, "ECNTBF", name.c_str());
    ECNTCF = new vpcl::re_register(0x0020, this, "ECNTCF", name.c_str());
    GRAF   = new vpcl::re_register(0x0014, this, "GRAF"  , name.c_str());
    GRBF   = new vpcl::re_register(0x001C, this, "GRBF"  , name.c_str());
    GRCF   = new vpcl::re_register(0x0024, this, "GRCF"  , name.c_str());
    GRDF   = new vpcl::re_register(0x0028, this, "GRDF"  , name.c_str());
    CDRF   = new vpcl::re_register(0x002C, this, "CDRF"  , name.c_str());
    NCNTFA = new vpcl::re_register(0x0008, this, "NCNTFA", name.c_str());
    NCNTFB = new vpcl::re_register(0x000C, this, "NCNTFB", name.c_str());
    NCRFA  = new vpcl::re_register(0x000A, this, "NCRFA" , name.c_str());
    NCRFB  = new vpcl::re_register(0x000E, this, "NCRFB" , name.c_str());
    ...
    mRegMap[0x0005]     = index++;
    mRegMap[0x0006]     = index++;
    mRegMap[0x0007]     = index++;
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_TCR1F_TCR2F, "TCR1F_TCR2F", 0x0000);
    CW_TCR1F  = new scml2::bitfield<uint>(TCR1F->name() , CW_TCR1F_TCR2F ,  0,  8);
    CW_TCR2F  = new scml2::bitfield<uint>(TCR2F->name() , CW_TCR1F_TCR2F , 16,  8);
    cw_instantiate_reg(CW_BKCRF_TSRF_TSCRF_TIERF, "BKCRF_TSRF_TSCRF_TIERF", 0x0004);
    CW_BKCRF  = new scml2::bitfield<uint>(BKCRF->name() , CW_BKCRF_TSRF_TSCRF_TIERF,  0,  8);
    CW_TSRF   = new scml2::bitfield<uint>(TSRF->name()  , CW_BKCRF_TSRF_TSCRF_TIERF,  8,  8);
    CW_TSCRF  = new scml2::bitfield<uint>(TSCRF->name() , CW_BKCRF_TSRF_TSCRF_TIERF, 16,  8);
    CW_TIERF  = new scml2::bitfield<uint>(TIERF->name() , CW_BKCRF_TSRF_TSCRF_TIERF, 24,  8);
    cw_instantiate_reg(CW_NCNTFA_NCRFA, "NCNTFA_NCRFA", 0x0008);
    CW_NCNTFA = new scml2::bitfield<uint>(NCNTFA->name(), CW_NCNTFA_NCRFA,  0, 16);
    CW_NCRFA  = new scml2::bitfield<uint>(NCRFA->name() , CW_NCNTFA_NCRFA, 16, 16);
    cw_instantiate_reg(CW_NCNTFB_NCRFB, "NCNTFB_NCRFB", 0x000C);
    CW_NCNTFB = new scml2::bitfield<uint>(NCNTFB->name(), CW_NCNTFB_NCRFB,  0, 16);
    CW_NCRFB  = new scml2::bitfield<uint>(NCRFB->name() , CW_NCNTFB_NCRFB, 16, 16);
    cw_instantiate_reg(CW_ECNTBF_, "ECNTBF_", 0x0018);
    CW_ECNTBF = new scml2::bitfield<uint>(ECNTBF->name(), CW_ECNTBF_     ,  0, 16);
    cw_instantiate_reg(CW_GRBF_, "GRBF_", 0x001C);
    CW_GRBF   = new scml2::bitfield<uint>(GRBF->name()  , CW_GRBF_       ,  0, 16);
    cw_instantiate_reg(CW_ECNTAF  , ECNTAF->name(), ECNTAF->addr());
    cw_instantiate_reg(CW_GRAF    , GRAF->name()  , GRAF->addr()  );
    cw_instantiate_reg(CW_ECNTCF  , ECNTCF->name(), ECNTCF->addr());
    cw_instantiate_reg(CW_GRCF    , GRCF->name()  , GRCF->addr()  );
    cw_instantiate_reg(CW_GRDF    , GRDF->name()  , GRDF->addr()  );
    cw_instantiate_reg(CW_CDRF    , CDRF->name()  , CDRF->addr()  );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(TCR1F   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(TCR2F   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(BKCRF   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(TSRF    , mCurReg, 0,  1,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(TSCRF   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(TIERF   , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCNTFA  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCRFA   , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCNTFB  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(NCRFB   , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ECNTAF  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(GRAF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ECNTBF  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(GRBF    , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ECNTCF  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(GRCF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(GRDF    , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CDRF    , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*TCR1F   ) ( 7,  5, "CKSELFx" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TCR1F   ) ( 4,  2, "MDF"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TCR1F   ) ( 1,  0, "EGSELF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TCR2F   ) ( 7,  7, "EISELEF" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TCR2F   ) ( 2,  0, "EISELF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TIERF   ) ( 3,  3, "OVECF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TIERF   ) ( 2,  2, "OVEBF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TIERF   ) ( 1,  1, "OVEAF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TIERF   ) ( 0,  0, "ICIEF"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 6,  6, "BKENAF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 5,  5, "BKENCF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 4,  4, "BKENDF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 2,  2, "ARSWAF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 1,  1, "ARSWCF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*BKCRF   ) ( 0,  0, "ARSWDF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*TSRF    ) ( 3,  3, "OVFCF"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TSRF    ) ( 2,  2, "OVFBF"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TSRF    ) ( 1,  1, "OVFAF"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TSRF    ) ( 0,  0, "ICFF"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*TSCRF   ) ( 3,  3, "OVFCCF"  , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TSCRF   ) ( 2,  2, "OVFCBF"  , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TSCRF   ) ( 1,  1, "OVFCAF"  , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*TSCRF   ) ( 0,  0, "ICFCF"   , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*ECNTAF  ) (31,  0, "ECNTAF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ECNTBF  ) (15,  0, "ECNTBF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ECNTCF  ) (31,  0, "ECNTCF"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*GRAF    ) (31,  0, "GRAF"    , 0xFFFFFFFF, "R|W"   , vpcl::SPP_ENABLE);
    (*GRBF    ) (15,  0, "GRBF"    , 0xFFFF    , "R|W"   , vpcl::SPP_ENABLE);
    (*GRCF    ) (31,  0, "GRCF"    , 0xFFFFFFFF, "R|W"   , vpcl::SPP_ENABLE);
    (*GRDF    ) (31,  0, "GRDF"    , 0xFFFFFFFF, "R|W"   , vpcl::SPP_ENABLE);
    (*CDRF    ) (31,  0, "CDRF"    , 0xFFFFFFFF, "R"     , vpcl::SPP_ENABLE);
    (*NCNTFA  ) (15,  0, "NCNTFA"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCNTFB  ) (15,  0, "NCNTFB"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCRFA   ) (15,  0, "NCTFA"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*NCRFB   ) (15,  0, "NCTFB"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["TCR1F"]["MDF" ] = &Catu5_timerf_sub_regif::cb_TCR1F_MDF;
    mWrCbAPI["BKCRF"]["BKENAF"] = &Catu5_timerf_sub_regif::cb_BKCRF_BKENAF;
    mWrCbAPI["TSCRF"]["OVFCCF"] = &Catu5_timerf_sub_regif::cb_TSCRF_OVFCCF;
    mWrCbAPI["TSCRF"]["OVFCBF"] = &Catu5_timerf_sub_regif::cb_TSCRF_OVFCBF;
    mWrCbAPI["TSCRF"]["OVFCAF"] = &Catu5_timerf_sub_regif::cb_TSCRF_OVFCAF;
    mWrCbAPI["TSCRF"]["ICFCF"] = &Catu5_timerf_sub_regif::cb_TSCRF_ICFCF;
    mWrCbAPI["GRAF"]["GRAF"] = &Catu5_timerf_sub_regif::cb_GRAF_GRAF;
    mWrCbAPI["GRCF"]["GRCF"] = &Catu5_timerf_sub_regif::cb_GRCF_GRCF;
    mWrCbAPI["GRDF"]["GRDF"] = &Catu5_timerf_sub_regif::cb_GRDF_GRDF;

    mRdCbAPI["CDRF"]["CDRF"] = &Catu5_timerf_sub_regif::cb_CDRF_CDRF;
    InitLocalVal();

    //Construct the list of register whose read callbacks are executed in debug mode
    list_rdcb_dbg.push_back(0x2C); // CDRF
}

/// Destructor: delete pointers
/// @return none
Catu5_timerf_sub_regif::~Catu5_timerf_sub_regif()
{
...
Catu5_timerf_sub_regif::uint Catu5_timerf_sub_regif::bit_select(
...
bool Catu5_timerf_sub_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Catu5_timerf_sub_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timerf_sub_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                        const unsigned char *p_data,   ///< [in] Writing data
                                        cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timerf_sub_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                        unsigned char *p_data,   ///< [out] Reading data
                                        cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Catu5_timerf_sub_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                            const unsigned char *p_data,  ///< [in] Writing data
                                            cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Catu5_timerf_sub_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                            unsigned char *p_data,   ///< [out] Reading data
                                            cuint size,              ///< [in]  Data size (byte)
                                            bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Catu5_timerf_sub_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                         unsigned char *p_data,          ///< [out] Reading data
                                         cuint size,                     ///< [in]  Data size (byte)
...
bool Catu5_timerf_sub_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                         const unsigned char *p_data,      ///< [in] Writing data
                                         cuint size,                       ///< [in] Data size (byte)
                                         cuint reg_index,                  ///< [in] Register index
...
bool Catu5_timerf_sub_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Catu5_timerf_sub_regif::CommandInit()
{
...
/// @return string
std::string Catu5_timerf_sub_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Catu5_timerf_sub_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Catu5_timerf_sub_regif::InitLocalVal()
{
    // Initialize local variables
    TCR1F_CKSELFx = 0x0;
    TCR1F_MDF = 0x0;
    ...
    ECNTBF_ECNTBF = 0x0;
    ECNTCF_ECNTCF = 0x0;
    GRAF_GRAF = 0xFFFFFFFF;
    GRBF_GRBF = 0xFFFF;
    GRCF_GRCF = 0xFFFFFFFF;
    GRDF_GRDF = 0xFFFFFFFF;
    CDRF_CDRF = 0xFFFFFFFF;
    NCNTFA_NCNTFA = 0x0;
    NCNTFB_NCNTFB = 0x0;
    NCRFA_NCTFA = 0x0;
    NCRFB_NCTFB = 0x0;
...
/// @return None
void Catu5_timerf_sub_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        TCR1F_CKSELFx              = (*TCR1F )["CKSELFx"];
        TCR1F_MDF                  = (*TCR1F )["MDF"   ];
        TCR1F_EGSELF               = (*TCR1F )["EGSELF"];
        return;
    }
    if (addr == 0x0002) {
        TCR2F_EISELEF              = (*TCR2F )["EISELEF"];
        TCR2F_EISELF               = (*TCR2F )["EISELF"];
        return;
    }
    if (addr == 0x0007) {
        TIERF_OVECF                = (*TIERF )["OVECF" ];
        TIERF_OVEBF                = (*TIERF )["OVEBF" ];
        TIERF_OVEAF                = (*TIERF )["OVEAF" ];
        TIERF_ICIEF                = (*TIERF )["ICIEF" ];
        return;
    }
    if (addr == 0x0004) {
        BKCRF_BKENAF               = (*BKCRF )["BKENAF"];
        BKCRF_BKENCF               = (*BKCRF )["BKENCF"];
        BKCRF_BKENDF               = (*BKCRF )["BKENDF"];
        BKCRF_ARSWAF               = (*BKCRF )["ARSWAF"];
        BKCRF_ARSWCF               = (*BKCRF )["ARSWCF"];
        BKCRF_ARSWDF               = (*BKCRF )["ARSWDF"];
        return;
    }
    if (addr == 0x0005) {
        TSRF_OVFCF                 = (*TSRF  )["OVFCF" ];
        TSRF_OVFBF                 = (*TSRF  )["OVFBF" ];
        TSRF_OVFAF                 = (*TSRF  )["OVFAF" ];
        TSRF_ICFF                  = (*TSRF  )["ICFF"  ];
        return;
    }
    if (addr == 0x0006) {
        TSCRF_OVFCCF               = (*TSCRF )["OVFCCF"];
        TSCRF_OVFCBF               = (*TSCRF )["OVFCBF"];
        TSCRF_OVFCAF               = (*TSCRF )["OVFCAF"];
        TSCRF_ICFCF                = (*TSCRF )["ICFCF" ];
        return;
    }
    if (addr == 0x0010) {
        ECNTAF_ECNTAF              = (*ECNTAF)["ECNTAF"];
        return;
    }
    if (addr == 0x0018) {
        ECNTBF_ECNTBF              = (*ECNTBF)["ECNTBF"];
        return;
    }
    if (addr == 0x0020) {
        ECNTCF_ECNTCF              = (*ECNTCF)["ECNTCF"];
        return;
    }
    if (addr == 0x0014) {
        GRAF_GRAF                  = (*GRAF  )["GRAF"  ];
    ...
    if (addr == 0x0008) {
        NCNTFA_NCNTFA              = (*NCNTFA)["NCNTFA"];
        return;
    }
    if (addr == 0x000C) {
        NCNTFB_NCNTFB              = (*NCNTFB)["NCNTFB"];
        return;
    }
    if (addr == 0x000A) {
        NCRFA_NCTFA                = (*NCRFA )["NCTFA" ];
        return;
    }
    if (addr == 0x000E) {
        NCRFB_NCTFB                = (*NCRFB )["NCTFB" ];
        return;
    }
}
...
/// @return None
void Catu5_timerf_sub_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*TCR1F )["CKSELFx"] = TCR1F_CKSELFx;
        (*TCR1F )["MDF"   ] = TCR1F_MDF;
        (*TCR1F )["EGSELF"] = TCR1F_EGSELF;
        return;
    }
    if (addr == 0x0002) {
        (*TCR2F )["EISELEF"] = TCR2F_EISELEF;
        (*TCR2F )["EISELF"] = TCR2F_EISELF;
        return;
    }
    if (addr == 0x0007) {
        (*TIERF )["OVECF" ] = TIERF_OVECF;
        (*TIERF )["OVEBF" ] = TIERF_OVEBF;
        (*TIERF )["OVEAF" ] = TIERF_OVEAF;
        (*TIERF )["ICIEF" ] = TIERF_ICIEF;
        return;
    }
    if (addr == 0x0004) {
        (*BKCRF )["BKENAF"] = BKCRF_BKENAF;
        (*BKCRF )["BKENCF"] = BKCRF_BKENCF;
        (*BKCRF )["BKENDF"] = BKCRF_BKENDF;
        (*BKCRF )["ARSWAF"] = BKCRF_ARSWAF;
        (*BKCRF )["ARSWCF"] = BKCRF_ARSWCF;
        (*BKCRF )["ARSWDF"] = BKCRF_ARSWDF;
        return;
    }
    if (addr == 0x0005) {
        (*TSRF  )["OVFCF" ] = TSRF_OVFCF;
        (*TSRF  )["OVFBF" ] = TSRF_OVFBF;
        (*TSRF  )["OVFAF" ] = TSRF_OVFAF;
        (*TSRF  )["ICFF"  ] = TSRF_ICFF;
        return;
    }
    if (addr == 0x0006) {
        (*TSCRF )["OVFCCF"] = TSCRF_OVFCCF;
        (*TSCRF )["OVFCBF"] = TSCRF_OVFCBF;
        (*TSCRF )["OVFCAF"] = TSCRF_OVFCAF;
        (*TSCRF )["ICFCF" ] = TSCRF_ICFCF;
        return;
    }
    if (addr == 0x0010) {
        (*ECNTAF)["ECNTAF"] = ECNTAF_ECNTAF;
        return;
    }
    if (addr == 0x0018) {
        (*ECNTBF)["ECNTBF"] = ECNTBF_ECNTBF;
        return;
    }
    if (addr == 0x0020) {
        (*ECNTCF)["ECNTCF"] = ECNTCF_ECNTCF;
        return;
    }
    if (addr == 0x0014) {
        (*GRAF  )["GRAF"  ] = GRAF_GRAF;
    ...
    if (addr == 0x0008) {
        (*NCNTFA)["NCNTFA"] = NCNTFA_NCNTFA;
        return;
    }
    if (addr == 0x000C) {
        (*NCNTFB)["NCNTFB"] = NCNTFB_NCNTFB;
        return;
    }
    if (addr == 0x000A) {
        (*NCRFA )["NCTFA" ] = NCRFA_NCTFA;
        return;
    }
    if (addr == 0x000E) {
        (*NCRFB )["NCTFB" ] = NCRFB_NCTFB;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Catu5_timerf_sub_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Catu5_timerf_sub_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Catu5_timerf_sub_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Catu5_timerf_sub_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Catu5_timerf_sub_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Catu5_timerf_sub_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Catu5_timerf_sub_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Catu5_timerf_sub_regif::uint Catu5_timerf_sub_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Catu5_timerf_sub_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Catu5_timerf_sub_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Catu5_timerf_sub_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Catu5_timerf_sub_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Catu5_timerf_sub_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Catu5_timerf_sub_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Catu5_timerf_sub_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
