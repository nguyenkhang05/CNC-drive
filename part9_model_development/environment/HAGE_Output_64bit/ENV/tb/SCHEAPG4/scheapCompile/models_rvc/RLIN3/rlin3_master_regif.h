...
/// $Author$
////////////////////////////////////////////////////////////////////////////////
#ifndef __RLIN3_MASTER_REGIF_H__
#define __RLIN3_MASTER_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of RLIN3_MASTER model
class Crlin3_master_regif
...
protected:
    ...
    typedef void (Crlin3_master_regif::* ptrRegValueIDFunc) (std::string);
    ptrRegValueIDFunc mNotifyRegValueIDAPI;
    virtual void NotifyRegValueID(const std::string reg_val_id) = 0;
#endif

public:
    Crlin3_master_regif(std::string name, uint buswidth);
    ~Crlin3_master_regif();
...
protected:
    ...
    virtual void cb_LBRP0_LBRP0(RegCBstr str) = 0;
    virtual void cb_LBRP1_LBRP1(RegCBstr str) = 0;
    virtual void cb_LSTC_LSTM(RegCBstr str) = 0;
    virtual void cb_LMD_LMD(RegCBstr str) = 0;
    virtual void cb_LBFC_BLT(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Crlin3_master_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Crlin3_master_regif::*) (RegCBstr)> > mRdCbAPI;
...
#endif //__RLIN3_MASTER_REG_DEF_H__
