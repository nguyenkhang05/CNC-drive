// ---------------------------------------------------------------------
// $Id: ATU5010_TIMERE_SUB.cpp,v 1.3 2018/03/06 10:15:45 binhnguyen Exp $
//
...
/// Description  : Constructor of ATU5010_TIMERE_SUB class
///*********************************
ATU5010_TIMERE_SUB::ATU5010_TIMERE_SUB (sc_module_name name,
            ATU5010_TIMERE *ATU5010_TIMERE_Ptr,
            unsigned int subnum):
                sc_module(name),
                ATU5010_TIMERE_SUB_AgentController(),
                PCLK("PCLK"),
                ...
                mSubNum(subnum)
{//{{{
    mTIMERE = ATU5010_TIMERE_Ptr;
    //Initialize variables - for clock, time resolution, reset

    std::ostringstream port_name;
    for (unsigned int index = 0; index < ATU5010_TIMERE_SUB_AgentController::emChannel; index++) {
        port_name.str("");
        port_name << "TOE" << index;
    ...
    mTIE_SUBFunc = new ATU5010_TIMERE_SUB_Func((std::string)name, this, subnum);
    sc_assert(mTIE_SUBFunc != NULL);
    
    for (unsigned int index = 0; index <= 3; index++) {
        std::ostringstream name;
        name.str("");name << "mFreeRunCnt" << index;
        mFreeRunCnt[index] = new ATU5010_Timer(name.str().c_str(), mTIMERE->mATU5010);
    ...
    for (unsigned int index = 0; index <= 3; index++) {
        ...
        mRunCntDTRE[index] = new ATU5010_Timer(name.str().c_str(), mTIMERE->mATU5010);
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleTOEPortMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::AdjustTOEChangeEventMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::RisingInterruptMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::FallingInterruptMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::PreCmpOvfMethod, this, signal_id),
     ...
     for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleCmpOvfMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::PreCmpDTREMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleCmpDTREMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::PostCmpCYLRMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::PreCmpCYLRMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleCmpCYLRMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::AdjustForceCmpEventMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleFlagAndInterruptDTREMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::HandleFlagAndInterruptCYLRMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::AdjustStartEventMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::StartTimerMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::StopTimerMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::RestartPWMCycleMethod, this, signal_id),
    ...
    for (unsigned int signal_id = 0; signal_id < 4; signal_id ++) {
        ...
        opt.dont_initialize();
        sc_core::sc_spawn(sc_bind(&ATU5010_TIMERE_SUB::RewriteCounterMethod, this, signal_id),
...
///*********************************
/// Function     : ~ATU5010_TIMERE_SUB
/// Description  : Destructor of ATU5010_TIMERE_SUB class
///*********************************
ATU5010_TIMERE_SUB::~ATU5010_TIMERE_SUB (void)
{//{{{ 
    delete mTIE_SUBFunc;
    for (unsigned int index = 0; index <= 3; index++) {
...
///*********************************
void ATU5010_TIMERE_SUB::EnableReset (const bool is_active)
{//{{{
    if (is_active) {
        Initialize();
        InitializePort();
...
void ATU5010_TIMERE_SUB::Initialize (void)
{//{{{
    mSubBlockEnable = false;
    mSubBlockReloadEnable = false;
    mCLKBUS0 = 0;
    mCLKBUS1 = 0;
    mCLKBUS2 = 0;
    mCLKBUS3 = 0;
    ...
    mPCLKClockStartPoint = 0;
     for (unsigned int index = 0; index < ATU5010_TIMERE_SUB_AgentController::emChannel; index++) {
        ...
        mChannelReloadEnable[index] = false;
    ...
    for (unsigned int index = 0; index < ATU5010_TIMERE_SUB_AgentController::emAllClockBus; index++) { 
       mInputClockStartPoint[index] = 0;
    }
}//}}}
void ATU5010_TIMERE_SUB::InitializePort (void)
{//{{{
    for (unsigned int index = 0; index < ATU5010_TIMERE_SUB_AgentController::emChannel; index++) {
...
void ATU5010_TIMERE_SUB::CancelAllEvents (void)
{//{{{
...
/// Description  : Destructor of ATU5010_TIMERE_SUB class
///*********************************
void ATU5010_TIMERE_SUB::CheckClockInputMethod (void)
{//{{{ 
...
***********************************/
void ATU5010_TIMERE_SUB::HandleCountClockFunction(void)
{//{{{
 ...
 sc_dt::uint64 PreCountClkPeriod[ATU5010_TIMERE_SUB_AgentController::emChannel];
 ...
 if (mCLKBUS0 != (sc_dt::uint64)clock_bus0.read()) {
     ...
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus0] = current_time;
 }
  if (mCLKBUS1 != (sc_dt::uint64)clock_bus1.read()) {
     mCLKBUS1 = (sc_dt::uint64)clock_bus1.read();
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus1] = current_time;
 }
  if (mCLKBUS2 != (sc_dt::uint64)clock_bus2.read()) {
     mCLKBUS2 = (sc_dt::uint64)clock_bus2.read();
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus2] = current_time;
 }
  if (mCLKBUS3 != (sc_dt::uint64)clock_bus3.read()) {
     mCLKBUS3 = (sc_dt::uint64)clock_bus3.read();
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus3] = current_time;
 }
  if (mCLKBUS4 != (sc_dt::uint64)clock_bus4.read()) {
     mCLKBUS4 = (sc_dt::uint64)clock_bus4.read();
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus4] = current_time;
 }
  if (mCLKBUS5 != (sc_dt::uint64)clock_bus5.read()) {
     mCLKBUS5 = (sc_dt::uint64)clock_bus5.read();
     mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus5] = current_time;
 }
 switch(subblock_ratio) {
    case 0: 
       ClkPeriod = mCLKBUS0;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus0];
       break;
    case 1:
       ClkPeriod = mCLKBUS1;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus1];
       break;
    case 2:
       ClkPeriod = mCLKBUS2;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus2];
       break;
    case 3:
       ClkPeriod = mCLKBUS3;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus3];
       break;
    case 4:
       ClkPeriod = mCLKBUS4;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus4];
       break;
    case 5:
       ClkPeriod = mCLKBUS5;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus5];
       break;
    default:
       ClkPeriod = mCLKBUS0;
       mCountClockStartPoint = mInputClockStartPoint[ATU5010_TIMERE_SUB_AgentController::emClockBus0];
    ...
    for (unsigned int index = 0; index <= 3; index++) {
       ...
       if(PreCountClkPeriod[index] == 0){ //zero clock condition
          ...
          if (mIsTimerRunning[index]){
              ...
              mStartTimerEvent[index].notify(CalculateClockEdge(index, true, true, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
          } else {
...
***********************************/
double ATU5010_TIMERE_SUB::CalculateClockEdge (unsigned int channel, const bool is_pos, const bool add_period, const double time_point,const double time_change_point)
{//{{{
    double period_num = 0;
...
**********************************/
unsigned int ATU5010_TIMERE_SUB::GetCntValue(const unsigned int channel)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::AdjustStartEventMethod (const unsigned int channel)
{//{{{
    if (mChannelEnable[channel] && mSubBlockEnable && mTimerEPrescaler[channel]) {
        if (mIsCounterRunningEnable[channel] == false){
            ...
            mStartTimerEvent[channel].notify(CalculateClockEdge(channel, true, false, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
    } else {
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::StartTimerMethod (const unsigned int channel)
{//{{{
  if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")){
    ...
    if (!mIsTimerRunning[channel]) {
        ...
        // set count period
        mFreeRunCnt[channel]->SetCounterPeriod(mCountClkPeriod[channel]);
        mRunCntDTRE[channel]->SetCounterPeriod(mCountClkPeriod[channel]);
        ...
        if(mClearCounter[channel] || mCYLRCmpMatchBit[channel]){ // counter is clear by overflow          
           if(mCYLRCmpMatchBit[channel]) {
            ...
            if(mTIE_SUBFunc->GetTCNTERegValue(channel) == mDTREValue[channel]){         
                // reload function is disable, then overflow occur
                if(!(mTIE_SUBFunc->IsReloadEnable(channel)) || (!mSubBlockReloadEnable)){
            		    mCounterOverflowEvent[channel].notify(SC_ZERO_TIME); 
              	}
              	
           		  mDutyMatchEvent[channel].notify(mCountClkPeriod[channel],mTIMERE->mATU5010->mTimeResolutionUnit);
              	
            }
            if(mTIE_SUBFunc->GetTCNTERegValue(channel) == mCYLREValue[channel] ){         
                mPostCycleMatchEvent[channel].notify(CalculateClockEdge(channel, false, false, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
                mCycleMatchEvent[channel].notify(mCountClkPeriod[channel],mTIMERE->mATU5010->mTimeResolutionUnit); 
            }
        } else {         
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::StopTimerMethod (const unsigned int channel)
{//{{{
    if (mIsTimerRunning[channel]) {
        // set counter status bit
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::RewriteCounterMethod (const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    double current_time = GetCurTime();
    if (mIsTimerRunning[channel]) {
        ...
        if((mChangeCounterValue[channel] == true)||(mTIE_SUBFunc->GetTCNTERegValue(channel) == mCYLREValue[channel])){
           ...
           mStartTimerEvent[channel].notify(CalculateClockEdge(channel, true, true, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
        }
}
}//}}} 
/*********************************
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::RestartPWMCycleMethod (const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    double current_time = GetCurTime();
    if (mIsTimerRunning[channel]) {
    ...
    mCounterOverflowEvent[channel].cancel();
    mDutyMatchEvent[channel].cancel();
    mCycleMatchEvent[channel].notify(CalculateClockEdge(channel, true, false, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
}
}//}}} 
/*********************************
...
**********************************/
void ATU5010_TIMERE_SUB::UpdateTCNTERegValue(unsigned int channel)
{//{{{
 mTIE_SUBFunc->SetTCNTERegValue(channel,GetCntValue(channel));
 }//}}} 
/*********************************
...
**********************************/
void ATU5010_TIMERE_SUB::SetCntValue(unsigned int channel, const unsigned int count)
{//{{{
    mFreeRunCnt[channel]->SetCounterInitialValue(count);

}//}}}
void ATU5010_TIMERE_SUB::SetCntDTREValue(unsigned int channel, const unsigned int count)
{//{{{
...
**********************************/
void ATU5010_TIMERE_SUB::SetCntCmpValue(unsigned int channel, unsigned int value)
{//{{{ 
      mFreeRunCnt[channel]->SetCompareMatchValue(value);

}//}}}
void ATU5010_TIMERE_SUB::SetCntDTRECmpValue(unsigned int channel, unsigned int value)
{//{{{ 
...
**********************************/
void ATU5010_TIMERE_SUB::PreCmpOvfMethod(const unsigned int channel)
{//{{{
    if ((mOvfTime[channel] == sc_time_stamp().to_double()) && (mIsOvf[channel])) {
        ...
        mIsOvf[channel] = true;
        if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) { //Check Clock & reset
            mIsTimerRunning[channel] = false ;
            mFreeRunCnt[channel]->StartStop(mIsTimerRunning[channel]);
            mRunCntDTRE[channel]->StartStop(mIsTimerRunning[channel]);
            // clear counter to 1
            ...
            mStartTimerEvent[channel].cancel();
            mCounterOverflowEvent[channel].notify(mCountClkPeriod[channel],mTIMERE->mATU5010->mTimeResolutionUnit); 
        }
    }
}//}}}
/*********************************
...
// Description  : Handle Overflow
**********************************/
void ATU5010_TIMERE_SUB::HandleCmpOvfMethod(const unsigned int channel)
{//{{{
    if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB"))   { //Check Clock & reset
...
**********************************/
void ATU5010_TIMERE_SUB::PreCmpDTREMethod(unsigned int channel)
{//{{{
...
// Description  : Handle Compare Event
**********************************/
void ATU5010_TIMERE_SUB::HandleCmpDTREMethod(unsigned int channel)
{//{{{
  if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
      ...
      if(mTIE_SUBFunc->getDRLDEValue(channel) != 0){
...
// Description  : Handle Compare Event
**********************************/
void ATU5010_TIMERE_SUB::AdjustForceCmpEventMethod(unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    double current_time = GetCurTime();
    mCounterOverflowEvent[channel].cancel();
    mClearCounter[channel] = false;
    mForceCycleMatchEvent[channel].notify(CalculateClockEdge(channel, true, false, current_time,mCountClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
}
}//}}}
/*********************************
...
// Description  : Handle Compare Event
**********************************/
void ATU5010_TIMERE_SUB::PreCmpCYLRMethod(unsigned int channel)
{//{{{
...
// Description  : Handle Compare Event
**********************************/
void ATU5010_TIMERE_SUB::PostCmpCYLRMethod(unsigned int channel)
{//{{{
     mClearCounter[channel] = false;
     mCounterOverflowEvent[channel].cancel();
}//}}}
...
// Description  : Handle Compare Event
**********************************/
void ATU5010_TIMERE_SUB::HandleCmpCYLRMethod(const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    ...
    if (mSubBlockEnable && mChannelEnable[channel]) {
        ...
        if ((mSubNum < 6) && (ShutOffIn == mTIE_SUBFunc->GetShutOffActiveInputLevel())
...
**********************************/
void ATU5010_TIMERE_SUB::HandleFlagAndInterruptCYLRMethod(const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    mTIE_SUBFunc->TurnCMFEFlag(channel);
    if (mTIE_SUBFunc->IsInterruptCMEE(channel)) {
...
**********************************/
void ATU5010_TIMERE_SUB::HandleFlagAndInterruptDTREMethod(const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    mTIE_SUBFunc->TurnDMFEFlag(channel);
    if (mTIE_SUBFunc->IsInterruptDMEE(channel)) {
        mRisingInterruptEvent[channel].notify(SC_ZERO_TIME);
    }
}
}//}}}
...
***********************************/
double ATU5010_TIMERE_SUB::GetCurTime(void)
{//{{{
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::RisingInterruptMethod(const unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {      //Check reset/clock condition
        INTATUECMIE[channel]->write(true);
        mFallingInterruptEvent[channel].notify(mPCLKPeriod,mTIMERE->mATU5010->mTimeResolutionUnit); //after 1 PCLK
    }
}//}}}
...
// Return value : None
**********************************/
void ATU5010_TIMERE_SUB::FallingInterruptMethod(const unsigned int channel)
{//{{{
     if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) { //Check reset/clock condition
...
**********************************/
void ATU5010_TIMERE_SUB::AdjustTOEChangeEventMethod(unsigned int channel)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    double current_time = GetCurTime();
    mTOEChangeRequestEvent[channel].notify(CalculateClockEdge(4, true, false, current_time,mPCLKClockStartPoint),mTIMERE->mATU5010->mTimeResolutionUnit);
}
}//}}}
/*********************************
...
// Description  : Handle TOE port output
**********************************/
void ATU5010_TIMERE_SUB::HandleTOEPortMethod(unsigned int channel)
{//{{{
     if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif")))&& mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {//Check reset
...
**********************************/
void ATU5010_TIMERE_SUB::ShutOffRequestFlowMethod(void)
{//{{{
if((!(mTIMERE->mATU5010->GetResetStatus("presetz"))) && (!(mTIMERE->mATU5010->GetResetStatus("presetz_bif"))) && mTIMERE->mATU5010->CheckClockPeriod("CLK_LSB")&& mTIMERE->mATU5010->CheckClockPeriod("CLK_HSB")) {
    bool ShutOffIn = (bool)POE.read();
