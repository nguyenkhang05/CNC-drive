// -----------------------------------------------------------------------------
// $Id: dsadc_e2xfcc1_2nd_regif.cpp 1398 2019-11-26 06:16:27Z chuonghoangle $
//
...
//
// Input file : dsadc_e2xfcc1_2nd_regif.txt
////////////////////////////////////////////////////////////////////////////////
// %MODULE DSADC_E2XFCC1_2ND
//     #                   name            offset_size
...
////////////////////////////////////////////////////////////////////////////////
/// @file dsadc_e2xfcc1_2nd_regif.cpp
/// @brief Register IF class of model DSADC_E2XFCC1_2ND
/// $Id: dsadc_e2xfcc1_2nd_regif.cpp 1398 2019-11-26 06:16:27Z chuonghoangle $
...
/// @return none
Cdsadc_e2xfcc1_2nd_regif::Cdsadc_e2xfcc1_2nd_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
    , cwmem("register", scml_memsize(0xD/1))
    #endif
{
    CommandInit();
    DSADCSYNSTCR = new vpcl::re_register(0x0000, this, "DSADCSYNSTCR", name.c_str());
    DSADCADGCR   = new vpcl::re_register(0x0004, this, "DSADCADGCR"  , name.c_str());
    DSADCTDCR    = new vpcl::re_register(0x000C, this, "DSADCTDCR"   , name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_DSADCSYNSTCR  , DSADCSYNSTCR->name(), DSADCSYNSTCR->addr());
    cw_instantiate_reg(CW_DSADCADGCR    , DSADCADGCR->name()  , DSADCADGCR->addr()  );
    cw_instantiate_reg(CW_DSADCTDCR     , DSADCTDCR->name()   , DSADCTDCR->addr()   );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(DSADCSYNSTCR  , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DSADCADGCR    , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DSADCTDCR     , mCurReg, 0,  1,       "8", "8|16|32");

    mRegList = mCurReg;

    (*DSADCSYNSTCR  ) ( 0,  0, "ADSTART" , 0x0       , "W"     , vpcl::SPP_ENABLE);
    (*DSADCADGCR    ) ( 5,  5, "ODDE"    , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*DSADCADGCR    ) ( 4,  4, "ODE"     , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*DSADCADGCR    ) ( 0,  0, "UNSND"   , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    (*DSADCTDCR     ) ( 0,  0, "TDE"     , 0x0       , "W|R"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["DSADCSYNSTCR"]["ADSTART"   ] = &Cdsadc_e2xfcc1_2nd_regif::cb_DSADCSYNSTCR_ADSTART;
    mWrCbAPI["DSADCTDCR" ]["TDE"       ] = &Cdsadc_e2xfcc1_2nd_regif::cb_DSADCTDCR_TDE;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cdsadc_e2xfcc1_2nd_regif::~Cdsadc_e2xfcc1_2nd_regif()
{
...
Cdsadc_e2xfcc1_2nd_regif::uint Cdsadc_e2xfcc1_2nd_regif::bit_select(
...
bool Cdsadc_e2xfcc1_2nd_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cdsadc_e2xfcc1_2nd_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdsadc_e2xfcc1_2nd_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                              const unsigned char *p_data,   ///< [in] Writing data
                              cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdsadc_e2xfcc1_2nd_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                              unsigned char *p_data,   ///< [out] Reading data
                              cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdsadc_e2xfcc1_2nd_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                  const unsigned char *p_data,  ///< [in] Writing data
                                  cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdsadc_e2xfcc1_2nd_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                  unsigned char *p_data,   ///< [out] Reading data
                                  cuint size,              ///< [in]  Data size (byte)
                                  bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cdsadc_e2xfcc1_2nd_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                               unsigned char *p_data,          ///< [out] Reading data
                               cuint size,                     ///< [in]  Data size (byte)
...
bool Cdsadc_e2xfcc1_2nd_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                               const unsigned char *p_data,      ///< [in] Writing data
                               cuint size,                       ///< [in] Data size (byte)
                               cuint reg_index,                  ///< [in] Register index
...
bool Cdsadc_e2xfcc1_2nd_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::CommandInit()
{
...
/// @return string
std::string Cdsadc_e2xfcc1_2nd_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cdsadc_e2xfcc1_2nd_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::InitLocalVal()
{
    // Initialize local variables
    DSADCSYNSTCR_ADSTART = 0x0;
    DSADCADGCR_ODDE = 0x0;
    DSADCADGCR_ODE = 0x0;
    DSADCADGCR_UNSND = 0x0;
    DSADCTDCR_TDE = 0x0;
}

/// Update bit value to local value
/// @return None
void Cdsadc_e2xfcc1_2nd_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        DSADCSYNSTCR_ADSTART             = (*DSADCSYNSTCR)["ADSTART"     ];
        return;
    }
    if (addr == 0x0004) {
        DSADCADGCR_ODDE                  = (*DSADCADGCR  )["ODDE"        ];
        DSADCADGCR_ODE                   = (*DSADCADGCR  )["ODE"         ];
        DSADCADGCR_UNSND                 = (*DSADCADGCR  )["UNSND"       ];
        return;
    }
    if (addr == 0x000C) {
        DSADCTDCR_TDE                    = (*DSADCTDCR   )["TDE"         ];
        return;
    }
}
...
/// @return None
void Cdsadc_e2xfcc1_2nd_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*DSADCSYNSTCR)["ADSTART"     ] = DSADCSYNSTCR_ADSTART;
        return;
    }
    if (addr == 0x0004) {
        (*DSADCADGCR  )["ODDE"        ] = DSADCADGCR_ODDE;
        (*DSADCADGCR  )["ODE"         ] = DSADCADGCR_ODE;
        (*DSADCADGCR  )["UNSND"       ] = DSADCADGCR_UNSND;
        return;
    }
    if (addr == 0x000C) {
        (*DSADCTDCR   )["TDE"         ] = DSADCTDCR_TDE;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cdsadc_e2xfcc1_2nd_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cdsadc_e2xfcc1_2nd_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cdsadc_e2xfcc1_2nd_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cdsadc_e2xfcc1_2nd_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cdsadc_e2xfcc1_2nd_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cdsadc_e2xfcc1_2nd_regif::uint Cdsadc_e2xfcc1_2nd_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cdsadc_e2xfcc1_2nd_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
unsigned char Cdsadc_e2xfcc1_2nd_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
unsigned char Cdsadc_e2xfcc1_2nd_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(unsigned char));
    return sizeof(unsigned char);
}
void Cdsadc_e2xfcc1_2nd_regif::cw_instantiate_reg(scml2::reg<unsigned char> * reg, std::string reg_name, int offset)
{
