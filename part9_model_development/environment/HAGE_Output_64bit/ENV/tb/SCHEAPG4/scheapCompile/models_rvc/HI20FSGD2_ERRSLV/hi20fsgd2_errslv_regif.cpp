// -----------------------------------------------------------------------------
// $Id: hi20fsgd2_errslv_regif.cpp,v 1.1 2019/11/26 04:05:44 hadinhtran Exp $
//
...
// 
////////////////////////////////////////////////////////////////////////////////
/// @file hi20fsgd2_errslv_regif.cpp
/// @brief Register IF class of model HI20FSGD2_ERRSLV
/// $Id: hi20fsgd2_errslv_regif.cpp,v 1.1 2019/11/26 04:05:44 hadinhtran Exp $
/// $Date: 2019/11/26 04:05:44 $
/// $Revison$
/// $Author: hadinhtran $
////////////////////////////////////////////////////////////////////////////////
...
/// @return none
Chi20fsgd2_errslv_regif::Chi20fsgd2_errslv_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", scml_memsize(0x1C/4))
    #endif
{
    CommandInit();
    PBGOVFCLR      = new vpcl::re_register(0x0000, this, "PBGOVFCLR"     , name.c_str());
    PBGOVFSTAT     = new vpcl::re_register(0x0004, this, "PBGOVFSTAT"    , name.c_str());
    ...
    PBGSPIDERRCLR  = new vpcl::re_register(0x0010, this, "PBGSPIDERRCLR" , name.c_str());
    PBGSPIDERRSTAT = new vpcl::re_register(0x0014, this, "PBGSPIDERRSTAT", name.c_str());
    PBGKCPROT      = new vpcl::re_register(0x0018, this, "PBGKCPROT"     , name.c_str());
    ...
    index = 0;
    #ifdef USR_CWR_SYSTEMC
    cw_instantiate_reg(CW_PBGOVFCLR       , PBGOVFCLR->name()     , PBGOVFCLR->addr()     );
    cw_instantiate_reg(CW_PBGOVFSTAT      , PBGOVFSTAT->name()    , PBGOVFSTAT->addr()    );
    ...
    cw_instantiate_reg(CW_PBGSPIDERRCLR   , PBGSPIDERRCLR->name() , PBGSPIDERRCLR->addr() );
    cw_instantiate_reg(CW_PBGSPIDERRSTAT  , PBGSPIDERRSTAT->name(), PBGSPIDERRSTAT->addr());
    cw_instantiate_reg(CW_PBGKCPROT       , PBGKCPROT->name()     , PBGKCPROT->addr()     );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(PBGOVFCLR       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGOVFSTAT      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGERRADDR      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGERRTYPE      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGSPIDERRCLR   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGSPIDERRSTAT  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(PBGKCPROT       , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*PBGOVFCLR       ) ( 1,  1, "CLRO"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PBGOVFSTAT      ) ( 1,  1, "OVF"     , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    (*PBGERRTYPE      ) (10,  6, "SPID"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PBGERRTYPE      ) ( 0,  0, "WRITE"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*PBGSPIDERRCLR   ) (31,  0, "SPIDCLR" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*PBGSPIDERRSTAT  ) (31,  0, "SPIDERR" , 0x0       , "R"     , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["PBGOVFCLR"   ]["CLRO"        ] = &Chi20fsgd2_errslv_regif::cb_PBGOVFCLR_CLRO;
    mWrCbAPI["PBGSPIDERRCLR"]["SPIDCLR"     ] = &Chi20fsgd2_errslv_regif::cb_PBGSPIDERRCLR_SPIDCLR;
    mWrCbAPI["PBGKCPROT"   ]["KCPROT"      ] = &Chi20fsgd2_errslv_regif::cb_PBGKCPROT_KCPROT;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Chi20fsgd2_errslv_regif::~Chi20fsgd2_errslv_regif()
{
...
Chi20fsgd2_errslv_regif::uint Chi20fsgd2_errslv_regif::bit_select(
...
bool Chi20fsgd2_errslv_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chi20fsgd2_errslv_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chi20fsgd2_errslv_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                         const unsigned char *p_data,   ///< [in] Writing data
                                         cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chi20fsgd2_errslv_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                         unsigned char *p_data,   ///< [out] Reading data
                                         cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chi20fsgd2_errslv_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                             const unsigned char *p_data,  ///< [in] Writing data
                                             cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chi20fsgd2_errslv_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                             unsigned char *p_data,   ///< [out] Reading data
                                             cuint size,              ///< [in]  Data size (byte)
                                             bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Chi20fsgd2_errslv_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                          unsigned char *p_data,          ///< [out] Reading data
                                          cuint size,                     ///< [in]  Data size (byte)
...
bool Chi20fsgd2_errslv_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                          const unsigned char *p_data,      ///< [in] Writing data
                                          cuint size,                       ///< [in] Data size (byte)
                                          cuint reg_index,                  ///< [in] Register index
...
bool Chi20fsgd2_errslv_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Chi20fsgd2_errslv_regif::CommandInit()
{
...
/// @return string
std::string Chi20fsgd2_errslv_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chi20fsgd2_errslv_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chi20fsgd2_errslv_regif::InitLocalVal()
{
    // Initialize local variables
    PBGOVFCLR_CLRO = 0x0;
    PBGOVFSTAT_OVF = 0x0;
    ...
    PBGSPIDERRCLR_SPIDCLR = 0x0;
    PBGSPIDERRSTAT_SPIDERR = 0x0;
...
/// @return None
void Chi20fsgd2_errslv_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        PBGOVFCLR_CLRO                     = (*PBGOVFCLR     )["CLRO"          ];
        return;
    }
    if (addr == 0x0004) {
        PBGOVFSTAT_OVF                     = (*PBGOVFSTAT    )["OVF"           ];
        return;
    }
    if (addr == 0x0008) {
    ...
    if (addr == 0x000C) {
        ...
        PBGERRTYPE_SPID                    = (*PBGERRTYPE    )["SPID"          ];
        PBGERRTYPE_WRITE                   = (*PBGERRTYPE    )["WRITE"         ];
        return;
    }
    if (addr == 0x0010) {
        PBGSPIDERRCLR_SPIDCLR              = (*PBGSPIDERRCLR )["SPIDCLR"       ];
        return;
    }
    if (addr == 0x0014) {
        PBGSPIDERRSTAT_SPIDERR             = (*PBGSPIDERRSTAT)["SPIDERR"       ];
        return;
    }
    if (addr == 0x0018) {
...
/// @return None
void Chi20fsgd2_errslv_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*PBGOVFCLR     )["CLRO"          ] = PBGOVFCLR_CLRO;
        return;
    }
    if (addr == 0x0004) {
        (*PBGOVFSTAT    )["OVF"           ] = PBGOVFSTAT_OVF;
        return;
    }
    if (addr == 0x0008) {
    ...
    if (addr == 0x000C) {
        ...
        (*PBGERRTYPE    )["SPID"          ] = PBGERRTYPE_SPID;
        (*PBGERRTYPE    )["WRITE"         ] = PBGERRTYPE_WRITE;
        return;
    }
    if (addr == 0x0010) {
        (*PBGSPIDERRCLR )["SPIDCLR"       ] = PBGSPIDERRCLR_SPIDCLR;
        return;
    }
    if (addr == 0x0014) {
        (*PBGSPIDERRSTAT)["SPIDERR"       ] = PBGSPIDERRSTAT_SPIDERR;
        return;
    }
    if (addr == 0x0018) {
...
/// @return vector
std::vector<std::string> Chi20fsgd2_errslv_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chi20fsgd2_errslv_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chi20fsgd2_errslv_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Chi20fsgd2_errslv_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Chi20fsgd2_errslv_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chi20fsgd2_errslv_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Chi20fsgd2_errslv_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Chi20fsgd2_errslv_regif::uint Chi20fsgd2_errslv_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return none
void Chi20fsgd2_errslv_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chi20fsgd2_errslv_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chi20fsgd2_errslv_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Chi20fsgd2_errslv_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Chi20fsgd2_errslv_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Chi20fsgd2_errslv_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Chi20fsgd2_errslv_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
