// -----------------------------------------------------------------------------
// $Id: atu5_glue_regif.h 1196 2019-10-17 05:33:04Z chuonghoangle $
//
...
////////////////////////////////////////////////////////////////////////////////
#ifndef __ATU5_GLUE_REGIF_H__
#define __ATU5_GLUE_REGIF_H__
#include <string>
#include <map>
#include <list>
#include <cstdarg>
...
/// Register IF class of ATU5_GLUE model
class Catu5_glue_regif
...
public:
    Catu5_glue_regif(std::string name, uint buswidth);
    ~Catu5_glue_regif();

protected:
    vpcl::re_register *ATUINTSELA  ;
    vpcl::re_register *ATUINTSELD  [4];
    vpcl::re_register *ATUINTSELD4 ;
    ...
    scml2::reg<uint> *CW_ATUINTSELD  [4];
    scml2::reg<uint> *CW_ATUINTSELD4 ;
    ...
    uint ATUINTSELD_ATU_INTSEL_D13[4];
    uint ATUINTSELD_ATU_INTSEL_D12[4];
    uint ATUINTSELD_ATU_INTSEL_D11[4];
    uint ATUINTSELD_ATU_INTSEL_D10[4];
    uint ATUINTSELD_ATU_INTSEL_D03[4];
    uint ATUINTSELD_ATU_INTSEL_D02[4];
    uint ATUINTSELD_ATU_INTSEL_D01[4];
    uint ATUINTSELD_ATU_INTSEL_D00[4];
    uint ATUINTSELD4_ATU_INTSEL_D03;
    uint ATUINTSELD4_ATU_INTSEL_D02;
    uint ATUINTSELD4_ATU_INTSEL_D01;
    uint ATUINTSELD4_ATU_INTSEL_D00;
    ...
    virtual void cb_ATUINTSELD4_ATU_INTSEL_D00(RegCBstr str) = 0;
    ...
    std::map<std::string, std::map<std::string, void (Catu5_glue_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Catu5_glue_regif::*) (RegCBstr)> > mRdCbAPI;
