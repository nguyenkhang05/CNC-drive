// ---------------------------------------------------------------------
// $Id: ATU5010_GLUE.h,v 1.0 2016/11/24 10:15:45 binhnguyen Exp $
//
...
// Corporation.
// ---------------------------------------------------------------------
#ifndef __ATU5010_GLUE_H__
#define __ATU5010_GLUE_H__

#include "BusSlaveBase.h"
#include "ATU5010_GLUE_AgentController.h"

class ATU5010_GLUE_Func;

class ATU5010_GLUE: public sc_module,
            public ATU5010_GLUE_AgentController,
...
private:
    ...
    ATU5010_GLUE_Func *mATU5010_GLUE_Func;            // ATU5010_GLUE_Func class instance
    ...
    //sc_event mINTSELCregChangeEvent[2];
...
public:
    ...
    /// Socket declaration
    TlmTargetSocket<32> *ts;            // For ATU5010_GLUE's registers

    SC_HAS_PROCESS (ATU5010_GLUE);
    ATU5010_GLUE (sc_module_name name,
...
private:
    ...
    void WriteSLIC00_73Method (void);
    void WriteSLIC80_133Method (void);
    ...
    /// Virtual functions of ATU5010_GLUE_AgentController class
