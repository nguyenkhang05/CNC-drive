// -----------------------------------------------------------------------------
// $Id: mecccap_lr0_pen_regif.h,v 1.2 2019/10/15 06:48:35 landang Exp $
//
...
public:
    Cmecccap_lr0_pen_regif(std::string name, uint buswidth);
    ~Cmecccap_lr0_pen_regif();
...
protected:
    ...
    std::map<std::string, std::map<std::string, void (Cmecccap_lr0_pen_regif::*) (RegCBstr)> > mWrCbAPI;
    std::map<std::string, std::map<std::string, void (Cmecccap_lr0_pen_regif::*) (RegCBstr)> > mRdCbAPI;
