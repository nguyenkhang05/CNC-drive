// -----------------------------------------------------------------------------
// $Id: hwcore_vrfbuf_regif.cpp,v 1.1 2020/10/27 04:49:12 huyquocpham Exp $
//
...
/// @return none
Chwcore_vrfbuf_regif::Chwcore_vrfbuf_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef USR_CWR_SYSTEMC
    , cwmem("register", 0x7A4)
    #endif
{
    CommandInit();
    CBCTR0        = new vpcl::re_register(0x0780, this, "CBCTR0"       , name.c_str());
    CBTIM         = new vpcl::re_register(0x0782, this, "CBTIM"        , name.c_str());
    CBTHTRESFIXIN = new vpcl::re_register(0x078A, this, "CBTHTRESFIXIN", name.c_str());
    CBIDFIX       = new vpcl::re_register(0x078C, this, "CBIDFIX"      , name.c_str());
    CBIQFIX       = new vpcl::re_register(0x0790, this, "CBIQFIX"      , name.c_str());
    CBPWMUIP      = new vpcl::re_register(0x0794, this, "CBPWMUIP"     , name.c_str());
    CBPWMVIP      = new vpcl::re_register(0x0798, this, "CBPWMVIP"     , name.c_str());
    CBPWMWIP      = new vpcl::re_register(0x079C, this, "CBPWMWIP"     , name.c_str());
    CBBREC        = new vpcl::re_register(0x07A0, this, "CBBREC"       , name.c_str());
    CBIREC3       = new vpcl::re_register(0x07A1, this, "CBIREC3"      , name.c_str());
    std::ostringstream str_tmp;
    for(uint i = 0; i < emNUM_CBAD; i++) {
        str_tmp.str("");
        str_tmp<<"CBAD"<< i;
        CBAD         [i] = new vpcl::re_register((0x0784) + 2*i, this, str_tmp.str(), name.c_str());
    }
    ...
    mRegMap[0x0782]     = index;
    mRegMap[0x0782 + 1] = index++;
    for(uint i = 0; i < emNUM_CBAD;         i++) {
        mRegMap[(0x0784)     + i*2 ] = index;
        mRegMap[(0x0784 + 1) + i*2 ] = index++;
    }
    mRegMap[0x078A]     = index;
    mRegMap[0x078A + 1] = index++;
    mRegMap[0x078C]     = index;
    mRegMap[0x078C + 1] = index;
    mRegMap[0x078C + 2] = index;
    mRegMap[0x078C + 3] = index++;
    mRegMap[0x0790]     = index;
    mRegMap[0x0790 + 1] = index;
    mRegMap[0x0790 + 2] = index;
    mRegMap[0x0790 + 3] = index++;
    mRegMap[0x0794]     = index;
    mRegMap[0x0794 + 1] = index;
    mRegMap[0x0794 + 2] = index;
    mRegMap[0x0794 + 3] = index++;
    mRegMap[0x0798]     = index;
    mRegMap[0x0798 + 1] = index;
    mRegMap[0x0798 + 2] = index;
    mRegMap[0x0798 + 3] = index++;
    mRegMap[0x079C]     = index;
    mRegMap[0x079C + 1] = index;
    mRegMap[0x079C + 2] = index;
    mRegMap[0x079C + 3] = index++;
    mRegMap[0x07A0]     = index++;
    mRegMap[0x07A1]     = index++;
    mTotalRegNum = index;
    mRegArray = new SRegList* [mTotalRegNum];
    index = 0;
#ifdef USR_CWR_SYSTEMC
    mCurReg = mRegArray[index++] = new SRegList(CBCTR0         , mCurReg, 0,  1,       "8", "8|16|32", false, &cwmem);
#else
    mCurReg = mRegArray[index++] = new SRegList(CBCTR0         , mCurReg, 0,  1,       "8", "8|16|32");
#endif
    mCurReg = mRegArray[index++] = new SRegList(CBTIM          , mCurReg, 0,  2,      "16", "8|16|32");
    for(uint i = 0; i < emNUM_CBAD         ; i++) mCurReg = mRegArray[index++] = new SRegList(CBAD           [i], mCurReg, i,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBTHTRESFIXIN  , mCurReg, 0,  2,      "16", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBIDFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBIQFIX        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBPWMUIP       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBPWMVIP       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBPWMWIP       , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBBREC         , mCurReg, 0,  1,       "8", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CBIREC3        , mCurReg, 0,  1,       "8", "8|16|32");

    mRegList = mCurReg;

    (*CBCTR0         ) ( 2,  2, "CBMON"   , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBCTR0         ) ( 1,  1, "CBEN1"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBCTR0         ) ( 0,  0, "CBEN0"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) (13, 13, "IREC3WBT", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) (12, 12, "IREC3VBT", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) (11, 11, "IREC3UBT", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) ( 9,  9, "CMP0BT"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) ( 2,  2, "PWMBT"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTIM          ) ( 0,  0, "INBT"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CBTHTRESFIXIN  ) (11,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBIDFIX        ) (31,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBIQFIX        ) (31,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBPWMUIP       ) (17,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBPWMVIP       ) (17,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBPWMWIP       ) (17,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBBREC         ) ( 2,  2, "WPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBBREC         ) ( 1,  1, "VPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBBREC         ) ( 0,  0, "UPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBIREC3        ) ( 2,  2, "WPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBIREC3        ) ( 1,  1, "VPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    (*CBIREC3        ) ( 0,  0, "UPTN"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    for(uint i = 0; i < emNUM_CBAD; i++) {
        (*CBAD           [i]) (11,  0, "DATA"    , 0x0       , "R"     , vpcl::SPP_ENABLE);
    }
    ...
    mWrCbAPI["CBCTR0"     ]["CBEN0"      ] = &Chwcore_vrfbuf_regif::cb_CBCTR0_CBEN0;

    #ifdef USE_WEB_SIM
    InitializeRegValueID();
    mNotifyRegValueIDAPI = &Chwcore_vrfbuf_regif::NotifyRegValueID;
    #endif
}

/// Destructor: delete pointers
/// @return none
Chwcore_vrfbuf_regif::~Chwcore_vrfbuf_regif()
{
...
Chwcore_vrfbuf_regif::uint Chwcore_vrfbuf_regif::bit_select(cuint val,    ///< [in] Writting address
...
bool Chwcore_vrfbuf_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chwcore_vrfbuf_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_vrfbuf_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                      const unsigned char *p_data,   ///< [in] Writing data
                                      cuint size)                    ///< [in] Data size (byte)
{
    assert(size != 0);
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chwcore_vrfbuf_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                      unsigned char *p_data,   ///< [out] Reading data
                                      cuint size)              ///< [in]  Data size (byte)
{
    assert(size != 0);
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chwcore_vrfbuf_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                          const unsigned char *p_data,  ///< [in] Writing data
                                          cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chwcore_vrfbuf_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                          unsigned char *p_data,   ///< [out] Reading data
                                          cuint size,              ///< [in]  Data size (byte)
                                          bool IsDbgFunc)          ///< [in]  Flag indicate reg_rd or reg_rd_dbg
{
...
bool Chwcore_vrfbuf_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                       unsigned char *p_data,          ///< [out] Reading data
                                       cuint size,                     ///< [in]  Data size (byte)
...
bool Chwcore_vrfbuf_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                       const unsigned char *p_data,      ///< [in] Writing data
                                       cuint size,                       ///< [in] Data size (byte)
                                       cuint reg_index,                  ///< [in] Register index
...
bool Chwcore_vrfbuf_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
/// @return none
void Chwcore_vrfbuf_regif::CommandInit()
{
...
/// @return string
std::string Chwcore_vrfbuf_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chwcore_vrfbuf_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Chwcore_vrfbuf_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Chwcore_vrfbuf_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Chwcore_vrfbuf_regif::IssueRegValueID(void)
{//{{{
...
/// @return vector
std::vector<std::string> Chwcore_vrfbuf_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chwcore_vrfbuf_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chwcore_vrfbuf_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
    if (mDumpRegisterRW) {
...
int Chwcore_vrfbuf_regif::get_reg_index(cuint access_addr)
{
    if (access_addr < (1<<11)) {
...
vpcl::re_register *Chwcore_vrfbuf_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chwcore_vrfbuf_regif::next_reg_object()
{
    assert(mCurReg != NULL);
...
/// @return none
void Chwcore_vrfbuf_regif::wr_cb(cuint addr, uint data)
{
    #ifdef USR_CWR_SYSTEMC
...
/// @return read data
Chwcore_vrfbuf_regif::uint Chwcore_vrfbuf_regif::rd_cb(cuint addr)
{
    #ifdef USR_CWR_SYSTEMC
    uint data=0;
...
/// @return none
void Chwcore_vrfbuf_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chwcore_vrfbuf_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chwcore_vrfbuf_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Chwcore_vrfbuf_regif::EnableReset(const bool is_active)
{
...
#ifdef USR_CWR_SYSTEMC
uint Chwcore_vrfbuf_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Chwcore_vrfbuf_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    int reg_index = get_reg_index((uint)tag);
    assert(reg_index != (1<<16));
    uint length = mRegArray[reg_index]->length;
...
void Chwcore_vrfbuf_regif::cw_set_all_callback_reg(void)
{
