...
rh850g4::loop_reg1_disp16_instr_t::loop_reg1_disp16_instr_t
(
...
void rh850g4::loop_reg1_disp16_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::loop_reg1_disp16_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::loop_reg1_disp16_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::loop_reg1_disp16_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  //fastiss::i32_t *disp16 = gen_get_disp16_u32_17_31_shift1(opcode);
  int disp16 = get_disp16_u32_17_31_shift1(opcode);
  ...
  fastiss::i32_t *pc_dest = gen_select(branch_taken, gen_i32_constant(trans_PC + 4), gen_i32_constant(trans_PC - disp16));
...
unsigned int rh850g4::loop_reg1_disp16_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}
