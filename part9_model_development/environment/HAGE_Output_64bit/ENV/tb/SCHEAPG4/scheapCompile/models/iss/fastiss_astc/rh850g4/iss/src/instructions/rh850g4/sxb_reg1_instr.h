...
#ifndef _RH850G4_SXB_REG1_INSTR_H_
#define _RH850G4_SXB_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// sxb reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sxb_reg1 instruction
   */
  class sxb_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sxb_reg1 instruction constructor
    ...
    /**
     * \brief sxb_reg1 instruction destructor
     */
    virtual ~sxb_reg1_instr_t();
    ...
    /**
     * \brief sxb_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sxb_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sxb_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SXB_REG1_INSTR_H_
