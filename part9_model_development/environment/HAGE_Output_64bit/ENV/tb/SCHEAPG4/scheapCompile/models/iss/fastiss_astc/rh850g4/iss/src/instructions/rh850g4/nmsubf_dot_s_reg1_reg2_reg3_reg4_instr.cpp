...
//------------------------------------------------------------------------------
// nmsubf.s reg1, reg2, reg3, reg4 implementation
//------------------------------------------------------------------------------

rh850g4::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t
(
...
void rh850g4::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "nmsubf.s " << reg1_name << ", " << reg2_name << ", " << reg3_name << ", " << reg4_name; 
  return disass_string.str();
}

unsigned int rh850g4::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::nmsubf_dot_s_reg1_reg2_reg3_reg4_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  gen_update_dest_and_fpsr(true, reg4, gen_i32_cast(trunc_result.result), gen_i8_constant(0x20), continue_block);
