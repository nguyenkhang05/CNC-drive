...
#ifndef _RH850G4_SATADD_IMM5_REG2_INSTR_H_
#define _RH850G4_SATADD_IMM5_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// satadd imm5, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief satadd_imm5_reg2 instruction
   */
  class satadd_imm5_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief satadd_imm5_reg2 instruction constructor
    ...
    /**
     * \brief satadd_imm5_reg2 instruction destructor
     */
    virtual ~satadd_imm5_reg2_instr_t();
    ...
    /**
     * \brief satadd_imm5_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief satadd_imm5_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief satadd_imm5_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SATADD_IMM5_REG2_INSTR_H_
