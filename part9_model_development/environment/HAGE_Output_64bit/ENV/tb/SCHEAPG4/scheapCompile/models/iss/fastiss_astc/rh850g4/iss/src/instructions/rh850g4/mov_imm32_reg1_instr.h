...
#ifndef _RH850G4_MOV_IMM32_REG1_INSTR_H_
#define _RH850G4_MOV_IMM32_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// mov imm32, reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief mov_imm32_reg1 instruction
   */
  class mov_imm32_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief mov_imm32_reg1 instruction constructor
    ...
    /**
     * \brief mov_imm32_reg1 instruction destructor
     */
    virtual ~mov_imm32_reg1_instr_t();
    ...
    /**
     * \brief mov_imm32_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief mov_imm32_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief mov_imm32_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MOV_IMM32_REG1_INSTR_H_
