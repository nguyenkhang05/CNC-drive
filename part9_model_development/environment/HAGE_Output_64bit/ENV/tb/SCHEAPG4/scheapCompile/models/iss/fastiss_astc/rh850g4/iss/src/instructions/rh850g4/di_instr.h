...
#ifndef _RH850G4_DI_INSTR_H_
#define _RH850G4_DI_INSTR_H_
...
{
  /**
   * \brief di instruction
   */
  class di_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief di instruction constructor
    ...
    /**
     * \brief di instruction destructor
     */
    virtual ~di_instr_t();
    ...
    /**
     * \brief di instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief di instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief di instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief di instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
