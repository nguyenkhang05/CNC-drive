...
#ifndef _RH850G4_FLPV_DOT_S4_IMM2_WREG2_WREG3_INSTR_H_
#define _RH850G4_FLPV_DOT_S4_IMM2_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// flpv.s4 imm2, wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction
   */
  class flpv_dot_s4_imm2_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction constructor
     ...
     */
    flpv_dot_s4_imm2_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction destructor
     */
    virtual ~flpv_dot_s4_imm2_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief flpv_dot_s4_imm2_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_FLPV_DOT_S4_IMM2_WREG2_WREG3_INSTR_H_
