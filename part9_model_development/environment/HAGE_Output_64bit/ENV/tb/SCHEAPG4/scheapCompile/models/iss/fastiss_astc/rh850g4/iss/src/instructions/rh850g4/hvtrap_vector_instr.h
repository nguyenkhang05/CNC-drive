...
#ifndef _RH850G4_HVTRAP_VECTOR_INSTR_H_
#define _RH850G4_HVTRAP_VECTOR_INSTR_H_
...
//------------------------------------------------------------------------------
// hvtrap vector declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief hvtrap_vector instruction
   */
  class hvtrap_vector_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief hvtrap_vector instruction constructor
    ...
    /**
     * \brief hvtrap_vector instruction destructor
     */
    virtual ~hvtrap_vector_instr_t();
    ...
    /**
     * \brief hvtrap_vector instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief hvtrap_vector instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief hvtrap_vector instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief hvtrap_vector instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief hvtrap_vector instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_HVTRAP_VECTOR_INSTR_H_
