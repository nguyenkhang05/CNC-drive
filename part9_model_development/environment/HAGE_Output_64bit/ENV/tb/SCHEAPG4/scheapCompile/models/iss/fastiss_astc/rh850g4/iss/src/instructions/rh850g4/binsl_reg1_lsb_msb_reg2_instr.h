...
#ifndef _RH850G4_BINSL_REG1_LSB_MSB_REG2_INSTR_H_
#define _RH850G4_BINSL_REG1_LSB_MSB_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// binsl reg1, lsb, msb, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief binsl_reg1_lsb_msb_reg2 instruction
   */
  class binsl_reg1_lsb_msb_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief binsl_reg1_lsb_msb_reg2 instruction constructor
     ...
     */
    binsl_reg1_lsb_msb_reg2_instr_t
    (
    ...
    /**
     * \brief binsl_reg1_lsb_msb_reg2 instruction destructor
     */
    virtual ~binsl_reg1_lsb_msb_reg2_instr_t();
    ...
    /**
     * \brief binsl_reg1_lsb_msb_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief binsl_reg1_lsb_msb_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief binsl_reg1_lsb_msb_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_BINSL_REG1_LSB_MSB_REG2_INSTR_H_
