...
#ifndef _RH850G4_DBCP_INSTR_H_
#define _RH850G4_DBCP_INSTR_H_
...
{
  /**
   * \brief dbcp instruction
   */
  class dbcp_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dbcp instruction constructor
    ...
    /**
     * \brief dbcp instruction destructor
     */
    virtual ~dbcp_instr_t();
    ...
    /**
     * \brief dbcp instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dbcp instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbcp instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
