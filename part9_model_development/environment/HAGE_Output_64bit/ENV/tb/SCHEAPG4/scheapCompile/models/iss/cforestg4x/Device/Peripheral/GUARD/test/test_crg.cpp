...
protected:
    ...
    virtual ~Crg1() {}
    virtual void SetUp() {
        m_crg           = new Crg (base_crgreg, base_crgreg_ivc, base_crgreg_csg, CORE_G4MH, CORE_VER_11, m_clid);
    }
...
public:
    ...
    const uint32_t base_crgreg_ivc = 0x0;
    const uint32_t base_crgreg_csg = 0x0;
    union {
      uint32_t m_data32;
      uint16_t m_data16[2];
      uint8_t  m_data8[4];
...
TEST_F(Crg1, Check_TargetWrite) {
    ...
    ASSERT_THROW(m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);
    ASSERT_THROW(m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);
    ASSERT_THROW(m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);
    ASSERT_THROW(m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);

    m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGKCPROT_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_32BIT);

    m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x53, 0x01, 0x00, 0x00}, SIZE_32BIT);
    // at least, 1 CRG channel setting is enable.

    m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crg->TargetWrite(sb_info, base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
...
TEST_F(Crg1, Check_TargetRead) {
    ...
    m_crg->TargetRead(sb_info, base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    ...
    m_crg->TargetRead(sb_info, base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    ...
    m_crg->TargetRead(sb_info, base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    ...
    m_crg->TargetRead(sb_info,  base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
...
TEST_F(Crg1, Check_TargetFetch) {
    ...
    m_crg->TargetFetch(sb_info, base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgprot, sizeof(m_data32));
    uint32_t m_data32_out_crgprot = m_data32;
    memcpy (&m_data32, data_8_input_crgprot, sizeof(m_data32));
    uint32_t m_data32_in_crgprot = m_data32;
    ...
    m_crg->TargetFetch(sb_info, base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgspid, sizeof(m_data32));
    uint32_t m_data32_out_crgspid = m_data32;
    memcpy (&m_data32, data_8_input_crgspid, sizeof(m_data32));
    uint32_t m_data32_in_crgspid = m_data32;
    ...
    m_crg->TargetFetch(sb_info, base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgbad, sizeof(m_data32));
    uint32_t m_data32_out_crgbad = m_data32;
    memcpy (&m_data32, data_8_input_crgbad, sizeof(m_data32));
    uint32_t m_data32_in_crgbad = m_data32;
    ...
    m_crg->TargetFetch(sb_info,  base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgadv, sizeof(m_data32));
    uint32_t m_data32_out_crgadv = m_data32;
    memcpy (&m_data32, data_8_input_crgadv, sizeof(m_data32));
    uint32_t m_data32_in_crgadv = m_data32;
...
TEST_F(Crg1, Check_TargetWriteDebug) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x53, 0x01, 0x00, 0x00}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
...
TEST_F(Crg1, Check_TargetReadDebug) {
    ...
    m_crg->TargetReadDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgprot, sizeof(m_data32));
    uint32_t m_data32_out_crgprot = m_data32;
    memcpy (&m_data32, data_8_input_crgprot, sizeof(m_data32));
    uint32_t m_data32_in_crgprot = m_data32;
    ...
    m_crg->TargetReadDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgspid, sizeof(m_data32));
    uint32_t m_data32_out_crgspid = m_data32;
    memcpy (&m_data32, data_8_input_crgspid, sizeof(m_data32));
    uint32_t m_data32_in_crgspid = m_data32;
    ...
    m_crg->TargetReadDebug(base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgbad, sizeof(m_data32));
    uint32_t m_data32_out_crgbad = m_data32;
    memcpy (&m_data32, data_8_input_crgbad, sizeof(m_data32));
    uint32_t m_data32_in_crgbad = m_data32;
    ...
    m_crg->TargetReadDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgadv, sizeof(m_data32));
    uint32_t m_data32_out_crgadv = m_data32;
    memcpy (&m_data32, data_8_input_crgadv, sizeof(m_data32));
    uint32_t m_data32_in_crgadv = m_data32;
...
TEST_F(Crg2, Check_IsAddressMatch_1) {
    ...
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC000000, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC000004, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC000FFF, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC00FFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC0FFFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFCFFFFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_11));

    // Set ADV = 0x03FFF000,
    m_crg->GetCrgCtrl()->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
...
TEST_F(Crg2, Check_IsAddressMatch_2) {
    ...
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC00FFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFC0FFFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFCFFFFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsSpidAllowed_1) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetSPID(0);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetSPID(31);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetSPID(15);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
...
TEST_F(Crg2, Check_IsSpidAllowed_2) {
    ...
    sb_info.SetSPID(0);
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetSPID(31);
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetSPID(15);
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
...
TEST_F(Crg2, Check_IsWriteGloAllowed_1) {
    ...
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsWriteGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsWriteGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsWriteGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsWriteGloAllowed(chn_0, DATA_RMW, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsWriteGloAllowed_3) {
    ...
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsWriteGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsReadGloAllowed_1) {
    ...
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, DATA_RMW, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsReadGloAllowed_3) {
    ...
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsReadGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsUMDisabled_1) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetUM(0);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsUMDisabled(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetUM(1);
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsUMDisabled(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsUMDisabled_2) {
    ...
    // Enable UME
    m_crg->GetCrgCtrl()->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
...
TEST_F(Crg2, Check_IsDbgAllowed_1) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetDM(0);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
    sb_info.SetDM(1);
    ASSERT_FALSE(m_crg->GetCrgCtrl()->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg2, Check_IsDbgAllowed_3) {
    ...
    sb_info.SetDM(1);
    ASSERT_TRUE(m_crg->GetCrgCtrl()->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_11));
}
...
TEST_F(Crg3, Check_IsMemAccPermit_1) {
    ...
    ASSERT_EQ(SYSERR_NONE, m_crg->IsMemAccPermit(sb_info, base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
...
TEST_F(Crg4, Check_IsMemAccPermit_AddrMatch_ch1) {
    SideBand sb_info;
    uint32_t chn_1 = 0x1;
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0xFC}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
                                    new uint8_t[4] {0x00, 0xF0, 0xFF, 0x03}, SIZE_32BIT);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->Reset();
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetGuardEn(true);
...
TEST_F(Crg4, Check_IsMemAccPermit_AddrMatch_ch2) {
    SideBand sb_info;
    uint32_t chn_2 = 0x2;
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0xFC}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
                                    new uint8_t[4] {0x00, 0xF0, 0xFF, 0x03}, SIZE_32BIT);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->Reset();
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetGuardEn(true);
...
TEST_F(Crg4, Check_IsMemAccPermit_AddrMatch_ch3) {
    SideBand sb_info;
    uint32_t chn_3 = 0x3;
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0xFC}, SIZE_32BIT);
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
                                    new uint8_t[4] {0x00, 0xF0, 0xFF, 0x03}, SIZE_32BIT);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->Reset();
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetGuardEn(true);
...
TEST_F(Crg4, Check_IsMemAccPermit_IsDbgAllowed_ch1) {
    ...
    // Enable Debug permision
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
                                    new uint8_t[4] {0x40, 0x00, 0x00, 0x00}, SIZE_32BIT);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->Reset();
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetGuardEn(true);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetChannelEn(chn_1, true);
...
TEST_F(Crg4, Check_IsMemAccPermit_IsDbgAllowed_ch2) {
    ...
    // Enable Debug permision
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
                                    new uint8_t[4] {0x40, 0x00, 0x00, 0x00}, SIZE_32BIT);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->Reset();
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetGuardEn(true);
    m_crg->GetCrgCtrl()->GetCrgCtrlReg()->GetCrgInternal()->SetChannelEn(chn_2, true);
...
TEST_F(Crg4, Check_IsMemAccPermit_IsDbgAllowed_ch3) {
    ...
    // Enable Debug permision
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
...
TEST_F(Crg4, Check_IsMemAccPermit_IsSPIDllowed_ch1) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Enable SPID
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
                                    new uint8_t[4] {0x02, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Disable Debug permision
    // Set WG, RG to invalid access.
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_1,
...
TEST_F(Crg4, Check_IsMemAccPermit_IsSPIDllowed_ch2) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Enable SPID
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
                                    new uint8_t[4] {0x02, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Disable Debug permision
    // Set WG, RG to invalid access.
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_2,
...
TEST_F(Crg4, Check_IsMemAccPermit_IsSPIDllowed_ch3) {
    ...
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Enable SPID
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
                                    new uint8_t[4] {0x02, 0x00, 0x00, 0x00}, SIZE_32BIT);
    // Disable Debug permision
    // Set WG, RG to invalid access.
    m_crg->TargetWriteDebug(base_crgreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_3,
...
TEST_F(Crg5, Check_CauseError_SX2MBLCL) {
    ...
    ASSERT_EQ(SYSERR_CRG, m_crg->CauseError(sb_info, err_addr_bank0,
                           INST_READ, CORE_G4MH, CORE_VER_11));
    ...
    ASSERT_EQ(0x1U, m_crg->GetCrgErrCap()->GetCrgErrStat()->GetERR());
...
TEST_F(Crg5, Check_CauseError_CRAMLCLm) {
    ...
    ASSERT_EQ(SYSERR_CRG, m_crg->CauseError(sb_info, err_addr_bank0,
                           DATA_WRITE, CORE_G4MH, CORE_VER_11));
    ASSERT_NE(nullptr, m_crg->GetCrgErrCap());
...
TEST_F(Crg5, Check_CauseError_PEnCLm) {
    ...
    ASSERT_EQ(SYSERR_CRG, m_crg->CauseError(sb_info, err_addr_bank0,
                           DATA_READ, CORE_G4MH, CORE_VER_11));
    ASSERT_NE(nullptr, m_crg->GetCrgErrCap());
