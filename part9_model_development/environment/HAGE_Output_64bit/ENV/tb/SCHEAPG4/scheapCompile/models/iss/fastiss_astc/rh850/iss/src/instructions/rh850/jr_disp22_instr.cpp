...
rh850::jr_disp22_instr_t::jr_disp22_instr_t
(
...
void rh850::jr_disp22_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
std::string rh850::jr_disp22_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  int disp22 = get_disp22_s32_0_5_17_31_shift1(opcode);
...
unsigned int rh850::jr_disp22_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850::jr_disp22_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
