...
#ifndef _RH850_CAXI_IND_REG1_REG2_REG3_INSTR_H_
#define _RH850_CAXI_IND_REG1_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// caxi [reg1], reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief caxi_ind_reg1_reg2_reg3 instruction
   */
  class caxi_ind_reg1_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction constructor
     ...
     */
    caxi_ind_reg1_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction destructor
     */
    virtual ~caxi_ind_reg1_reg2_reg3_instr_t();
    ...
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief caxi_ind_reg1_reg2_reg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_CAXI_IND_REG1_REG2_REG3_INSTR_H_
