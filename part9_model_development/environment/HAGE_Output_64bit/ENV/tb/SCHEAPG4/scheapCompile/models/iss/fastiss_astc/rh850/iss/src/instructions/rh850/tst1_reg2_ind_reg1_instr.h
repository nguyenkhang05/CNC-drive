...
#ifndef _RH850_TST1_REG2_IND_REG1_INSTR_H_
#define _RH850_TST1_REG2_IND_REG1_INSTR_H_
...
namespace rh850
{
  ...
  public:
    ...
    /**
     * \brief tst1_reg2_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_TST1_REG2_IND_REG1_INSTR_H_
