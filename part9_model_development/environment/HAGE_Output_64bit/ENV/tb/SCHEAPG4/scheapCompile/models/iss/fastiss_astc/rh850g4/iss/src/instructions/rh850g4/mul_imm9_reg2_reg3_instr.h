...
#ifndef _RH850G4_MUL_IMM9_REG2_REG3_INSTR_H_
#define _RH850G4_MUL_IMM9_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// mul imm9, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief mul_imm9_reg2_reg3 instruction
   */
  class mul_imm9_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief mul_imm9_reg2_reg3 instruction constructor
    ...
    /**
     * \brief mul_imm9_reg2_reg3 instruction destructor
     */
    virtual ~mul_imm9_reg2_reg3_instr_t();
    ...
    /**
     * \brief mul_imm9_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief mul_imm9_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief mul_imm9_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MUL_IMM9_REG2_REG3_INSTR_H_
