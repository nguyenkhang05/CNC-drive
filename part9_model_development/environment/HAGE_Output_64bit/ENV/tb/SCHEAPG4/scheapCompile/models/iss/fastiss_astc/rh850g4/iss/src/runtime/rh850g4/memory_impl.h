...
#ifndef _RH850G4_MEMORY_IMPL_H_
#define _RH850G4_MEMORY_IMPL_H_
...
namespace rh850g4
{
  class memory_impl_t : public rh850g4::memory_if_t
  {
  protected:
    rh850g4::cpu_state_if_t *m_cpu_state;
    fastiss::code_gen_if_t* m_code_gen_impl;
    rh850g4::bus_interface_t *m_bus_interface;
  public:
    memory_impl_t();
    ~memory_impl_t();
    ...
    void initialise_analysis_points(rh850g4::analysis_callback_manager *callback_manager);
    ...
    void add_read_watchpoint( rh850g4::watchpoint_info_t *wp );
    void add_write_watchpoint( rh850g4::watchpoint_info_t *wp );

    void erase_watchpoint( unsigned int wp );
    void erase_read_watchpoint( rh850g4::watchpoint_info_t *wp );
    void erase_write_watchpoint( rh850g4::watchpoint_info_t *wp );
    ...
    virtual unsigned long long calculate_effective_address(rh850g4::access_type_t type, unsigned int virtual_address) = 0;
    virtual bool calculate_physical_address(rh850g4::access_type_t type,
  ...
  protected:
    ...
    // Analysis points
    rh850g4::analysis_point_if *m_imm_ld_analysis_point;
    rh850g4::analysis_point_if *m_imm_st_analysis_point;
    rh850g4::analysis_point_if *m_gen_ld_analysis_point;
    rh850g4::analysis_point_if *m_gen_st_analysis_point;
  };
}

#endif // _RH850G4_MEMORY_IMPL_H_
