...
#ifndef _RH850G4_PREPARE_LIST12_IMM5_BITS_FF_INSTR_H_
#define _RH850G4_PREPARE_LIST12_IMM5_BITS_FF_INSTR_H_
...
//------------------------------------------------------------------------------
// prepare list12, imm5, bits_ff declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief prepare_list12_imm5_bits_ff instruction
   */
  class prepare_list12_imm5_bits_ff_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief prepare_list12_imm5_bits_ff instruction constructor
     ...
     */
    prepare_list12_imm5_bits_ff_instr_t
    (
    ...
    /**
     * \brief prepare_list12_imm5_bits_ff instruction destructor
     */
    virtual ~prepare_list12_imm5_bits_ff_instr_t();
    ...
    /**
     * \brief prepare_list12_imm5_bits_ff instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief prepare_list12_imm5_bits_ff instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief prepare_list12_imm5_bits_ff instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief prepare_list12_imm5_bits_ff instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_PREPARE_LIST12_IMM5_BITS_FF_INSTR_H_
