...
#ifndef _RH850G4_LDM_DOT_MP_IND_REG1_EH_DEC_ET_INSTR_H_
#define _RH850G4_LDM_DOT_MP_IND_REG1_EH_DEC_ET_INSTR_H_
...
//------------------------------------------------------------------------------
// ldm.mp [reg1], eh-et declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction
   */
  class ldm_dot_mp_ind_reg1_eh_dec_et_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction constructor
     ...
     */
    ldm_dot_mp_ind_reg1_eh_dec_et_instr_t
    (
    ...
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction destructor
     */
    virtual ~ldm_dot_mp_ind_reg1_eh_dec_et_instr_t();
    ...
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldm_dot_mp_ind_reg1_eh_dec_et instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_LDM_DOT_MP_IND_REG1_EH_DEC_ET_INSTR_H_
