...
#ifndef _RH850G4_NOP_INSTR_H_
#define _RH850G4_NOP_INSTR_H_
...
namespace rh850g4
{
   ...
   */
  class nop_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief nop instruction constructor
    ...
    /**
     * \brief nop instruction destructor
     */
    virtual ~nop_instr_t();
    ...
    /**
     * \brief nop instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief nop instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief nop instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
