...
#ifndef _RH850G4_SLD_DOT_W_DISP8_IND_EP_REG2_INSTR_H_
#define _RH850G4_SLD_DOT_W_DISP8_IND_EP_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// sld.w disp8 [ep], reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sld_dot_w_disp8_ind_ep_reg2 instruction
   */
  class sld_dot_w_disp8_ind_ep_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sld_dot_w_disp8_ind_ep_reg2 instruction constructor
     ...
     */
    sld_dot_w_disp8_ind_ep_reg2_instr_t
    (
    ...
    /**
     * \brief sld_dot_w_disp8_ind_ep_reg2 instruction destructor
     */
    virtual ~sld_dot_w_disp8_ind_ep_reg2_instr_t();
    ...
    /**
     * \brief sld_dot_w_disp8_ind_ep_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sld_dot_w_disp8_ind_ep_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sld_dot_w_disp8_ind_ep_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SLD_DOT_W_DISP8_IND_EP_REG2_INSTR_H_
