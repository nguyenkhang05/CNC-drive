...
#ifndef _RH850G4_PREPARE_LIST12_IMM5_INSTR_H_
#define _RH850G4_PREPARE_LIST12_IMM5_INSTR_H_
...
//------------------------------------------------------------------------------
// prepare list12, imm5 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief prepare_list12_imm5 instruction
   */
  class prepare_list12_imm5_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief prepare_list12_imm5 instruction constructor
    ...
    /**
     * \brief prepare_list12_imm5 instruction destructor
     */
    virtual ~prepare_list12_imm5_instr_t();
    ...
    /**
     * \brief prepare_list12_imm5 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief prepare_list12_imm5 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief prepare_list12_imm5 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief prepare_list12_imm5 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_PREPARE_LIST12_IMM5_INSTR_H_
