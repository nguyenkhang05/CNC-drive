...
#ifndef _RH850G4_ROUNDF_DOT_SUW4_WREG2_WREG3_INSTR_H_
#define _RH850G4_ROUNDF_DOT_SUW4_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// roundf.suw4 wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief roundf_dot_suw4_wreg2_wreg3 instruction
   */
  class roundf_dot_suw4_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction constructor
     ...
     */
    roundf_dot_suw4_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction destructor
     */
    virtual ~roundf_dot_suw4_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief roundf_dot_suw4_wreg2_wreg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_ROUNDF_DOT_SUW4_WREG2_WREG3_INSTR_H_
