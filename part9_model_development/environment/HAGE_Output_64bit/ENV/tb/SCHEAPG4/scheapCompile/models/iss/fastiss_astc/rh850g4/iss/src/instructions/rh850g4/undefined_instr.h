...
#ifndef _RH850G4_UNDEFINED_INSTR_H_
#define _RH850G4_UNDEFINED_INSTR_H_
...
//------------------------------------------------------------------------------
// Undefined instruction declaration
//------------------------------------------------------------------------------
...
namespace rh850g4
{
   ...
   */
  class undefined_instr_t : public instruction_base_impl_t
  {
  public:
    /**
    ...
    /**
     * \brief Undefined instruction destructor
     */
    virtual ~undefined_instr_t();
    ...
    /**
     * \brief Undefined instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief Undefined instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief None instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief Undefined instruction terminates_block attribute query handler
     * \param opcode Undefined instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_UNDEFINED_INSTR_H_
