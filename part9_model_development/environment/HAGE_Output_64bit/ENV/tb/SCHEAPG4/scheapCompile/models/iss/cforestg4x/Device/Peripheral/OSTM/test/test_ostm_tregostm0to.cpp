...
public:
  ...
  PhysAddr start_addr = 0xFFEC0008;
...
TEST_F(OstmRegAccessTest, CheckTO_GetName) {
    ...
    TRegOSTMnTO* OSTM0TO = new TRegOSTMnTO(m_ostm0_core);

    ASSERT_STREQ("OSTMnTO", OSTM0TO->GetName());
...
TEST_F(OstmRegAccessTest, CheckTO_InitalValue) {
    for (ostmch = 0; ostmch < MAX_OSTM_NUM; ostmch++){
        ...
        ASSERT_EQ(expect_data, OSTM0TO->GetVal());
        delete OSTM0TO;
        delete m_ostm0_core;
        delete m_ostm[ostmch];
    }
...
std::tuple<PhysAddr, int32_t, ByteSize, ByteSize, int32_t> const RW_ParametersTable[] = {
  /* 0000 */ std::make_tuple(0xFFEC0008 /* TO */, 0xf3f2ffff, SIZE_16BIT, SIZE_16BIT, 0x0), //16bit access
  /* 0000 */ std::make_tuple(0xFFEC000A /* TO */, 0xf3f2ffff, SIZE_16BIT, SIZE_16BIT, 0x0), //16bit access
  /* 0000 */ std::make_tuple(0xFFEC0008 /* TO */, 0xf3f2ffff, SIZE_8BIT, SIZE_8BIT, 0x1), //8bit access
  /* 0000 */ std::make_tuple(0xFFEC0008 /* TO */, 0xf3f2ffff, SIZE_32BIT, SIZE_32BIT, 0x0), //32bit access
  /* 0000 */ std::make_tuple(0xFFEC0009 /* TO */, 0xf3f2ffff, SIZE_8BIT, SIZE_8BIT, 0x0), //8bit access
  /* 0000 */ std::make_tuple(0xFFEC000A /* TO */, 0xf3f2ffff, SIZE_8BIT, SIZE_8BIT, 0x0), //8bit access
  /* 0000 */ std::make_tuple(0xFFEC000B /* TO */, 0xf3f2ffff, SIZE_8BIT, SIZE_8BIT, 0x0), //8bit access
