...
outf.WriteLine("const char " & symbol & "_data[] = {")
...
While Not ts.atEndOfStream
    ...
    rem hexstr = Hex(byteval)
    rem If byteval < 16 Then hexstr = "0" & hexstr
    rem outf.Write("0x" & hexstr)
    outf.Write(byteval)
    offset = offset + 1
Wend

outf.WriteLine(vbCrLf & ",0};" & vbCrLf)
