...
//------------------------------------------------------------------------------
// mac reg1, reg2, reg3, reg4 implementation
//------------------------------------------------------------------------------

rh850::mac_reg1_reg2_reg3_reg4_instr_t::mac_reg1_reg2_reg3_reg4_instr_t
(
...
void rh850::mac_reg1_reg2_reg3_reg4_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850::mac_reg1_reg2_reg3_reg4_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "mac " << reg1_name << ", " << reg2_name << ", " << reg3_name << ", " << reg4_name;
  return disass_string.str();
}

unsigned int rh850::mac_reg1_reg2_reg3_reg4_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850::mac_reg1_reg2_reg3_reg4_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  fastiss::i32_t *reg3_plus1_load = gen_read_GR(rh850::GR_index_t((reg3 +1) & 0x1f));

  // Calculate result
  fastiss::i64_t *mul_res = gen_mul(gen_i64_sext(reg2_load), gen_i64_sext(reg1_load));  
  ...
  gen_write_GR(rh850::GR_index_t(reg4+1), gen_i32_extract(result, gen_i64_constant(1)));
