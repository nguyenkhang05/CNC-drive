...
#ifndef _RH850G4_OR_REG1_REG2_INSTR_H_
#define _RH850G4_OR_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// or reg1, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief or_reg1_reg2 instruction
   */
  class or_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief or_reg1_reg2 instruction constructor
    ...
    /**
     * \brief or_reg1_reg2 instruction destructor
     */
    virtual ~or_reg1_reg2_instr_t();
    ...
    /**
     * \brief or_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief or_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief or_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_OR_REG1_REG2_INSTR_H_
