...
#ifndef _RH850G4_ABSF_DOT_D_REG2_REG3_INSTR_H_
#define _RH850G4_ABSF_DOT_D_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// absf.d reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief absf_dot_d_reg2_reg3 instruction
   */
  class absf_dot_d_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief absf_dot_d_reg2_reg3 instruction constructor
    ...
    /**
     * \brief absf_dot_d_reg2_reg3 instruction destructor
     */
    virtual ~absf_dot_d_reg2_reg3_instr_t();
    ...
    /**
     * \brief absf_dot_d_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief absf_dot_d_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief absf_dot_d_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ABSF_DOT_D_REG2_REG3_INSTR_H_
