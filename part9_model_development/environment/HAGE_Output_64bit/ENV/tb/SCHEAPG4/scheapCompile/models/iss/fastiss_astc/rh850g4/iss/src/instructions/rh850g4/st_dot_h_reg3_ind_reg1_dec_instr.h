...
#ifndef _RH850G4_ST_DOT_H_REG3_IND_REG1_DEC_INSTR_H_
#define _RH850G4_ST_DOT_H_REG3_IND_REG1_DEC_INSTR_H_
...
{
  /**
   * \brief st_dot_h_reg3_ind_reg1_dec instruction
   */
  class st_dot_h_reg3_ind_reg1_dec_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief st_dot_h_reg3_ind_reg1_dec instruction constructor
     ...
     */
    st_dot_h_reg3_ind_reg1_dec_instr_t
    (
    ...
    /**
     * \brief st_dot_h_reg3_ind_reg1_dec instruction destructor
     */
    virtual ~st_dot_h_reg3_ind_reg1_dec_instr_t();
    ...
    /**
     * \brief st_dot_h_reg3_ind_reg1_dec instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief st_dot_h_reg3_ind_reg1_dec instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief st_dot_h_reg3_ind_reg1_dec instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ST_DOT_H_REG3_IND_REG1_DEC_INSTR_H_
