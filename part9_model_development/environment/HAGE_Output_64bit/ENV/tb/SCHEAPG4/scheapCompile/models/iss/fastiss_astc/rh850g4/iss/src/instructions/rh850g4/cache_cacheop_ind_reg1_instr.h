...
#ifndef _RH850G4_CACHE_CACHEOP_IND_REG1_INSTR_H_
#define _RH850G4_CACHE_CACHEOP_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// cache cacheop, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief cache_cacheop_ind_reg1 instruction
   */
  class cache_cacheop_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief cache_cacheop_ind_reg1 instruction constructor
     ...
     */
    cache_cacheop_ind_reg1_instr_t
    (
    ...
    /**
     * \brief cache_cacheop_ind_reg1 instruction destructor
     */
    virtual ~cache_cacheop_ind_reg1_instr_t();
    ...
    /**
     * \brief cache_cacheop_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief cache_cacheop_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief cache_cacheop_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_CACHE_CACHEOP_IND_REG1_INSTR_H_
