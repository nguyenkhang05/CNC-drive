...
protected:
    ...
    virtual void SetUp() {
        ...
        m_treg_crgctrlreg   = new TRegCrgCtrlReg (base_crgctrlreg, base_crgreg_ivc, CORE_G4MH, CORE_VER_11, guard_internal);
    }
...
TEST_F(TRegCrgCtrlReg1, Check_Initial_Setup) {
    ...
    for (uint32_t chn = 0; chn < GuardInternal_Interface::NUM_CRG_CTRL_CHANNEL; chn++) {
        ...
        ASSERT_EQ(base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn, m_treg_crgctrlreg->GetCrgProt(chn)->GetRegAddr());
        ...
        ASSERT_EQ(base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn, m_treg_crgctrlreg->GetCrgSpid(chn)->GetRegAddr());
        ...
        ASSERT_EQ(base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn, m_treg_crgctrlreg->GetCrgBad(chn)->GetRegAddr());
        ...
        ASSERT_EQ(base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn, m_treg_crgctrlreg->GetCrgAdv(chn)->GetRegAddr());
    }
}
