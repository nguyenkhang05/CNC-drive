...
G4_MevAdptr::G4_MevAdptr( sc_module_name name ):
  sc_module( name ),
  is( 0 ),
  ts( 0 ),
  mPeNum( 1 ),
...
/// <returns>none</returns>
void
G4_MevAdptr::setPeNum( unsigned int peNum )
{
...
/// <returns>none</returns>
void
G4_MevAdptr::setClkDivision( unsigned int peid, unsigned int clkDiv )
{
...
/// <returns>none</returns>
void
G4_MevAdptr::setReadLatency( uint64 latency )
{
...
/// <returns>none</returns>
void
G4_MevAdptr::setWriteLatency( uint64 latency )
{
...
unsigned int
G4_MevAdptr::transport_dbg( TlmTransactionType& trans )
{
...
void
G4_MevAdptr::invalidate_direct_mem_ptr(
  uint64 startRange,
  uint64 endRange )
{
...
/// <summary>dummy</summary>
bool
G4_MevAdptr::get_direct_mem_ptr(
  TlmTransactionType& trans,
  tlm::tlm_dmi&       dmiData )
{
