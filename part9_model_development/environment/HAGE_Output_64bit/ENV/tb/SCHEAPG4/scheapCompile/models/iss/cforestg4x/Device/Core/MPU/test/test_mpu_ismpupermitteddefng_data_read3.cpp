/**
 * @file test_mpu_ismpupermitteddefng_data_read3.cpp
 *
 ...
 */
TEST_P(MpuMethodCheck, CheckIsMpuPermittedDefNG_DATA_READ_5) {
 ...
 *        condition: GMPE=0 & no host entry
 */
TEST_P(MpuMethodCheck, CheckIsMpuPermittedDefNG_DATA_READ_6) {
  bool gm = std::get<0>(GetParam());
  bool mpe = std::get<1>(GetParam());
  bool gmpe = std::get<2>(GetParam());
  bool um = std::get<3>(GetParam());
 ...
 */
TEST_F(MpuMethodCheck, CheckIsMpuPermittedDefNG_DATA_READ_7) {
 ...
 */
TEST_F(MpuMethodCheck, CheckIsMpuPermittedDefNG_DATA_READ_8) {
