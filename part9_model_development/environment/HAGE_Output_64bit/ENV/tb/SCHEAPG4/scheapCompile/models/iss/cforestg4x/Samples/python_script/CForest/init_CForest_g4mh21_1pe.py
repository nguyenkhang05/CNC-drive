...
set_guards_param ("crg", 0, "crgaddrw", 19) # Set 19 for ADDRW of CRG_CL0
#set_guards_param ("crg", 1, "crgaddrw", 19) # Set 19 for ADDRW of CRG_CL1
#set_guards_param ("crg", 2, "crgaddrw", 21) # Set 21 for ADDRW of CRG_CL2
#set_guards_param ("crg", 3, "crgaddrw", 18) # Set 18 for ADDRW of CRG_CL3

#set_peinfo(peid, clid, core)
set_peinfo (0,    0,    'g4mh2.1') # PE0CL0
#set_peinfo (1,    0,    'g4mh2.1') # PE1CL0
#set_peinfo (2,    1,    'g4mh2.1') # PE2CL1
#set_peinfo (3,    1,    'g4mh2.1') # PE3CL1
