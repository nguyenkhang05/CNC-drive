...
#ifndef _RH850G4_RIE_IMM5_IMM4_INSTR_H_
#define _RH850G4_RIE_IMM5_IMM4_INSTR_H_
...
//------------------------------------------------------------------------------
// rie imm5, imm4 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief rie_imm5_imm4 instruction
   */
  class rie_imm5_imm4_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief rie_imm5_imm4 instruction constructor
    ...
    /**
     * \brief rie_imm5_imm4 instruction destructor
     */
    virtual ~rie_imm5_imm4_instr_t();
    ...
    /**
     * \brief rie_imm5_imm4 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rie_imm5_imm4 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rie_imm5_imm4 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rie_imm5_imm4 instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rie_imm5_imm4 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_RIE_IMM5_IMM4_INSTR_H_
