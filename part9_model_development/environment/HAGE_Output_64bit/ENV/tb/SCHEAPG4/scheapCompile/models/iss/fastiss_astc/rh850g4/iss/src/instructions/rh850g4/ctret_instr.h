...
#ifndef _RH850G4_CTRET_INSTR_H_
#define _RH850G4_CTRET_INSTR_H_
...
{
  /**
   * \brief ctret instruction
   */
  class ctret_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ctret instruction constructor
    ...
    /**
     * \brief ctret instruction destructor
     */
    virtual ~ctret_instr_t();
    ...
    /**
     * \brief ctret instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ctret instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ctret instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ctret instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ctret instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
