...
#ifndef _RH850_CLR1_BIT_3_DISP16_IND_REG1_INSTR_H_
#define _RH850_CLR1_BIT_3_DISP16_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// clr1 bit#3, disp16 [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief clr1_bit_3_disp16_ind_reg1 instruction
   */
  class clr1_bit_3_disp16_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction constructor
     ...
     */
    clr1_bit_3_disp16_ind_reg1_instr_t
    (
    ...
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction destructor
     */
    virtual ~clr1_bit_3_disp16_ind_reg1_instr_t();
    ...
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief clr1_bit_3_disp16_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_CLR1_BIT_3_DISP16_IND_REG1_INSTR_H_
