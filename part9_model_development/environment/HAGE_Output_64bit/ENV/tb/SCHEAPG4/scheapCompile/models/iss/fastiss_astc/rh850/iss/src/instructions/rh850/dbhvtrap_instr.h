...
#ifndef _RH850_DBHVTRAP_INSTR_H_
#define _RH850_DBHVTRAP_INSTR_H_
...
//------------------------------------------------------------------------------
// dbhvtrap declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief dbhvtrap instruction
   */
  class dbhvtrap_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dbhvtrap instruction constructor
    ...
    /**
     * \brief dbhvtrap instruction destructor
     */
    virtual ~dbhvtrap_instr_t();
    ...
    /**
     * \brief dbhvtrap instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dbhvtrap instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbhvtrap instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_DBHVTRAP_INSTR_H_
