...
#ifndef _RH850_SET1_REG2_IND_REG1_INSTR_H_
#define _RH850_SET1_REG2_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// set1 reg2, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief set1_reg2_ind_reg1 instruction
   */
  class set1_reg2_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief set1_reg2_ind_reg1 instruction constructor
    ...
    /**
     * \brief set1_reg2_ind_reg1 instruction destructor
     */
    virtual ~set1_reg2_ind_reg1_instr_t();
    ...
    /**
     * \brief set1_reg2_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief set1_reg2_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief set1_reg2_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief set1_reg2_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_SET1_REG2_IND_REG1_INSTR_H_
