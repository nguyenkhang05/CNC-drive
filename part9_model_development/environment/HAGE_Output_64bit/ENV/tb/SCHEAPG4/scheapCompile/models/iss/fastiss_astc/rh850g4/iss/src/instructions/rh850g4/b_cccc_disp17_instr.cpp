...
rh850g4::b_cccc_disp17_instr_t::b_cccc_disp17_instr_t
(
...
void rh850g4::b_cccc_disp17_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
std::string rh850g4::b_cccc_disp17_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  unsigned char cccc = get_cccc_u8_0_3(opcode);
  int disp17 = get_disp17_s32_4_17_31_shift1(opcode);
...
unsigned int rh850g4::b_cccc_disp17_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::b_cccc_disp17_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  fastiss::i32_t *pc_dest = gen_select(branch_taken, gen_i32_constant(trans_PC + disp17), gen_i32_constant(trans_PC + 4));
...
unsigned int rh850g4::b_cccc_disp17_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}
