...
#ifndef _RH850G4_LD_DOT_W_DISP16_IND_REG1_REG2_INSTR_H_
#define _RH850G4_LD_DOT_W_DISP16_IND_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// ld.w disp16 [reg1], reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction
   */
  class ld_dot_w_disp16_ind_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction constructor
     ...
     */
    ld_dot_w_disp16_ind_reg1_reg2_instr_t
    (
    ...
    /**
     * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction destructor
     */
    virtual ~ld_dot_w_disp16_ind_reg1_reg2_instr_t();
    ...
    /**
     * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ld_dot_w_disp16_ind_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_LD_DOT_W_DISP16_IND_REG1_REG2_INSTR_H_
