...
/**
 * \file operand_if.h
 * \brief Defines the rh850g4 operand extraction interface class
 */

#ifndef _RH850G4_OPERAND_IF_H_
#define _RH850G4_OPERAND_IF_H_
...
//------------------------------------------------------------------------------
// rh850g4 operand extraction interface definition
//------------------------------------------------------------------------------
...
namespace rh850g4
{
  ...
  public:
     ...
     */
    virtual rh850g4::GR_index_t get_reg1_u8_0_4(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg1 operand
     */
    virtual rh850g4::GR_index_t get_reg1_u8_16_20(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::GR_index_t get_reg2_u8_0_4(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg2 operand
     */
    virtual rh850g4::GR_index_t get_reg2_u8_11_15(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::GR_index_t get_reg3_u8_27_31(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::GR_index_t get_reg4_u8_17_20_shift1(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg4 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg4 operand
     */
    virtual rh850g4::GR_index_t get_reg4_u8_17_20_23(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg1 operand
     */
    virtual rh850g4::GR_index_t get_reg1_u8_1_4_shift1(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg2 operand
     */
    virtual rh850g4::GR_index_t get_reg2_u8_12_15_shift1(opcode_t opcode) = 0;
    /**
     * \brief Calculates a GR register group index value representing the value of the reg3 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg3 operand
     */
    virtual rh850g4::GR_index_t get_reg3_u8_28_31_shift1(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::SR_SELID_0_index_t get_regID_u8_0_4(opcode_t opcode) = 0;
    /**
     * \brief Calculates a SR_SELID_0 register group index value representing the value of the regID operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the regID operand
     */
    virtual rh850g4::SR_SELID_0_index_t get_regID_u8_11_15(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::GR_index_t get_rt_u8_27_31(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::GR_index_t get_rh_u8_0_4(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::WR_index_t get_wreg1_u8_0_4(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::WR_index_t get_wreg2_u8_11_15(opcode_t opcode) = 0;
    /**
     * \brief Calculates a WR register group index value representing the value of the wreg2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the wreg2 operand
     */
    virtual rh850g4::WR_index_t get_wreg2_u8_43_47(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::WR_index_t get_wreg3_u8_27_31(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::WR_index_t get_wreg4_u8_32_36(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the fcond operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the fcond operand
     */
    virtual unsigned char get_fcond_u8_17_20(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the disp16 operand
     */
    virtual int get_disp16_s32_34_47_shift2(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the disp16 operand
     */
    virtual int get_disp16_s32_35_47_shift3(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the disp16 operand
     */
    virtual int get_disp16_s32_36_47_shift4(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual unsigned int get_imm1_u32_21(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual unsigned int get_imm2_u32_0_1(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the imm2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the imm2 operand
     */
    virtual unsigned int get_imm2_u32_21_22(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual unsigned int get_imm3_u32_27_29(opcode_t opcode) = 0;
    /**
     * \brief Calculates an integer value representing the value of the imm4 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the imm4 operand
     */
    virtual unsigned int get_imm4_u32_21_24(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual unsigned int get_imm12_u32_21_32_42(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::SR_SELID_5_index_t get_et_u8_27_31(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual rh850g4::SR_SELID_5_index_t get_eh_u8_11_14(opcode_t opcode) = 0;
    /**
     * @}
     */
     ...
     * \return Object representing the value of the fcond operand
     */
    virtual fastiss::i8_t *gen_get_fcond_u8_17_20(opcode_t opcode) = 0;
    /**
     * \brief Generates code to calculate the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the disp16 operand
     */
    virtual fastiss::i32_t *gen_get_disp16_s32_34_47_shift2(opcode_t opcode) = 0;
    /**
     * \brief Generates code to calculate the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the disp16 operand
     */
    virtual fastiss::i32_t *gen_get_disp16_s32_35_47_shift3(opcode_t opcode) = 0;
    /**
     * \brief Generates code to calculate the value of the disp16 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the disp16 operand
     */
    virtual fastiss::i32_t *gen_get_disp16_s32_36_47_shift4(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual fastiss::i32_t *gen_get_imm1_u32_21(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual fastiss::i32_t *gen_get_imm2_u32_0_1(opcode_t opcode) = 0;
    /**
     * \brief Generates code to calculate the value of the imm2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the imm2 operand
     */
    virtual fastiss::i32_t *gen_get_imm2_u32_21_22(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual fastiss::i32_t *gen_get_imm3_u32_27_29(opcode_t opcode) = 0;
    /**
     * \brief Generates code to calculate the value of the imm4 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the imm4 operand
     */
    virtual fastiss::i32_t *gen_get_imm4_u32_21_24(opcode_t opcode) = 0;
    /**
     ...
     */
    virtual fastiss::i32_t *gen_get_imm12_u32_21_32_42(opcode_t opcode) = 0;
    /**
     * @}
     */
  };
