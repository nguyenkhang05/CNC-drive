...
#ifndef _RH850G4_LD_DOT_BU_IND_REG1_INC_REG3_INSTR_H_
#define _RH850G4_LD_DOT_BU_IND_REG1_INC_REG3_INSTR_H_
...
{
  /**
   * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction
   */
  class ld_dot_bu_ind_reg1_inc_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction constructor
     ...
     */
    ld_dot_bu_ind_reg1_inc_reg3_instr_t
    (
    ...
    /**
     * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction destructor
     */
    virtual ~ld_dot_bu_ind_reg1_inc_reg3_instr_t();
    ...
    /**
     * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ld_dot_bu_ind_reg1_inc_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_LD_DOT_BU_IND_REG1_INC_REG3_INSTR_H_
