...
TEST_F(TregFNCAccessTest, CheckFNC_IsRegWriteEnable) {
  intc1->HardReset();
  TRegFNC *fnc;
  fnc = new TRegFNC (reg_size, min_access_size, base_addr, intc1);
  fnc->Reset();
...
TEST_F(TregFNCAccessTest, CheckFNC_IsRegReadEnable) {
  intc1->HardReset();
  TRegFNC *fnc;
  fnc = new TRegFNC (reg_size, min_access_size, base_addr, intc1);
  fnc->Reset();
  ...
  sideband.SetGM(0);
  sideband.SetUM(0);
  ASSERT_EQ(true, fnc->IsRegReadEnable(sideband));
...
class TregFNCAccessTest3_HV
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
    TregFNCAccessTest3_HV() {}
  virtual ~TregFNCAccessTest3_HV() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_HV, CheckFNC_AccessTest1_1_HV) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr, (uint8_t*)wdata, SIZE_16BIT);
  ASSERT_EQ(0x0U, syserr);
  syserr = fnc->Read(sideband, base_addr, (uint8_t*)rdata, SIZE_16BIT);
  ASSERT_EQ(0x0U, syserr);
...
TEST_P(TregFNCAccessTest3_HV, CheckFNC_AccessTest_2_HV) {
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr, (uint8_t*)wdata1, SIZE_8BIT);
  ASSERT_EQ(0x0U, syserr);
  syserr = fnc->Read(sideband, base_addr, (uint8_t*)rdata1, SIZE_8BIT);
  ASSERT_EQ(0x0U, syserr);
...
TEST_P(TregFNCAccessTest3_HV, CheckFNC_AccessTest_3_HV) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr+1, (uint8_t*)wdata2, SIZE_8BIT);
  ASSERT_EQ(0x0U, syserr);
  syserr = fnc->Read(sideband, base_addr+1, (uint8_t*)rdata2, SIZE_8BIT);
  ASSERT_EQ(0x0U, syserr);
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_HV,
                        ::testing::ValuesIn(WithParamInterface2));

class TregFNCAccessTest3_HV_DM0
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
    TregFNCAccessTest3_HV_DM0() {}
  virtual ~TregFNCAccessTest3_HV_DM0() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_HV_DM0, CheckFNC_AccessTest1_1_HV_DM0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
...
TEST_P(TregFNCAccessTest3_HV_DM0, CheckFNC_AccessTest_2_HV_DM0) {
  uint8_t temp1 = std::get<0>(GetParam());
  uint8_t expect1 = std::get<1>(GetParam());
...
TEST_P(TregFNCAccessTest3_HV_DM0, CheckFNC_AccessTest_3_HV_DM0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
...
std::tuple<uint16_t, uint16_t> const WithParamInterface2_DM0[] = {
  /* 0000 */ std::make_tuple(0xffff, 0x0000),
  /* 0001 */ std::make_tuple(0x0000, 0x0000),
  /* 0002 */ std::make_tuple(0x9000, 0x0000),
  // please write more test case.
};
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_HV_DM0,
                        ::testing::ValuesIn(WithParamInterface2_DM0));


class TregFNCAccessTest3_SV
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
    TregFNCAccessTest3_SV() {}
  virtual ~TregFNCAccessTest3_SV() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV) {
  uint16_t temp = std::get<0>(GetParam());
  ...
  uint32_t index_16 = (base_addr >> 1) & 0x1;
  memcpy (&m_data16[index_16], rdata, sizeof(m_data16));
  ASSERT_EQ(0x0U, m_data16[index_16]);

  delete fnc;
}

TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_32bits) {
  uint16_t temp = std::get<0>(GetParam());
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr, (uint8_t*)wdata, SIZE_32BIT);
  ASSERT_EQ(0x19U, syserr);
  syserr = fnc->Read(sideband, base_addr, (uint8_t*)rdata, SIZE_32BIT);
  ASSERT_EQ(0x19U, syserr);
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_32bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_64bits) {
  uint16_t temp = std::get<0>(GetParam());
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr, (uint8_t*)wdata, SIZE_64BIT);
  ASSERT_EQ(0x19U, syserr);
  syserr = fnc->Read(sideband, base_addr, (uint8_t*)rdata, SIZE_64BIT);
  ASSERT_EQ(0x19U, syserr);
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_64bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_128bits) {
  uint16_t temp = std::get<0>(GetParam());
  ...
  SysErrCause syserr = fnc->Write(sideband, base_addr, (uint8_t*)wdata, SIZE_128BIT);
  ASSERT_EQ(0x19U, syserr);
  syserr = fnc->Read(sideband, base_addr, (uint8_t*)rdata, SIZE_128BIT);
  ASSERT_EQ(0x19U, syserr);
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest1_1_SV_128bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest_2_SV) {
  uint8_t temp1 = std::get<0>(GetParam());
  ...
  uint8_t m_rdata1 = (*(reinterpret_cast<uint8_t*> (rdata1)));
  ASSERT_EQ(0x0U, m_rdata1);

  delete fnc;
}

TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest_2_SV_DM0) {
  uint8_t temp1 = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest_3_SV) {
  uint16_t temp = std::get<0>(GetParam());
  uint8_t temp2 = (uint8_t (temp >> 8));
  ...
  uint8_t m_rdata2 = (*(reinterpret_cast<uint8_t*> (rdata2)));
  ASSERT_EQ(0x0U, m_rdata2);

  delete fnc;
}

TEST_P(TregFNCAccessTest3_SV, CheckFNC_AccessTest_3_SV_DM0) {
  uint16_t temp = std::get<0>(GetParam());
  uint8_t temp2 = (uint8_t (temp >> 8));
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_SV,
                        ::testing::ValuesIn(WithParamInterface2_SV));


class TregFNCAccessTest3_UM
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
    TregFNCAccessTest3_UM() {}
  virtual ~TregFNCAccessTest3_UM() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_32bits) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_32bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_64bits) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_64bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_128bits) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest1_1_UM_128bits_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest_2_UM) {
  uint8_t temp1 = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest_2_UM_DM0) {
  uint8_t temp1 = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest_3_UM) {
  uint16_t temp = std::get<0>(GetParam());
...
TEST_P(TregFNCAccessTest3_UM, CheckFNC_AccessTest_3_UM_DM0) {
  uint16_t temp = std::get<0>(GetParam());
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_UM,
                        ::testing::ValuesIn(WithParamInterface2_UM));

class TregFNCAccessTest3_IHVE0
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
	TregFNCAccessTest3_IHVE0() {}
  virtual ~TregFNCAccessTest3_IHVE0() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_IHVE0, CheckFNC_AccessTest1_1_IHVE0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  uint8_t *wdata = reinterpret_cast<uint8_t *>(&temp);
  uint8_t rdata[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
TEST_P(TregFNCAccessTest3_IHVE0, CheckFNC_AccessTest1_2_IHVE0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  uint8_t *wdata = reinterpret_cast<uint8_t *>(&temp);
  uint8_t rdata[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_IHVE0,
                        ::testing::ValuesIn(WithParamInterface2_IHVE0));

class TregFNCAccessTest3_IHVE0_DM0
    : public testing::Test,
      public testing::WithParamInterface<std::tuple<uint16_t, uint16_t>> {
protected:
	TregFNCAccessTest3_IHVE0_DM0() {}
  virtual ~TregFNCAccessTest3_IHVE0_DM0() {}
  virtual void SetUp() {
    mock_fsbus = new MockFsBus ();
    mock_pe = new MockProcElement(pe_id, (CoreType)CORE_G4MH, (CoreVersion)CORE_VER_10, (ArchClass)E3V5_S);
    intc1 = new CIntc1(mock_pe, pe_id, mock_fsbus, (CoreType)CORE_G4MH, (CoreVersion)0x20);
...
TEST_P(TregFNCAccessTest3_IHVE0_DM0, CheckFNC_AccessTest1_1_IHVE0_DM0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  uint8_t *wdata = reinterpret_cast<uint8_t *>(&temp);
  uint8_t rdata[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
TEST_P(TregFNCAccessTest3_IHVE0_DM0, CheckFNC_AccessTest1_2_IHVE0_DM0) {
  uint16_t temp = std::get<0>(GetParam());
  uint16_t expect = std::get<1>(GetParam());
  uint8_t *wdata = reinterpret_cast<uint8_t *>(&temp);
  uint8_t rdata[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest3_IHVE0_DM0,
...
INSTANTIATE_TEST_CASE_P(CheckFNC_AccessTest1, TregFNCAccessTest4,
