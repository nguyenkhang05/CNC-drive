...
#ifndef _RH850G4_JARL_DISP32_REG1_INSTR_H_
#define _RH850G4_JARL_DISP32_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// jarl disp32, reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief jarl_disp32_reg1 instruction
   */
  class jarl_disp32_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief jarl_disp32_reg1 instruction constructor
    ...
    /**
     * \brief jarl_disp32_reg1 instruction destructor
     */
    virtual ~jarl_disp32_reg1_instr_t();
    ...
    /**
     * \brief jarl_disp32_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief jarl_disp32_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jarl_disp32_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jarl_disp32_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_JARL_DISP32_REG1_INSTR_H_
