...
#ifndef _NSMVCFGV01__H__
#define _NSMVCFGV01__H__

#include "NSMVCFGV01.h"
...
NSMVCFGV01::NSMVCFGV01( sc_module_name name, NSMVG4CPUV01* pG3mcpu ):
  sc_module( name ),
  ...
  mpCfgFunc(0)
{
  ...
  char inst_name[128];
  sprintf( inst_name, "%s.CfGrdFunc", this->name() );
  mpCfgFunc = new CfgFunc( inst_name );
  mpCfgFunc->setG3mcpuPtr( pG3mcpu );
  mBusSlaveIf32[0]->setFuncModulePtr( mpCfgFunc );
...
/// <returns>none</returns>
void NSMVCFGV01::ResetProc( void )
{
