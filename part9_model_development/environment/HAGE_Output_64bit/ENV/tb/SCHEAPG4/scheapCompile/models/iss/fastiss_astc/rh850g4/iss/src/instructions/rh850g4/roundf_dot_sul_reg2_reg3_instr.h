...
#ifndef _RH850G4_ROUNDF_DOT_SUL_REG2_REG3_INSTR_H_
#define _RH850G4_ROUNDF_DOT_SUL_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// roundf.sul reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief roundf_dot_sul_reg2_reg3 instruction
   */
  class roundf_dot_sul_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief roundf_dot_sul_reg2_reg3 instruction constructor
     ...
     */
    roundf_dot_sul_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief roundf_dot_sul_reg2_reg3 instruction destructor
     */
    virtual ~roundf_dot_sul_reg2_reg3_instr_t();
    ...
    /**
     * \brief roundf_dot_sul_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief roundf_dot_sul_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief roundf_dot_sul_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ROUNDF_DOT_SUL_REG2_REG3_INSTR_H_
