...
//------------------------------------------------------------------------------
// subf.s reg1, reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::subf_dot_s_reg1_reg2_reg3_instr_t::subf_dot_s_reg1_reg2_reg3_instr_t
(
...
void rh850g4::subf_dot_s_reg1_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::subf_dot_s_reg1_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "subf.s " << reg1_name << ", " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::subf_dot_s_reg1_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::subf_dot_s_reg1_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  fastiss::f32_with_exception_flags_t sub_result = gen_f32_sub(reg2_float80, reg1_float80, gen_read_round_mode());
  ...
  sub_result.inexact = gen_inexact_denorm_update(sub_result.invalid, sub_result.divide_by_zero, sub_result.inexact, reg1_float32, reg2_float32);
