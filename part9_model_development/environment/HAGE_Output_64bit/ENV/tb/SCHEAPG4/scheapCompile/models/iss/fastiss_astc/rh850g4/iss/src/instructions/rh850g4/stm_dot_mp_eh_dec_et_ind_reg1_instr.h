...
#ifndef _RH850G4_STM_DOT_MP_EH_DEC_ET_IND_REG1_INSTR_H_
#define _RH850G4_STM_DOT_MP_EH_DEC_ET_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// stm.mp eh-et, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction
   */
  class stm_dot_mp_eh_dec_et_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction constructor
     ...
     */
    stm_dot_mp_eh_dec_et_ind_reg1_instr_t
    (
    ...
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction destructor
     */
    virtual ~stm_dot_mp_eh_dec_et_ind_reg1_instr_t();
    ...
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stm_dot_mp_eh_dec_et_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_STM_DOT_MP_EH_DEC_ET_IND_REG1_INSTR_H_
