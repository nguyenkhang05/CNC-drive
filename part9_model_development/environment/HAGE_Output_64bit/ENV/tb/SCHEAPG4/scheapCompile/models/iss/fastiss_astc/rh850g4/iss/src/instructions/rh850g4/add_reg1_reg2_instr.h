...
#ifndef _RH850G4_ADD_REG1_REG2_INSTR_H_
#define _RH850G4_ADD_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// add reg1, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief add_reg1_reg2 instruction
   */
  class add_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief add_reg1_reg2 instruction constructor
    ...
    /**
     * \brief add_reg1_reg2 instruction destructor
     */
    virtual ~add_reg1_reg2_instr_t();
    ...
    /**
     * \brief add_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief add_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief add_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ADD_REG1_REG2_INSTR_H_
