...
#ifndef _RH850G4_SHR_REG1_REG2_REG3_INSTR_H_
#define _RH850G4_SHR_REG1_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// shr reg1, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief shr_reg1_reg2_reg3 instruction
   */
  class shr_reg1_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief shr_reg1_reg2_reg3 instruction constructor
    ...
    /**
     * \brief shr_reg1_reg2_reg3 instruction destructor
     */
    virtual ~shr_reg1_reg2_reg3_instr_t();
    ...
    /**
     * \brief shr_reg1_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief shr_reg1_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief shr_reg1_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SHR_REG1_REG2_REG3_INSTR_H_
