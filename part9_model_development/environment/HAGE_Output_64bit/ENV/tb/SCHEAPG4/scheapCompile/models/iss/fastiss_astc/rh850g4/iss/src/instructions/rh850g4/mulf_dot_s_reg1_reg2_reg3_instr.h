...
#ifndef _RH850G4_MULF_DOT_S_REG1_REG2_REG3_INSTR_H_
#define _RH850G4_MULF_DOT_S_REG1_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// mulf.s reg1, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief mulf_dot_s_reg1_reg2_reg3 instruction
   */
  class mulf_dot_s_reg1_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief mulf_dot_s_reg1_reg2_reg3 instruction constructor
     ...
     */
    mulf_dot_s_reg1_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief mulf_dot_s_reg1_reg2_reg3 instruction destructor
     */
    virtual ~mulf_dot_s_reg1_reg2_reg3_instr_t();
    ...
    /**
     * \brief mulf_dot_s_reg1_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief mulf_dot_s_reg1_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief mulf_dot_s_reg1_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MULF_DOT_S_REG1_REG2_REG3_INSTR_H_
