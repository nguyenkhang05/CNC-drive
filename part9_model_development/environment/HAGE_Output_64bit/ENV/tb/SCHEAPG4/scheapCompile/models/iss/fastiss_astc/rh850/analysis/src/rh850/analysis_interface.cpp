...
std::map<rh850::core_base_t *, AnalysisInterfaceInfo> analysis_interface_info_map;
...
CoreAnalysisInterface *create_analysis_interface(rh850::core_base_t *core)
{
  if (core)
  {
