...
#ifndef _RH850_STEP_TRANSLATOR_H_
#define _RH850_STEP_TRANSLATOR_H_
...
//------------------------------------------------------------------------------
// rh850 step translator definition
//------------------------------------------------------------------------------
...
namespace rh850
{
   ...
   */
  class step_translator_t : public rh850::translator_base_t
  {
  public:
    /**
  ...
  private:
    ...
    bool m_swdt_enable;
     /**
     * \brief pointer flag of MIP enable or notn
     */          
    bool* mp_mip_enable;
  };  
}

#endif // _RH850_STEP_TRANSLATOR_H_
