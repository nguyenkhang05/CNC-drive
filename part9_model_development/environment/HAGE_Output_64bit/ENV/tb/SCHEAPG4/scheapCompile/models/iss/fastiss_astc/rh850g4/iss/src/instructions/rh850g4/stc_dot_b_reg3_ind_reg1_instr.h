...
#ifndef _RH850G4_STC_DOT_B_REG3_IND_REG1_INSTR_H_
#define _RH850G4_STC_DOT_B_REG3_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// stc.b reg3, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief stc_dot_b_reg3_ind_reg1 instruction
   */
  class stc_dot_b_reg3_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction constructor
     ...
     */
    stc_dot_b_reg3_ind_reg1_instr_t
    (
    ...
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction destructor
     */
    virtual ~stc_dot_b_reg3_ind_reg1_instr_t();
    ...
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stc_dot_b_reg3_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_STC_DOT_B_REG3_IND_REG1_INSTR_H_
