...
protected:
    ...
    virtual ~CrgCap1() {}
    virtual void SetUp() {
        m_crgcap           = new CrgCap (base_crgcapreg, CORE_G4MH, CORE_VER_20);
    }
...
TEST_F(CrgCap1, Check_TargetWrite) {
    ...
    ASSERT_THROW(m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);
    ASSERT_THROW(m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_64BIT), std::range_error);
    ASSERT_THROW(m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_128BIT), std::range_error);
    ...
    ASSERT_EQ(SYSERR_NONE, m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_32BIT));
    ASSERT_EQ(SYSERR_NONE, m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_32BIT));
    ASSERT_EQ(SYSERR_NONE, m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_16BIT));
    ASSERT_EQ(SYSERR_NONE, m_crgcap->TargetWrite(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_8BIT));
}
...
TEST_F(CrgCap1, Check_TargetRead) {
    ...
    uint8_t data_8_output_crgspidstat[4]   = {0xff, 0xff, 0xff, 0xff};
    uint8_t data_8_output_crgspidclr [4]   = {0xff, 0xff, 0xff, 0xff};

    m_crgcap->GetCrgErrReg()->GetCrgErrAddr()->SetAddr(0xcafecafe);
    m_crgcap->GetCrgErrReg()->GetCrgSpidErrStat()->SetSPIDERR(0x0);
    ...
    m_crgcap->TargetRead(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, data_8_output_crgspidstat, SIZE_32BIT);
    m_crgcap->TargetRead(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET,  data_8_output_crgspidclr, SIZE_32BIT);
    ...
    memcpy (&m_data32, data_8_output_crgspidstat, sizeof(m_data32));
    uint32_t m_data32_out_crgspidstat = m_data32;
    memcpy (&m_data32, data_8_output_crgspidclr, sizeof(m_data32));
    uint32_t m_data32_out_crgspidclr = m_data32;
    ...
    ASSERT_EQ(0x1U, m_data32_out_crgspidstat);
    ASSERT_EQ(0x0U, m_data32_out_crgspidclr);
}
...
TEST_F(CrgCap1, Check_TargetFetch) {
    ...
    m_crgcap->TargetFetch(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, data_8_output_crgspidstat, SIZE_32BIT);
    m_crgcap->TargetFetch(sb_info, base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET,  data_8_output_crgspidclr, SIZE_32BIT);
...
TEST_F(CrgCap1, Check_TargetWriteDebug) {
    ...
    m_crgcap->TargetWriteDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crgcap->TargetWriteDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET,  new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    ...
    ASSERT_EQ(0x0U, m_data32_out_crgstat);
    ASSERT_EQ(0x0U, m_data32_out_crgspidstat);
    ...
    m_crgcap->TargetWriteDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    m_crgcap->TargetWriteDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET,  new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    ...
    memcpy (&m_data32, data_8_output_crgspidstat, sizeof(m_data32));
    m_data32_out_crgspidstat = m_data32;
    memcpy (&m_data32, data_8_output_crgspidclr, sizeof(m_data32));
    m_data32_out_crgspidclr = m_data32;
...
TEST_F(CrgCap1, Check_TargetReadDebug) {
    ...
    m_crgcap->TargetReadDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRSTAT_OFFSET, data_8_output_crgspidstat, SIZE_32BIT);
    m_crgcap->TargetReadDebug(base_crgcapreg + TRegCrgErrReg::CRGSPIDERRCLR_OFFSET, data_8_output_crgspidclr, SIZE_32BIT);
