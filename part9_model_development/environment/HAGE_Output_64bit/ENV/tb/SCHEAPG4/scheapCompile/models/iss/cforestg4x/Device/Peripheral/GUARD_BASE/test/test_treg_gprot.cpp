...
protected:
    ...
    virtual ~TRegGPROT1() {}
    virtual void SetUp() {
        m_treg_gprot   = new GPROT (reg_size_gprot, min_access_size_gprot, m_reg_addr, m_channel, "GPROT", CRG_MODULE, CORE_G4MH, CORE_VER_11, &m_guard_internal);
    }
