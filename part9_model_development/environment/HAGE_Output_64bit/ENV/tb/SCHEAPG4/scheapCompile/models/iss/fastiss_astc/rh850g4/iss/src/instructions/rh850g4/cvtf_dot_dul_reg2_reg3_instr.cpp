...
//------------------------------------------------------------------------------
// cvtf.dul reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::cvtf_dot_dul_reg2_reg3_instr_t::cvtf_dot_dul_reg2_reg3_instr_t
(
...
void rh850g4::cvtf_dot_dul_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::cvtf_dot_dul_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "cvtf.dul " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::cvtf_dot_dul_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::cvtf_dot_dul_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg2 = get_reg2_u8_12_15_shift1(opcode);
  GR_index_t reg3 = get_reg3_u8_28_31_shift1(opcode);
  ...
  fastiss::i64_with_exception_flags_t convert_result = gen_i64_unsigned_convert(reg2_pair_float64_flushed, gen_read_round_mode());
