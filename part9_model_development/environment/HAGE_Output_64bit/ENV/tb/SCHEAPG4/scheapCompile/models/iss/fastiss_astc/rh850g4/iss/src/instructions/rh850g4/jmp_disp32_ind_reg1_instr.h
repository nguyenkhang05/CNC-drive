...
#ifndef _RH850G4_JMP_DISP32_IND_REG1_INSTR_H_
#define _RH850G4_JMP_DISP32_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// jmp disp32[reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief jmp_disp32_ind_reg1 instruction
   */
  class jmp_disp32_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief jmp_disp32_ind_reg1 instruction constructor
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction destructor
     */
    virtual ~jmp_disp32_ind_reg1_instr_t();
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief jmp_disp32_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_JMP_DISP32_IND_REG1_INSTR_H_
