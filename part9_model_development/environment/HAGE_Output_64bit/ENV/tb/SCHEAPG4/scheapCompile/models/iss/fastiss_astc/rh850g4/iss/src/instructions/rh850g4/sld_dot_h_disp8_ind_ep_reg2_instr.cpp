...
rh850g4::sld_dot_h_disp8_ind_ep_reg2_instr_t::sld_dot_h_disp8_ind_ep_reg2_instr_t
(
...
void rh850g4::sld_dot_h_disp8_ind_ep_reg2_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(2);  
}

std::string rh850g4::sld_dot_h_disp8_ind_ep_reg2_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::sld_dot_h_disp8_ind_ep_reg2_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850g4::sld_dot_h_disp8_ind_ep_reg2_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
