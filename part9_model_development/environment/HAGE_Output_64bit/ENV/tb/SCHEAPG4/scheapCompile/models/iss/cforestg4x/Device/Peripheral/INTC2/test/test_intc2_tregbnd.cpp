...
protected:
  ...
  virtual void SetUp() {
    ...
    TRegMask mask = TRegMask (TRegBND<EIBD>::INTC2_EIBD_MASK_G4MH);
    bnd_eibd = new TRegBND<EIBD>(SIZE_32BIT, SIZE_8BIT, addr, mask, channel, pe_id, cintc2, INTC2_STANDARD);
  }
...
std::make_tuple(0xFFF82081, 0xFFFFFFFF, SIZE_8BIT, 0x00, 0x1),
std::make_tuple(0xFFF82081, 0x0, SIZE_8BIT, 0x0, 0x1),
std::make_tuple(0xFFF82082, 0xFFFFFFFF, SIZE_8BIT, 0x00, 0x2),
