...
#ifndef _RH850G4_CLL_INSTR_H_
#define _RH850G4_CLL_INSTR_H_
...
{
  /**
   * \brief cll instruction
   */
  class cll_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief cll instruction constructor
    ...
    /**
     * \brief cll instruction destructor
     */
    virtual ~cll_instr_t();
    ...
    /**
     * \brief cll instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief cll instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief cll instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
