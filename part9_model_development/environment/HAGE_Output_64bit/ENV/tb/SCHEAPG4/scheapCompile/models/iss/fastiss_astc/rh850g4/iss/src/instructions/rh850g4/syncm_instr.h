...
#ifndef _RH850G4_SYNCM_INSTR_H_
#define _RH850G4_SYNCM_INSTR_H_
...
{
  /**
   * \brief syncm instruction
   */
  class syncm_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief syncm instruction constructor
    ...
    /**
     * \brief syncm instruction destructor
     */
    virtual ~syncm_instr_t();
    ...
    /**
     * \brief syncm instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief syncm instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief syncm instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
