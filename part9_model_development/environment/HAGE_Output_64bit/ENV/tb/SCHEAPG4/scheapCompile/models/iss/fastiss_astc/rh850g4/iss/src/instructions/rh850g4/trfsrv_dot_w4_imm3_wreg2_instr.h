...
#ifndef _RH850G4_TRFSRV_DOT_W4_IMM3_WREG2_INSTR_H_
#define _RH850G4_TRFSRV_DOT_W4_IMM3_WREG2_INSTR_H_
...
//------------------------------------------------------------------------------
// trfsrv.w4 imm3, wreg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief trfsrv_dot_w4_imm3_wreg2 instruction
   */
  class trfsrv_dot_w4_imm3_wreg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief trfsrv_dot_w4_imm3_wreg2 instruction constructor
     ...
     */
    trfsrv_dot_w4_imm3_wreg2_instr_t
    (
    ...
    /**
     * \brief trfsrv_dot_w4_imm3_wreg2 instruction destructor
     */
    virtual ~trfsrv_dot_w4_imm3_wreg2_instr_t();
    ...
    /**
     * \brief trfsrv_dot_w4_imm3_wreg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief trfsrv_dot_w4_imm3_wreg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief trfsrv_dot_w4_imm3_wreg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_TRFSRV_DOT_W4_IMM3_WREG2_INSTR_H_
