...
#ifndef _RH850G4_DISPOSE_IMM5_LIST12_IND_REG1_INSTR_H_
#define _RH850G4_DISPOSE_IMM5_LIST12_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// dispose imm5, list12, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief dispose_imm5_list12_ind_reg1 instruction
   */
  class dispose_imm5_list12_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction constructor
     ...
     */
    dispose_imm5_list12_ind_reg1_instr_t
    (
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction destructor
     */
    virtual ~dispose_imm5_list12_ind_reg1_instr_t();
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dispose_imm5_list12_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_DISPOSE_IMM5_LIST12_IND_REG1_INSTR_H_
