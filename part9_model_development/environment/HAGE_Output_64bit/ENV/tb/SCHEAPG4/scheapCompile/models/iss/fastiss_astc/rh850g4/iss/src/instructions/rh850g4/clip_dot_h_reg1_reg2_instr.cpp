...
//------------------------------------------------------------------------------
// clip.h reg1, reg2 implementation
//------------------------------------------------------------------------------

rh850g4::clip_dot_h_reg1_reg2_instr_t::clip_dot_h_reg1_reg2_instr_t
(
...
void rh850g4::clip_dot_h_reg1_reg2_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::clip_dot_h_reg1_reg2_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "clip.h " << reg1_name << ", " << reg2_name;
  return disass_string.str();
}

unsigned int rh850g4::clip_dot_h_reg1_reg2_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::clip_dot_h_reg1_reg2_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  // check the reg1 val
  fastiss::i1_t *flag1 = gen_icmp_ule(reg1_load, gen_i32_constant(0x00007FFF));
  fastiss::i1_t *flag2 = gen_icmp_uge(reg1_load, gen_i32_constant(0xFFFF8000));
  ...
  fastiss::i32_t *value = gen_select(gen_or(flag1, flag2), 
				     ...
				     gen_select(gen_icmp_eq(gen_and(reg1_load, gen_i32_constant(0x80000000)), gen_i32_constant(0x80000000)),
						gen_i32_constant(0xFFFF8000),
						gen_i32_constant(0x00007FFF)));
  ...
  gen_write_PSW_OV(gen_select(gen_or(flag1, flag2), gen_i1_constant(0), gen_i1_constant(1)));
