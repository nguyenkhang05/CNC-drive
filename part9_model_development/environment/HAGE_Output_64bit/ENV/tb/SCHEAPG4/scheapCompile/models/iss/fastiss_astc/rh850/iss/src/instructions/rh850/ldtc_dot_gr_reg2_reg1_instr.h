...
#ifndef _RH850_LDTC_DOT_GR_REG2_REG1_INSTR_H_
#define _RH850_LDTC_DOT_GR_REG2_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// ldtc.gr reg2, reg1 declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief ldtc_dot_gr_reg2_reg1 instruction
   */
  class ldtc_dot_gr_reg2_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldtc_dot_gr_reg2_reg1 instruction constructor
    ...
    /**
     * \brief ldtc_dot_gr_reg2_reg1 instruction destructor
     */
    virtual ~ldtc_dot_gr_reg2_reg1_instr_t();
    ...
    /**
     * \brief ldtc_dot_gr_reg2_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldtc_dot_gr_reg2_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldtc_dot_gr_reg2_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_LDTC_DOT_GR_REG2_REG1_INSTR_H_
