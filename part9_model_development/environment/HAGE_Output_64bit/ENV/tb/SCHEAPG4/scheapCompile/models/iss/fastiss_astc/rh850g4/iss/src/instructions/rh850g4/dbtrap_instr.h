...
#ifndef _RH850G4_DBTRAP_INSTR_H_
#define _RH850G4_DBTRAP_INSTR_H_
...
namespace rh850g4
{
  ...
  public:
    ...
    /**
     * \brief dbtrap instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_DBTRAP_INSTR_H_
