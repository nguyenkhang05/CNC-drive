...
#ifndef _RH850G4_BLOCK_FUNCTION_L1_CACHE_H_
#define _RH850G4_BLOCK_FUNCTION_L1_CACHE_H_
...
#include "rh850g4/block_function_l2_cache.h"
...
namespace rh850g4
{
  ...
  public:
     ...
     */
    block_function_l1_cache_t(rh850g4::memory_if_t *memory_impl, rh850g4::block_function_l2_cache_t *fn_l2_cache);
    /**
...
inline fastiss::block_function_t *rh850g4::block_function_l1_cache_t::lookup_function(unsigned int key)
{
  rh850g4::block_function_l1_cache_t::entry_t *cache_entry = find_entry(key);
...
inline void rh850g4::block_function_l1_cache_t::flush_function(unsigned int key)
{
  flush_entry(key);
}

#endif // _RH850G4_BLOCK_FUNCTION_L1_CACHE_H_
