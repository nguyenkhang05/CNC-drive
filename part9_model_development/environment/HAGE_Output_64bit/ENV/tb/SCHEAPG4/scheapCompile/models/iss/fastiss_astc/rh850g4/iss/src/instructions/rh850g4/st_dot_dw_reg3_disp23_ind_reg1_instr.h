...
#ifndef _RH850G4_ST_DOT_DW_REG3_DISP23_IND_REG1_INSTR_H_
#define _RH850G4_ST_DOT_DW_REG3_DISP23_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// st.dw reg3, disp23 [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction
   */
  class st_dot_dw_reg3_disp23_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction constructor
     ...
     */
    st_dot_dw_reg3_disp23_ind_reg1_instr_t
    (
    ...
    /**
     * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction destructor
     */
    virtual ~st_dot_dw_reg3_disp23_ind_reg1_instr_t();
    ...
    /**
     * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief st_dot_dw_reg3_disp23_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ST_DOT_DW_REG3_DISP23_IND_REG1_INSTR_H_
