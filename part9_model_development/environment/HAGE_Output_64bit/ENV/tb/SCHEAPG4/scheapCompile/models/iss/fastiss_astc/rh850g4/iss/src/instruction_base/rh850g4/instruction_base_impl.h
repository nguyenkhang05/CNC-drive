 ...
 * \brief Defines common base class for all rh850g4 instructions
 */

#ifndef _RH850G4_INSTRUCTION_BASE_IMPL_H_
#define _RH850G4_INSTRUCTION_BASE_IMPL_H_

//------------------------------------------------------------------------------
// Includes
//------------------------------------------------------------------------------

#include "rh850g4/instruction_base_if.h"
#include "rh850g4/immediate_base.h"
#include "fastiss/code_gen_bridge.h"
#include "rh850g4/operand_bridge.h"
#include <string>
#include <cstdio>

//------------------------------------------------------------------------------
// rh850g4 instruction base class definition
//------------------------------------------------------------------------------
...
{
  /**
   * \brief Common base class for all rh850g4 instructions
   *
  ...
  class instruction_base_impl_t :
    public rh850g4::instruction_base_if_t,
    public rh850g4::immediate_base_t,
    public fastiss::code_gen_bridge_t, 
    public rh850g4::operand_bridge_t
  {
  public:
    /**
     ...
     * rh850g4::instruction_base_if_t::terminates_block
     ...
     */
    virtual bool terminates_block(rh850g4::opcode_t opcode, unsigned int trans_PC);
    /**
     ...
     */
    virtual unsigned int cycle_count(rh850g4::opcode_t opcode, unsigned int trans_PC);
  };
}

#endif // _RH850G4_INSTRUCTION_BASE_IMPL_H_
