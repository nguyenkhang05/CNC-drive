...
#ifndef _RH850_STTC_DOT_GR_REG1_REG2_INSTR_H_
#define _RH850_STTC_DOT_GR_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// sttc.gr reg1, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief sttc_dot_gr_reg1_reg2 instruction
   */
  class sttc_dot_gr_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sttc_dot_gr_reg1_reg2 instruction constructor
    ...
    /**
     * \brief sttc_dot_gr_reg1_reg2 instruction destructor
     */
    virtual ~sttc_dot_gr_reg1_reg2_instr_t();
    ...
    /**
     * \brief sttc_dot_gr_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sttc_dot_gr_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sttc_dot_gr_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_STTC_DOT_GR_REG1_REG2_INSTR_H_
