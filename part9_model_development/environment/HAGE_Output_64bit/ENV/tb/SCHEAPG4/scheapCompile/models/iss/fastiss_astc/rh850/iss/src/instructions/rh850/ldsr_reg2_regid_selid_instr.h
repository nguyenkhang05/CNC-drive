...
#ifndef _RH850_LDSR_REG2_REGID_SELID_INSTR_H_
#define _RH850_LDSR_REG2_REGID_SELID_INSTR_H_
...
//------------------------------------------------------------------------------
// ldsr reg2, regID, selID declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief ldsr_reg2_regid_selid instruction
   */
  class ldsr_reg2_regid_selid_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldsr_reg2_regid_selid instruction constructor
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction destructor
     */
    virtual ~ldsr_reg2_regid_selid_instr_t();
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldsr_reg2_regid_selid instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_LDSR_REG2_REGID_SELID_INSTR_H_
