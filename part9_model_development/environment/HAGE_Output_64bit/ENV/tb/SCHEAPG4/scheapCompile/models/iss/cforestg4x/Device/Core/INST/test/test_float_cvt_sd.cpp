...
class CVTF_SDTest : public testing::Test,
 ...
 * SoftFloat-3a
 */
TEST_P(CVTF_SDTest, Check_CVTF_SD) {
  ...
  // call softfloat func
  op = EXPECT_CALL((*m_sf), f32_to_f64(_)).Times(1).After(inits);
...
INSTANTIATE_TEST_CASE_P(quebec_cvtf_sd, CVTF_SDTest,
...
int main(int argc, char **argv) {
  ::test_data_dir = argv[argc - 1];
  {
    ::testing::internal::FilePath filepath = ::testing::internal::FilePath::ConcatPaths(
        ...
        ::testing::internal::FilePath("data/UT_cvtf_sd_mod64.csv"));
