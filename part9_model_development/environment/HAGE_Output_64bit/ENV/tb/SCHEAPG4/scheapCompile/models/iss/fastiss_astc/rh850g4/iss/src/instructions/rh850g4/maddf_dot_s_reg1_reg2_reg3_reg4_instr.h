...
#ifndef _RH850G4_MADDF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
#define _RH850G4_MADDF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
...
//------------------------------------------------------------------------------
// maddf.s reg1, reg2, reg3, reg4 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction
   */
  class maddf_dot_s_reg1_reg2_reg3_reg4_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction constructor
     ...
     */
    maddf_dot_s_reg1_reg2_reg3_reg4_instr_t
    (
    ...
    /**
     * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction destructor
     */
    virtual ~maddf_dot_s_reg1_reg2_reg3_reg4_instr_t();
    ...
    /**
     * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief maddf_dot_s_reg1_reg2_reg3_reg4 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MADDF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
