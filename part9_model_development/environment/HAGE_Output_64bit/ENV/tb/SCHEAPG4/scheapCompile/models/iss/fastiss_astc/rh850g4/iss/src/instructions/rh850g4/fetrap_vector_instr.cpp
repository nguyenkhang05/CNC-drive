...
rh850g4::fetrap_vector_instr_t::fetrap_vector_instr_t
(
...
void rh850g4::fetrap_vector_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(2);  
}

std::string rh850g4::fetrap_vector_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::fetrap_vector_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850g4::fetrap_vector_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
bool rh850g4::fetrap_vector_instr_t::terminates_block(opcode_t opcode, unsigned int trans_PC)
{
  return true;
}

unsigned int rh850g4::fetrap_vector_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 8;
}
