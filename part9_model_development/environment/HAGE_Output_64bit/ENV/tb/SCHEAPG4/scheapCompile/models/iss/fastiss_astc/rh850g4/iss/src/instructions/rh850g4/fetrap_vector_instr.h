...
#ifndef _RH850G4_FETRAP_VECTOR_INSTR_H_
#define _RH850G4_FETRAP_VECTOR_INSTR_H_
...
//------------------------------------------------------------------------------
// fetrap vector declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief fetrap_vector instruction
   */
  class fetrap_vector_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief fetrap_vector instruction constructor
    ...
    /**
     * \brief fetrap_vector instruction destructor
     */
    virtual ~fetrap_vector_instr_t();
    ...
    /**
     * \brief fetrap_vector instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief fetrap_vector instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief fetrap_vector instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief fetrap_vector instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief fetrap_vector instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_FETRAP_VECTOR_INSTR_H_
