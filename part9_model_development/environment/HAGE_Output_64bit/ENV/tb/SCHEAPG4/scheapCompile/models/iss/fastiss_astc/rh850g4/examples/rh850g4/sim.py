...
import sysc
import time
import rh850g4.debug
import rh850g4.execution_tracer
import rh850g4.translation_tracer
import rh850g4.disassembler
import rh850g4.analysis_delegate

#------------------------------------------------------------------------------
# Create and install analysis delegate
#------------------------------------------------------------------------------
 
delegate = rh850g4.analysis_delegate.AnalysisDelegate()
...
vlab.properties(name="rh850g4_example_platform",
...
cpu_component = vlab.component(name="rh850g4_core", description="rh850g4.description")
...
(cpu.facade, cpu.target) = rh850g4.debug.initialise(cpu, 0)

# Install disassembler(s)
cpu.rh850e3_disassembler = rh850g4.disassembler.rh850e3_disassembler()
...
if (args["trace-disable"] == False):
  cpu.execution_tracer = rh850g4.execution_tracer.rh850g4_execution_tracer(args["trace-file-name"])
if (args["enable-translation-trace"]):
  cpu.translation_tracer = rh850g4.translation_tracer.rh850g4_translation_tracer()
