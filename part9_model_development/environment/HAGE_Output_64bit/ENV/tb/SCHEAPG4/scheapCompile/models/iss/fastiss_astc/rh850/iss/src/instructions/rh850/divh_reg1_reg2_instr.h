...
#ifndef _RH850_DIVH_REG1_REG2_INSTR_H_
#define _RH850_DIVH_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// divh reg1, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief divh_reg1_reg2 instruction
   */
  class divh_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief divh_reg1_reg2 instruction constructor
    ...
    /**
     * \brief divh_reg1_reg2 instruction destructor
     */
    virtual ~divh_reg1_reg2_instr_t();
    ...
    /**
     * \brief divh_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief divh_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief divh_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief divh_reg1_reg2 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_DIVH_REG1_REG2_INSTR_H_
