...
// ----------------------------------------
class CrgCtrl1 : public testing::Test {
protected:
    CrgCtrl1() {}
    virtual ~CrgCtrl1() {}
    virtual void SetUp() {
        ...
        m_crgctrl           = new CrgCtrl (base_crgctrlreg, base_crgreg_ivc, CORE_G4MH, CORE_VER_11, guard_internal);
    }
...
TEST_F(CrgCtrl1, Check_Initial_Setup) {
 ...
 */
TEST_F(CrgCtrl1, Check_TargetWrite) {
    SideBand sb_info;
    uint32_t chn_0 = 0x0;

    m_crgctrl->TargetWrite(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGKCPROT_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_32BIT);

    m_crgctrl->TargetWrite(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x53, 0x01, 0x00, 0x00}, SIZE_32BIT);
    // at least, 1 CRG channel setting is enable.

    m_crgctrl->TargetWrite(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crgctrl->TargetWrite(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crgctrl->TargetWrite(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
 ...
 */
TEST_F(CrgCtrl1, Check_TargetRead) {
    SideBand sb_info;
    uint32_t chn_0 = 0x0;
    ...
    m_crgctrl->TargetRead(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    ...
    m_crgctrl->TargetRead(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    ...
    m_crgctrl->TargetRead(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    ...
    m_crgctrl->TargetRead(sb_info,  base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
 ...
 */
TEST_F(CrgCtrl1, Check_TargetFetch) {
    SideBand sb_info;
    uint32_t chn_0 = 0x0;
    uint8_t data_8_input_crgkcprot[4] = {0x01, 0xa5, 0xa5, 0xa5};
    uint8_t data_8_input_crgprot[4] = {0x53, 0x01, 0x00, 0x00};
    ...
    m_crgctrl->TargetFetch(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgprot, sizeof(m_data32));
    uint32_t m_data32_out_crgprot = m_data32;
    memcpy (&m_data32, data_8_input_crgprot, sizeof(m_data32));
    uint32_t m_data32_in_crgprot = m_data32;
    ...
    m_crgctrl->TargetFetch(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgspid, sizeof(m_data32));
    uint32_t m_data32_out_crgspid = m_data32;
    memcpy (&m_data32, data_8_input_crgspid, sizeof(m_data32));
    uint32_t m_data32_in_crgspid = m_data32;
    ...
    m_crgctrl->TargetFetch(sb_info, base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgbad, sizeof(m_data32));
    uint32_t m_data32_out_crgbad = m_data32;
    memcpy (&m_data32, data_8_input_crgbad, sizeof(m_data32));
    uint32_t m_data32_in_crgbad = m_data32;
    ...
    m_crgctrl->TargetFetch(sb_info,  base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgadv, sizeof(m_data32));
    uint32_t m_data32_out_crgadv = m_data32;
    memcpy (&m_data32, data_8_input_crgadv, sizeof(m_data32));
    uint32_t m_data32_in_crgadv = m_data32;
 ...
 */
TEST_F(CrgCtrl1, Check_TargetWriteDebug) {
    uint32_t chn_0 = 0x0;

    m_crgctrl->TargetWriteDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGKCPROT_OFFSET, new uint8_t[4] {0x01, 0xA5, 0xA5, 0xA5}, SIZE_32BIT);
    m_crgctrl->TargetWriteDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0x53, 0x01, 0x00, 0x00}, SIZE_32BIT);
    m_crgctrl->TargetWriteDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crgctrl->TargetWriteDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
    m_crgctrl->TargetWriteDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0,
                                    new uint8_t[4] {0xFF, 0xFF, 0xFF, 0xFF}, SIZE_32BIT);
 ...
 */
TEST_F(CrgCtrl1, Check_TargetReadDebug) {
    SideBand sb_info;
    uint32_t chn_0 = 0x0;
    uint8_t data_8_input_crgkcprot[4] = {0x01, 0xa5, 0xa5, 0xa5};
    uint8_t data_8_input_crgprot[4] = {0x53, 0x01, 0x00, 0x00};
    ...
    m_crgctrl->TargetReadDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGPROT_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgprot, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgprot, sizeof(m_data32));
    uint32_t m_data32_out_crgprot = m_data32;
    memcpy (&m_data32, data_8_input_crgprot, sizeof(m_data32));
    uint32_t m_data32_in_crgprot = m_data32;
    ...
    m_crgctrl->TargetReadDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGSPID_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgspid, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgspid, sizeof(m_data32));
    uint32_t m_data32_out_crgspid = m_data32;
    memcpy (&m_data32, data_8_input_crgspid, sizeof(m_data32));
    uint32_t m_data32_in_crgspid = m_data32;
    ...
    m_crgctrl->TargetReadDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGBAD_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgbad, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgbad, sizeof(m_data32));
    uint32_t m_data32_out_crgbad = m_data32;
    memcpy (&m_data32, data_8_input_crgbad, sizeof(m_data32));
    uint32_t m_data32_in_crgbad = m_data32;
    ...
    m_crgctrl->TargetReadDebug(base_crgctrlreg + TRegCrgCtrlReg::CRGADV_OFFSET + TRegCrgCtrlReg::CRG_CTRL_CHANNEL_RANGE_G4MH1X * chn_0, data_8_output_crgadv, SIZE_32BIT);
    memcpy (&m_data32, data_8_output_crgadv, sizeof(m_data32));
    uint32_t m_data32_out_crgadv = m_data32;
    memcpy (&m_data32, data_8_input_crgadv, sizeof(m_data32));
    uint32_t m_data32_in_crgadv = m_data32;
