...
rh850::hvtrap_vector_instr_t::hvtrap_vector_instr_t
(
...
void rh850::hvtrap_vector_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850::hvtrap_vector_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850::hvtrap_vector_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850::hvtrap_vector_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
