...
#ifndef _RH850G4_DBRET_INSTR_H_
#define _RH850G4_DBRET_INSTR_H_
...
{
  /**
   * \brief dbret instruction
   */
  class dbret_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dbret instruction constructor
    ...
    /**
     * \brief dbret instruction destructor
     */
    virtual ~dbret_instr_t();
    ...
    /**
     * \brief dbret instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dbret instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbret instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbret instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
