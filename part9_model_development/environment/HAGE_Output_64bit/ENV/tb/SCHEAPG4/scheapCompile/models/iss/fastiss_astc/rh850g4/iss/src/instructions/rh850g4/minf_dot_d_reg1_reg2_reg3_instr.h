...
#ifndef _RH850G4_MINF_DOT_D_REG1_REG2_REG3_INSTR_H_
#define _RH850G4_MINF_DOT_D_REG1_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// minf.d reg1, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief minf_dot_d_reg1_reg2_reg3 instruction
   */
  class minf_dot_d_reg1_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief minf_dot_d_reg1_reg2_reg3 instruction constructor
     ...
     */
    minf_dot_d_reg1_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief minf_dot_d_reg1_reg2_reg3 instruction destructor
     */
    virtual ~minf_dot_d_reg1_reg2_reg3_instr_t();
    ...
    /**
     * \brief minf_dot_d_reg1_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief minf_dot_d_reg1_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief minf_dot_d_reg1_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MINF_DOT_D_REG1_REG2_REG3_INSTR_H_
