...
#ifndef _RH850G4_FMSF_DOT_S4_WREG1_WREG2_WREG3_INSTR_H_
#define _RH850G4_FMSF_DOT_S4_WREG1_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// fmsf.s4 wreg1, wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction
   */
  class fmsf_dot_s4_wreg1_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction constructor
     ...
     */
    fmsf_dot_s4_wreg1_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction destructor
     */
    virtual ~fmsf_dot_s4_wreg1_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief fmsf_dot_s4_wreg1_wreg2_wreg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_FMSF_DOT_S4_WREG1_WREG2_WREG3_INSTR_H_
