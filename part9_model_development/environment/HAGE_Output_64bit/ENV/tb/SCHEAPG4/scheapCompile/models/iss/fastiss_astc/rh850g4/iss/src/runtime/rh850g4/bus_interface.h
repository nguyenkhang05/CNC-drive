...
#ifndef _RH850G4_BUS_INTERFACE_H_
#define _RH850G4_BUS_INTERFACE_H_
...
namespace rh850g4
{
  ...
  public:
     ...
     */
    virtual void initialise(fastiss::code_gen_if_t *code_gen_impl, rh850g4::cpu_state_if_t *cpu_state, rh850g4::memory_if_t *memory_impl, bool blocking_tlm);
     ...
     */
    virtual unsigned int transport_dbg(rh850g4::access_type_t type, sc_dt::uint64 eff_address, unsigned int size, unsigned char *data);
     ...
     * \return the number of bytes actually read or written
     */
    virtual unsigned int transport_dbg_physical(rh850g4::access_type_t type, unsigned int physical_address, unsigned int size, unsigned char *data);
  ...
  public:
     ...
     */
    bool dmi_read(rh850g4::access_type_t type, sc_dt::uint64 eff_address, unsigned int size, unsigned char *data, sc_core::sc_time& delay);
    /**
     ...
     */
    bool dmi_write(rh850g4::access_type_t type, sc_dt::uint64 eff_address, unsigned int size, unsigned char *data, sc_core::sc_time& delay);      
     ...
     */
    virtual void dmi_pointer_post_callout(rh850g4::access_type_t type, dmi_region *val) = 0;
  ...
  protected:
    ...
    rh850g4::cpu_state_if_t *m_cpu_state;
    rh850g4::memory_if_t* m_memory;
    /**
...
#endif //  _RH850G4_BUS_INTERFACE_H_
