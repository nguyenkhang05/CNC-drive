...
#ifndef _RH850G4_B_CCCC_DISP17_INSTR_H_
#define _RH850G4_B_CCCC_DISP17_INSTR_H_
...
//------------------------------------------------------------------------------
// bcccc disp17 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief b_cccc_disp17 instruction
   */
  class b_cccc_disp17_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief b_cccc_disp17 instruction constructor
    ...
    /**
     * \brief b_cccc_disp17 instruction destructor
     */
    virtual ~b_cccc_disp17_instr_t();
    ...
    /**
     * \brief b_cccc_disp17 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief b_cccc_disp17 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief b_cccc_disp17 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief b_cccc_disp17 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_B_CCCC_DISP17_INSTR_H_
