...
#ifndef _RH850G4_FNMAF_DOT_S_REG1_REG2_REG3_INSTR_H_
#define _RH850G4_FNMAF_DOT_S_REG1_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// fnmaf.s reg1, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction
   */
  class fnmaf_dot_s_reg1_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction constructor
     ...
     */
    fnmaf_dot_s_reg1_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction destructor
     */
    virtual ~fnmaf_dot_s_reg1_reg2_reg3_instr_t();
    ...
    /**
     * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief fnmaf_dot_s_reg1_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_FNMAF_DOT_S_REG1_REG2_REG3_INSTR_H_
