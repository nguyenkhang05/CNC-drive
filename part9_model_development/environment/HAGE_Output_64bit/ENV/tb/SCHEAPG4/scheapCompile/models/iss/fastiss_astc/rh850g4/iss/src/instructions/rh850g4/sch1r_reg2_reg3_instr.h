...
#ifndef _RH850G4_SCH1R_REG2_REG3_INSTR_H_
#define _RH850G4_SCH1R_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// sch1r reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sch1r_reg2_reg3 instruction
   */
  class sch1r_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sch1r_reg2_reg3 instruction constructor
    ...
    /**
     * \brief sch1r_reg2_reg3 instruction destructor
     */
    virtual ~sch1r_reg2_reg3_instr_t();
    ...
    /**
     * \brief sch1r_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sch1r_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sch1r_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SCH1R_REG2_REG3_INSTR_H_
