...
#ifndef _RH850G4_SASF_CCCC_REG2_INSTR_H_
#define _RH850G4_SASF_CCCC_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// sasf cccc, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sasf_cccc_reg2 instruction
   */
  class sasf_cccc_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sasf_cccc_reg2 instruction constructor
    ...
    /**
     * \brief sasf_cccc_reg2 instruction destructor
     */
    virtual ~sasf_cccc_reg2_instr_t();
    ...
    /**
     * \brief sasf_cccc_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sasf_cccc_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sasf_cccc_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SASF_CCCC_REG2_INSTR_H_
