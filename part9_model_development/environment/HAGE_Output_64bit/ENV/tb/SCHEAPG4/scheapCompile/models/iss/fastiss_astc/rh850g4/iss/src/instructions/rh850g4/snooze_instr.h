...
#ifndef _RH850G4_SNOOZE_INSTR_H_
#define _RH850G4_SNOOZE_INSTR_H_
...
{
  /**
   * \brief snooze instruction
   */
  class snooze_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief snooze instruction constructor
    ...
    /**
     * \brief snooze instruction destructor
     */
    virtual ~snooze_instr_t();
    ...
    /**
     * \brief snooze instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief snooze instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief snooze instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SNOOZE_INSTR_H_
