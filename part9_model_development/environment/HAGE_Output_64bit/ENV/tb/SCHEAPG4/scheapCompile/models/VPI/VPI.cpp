...
#ifdef BUS_TST
  BW_DECODER = 
    new BACKWARD_DECODER<BUS_WIDTH_VPI>( "BW_DECODER", fp );
  DECODER = 
    new OSCI2DCDR<BUS_WIDTH_VPI>( "DECODER", pMapFileName, fp );
#else //BUS_TST
  BW_DECODER = 
    new BACKWARD_DECODER<BUS_WIDTH_VPI>( "BW_DECODER" );
  DECODER = 
    new OSCI2DCDR<BUS_WIDTH_VPI>( "DECODER", pMapFileName );
#endif //BUS_TST
