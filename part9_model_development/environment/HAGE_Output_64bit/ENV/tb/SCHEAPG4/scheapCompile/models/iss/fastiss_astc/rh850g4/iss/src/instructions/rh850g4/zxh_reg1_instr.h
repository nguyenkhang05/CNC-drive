...
#ifndef _RH850G4_ZXH_REG1_INSTR_H_
#define _RH850G4_ZXH_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// zxh reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief zxh_reg1 instruction
   */
  class zxh_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief zxh_reg1 instruction constructor
    ...
    /**
     * \brief zxh_reg1 instruction destructor
     */
    virtual ~zxh_reg1_instr_t();
    ...
    /**
     * \brief zxh_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief zxh_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief zxh_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ZXH_REG1_INSTR_H_
