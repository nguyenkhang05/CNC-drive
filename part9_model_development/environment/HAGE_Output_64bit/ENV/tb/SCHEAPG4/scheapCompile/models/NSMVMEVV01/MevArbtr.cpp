...
MevArbtr::MevArbReqList::MevArbReqList( const char* upperModName ):
  mpPriorityList( 0 ),
  mPeNum( 1 )
{
...
/// <returns>none</returns>
MevArbtr::MevArbReqList::~MevArbReqList( void )
{
  dmsgmv( mModName << ".~MevArbReqList()" );
}
...
OSCI2ARBTR<BUS_WIDTH_APB>::BusArbRequest*
MevArbtr::MevArbReqList::getOtherRequest( TlmBwTransportIf* pIf )
{
...
/// <returns>none</returns>
void
MevArbtr::MevArbReqList::setPeNum( unsigned int peNum )
{
...
/// <returns>none</returns>
void
MevArbtr::MevArbReqList::setPriorityList(
...
/// <returns>none</returns>
MevArbtr::MevArbtr( sc_module_name name ):
  OSCI2ARBTR<BUS_WIDTH_APB>( name ),
  mPeRequestList( name )
{
  dmsgmv( this->name() << ".MevArbtr()" );
...
/// <returns>none</returns>
void
MevArbtr::setPeNum( unsigned int peNum )
{
...
/// <returns>none</returns>
void
MevArbtr::setPriority( unsigned int peid, unsigned int priority )
{
...
/// <returns>none</returns>
void
MevArbtr::rmvPriority( unsigned int peid )
{
...
/// <returns>none</returns>
void
MevArbtr::resetProcess( void )
{
  dmsgmv( this->name() << ".resetProcess()" );
  mPeRequestList.reset();
  OSCI2ARBTR<BUS_WIDTH_APB>::resetProcess();
}
...
/// <returns>none</returns>
void
MevArbtr::actionAtClockPos( void )
{
