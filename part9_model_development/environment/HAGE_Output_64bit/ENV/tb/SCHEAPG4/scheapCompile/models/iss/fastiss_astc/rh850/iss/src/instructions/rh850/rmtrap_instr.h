...
#ifndef _RH850_RMTRAP_INSTR_H_
#define _RH850_RMTRAP_INSTR_H_
...
{
  /**
   * \brief rmtrap instruction
   */
  class rmtrap_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief rmtrap instruction constructor
    ...
    /**
     * \brief rmtrap instruction destructor
     */
    virtual ~rmtrap_instr_t();
    ...
    /**
     * \brief rmtrap instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rmtrap instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rmtrap instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
