...
#ifndef _RH850G4_TRAP_VECTOR_INSTR_H_
#define _RH850G4_TRAP_VECTOR_INSTR_H_
...
//------------------------------------------------------------------------------
// trap vector declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief trap_vector instruction
   */
  class trap_vector_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief trap_vector instruction constructor
    ...
    /**
     * \brief trap_vector instruction destructor
     */
    virtual ~trap_vector_instr_t();
    ...
    /**
     * \brief trap_vector instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief trap_vector instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief trap_vector instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief trap_vector instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief trap_vector instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_TRAP_VECTOR_INSTR_H_
