...
protected:
    ...
    virtual ~Peg1() {}
    virtual void SetUp() {
        m_peg           = new Peg (m_peid, base_pegreg, CORE_G4MH, CORE_VER_20);
    }
...
TEST_F(Peg2, Check_IsAddressMatch_1) {
    ...
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFC000000, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFC000004, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFC000FFF, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFC00FFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFC0FFFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFCFFFFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_20));
...
TEST_F(Peg2, Check_IsAddressMatch_2) {
    ...
    m_peg->TargetWriteDebug(base_pegreg + TRegPegCtrlReg::PEGADV_OFFSET + TRegPegCtrlReg::PEG_CTRL_CHANNEL_RANGE * chn_0,
                                    new uint8_t[4] {0x00, 0xF0, 0xFF, 0x03}, SIZE_32BIT);
    ASSERT_FALSE( m_peg->IsAddressMatch(chn_0, 0xFC00FFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsAddressMatch(chn_0, 0xFC0FFFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsAddressMatch(chn_0, 0xFCFFFFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsAddressMatch(chn_0, 0xFFFFFFFF, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsSpidAllowed_1) {
    ...
    m_peg->TargetWriteDebug(base_pegreg + TRegPegCtrlReg::PEGSPID_OFFSET + TRegPegCtrlReg::PEG_CTRL_CHANNEL_RANGE * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetSPID(0);
    ASSERT_FALSE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetSPID(31);
    ASSERT_FALSE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetSPID(15);
    ASSERT_FALSE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
...
TEST_F(Peg2, Check_IsSpidAllowed_2) {
    ...
    sb_info.SetSPID(0);
    ASSERT_TRUE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetSPID(31);
    ASSERT_TRUE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetSPID(15);
    ASSERT_TRUE( m_peg->IsSpidAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
...
TEST_F(Peg2, Check_IsWriteGloAllowed_1) {
    ...
    ASSERT_FALSE( m_peg->IsWriteGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsWriteGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsWriteGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsWriteGloAllowed(chn_0, DATA_RMW, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsWriteGloAllowed_3) {
    ...
    ASSERT_TRUE( m_peg->IsWriteGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsReadGloAllowed_1) {
    ...
    ASSERT_FALSE( m_peg->IsReadGloAllowed(chn_0, DATA_WRITE, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsReadGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsReadGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_20));
    ASSERT_FALSE( m_peg->IsReadGloAllowed(chn_0, DATA_RMW, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsReadGloAllowed_3) {
    ...
    ASSERT_TRUE( m_peg->IsReadGloAllowed(chn_0, DATA_READ, CORE_G4MH, CORE_VER_20));
    ASSERT_TRUE( m_peg->IsReadGloAllowed(chn_0, INST_READ, CORE_G4MH, CORE_VER_20));
...
TEST_F(Peg2, Check_IsUMDisabled_1) {
    ...
    sb_info.SetUM(0);
    ASSERT_FALSE( m_peg->IsUMDisabled(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetUM(1);
    ASSERT_FALSE( m_peg->IsUMDisabled(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsUMDisabled_3) {
    ...
    m_peg->TargetWriteDebug(base_pegreg + TRegPegCtrlReg::PEGPROT_OFFSET + TRegPegCtrlReg::PEG_CTRL_CHANNEL_RANGE * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetUM(1);
    ASSERT_TRUE( m_peg->IsUMDisabled(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
...
TEST_F(Peg2, Check_IsDbgAllowed_1) {
    ...
    m_peg->TargetWriteDebug(base_pegreg + TRegPegCtrlReg::PEGPROT_OFFSET + TRegPegCtrlReg::PEG_CTRL_CHANNEL_RANGE * chn_0,
                                    new uint8_t[4] {0x00, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetDM(0);
    ASSERT_FALSE( m_peg->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
    sb_info.SetDM(1);
    ASSERT_FALSE( m_peg->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg2, Check_IsDbgAllowed_3) {
    ...
    m_peg->TargetWriteDebug(base_pegreg + TRegPegCtrlReg::PEGPROT_OFFSET + TRegPegCtrlReg::PEG_CTRL_CHANNEL_RANGE * chn_0,
                                    new uint8_t[4] {0x40, 0x00, 0x00, 0x00}, SIZE_32BIT);
    sb_info.SetDM(1);
    ASSERT_TRUE( m_peg->IsDbgAllowed(chn_0, sb_info, CORE_G4MH, CORE_VER_20));
}
...
TEST_F(Peg5, Check_CauseError_SamePE_InstRead_S_Input_SYSERR_PEG_M) {
    ...
    ASSERT_EQ(SYSERR_PEG_S, m_peg->CauseError(sb_info, err_addr,
                           INST_READ, CORE_G4MH, CORE_VER_20, SYSERR_PEG_M));
    ...
    ASSERT_EQ(0x400U, m_peg->GetPegErrCap()->GetPegSpidErrStat()->GetSPIDERR());
    ...
    ASSERT_EQ(SYSERR_NONE, m_peg->CauseError(sb_info, err_addr2,
                           INST_READ, CORE_G4MH, CORE_VER_20, SYSERR_PEG_M));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ASSERT_EQ(0xFFC6C830, m_peg->GetPegErrCap()->m_reg_addr_base);
...
TEST_F(Peg5, Check_CauseError_SamePE_InstRead_S_Input_SYSERR_PEG_S) {
    uint32_t err_dm = 0x1, err_um = 0x1, err_spid = 0x0;
    uint32_t err_addr = 0xFFFFFFFF, err_addr2 = 0xcafecafe;
    SideBand sb_info;
    sb_info.SetBMID(0x0);
    sb_info.SetSPID(err_spid);
    ...
    ASSERT_EQ(SYSERR_PEG_S, m_peg->CauseError(sb_info, err_addr,
                           INST_READ, CORE_G4MH, CORE_VER_20, SYSERR_PEG_S));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ...
    ASSERT_EQ(0x0U, m_peg->GetPegErrCap()->GetPegErrType()->GetSEC());
    ASSERT_EQ(0x1U, m_peg->GetPegErrCap()->GetPegSpidErrStat()->GetSPIDERR());
    ASSERT_EQ(0x0U, m_peg->GetPegErrCap()->GetPegErrStat()->GetOVF());
    ASSERT_EQ(0x0U, m_peg->GetPegErrCap()->GetPegErrType()->GetWrite());
    ASSERT_EQ(err_spid, m_peg->GetPegErrCap()->GetPegErrType()->GetSPID());
    ASSERT_EQ(err_dm, m_peg->GetPegErrCap()->GetPegErrType()->GetDBG());
...
TEST_F(Peg5, Check_CauseError_SamePE_DataReadWrite) {
    ...
    ASSERT_EQ(SYSERR_NONE, m_peg->CauseError(sb_info, 0xFFFFFFFF,
                           DATA_WRITE, CORE_G4MH, CORE_VER_20, SYSERR_PEG_M));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ASSERT_EQ(0xFFFFFFFF, m_peg->GetPegErrCap()->m_reg_addr_base);

    ASSERT_EQ(SYSERR_NONE, m_peg->CauseError(sb_info, 0xFFFFFFFF,
                           DATA_READ, CORE_G4MH, CORE_VER_20, SYSERR_PEG_M));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ASSERT_EQ(0xFFFFFFFF, m_peg->GetPegErrCap()->m_reg_addr_base);

    // In case input is SYSERR_PEG_S
    ASSERT_EQ(SYSERR_NONE, m_peg->CauseError(sb_info, 0xFFFFFFFF,
                           DATA_WRITE, CORE_G4MH, CORE_VER_20, SYSERR_PEG_S));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ASSERT_EQ(0xFFFFFFFF, m_peg->GetPegErrCap()->m_reg_addr_base);

    ASSERT_EQ(SYSERR_NONE, m_peg->CauseError(sb_info, 0xFFFFFFFF,
                           DATA_READ, CORE_G4MH, CORE_VER_20, SYSERR_PEG_S));
    ASSERT_NE(nullptr, m_peg->GetPegErrCap());
    ASSERT_EQ(0xFFFFFFFF, m_peg->GetPegErrCap()->m_reg_addr_base);
}
