...
#ifndef _RH850_MEMORY_BRIDGE_H_
#define _RH850_MEMORY_BRIDGE_H_
...
namespace rh850
{
   ...
   */
  class memory_bridge_t : public rh850::memory_if_t
  {
  public:
    /**
     ...
     */          
    memory_bridge_t(rh850::memory_if_t* memory_impl);
    /**
