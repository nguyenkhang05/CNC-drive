...
#ifndef __MEMORY_FUNCTION32_H__
#define __MEMORY_FUNCTION32_H__

#include "BusSlaveFuncIf.h"
#include "OSCI2.h"

class MemoryFunction32 : public BusSlaveFuncIf{
  
 public:
#ifdef BUSIF_TST
  MemoryFunction32(FILE *fp):BusSlaveFuncIf(),mSize(0),tstFp(fp){}
#else  //BUSIF_TST
  MemoryFunction32(void):BusSlaveFuncIf(),mSize(0){}
#endif //BUSIF_TST
  
  ~MemoryFunction32(void){}
