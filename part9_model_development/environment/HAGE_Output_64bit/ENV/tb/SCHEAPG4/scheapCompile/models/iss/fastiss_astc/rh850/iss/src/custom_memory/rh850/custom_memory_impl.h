...
#ifndef _RH850_CUSTOM_MEMORY_IMPL_H_
#define _RH850_CUSTOM_MEMORY_IMPL_H_

//------------------------------------------------------------------------------
// Includes
//------------------------------------------------------------------------------

#include "rh850/memory_impl.h"

//------------------------------------------------------------------------------
// rh850 custom memory definition
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief rh850 customised memory implementation. This class provides
   * customised implementations of the methods available in the memory interface, allowing
   * customised memory access behaviour.
   */
  class custom_memory_impl_t : public rh850::memory_impl_t
  {
  public:
    /**
     * \brief Constructor
     ...
     */
    unsigned long long calculate_effective_address(rh850::access_type_t type, unsigned int virtual_address);
    /**
     ...
     */
    bool calculate_physical_address(rh850::access_type_t type,
...
#endif // _RH850_CUSTOM_MEMORY_IMPL_H_
