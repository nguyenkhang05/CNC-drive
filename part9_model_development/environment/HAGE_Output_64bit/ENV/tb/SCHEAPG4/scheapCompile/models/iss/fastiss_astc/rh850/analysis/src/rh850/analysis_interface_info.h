...
#ifndef _RH850_ANALYSIS_INTERFACE_INFO_H_
#define _RH850_ANALYSIS_INTERFACE_INFO_H_
...
public:
   ...
   */
  rh850::analysis_callback_descriptor *m_execute_callback;
  
  /**
   * \brief Descriptor for the internal execution plug-in callback.
   */
  rh850::analysis_callback_descriptor *m_memory_access_callback;

  /**
   * \brief Descriptor for the internal function call plug-in start of symbol callback.
   */
  rh850::analysis_callback_descriptor *m_start_symbol_callback;

  /**
   * \brief Descriptor for the internal function call plug-in known symbol callback.
   */
  rh850::analysis_callback_descriptor *m_known_symbol_callback;

  /**
   * \brief Descriptor for the internal function call plug-in unknown symbol callback.
   */
  rh850::analysis_callback_descriptor *m_unknown_symbol_callback;
...
#endif // _RH850_ANALYSIS_INTERFACE_INFO_H_
