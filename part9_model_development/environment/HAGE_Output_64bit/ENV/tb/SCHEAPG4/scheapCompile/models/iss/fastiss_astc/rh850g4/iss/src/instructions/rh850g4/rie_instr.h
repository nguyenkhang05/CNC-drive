...
#ifndef _RH850G4_RIE_INSTR_H_
#define _RH850G4_RIE_INSTR_H_
...
{
  /**
   * \brief rie instruction
   */
  class rie_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief rie instruction constructor
    ...
    /**
     * \brief rie instruction destructor
     */
    virtual ~rie_instr_t();
    ...
    /**
     * \brief rie instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rie instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rie instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rie instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rie instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
