...
#ifndef _RH850G4_MEMORY_IF_H_
#define _RH850G4_MEMORY_IF_H_
...
namespace rh850g4
{
  ...
  public:
     ...
     */
    virtual unsigned int add_watchpoint(unsigned int address, unsigned int bus_interface_id, unsigned int size, rh850g4::watchpoint_kind_t kind) = 0;
     ...
     * \return The loaded value
     */
    virtual rh850g4::uint128_t i128_fetch(unsigned int addr, bool *is_error = NULL) = 0;
    /**
     ...
     * \return The loaded value
     */
    virtual rh850g4::uint128_t i128_load(unsigned int addr, bool *is_error = NULL) = 0;
    /**
     ...
     * address translation or due to a TLM error) or false otherwise.
     */
    virtual void i128_store(unsigned int addr, rh850g4::uint128_t data, bool *is_error = NULL) = 0;
    /**
     * @}
     */
