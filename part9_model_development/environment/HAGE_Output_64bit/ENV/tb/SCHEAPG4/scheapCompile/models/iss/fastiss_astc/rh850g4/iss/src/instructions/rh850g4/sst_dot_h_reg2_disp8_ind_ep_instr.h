...
#ifndef _RH850G4_SST_DOT_H_REG2_DISP8_IND_EP_INSTR_H_
#define _RH850G4_SST_DOT_H_REG2_DISP8_IND_EP_INSTR_H_
...
//------------------------------------------------------------------------------
// sst.h reg2, disp8 [ep] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sst_dot_h_reg2_disp8_ind_ep instruction
   */
  class sst_dot_h_reg2_disp8_ind_ep_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sst_dot_h_reg2_disp8_ind_ep instruction constructor
     ...
     */
    sst_dot_h_reg2_disp8_ind_ep_instr_t
    (
    ...
    /**
     * \brief sst_dot_h_reg2_disp8_ind_ep instruction destructor
     */
    virtual ~sst_dot_h_reg2_disp8_ind_ep_instr_t();
    ...
    /**
     * \brief sst_dot_h_reg2_disp8_ind_ep instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sst_dot_h_reg2_disp8_ind_ep instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sst_dot_h_reg2_disp8_ind_ep instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SST_DOT_H_REG2_DISP8_IND_EP_INSTR_H_
