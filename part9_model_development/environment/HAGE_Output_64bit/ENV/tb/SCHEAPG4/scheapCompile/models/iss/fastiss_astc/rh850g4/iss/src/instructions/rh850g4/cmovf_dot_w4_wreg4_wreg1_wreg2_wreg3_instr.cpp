...
//------------------------------------------------------------------------------
// cmovf.w4 wreg4, wreg1, wreg2, wreg3 implementation
//------------------------------------------------------------------------------

rh850g4::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t
(
...
void rh850g4::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(6);  
}

std::string rh850g4::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  WR_index_t wreg4 = get_wreg4_u8_32_36(opcode);
  std::string wreg4_name = register_name_WR(WR_index_t(wreg4*2));
  ...
  disass_string << "cmovf.w4 " << wreg4_name << ", " << wreg1_name << ", " << wreg2_name << ", " << wreg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 6;
}

void rh850g4::cmovf_dot_w4_wreg4_wreg1_wreg2_wreg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  WR_index_t wreg4 = get_wreg4_u8_32_36(opcode);
  WR_index_t wreg1 = get_wreg1_u8_0_4(opcode);
  ...
  WR_index_t wreg4lo = WR_index_t(wreg4*2);
  WR_index_t wreg4up = WR_index_t((wreg4*2) + 1);
  ...
  fastiss::i64_t *wreg4lo_load = gen_read_WR(wreg4lo);
  fastiss::i64_t *wreg4up_load = gen_read_WR(wreg4up);
  ...
  fastiss::i32_t *wr4_w0_val = gen_i32_extract(wreg4lo_load, gen_i64_constant(0));
  fastiss::i32_t *wr4_w1_val = gen_i32_extract(wreg4lo_load, gen_i64_constant(1));
  fastiss::i32_t *wr4_w2_val = gen_i32_extract(wreg4up_load, gen_i64_constant(0));
  fastiss::i32_t *wr4_w3_val = gen_i32_extract(wreg4up_load, gen_i64_constant(1));

  // Determine the move result
  fastiss::i32_t *w0_val = gen_select(gen_icmp_ne(wr4_w0_val, gen_i32_constant(0)), wr1_w0_val, wr2_w0_val);
  fastiss::i32_t *w1_val = gen_select(gen_icmp_ne(wr4_w1_val, gen_i32_constant(0)), wr1_w1_val, wr2_w1_val);
  fastiss::i32_t *w2_val = gen_select(gen_icmp_ne(wr4_w2_val, gen_i32_constant(0)), wr1_w2_val, wr2_w2_val);
  fastiss::i32_t *w3_val = gen_select(gen_icmp_ne(wr4_w3_val, gen_i32_constant(0)), wr1_w3_val, wr2_w3_val);
