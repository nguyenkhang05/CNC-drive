...
#ifndef _RH850G4_MOVV_DOT_W4_WREG2_WREG3_INSTR_H_
#define _RH850G4_MOVV_DOT_W4_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// movv.w4 wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief movv_dot_w4_wreg2_wreg3 instruction
   */
  class movv_dot_w4_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief movv_dot_w4_wreg2_wreg3 instruction constructor
     ...
     */
    movv_dot_w4_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief movv_dot_w4_wreg2_wreg3 instruction destructor
     */
    virtual ~movv_dot_w4_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief movv_dot_w4_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief movv_dot_w4_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief movv_dot_w4_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MOVV_DOT_W4_WREG2_WREG3_INSTR_H_
