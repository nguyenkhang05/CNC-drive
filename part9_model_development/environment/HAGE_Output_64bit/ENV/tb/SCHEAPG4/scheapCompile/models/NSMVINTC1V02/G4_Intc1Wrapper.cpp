/*************************************************************************
 *
 * $Id: G4_Intc1Wrapper.cpp,v 1.4 2020/02/24 10:48:51 hadinhtran Exp $
 *
...
G4_Intc1Wrapper::G4_Intc1Wrapper(
  sc_module_name name,
  const char*    pCfgFileName,
  unsigned int   peid ):
  NSMVINTC1V02( name, pCfgFileName, peid )
{
  dmsgsc( "G4_Intc1Wrapper::G4_Intc1Wrapper()" );
...
/// <returns>none</returns>
G4_Intc1Wrapper::~G4_Intc1Wrapper( void )
{
  dmsgsc( "G4_Intc1Wrapper::~G4_Intc1Wrapper()" );
  //------------ for user coding from here -------------------
...
///<returns>none</returns>
void
G4_Intc1Wrapper::read (
  unsigned int   addr,
  unsigned char* pData,
  unsigned int   size )
{
  dmsgsc( "G4_Intc1Wrapper::read()" );
...
///<returns>none</returns>
void
G4_Intc1Wrapper::write (
  unsigned int   addr,
  unsigned char* pData,
  unsigned int   size )
{
  dmsgsc( "G4_Intc1Wrapper::write()" );
  TlmBasicPayload trans;
  BusTime_t       t;
...
/*
void
G4_Intc1Wrapper::user_function ( void )
{
