...
#ifndef _RH850G4_LOOP_REG1_DISP16_INSTR_H_
#define _RH850G4_LOOP_REG1_DISP16_INSTR_H_
...
//------------------------------------------------------------------------------
// loop reg1, disp16 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief loop_reg1_disp16 instruction
   */
  class loop_reg1_disp16_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief loop_reg1_disp16 instruction constructor
    ...
    /**
     * \brief loop_reg1_disp16 instruction destructor
     */
    virtual ~loop_reg1_disp16_instr_t();
    ...
    /**
     * \brief loop_reg1_disp16 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief loop_reg1_disp16 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief loop_reg1_disp16 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief loop_reg1_disp16 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_LOOP_REG1_DISP16_INSTR_H_
