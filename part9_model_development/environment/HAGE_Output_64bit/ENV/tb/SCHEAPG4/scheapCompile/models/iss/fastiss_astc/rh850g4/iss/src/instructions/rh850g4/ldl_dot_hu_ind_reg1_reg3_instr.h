...
#ifndef _RH850G4_LDL_DOT_HU_IND_REG1_REG3_INSTR_H_
#define _RH850G4_LDL_DOT_HU_IND_REG1_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// ldl.hu [reg1], reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ldl_dot_hu_ind_reg1_reg3 instruction
   */
  class ldl_dot_hu_ind_reg1_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction constructor
     ...
     */
    ldl_dot_hu_ind_reg1_reg3_instr_t
    (
    ...
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction destructor
     */
    virtual ~ldl_dot_hu_ind_reg1_reg3_instr_t();
    ...
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldl_dot_hu_ind_reg1_reg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_LDL_DOT_HU_IND_REG1_REG3_INSTR_H_
