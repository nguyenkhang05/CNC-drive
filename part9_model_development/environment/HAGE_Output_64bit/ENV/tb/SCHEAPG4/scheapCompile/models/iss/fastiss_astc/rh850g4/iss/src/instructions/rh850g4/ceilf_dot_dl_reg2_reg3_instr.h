...
#ifndef _RH850G4_CEILF_DOT_DL_REG2_REG3_INSTR_H_
#define _RH850G4_CEILF_DOT_DL_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// ceilf.dl reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ceilf_dot_dl_reg2_reg3 instruction
   */
  class ceilf_dot_dl_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ceilf_dot_dl_reg2_reg3 instruction constructor
     ...
     */
    ceilf_dot_dl_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief ceilf_dot_dl_reg2_reg3 instruction destructor
     */
    virtual ~ceilf_dot_dl_reg2_reg3_instr_t();
    ...
    /**
     * \brief ceilf_dot_dl_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ceilf_dot_dl_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ceilf_dot_dl_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_CEILF_DOT_DL_REG2_REG3_INSTR_H_
