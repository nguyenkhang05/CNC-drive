/**
 * @file test_float_cvt_ds.cpp
 *
 * @date Created on: 2016
 * @author Author: YVo <y.vo.wg@rvc.renesas.com>
 * @brief UNIT TEST for f64 to f32
...
class CVTF_DSTest : public testing::Test,
...
/*!
 * @brief Check f64_to_f32
 * SoftFloat-3a
 */
TEST_P(CVTF_DSTest, Check_CVTF_DS) {
  ...
  // call softfloat func
  op = EXPECT_CALL((*m_sf), f64_to_f32(_)).Times(1).After(inits);
...
INSTANTIATE_TEST_CASE_P(quebec_cvtf_ds, CVTF_DSTest,
...
int main(int argc, char **argv) {
  ::test_data_dir = argv[argc - 1];
  {
    ::testing::internal::FilePath filepath = ::testing::internal::FilePath::ConcatPaths(
        ...
        ::testing::internal::FilePath("data/UT_cvtf_ds_mod64.csv"));
