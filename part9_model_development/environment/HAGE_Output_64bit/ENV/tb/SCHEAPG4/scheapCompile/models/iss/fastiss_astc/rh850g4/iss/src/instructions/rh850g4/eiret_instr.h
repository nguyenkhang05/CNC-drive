...
#ifndef _RH850G4_EIRET_INSTR_H_
#define _RH850G4_EIRET_INSTR_H_
...
{
  /**
   * \brief eiret instruction
   */
  class eiret_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief eiret instruction constructor
    ...
    /**
     * \brief eiret instruction destructor
     */
    virtual ~eiret_instr_t();
    ...
    /**
     * \brief eiret instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief eiret instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief eiret instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief eiret instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief eiret instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
