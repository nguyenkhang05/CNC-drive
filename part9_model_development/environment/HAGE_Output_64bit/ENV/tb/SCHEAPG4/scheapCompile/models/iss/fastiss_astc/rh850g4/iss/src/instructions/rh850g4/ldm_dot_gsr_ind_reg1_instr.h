...
#ifndef _RH850G4_LDM_DOT_GSR_IND_REG1_INSTR_H_
#define _RH850G4_LDM_DOT_GSR_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// ldm.gsr [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ldm_dot_gsr_ind_reg1 instruction
   */
  class ldm_dot_gsr_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction constructor
    ...
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction destructor
     */
    virtual ~ldm_dot_gsr_ind_reg1_instr_t();
    ...
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldm_dot_gsr_ind_reg1 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_LDM_DOT_GSR_IND_REG1_INSTR_H_
