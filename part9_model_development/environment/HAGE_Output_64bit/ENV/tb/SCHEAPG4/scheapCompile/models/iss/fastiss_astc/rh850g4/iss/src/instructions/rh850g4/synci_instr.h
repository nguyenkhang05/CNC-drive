...
#ifndef _RH850G4_SYNCI_INSTR_H_
#define _RH850G4_SYNCI_INSTR_H_
...
{
  /**
   * \brief synci instruction
   */
  class synci_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief synci instruction constructor
    ...
    /**
     * \brief synci instruction destructor
     */
    virtual ~synci_instr_t();
    ...
    /**
     * \brief synci instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief synci instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief synci instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
