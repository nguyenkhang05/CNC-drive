...
void rh850::rie_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(2);  
}

std::string rh850::rie_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
...
unsigned int rh850::rie_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850::rie_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Set the FEPC to PC
  ...
  // gen_write_PSW_HVC(gen_i1_constant(0)); G3K doesn't have this bit
...
bool rh850::rie_instr_t::terminates_block(opcode_t opcode, unsigned int trans_PC)
{
  return true;
}

unsigned int rh850::rie_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 7;
}
