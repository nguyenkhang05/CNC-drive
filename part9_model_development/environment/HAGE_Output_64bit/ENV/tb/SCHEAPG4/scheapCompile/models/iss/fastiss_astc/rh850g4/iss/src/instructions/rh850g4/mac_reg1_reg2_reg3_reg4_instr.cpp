...
rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::mac_reg1_reg2_reg3_reg4_instr_t
(
...
void rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
...
unsigned int rh850g4::mac_reg1_reg2_reg3_reg4_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}
