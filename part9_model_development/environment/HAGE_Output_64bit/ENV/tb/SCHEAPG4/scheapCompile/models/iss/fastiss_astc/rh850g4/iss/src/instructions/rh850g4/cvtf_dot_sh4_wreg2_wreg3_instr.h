...
#ifndef _RH850G4_CVTF_DOT_SH4_WREG2_WREG3_INSTR_H_
#define _RH850G4_CVTF_DOT_SH4_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// cvtf.sh4 wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief cvtf_dot_sh4_wreg2_wreg3 instruction
   */
  class cvtf_dot_sh4_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction constructor
     ...
     */
    cvtf_dot_sh4_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction destructor
     */
    virtual ~cvtf_dot_sh4_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief cvtf_dot_sh4_wreg2_wreg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_CVTF_DOT_SH4_WREG2_WREG3_INSTR_H_
