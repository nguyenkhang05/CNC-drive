...
//------------------------------------------------------------------------------
// recipf.d reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::recipf_dot_d_reg2_reg3_instr_t::recipf_dot_d_reg2_reg3_instr_t
(
...
void rh850g4::recipf_dot_d_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::recipf_dot_d_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "recipf.d " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::recipf_dot_d_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::recipf_dot_d_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg2 = get_reg2_u8_12_15_shift1(opcode);
  GR_index_t reg3 = get_reg3_u8_28_31_shift1(opcode);
  ...
  gen_cond_branch(gen_is_zero(reg2_pair_float64_flushed), div_by_zero_branch, perform_calc_branch);
  ...
  fastiss::i64_t* div_val = gen_select(gen_is_positive(reg2_pair_float64), gen_i64_constant(0x7ff0000000000000ULL), gen_i64_constant(0xfff0000000000000ULL));
  ...
  fastiss::f64_with_exception_flags_t div_result = gen_f64_div(gen_f64_constant(1), reg2_pair_float64_flushed, gen_i8_constant(0));
  ...
  div_result.inexact = gen_inexact_denorm_update(div_result.invalid, div_result.divide_by_zero, div_result.inexact, reg2_pair_float64);
...
unsigned int rh850g4::recipf_dot_d_reg2_reg3_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 16;
}
