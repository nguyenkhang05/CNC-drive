...
//------------------------------------------------------------------------------
// ceilf.sw reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::ceilf_dot_sw_reg2_reg3_instr_t::ceilf_dot_sw_reg2_reg3_instr_t
(
...
void rh850g4::ceilf_dot_sw_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::ceilf_dot_sw_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "ceilf.sw " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::ceilf_dot_sw_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::ceilf_dot_sw_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  GR_index_t reg3 = get_reg3_u8_27_31(opcode);
  ...
  fastiss::i32_with_exception_flags_t convert_result = gen_i32_signed_convert(reg2_float32_flushed, gen_i8_constant(2));
