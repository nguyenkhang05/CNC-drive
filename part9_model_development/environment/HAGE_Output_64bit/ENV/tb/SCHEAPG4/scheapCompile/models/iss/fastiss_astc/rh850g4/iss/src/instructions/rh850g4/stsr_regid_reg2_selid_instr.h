...
#ifndef _RH850G4_STSR_REGID_REG2_SELID_INSTR_H_
#define _RH850G4_STSR_REGID_REG2_SELID_INSTR_H_
...
//------------------------------------------------------------------------------
// stsr regID, reg2, selID declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief stsr_regid_reg2_selid instruction
   */
  class stsr_regid_reg2_selid_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief stsr_regid_reg2_selid instruction constructor
    ...
    /**
     * \brief stsr_regid_reg2_selid instruction destructor
     */
    virtual ~stsr_regid_reg2_selid_instr_t();
    ...
    /**
     * \brief stsr_regid_reg2_selid instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief stsr_regid_reg2_selid instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stsr_regid_reg2_selid instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_STSR_REGID_REG2_SELID_INSTR_H_
