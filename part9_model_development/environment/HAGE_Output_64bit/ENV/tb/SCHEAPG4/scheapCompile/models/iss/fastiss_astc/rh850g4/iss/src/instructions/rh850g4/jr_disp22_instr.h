...
#ifndef _RH850G4_JR_DISP22_INSTR_H_
#define _RH850G4_JR_DISP22_INSTR_H_
...
//------------------------------------------------------------------------------
// jr disp22 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief jr_disp22 instruction
   */
  class jr_disp22_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief jr_disp22 instruction constructor
    ...
    /**
     * \brief jr_disp22 instruction destructor
     */
    virtual ~jr_disp22_instr_t();
    ...
    /**
     * \brief jr_disp22 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief jr_disp22 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jr_disp22 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jr_disp22 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_JR_DISP22_INSTR_H_
