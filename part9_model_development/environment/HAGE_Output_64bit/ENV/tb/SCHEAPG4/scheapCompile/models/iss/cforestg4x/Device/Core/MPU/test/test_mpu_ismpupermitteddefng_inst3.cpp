/**
 * @file test_mpu_ismpupermitteddefng_inst3.cpp
 *
 ...
 *        condition: no host entry & (GMPM.GMPE=0 | MPM.MPE=0)
 */
TEST_P(MpuMethodCheck, CheckIsMpuPermittedDefNG_INST_READ_5) {
 ...
 *        condition: no host entry & (GMPM.GMPE=0 | MPM.MPE=0)
 */
TEST_P(MpuMethodCheck, CheckIsMpuPermittedDefNG_INST_READ_6) {
  bool gm = std::get<0>(GetParam());
  bool mpe = std::get<1>(GetParam());
  bool gmpe = std::get<2>(GetParam());
  bool um = std::get<3>(GetParam());
 ...
 */
TEST_F(MpuMethodCheck, CheckIsMpuPermittedDefNG_INST_READ_7) {
 ...
 */
TEST_F(MpuMethodCheck, CheckIsMpuPermittedDefNG_INST_READ_8) {
