...
#ifndef _RH850G4_SXH_REG1_INSTR_H_
#define _RH850G4_SXH_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// sxh reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief sxh_reg1 instruction
   */
  class sxh_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sxh_reg1 instruction constructor
    ...
    /**
     * \brief sxh_reg1 instruction destructor
     */
    virtual ~sxh_reg1_instr_t();
    ...
    /**
     * \brief sxh_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sxh_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sxh_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SXH_REG1_INSTR_H_
