...
rh850g4::ld_dot_hu_disp23_ind_reg1_reg3_instr_t::ld_dot_hu_disp23_ind_reg1_reg3_instr_t
(
...
void rh850g4::ld_dot_hu_disp23_ind_reg1_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(6);  
}

std::string rh850g4::ld_dot_hu_disp23_ind_reg1_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::ld_dot_hu_disp23_ind_reg1_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 6;
}

void rh850g4::ld_dot_hu_disp23_ind_reg1_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
