...
#ifndef _RH850G4_NEGF_DOT_D_REG2_REG3_INSTR_H_
#define _RH850G4_NEGF_DOT_D_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// negf.d reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief negf_dot_d_reg2_reg3 instruction
   */
  class negf_dot_d_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief negf_dot_d_reg2_reg3 instruction constructor
    ...
    /**
     * \brief negf_dot_d_reg2_reg3 instruction destructor
     */
    virtual ~negf_dot_d_reg2_reg3_instr_t();
    ...
    /**
     * \brief negf_dot_d_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief negf_dot_d_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief negf_dot_d_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_NEGF_DOT_D_REG2_REG3_INSTR_H_
