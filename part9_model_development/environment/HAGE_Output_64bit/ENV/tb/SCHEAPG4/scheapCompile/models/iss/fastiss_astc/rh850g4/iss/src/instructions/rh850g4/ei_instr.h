...
#ifndef _RH850G4_EI_INSTR_H_
#define _RH850G4_EI_INSTR_H_
...
{
  /**
   * \brief ei instruction
   */
  class ei_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ei instruction constructor
    ...
    /**
     * \brief ei instruction destructor
     */
    virtual ~ei_instr_t();
    ...
    /**
     * \brief ei instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ei instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ei instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ei instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ei instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
