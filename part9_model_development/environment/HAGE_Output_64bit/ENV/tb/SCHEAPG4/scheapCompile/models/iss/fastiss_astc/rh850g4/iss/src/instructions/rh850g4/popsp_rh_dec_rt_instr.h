...
#ifndef _RH850G4_POPSP_RH_DEC_RT_INSTR_H_
#define _RH850G4_POPSP_RH_DEC_RT_INSTR_H_
...
//------------------------------------------------------------------------------
// popsp rh-rt declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief popsp_rh_dec_rt instruction
   */
  class popsp_rh_dec_rt_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief popsp_rh_dec_rt instruction constructor
    ...
    /**
     * \brief popsp_rh_dec_rt instruction destructor
     */
    virtual ~popsp_rh_dec_rt_instr_t();
    ...
    /**
     * \brief popsp_rh_dec_rt instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief popsp_rh_dec_rt instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief popsp_rh_dec_rt instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief popsp_rh_dec_rt instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_POPSP_RH_DEC_RT_INSTR_H_
