...
#ifndef _RH850_CUSTOM_IMPL_H_
#define _RH850_CUSTOM_IMPL_H_
...
namespace rh850
{
  ...
  public:
    ...
    void gen_update_dest_and_fpsr(bool is_single_precision, rh850::GR_index_t dest_index, fastiss::i64_t* dest_val, fastiss::i8_t* exception_flags, fastiss::block_t *continue_block);
     ...
     /**
     * \brief return MDP enable or not,
     */
    bool is_mdp_enable(void);

     /**
     * \brief set MDP enable or not,
     */
  ...
  private:
    ...
    /**
     * \brief valiable to specified the cpu milestone 
     */          
    unsigned int m_cpu_milestone;

     /**
     * \brief A flag whether the MDP is enable or not
     */
    bool m_mdp_enable; 
