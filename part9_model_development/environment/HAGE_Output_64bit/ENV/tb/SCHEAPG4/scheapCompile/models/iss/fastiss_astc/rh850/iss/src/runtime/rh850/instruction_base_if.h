 ...
 * \brief Defines common base interface class for all rh850 instructions
 */

#ifndef _RH850_INSTRUCTION_BASE_IF_H_
#define _RH850_INSTRUCTION_BASE_IF_H_
...
//------------------------------------------------------------------------------
// rh850 instruction base interface definition
//------------------------------------------------------------------------------
...
{
  /**
   * \brief Common base class for all rh850 instructions. Provides the
  ...
  public:
     ...
     * rh850::instruction_base_if_t::terminates_block attribute is used for
     * this purpose).
     *
     ...
     */
    virtual bool terminates_block(rh850::opcode_t opcode, unsigned int trans_PC) = 0;
    /**
     ...
     */
    virtual unsigned int cycle_count(rh850::opcode_t opcode, unsigned int trans_PC) = 0;
    /**
     * @}
     */
  };
...
#endif // _RH850_INSTRUCTION_BASE_IF_H_
