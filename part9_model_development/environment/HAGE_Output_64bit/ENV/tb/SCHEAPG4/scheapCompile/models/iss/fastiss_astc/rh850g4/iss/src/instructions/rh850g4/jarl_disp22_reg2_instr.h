...
#ifndef _RH850G4_JARL_DISP22_REG2_INSTR_H_
#define _RH850G4_JARL_DISP22_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// jarl disp22, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief jarl_disp22_reg2 instruction
   */
  class jarl_disp22_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief jarl_disp22_reg2 instruction constructor
    ...
    /**
     * \brief jarl_disp22_reg2 instruction destructor
     */
    virtual ~jarl_disp22_reg2_instr_t();
    ...
    /**
     * \brief jarl_disp22_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief jarl_disp22_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jarl_disp22_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief jarl_disp22_reg2 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_JARL_DISP22_REG2_INSTR_H_
