...
rh850::cmp_imm5_reg2_instr_t::cmp_imm5_reg2_instr_t
(
...
void rh850::cmp_imm5_reg2_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(2);  
}

std::string rh850::cmp_imm5_reg2_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850::cmp_imm5_reg2_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850::cmp_imm5_reg2_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
