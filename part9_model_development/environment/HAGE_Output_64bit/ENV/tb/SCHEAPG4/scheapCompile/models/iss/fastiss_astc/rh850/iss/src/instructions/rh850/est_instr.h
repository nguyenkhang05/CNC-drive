...
#ifndef _RH850_EST_INSTR_H_
#define _RH850_EST_INSTR_H_
...
{
  /**
   * \brief est instruction
   */
  class est_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief est instruction constructor
    ...
    /**
     * \brief est instruction destructor
     */
    virtual ~est_instr_t();
    ...
    /**
     * \brief est instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief est instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief est instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
