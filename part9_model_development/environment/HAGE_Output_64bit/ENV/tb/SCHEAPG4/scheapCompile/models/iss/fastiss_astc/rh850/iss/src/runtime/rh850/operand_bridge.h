 ...
 * \brief Defines the rh850 operand extraction bridge class
 */

#ifndef _RH850_OPERAND_BRIDGE_H_
#define _RH850_OPERAND_BRIDGE_H_

//------------------------------------------------------------------------------
// Includes
//------------------------------------------------------------------------------

#include "rh850/operand_if.h"

//------------------------------------------------------------------------------
// rh850 operand extraction interface bridge definition
//------------------------------------------------------------------------------
...
namespace rh850
{
  ...
  public:
     ...
     */
    rh850::GR_index_t get_reg1_u8_0_4(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg1 operand
     */
    rh850::GR_index_t get_reg1_u8_16_20(opcode_t opcode);
    /**
     ...
     */
    rh850::GR_index_t get_reg2_u8_0_4(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg2 operand
     */
    rh850::GR_index_t get_reg2_u8_11_15(opcode_t opcode);
    /**
     ...
     */
    rh850::GR_index_t get_reg3_u8_27_31(opcode_t opcode);
    /**
     ...
     */
    rh850::GR_index_t get_reg4_u8_17_20_shift1(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg4 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg4 operand
     */
    rh850::GR_index_t get_reg4_u8_17_20_23(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg1 operand
     */
    rh850::GR_index_t get_reg1_u8_1_4_shift1(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg2 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg2 operand
     */
    rh850::GR_index_t get_reg2_u8_12_15_shift1(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg3 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg3 operand
     */
    rh850::GR_index_t get_reg3_u8_28_31_shift1(opcode_t opcode);
    /**
     ...
     */
    rh850::SR_SELID_0_index_t get_regID_u8_0_4(opcode_t opcode);
    /**
     * \brief Calculates a SR_SELID_0 register group index value representing the value of the regID operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the regID operand
     */
    rh850::SR_SELID_0_index_t get_regID_u8_11_15(opcode_t opcode);
    /**
     ...
     */
    rh850::GR_index_t get_rt_u8_27_31(opcode_t opcode);
    /**
     ...
     */
    rh850::GR_index_t get_rh_u8_0_4(opcode_t opcode);
    /**
     * \brief Calculates a GR register group index value representing the value of the reg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the reg1 operand
     */
    rh850::GR_index_t get_reg1_u8_11_15(opcode_t opcode);
    /**
     ...
     */
    unsigned char get_vreg1_u8_0_4(opcode_t opcode);
    /**
     * \brief Calculates an integer value representing the value of the vreg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Value of the vreg1 operand
     */
    unsigned char get_vreg1_u8_11_15(opcode_t opcode);
    /**
  ...
  protected:
     ...
     */
    fastiss::i8_t *gen_get_vreg1_u8_0_4(opcode_t opcode);
    /**
     * \brief Generates code to calculate the value of the vreg1 operand for a given opcode value
     * \param opcode Opcode value
     * \return Object representing the value of the vreg1 operand
     */
    fastiss::i8_t *gen_get_vreg1_u8_11_15(opcode_t opcode);
    /**
...
#endif // _RH850_OPERAND_BRIDGE_H_
