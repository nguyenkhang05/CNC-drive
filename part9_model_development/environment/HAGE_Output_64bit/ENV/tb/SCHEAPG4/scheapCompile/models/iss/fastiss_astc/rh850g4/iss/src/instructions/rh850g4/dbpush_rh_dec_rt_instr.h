...
#ifndef _RH850G4_DBPUSH_RH_DEC_RT_INSTR_H_
#define _RH850G4_DBPUSH_RH_DEC_RT_INSTR_H_
...
//------------------------------------------------------------------------------
// dbpush rh-rt declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief dbpush_rh_dec_rt instruction
   */
  class dbpush_rh_dec_rt_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dbpush_rh_dec_rt instruction constructor
    ...
    /**
     * \brief dbpush_rh_dec_rt instruction destructor
     */
    virtual ~dbpush_rh_dec_rt_instr_t();
    ...
    /**
     * \brief dbpush_rh_dec_rt instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dbpush_rh_dec_rt instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbpush_rh_dec_rt instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_DBPUSH_RH_DEC_RT_INSTR_H_
