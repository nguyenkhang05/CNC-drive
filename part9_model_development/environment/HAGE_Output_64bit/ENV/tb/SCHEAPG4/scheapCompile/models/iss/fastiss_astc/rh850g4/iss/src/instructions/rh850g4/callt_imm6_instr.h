...
#ifndef _RH850G4_CALLT_IMM6_INSTR_H_
#define _RH850G4_CALLT_IMM6_INSTR_H_
...
//------------------------------------------------------------------------------
// callt imm6 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief callt_imm6 instruction
   */
  class callt_imm6_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief callt_imm6 instruction constructor
    ...
    /**
     * \brief callt_imm6 instruction destructor
     */
    virtual ~callt_imm6_instr_t();
    ...
    /**
     * \brief callt_imm6 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief callt_imm6 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief callt_imm6 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief callt_imm6 instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief callt_imm6 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_CALLT_IMM6_INSTR_H_
