...
#ifndef _RH850G4_HALT_INSTR_H_
#define _RH850G4_HALT_INSTR_H_
...
namespace rh850g4
{
   ...
   */
  class halt_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief halt instruction constructor
    ...
    /**
     * \brief halt instruction destructor
     */
    virtual ~halt_instr_t();
    ...
    /**
     * \brief halt instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief halt instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief halt instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief halt instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
