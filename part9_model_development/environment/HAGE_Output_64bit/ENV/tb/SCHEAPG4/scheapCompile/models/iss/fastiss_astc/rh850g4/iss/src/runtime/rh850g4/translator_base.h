...
#ifndef _RH850G4_TRANSLATOR_BASE_H_
#define _RH850G4_TRANSLATOR_BASE_H_
...
{
  /**
   * \brief Indices for individual instruction sets in the rh850g4
   */
  typedef enum
  {
  ...
  public:
     ...
     */          
    virtual void set_active_instruction_set(rh850g4::instruction_set_index_t index);
     ...
     * \return Opcode value
     */
    virtual rh850g4::opcode_t get_decode_opcode();
    /**
     * \brief Reads the opcode of the instruction currently in the
     * execute translation phase.
     * \return Opcode value
     */
    virtual rh850g4::opcode_t get_execute_opcode();
    /**
  ...
  protected:
     ...
     */
    virtual rh850g4::opcode_t fetch_opcode_callout(unsigned int addr);
     ...
     */
    rh850g4::decoder_if_t *m_decoder[2];
  ...
  private:
     ...
     */
    rh850g4::rh850e3_decoder_t *m_rh850e3_decoder[2];
  ...
  protected:
     ...
     */          
    rh850g4::instruction_base_if_t *m_null_instruction;
    /**
     ...
     */          
    rh850g4::instruction_base_if_t *m_terminate_instruction;
     ...
     * phase
     */
    rh850g4::opcode_t m_opcode[2];
    /**
     * \brief Array containing the instruction in each translation phase
     */
    rh850g4::instruction_base_if_t *m_instruction[2];
...
#endif // _RH850G4_TRANSLATOR_BASE_H_
