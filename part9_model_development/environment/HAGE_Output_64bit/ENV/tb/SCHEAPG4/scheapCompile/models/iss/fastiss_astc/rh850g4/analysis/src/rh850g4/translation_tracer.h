...
#ifndef _RH850G4_TRANSLATION_TRACER_H_
#define _RH850G4_TRANSLATION_TRACER_H_
...
namespace rh850g4
{
  ...
  public:    
    ...
    void attach(rh850g4::core_base_t *core)
    {
      ...
      m_pre_translate_loop_attachment = m_core->attach("pre_translate_loop", (rh850g4::analysis_callback)pre_translate_callback, this);
     ...
     */
    static void pre_translate_callback(rh850g4::translation_tracer *tracer)
    {
     ...
     * \param tracer Pointer to self.
     */
    static void fetch_callback(rh850g4::translation_tracer *tracer)
    {
      rh850g4::core_base_t *core = tracer->m_core;
     ...
     */
    rh850g4::analysis_attachment_descriptor *m_pre_translate_loop_attachment;    
...
#endif // _RH850G4_TRANSLATION_TRACER_H_
