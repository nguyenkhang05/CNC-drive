...
#ifndef _RH850G4_ROTL_IMM5_REG2_REG3_INSTR_H_
#define _RH850G4_ROTL_IMM5_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// rotl imm5, reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief rotl_imm5_reg2_reg3 instruction
   */
  class rotl_imm5_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief rotl_imm5_reg2_reg3 instruction constructor
    ...
    /**
     * \brief rotl_imm5_reg2_reg3 instruction destructor
     */
    virtual ~rotl_imm5_reg2_reg3_instr_t();
    ...
    /**
     * \brief rotl_imm5_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief rotl_imm5_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief rotl_imm5_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ROTL_IMM5_REG2_REG3_INSTR_H_
