...
#ifndef _RH850G4_SYNCE_INSTR_H_
#define _RH850G4_SYNCE_INSTR_H_
...
{
  /**
   * \brief synce instruction
   */
  class synce_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief synce instruction constructor
    ...
    /**
     * \brief synce instruction destructor
     */
    virtual ~synce_instr_t();
    ...
    /**
     * \brief synce instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief synce instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief synce instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
