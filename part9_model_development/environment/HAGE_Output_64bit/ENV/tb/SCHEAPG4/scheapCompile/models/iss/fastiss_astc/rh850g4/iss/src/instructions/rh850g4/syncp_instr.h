...
#ifndef _RH850G4_SYNCP_INSTR_H_
#define _RH850G4_SYNCP_INSTR_H_
...
{
  /**
   * \brief syncp instruction
   */
  class syncp_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief syncp instruction constructor
    ...
    /**
     * \brief syncp instruction destructor
     */
    virtual ~syncp_instr_t();
    ...
    /**
     * \brief syncp instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief syncp instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief syncp instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
