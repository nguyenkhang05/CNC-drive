...
#ifndef _RH850G4_CONTINUE_TRANSLATOR_H_
#define _RH850G4_CONTINUE_TRANSLATOR_H_

//------------------------------------------------------------------------------
// Includes
//------------------------------------------------------------------------------

#include "rh850g4/continue_translator_base.h"
...
//------------------------------------------------------------------------------
// rh850g4 continue translator definition
//------------------------------------------------------------------------------
...
namespace rh850g4
{
   ...
   * once only.
   */
  class continue_translator_t : public rh850g4::continue_translator_base_t
  {
  public:
    /**
...
#endif // _RH850G4_CONTINUE_TRANSLATOR_H_
