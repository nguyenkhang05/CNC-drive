...
#ifndef _RH850_DST_INSTR_H_
#define _RH850_DST_INSTR_H_
...
{
  /**
   * \brief dst instruction
   */
  class dst_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dst instruction constructor
    ...
    /**
     * \brief dst instruction destructor
     */
    virtual ~dst_instr_t();
    ...
    /**
     * \brief dst instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dst instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dst instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
