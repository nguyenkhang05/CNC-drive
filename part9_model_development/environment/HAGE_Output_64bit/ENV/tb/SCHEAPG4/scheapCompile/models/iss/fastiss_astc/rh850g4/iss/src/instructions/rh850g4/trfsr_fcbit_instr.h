...
#ifndef _RH850G4_TRFSR_FCBIT_INSTR_H_
#define _RH850G4_TRFSR_FCBIT_INSTR_H_
...
//------------------------------------------------------------------------------
// trfsr fcbit declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief trfsr_fcbit instruction
   */
  class trfsr_fcbit_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief trfsr_fcbit instruction constructor
    ...
    /**
     * \brief trfsr_fcbit instruction destructor
     */
    virtual ~trfsr_fcbit_instr_t();
    ...
    /**
     * \brief trfsr_fcbit instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief trfsr_fcbit instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief trfsr_fcbit instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_TRFSR_FCBIT_INSTR_H_
