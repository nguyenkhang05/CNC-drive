...
# ---------------------------------------------------------
# Create VCI slave ram instance.
# ---------------------------------------------------------
#                                   |  same cl   |  diff cl   |
#ms_cl|start     | end       | attr |  F,  R,  W |  F,  R,  W | clid         |outstand | repeat|
#ms_cl (0x10000000, 0x1FFFFFFF, "RWX", 23,  5,  7,  23,  5,  7, CFDEF_GLOBAL,  8,        2) # VCI Slave0
#ms_cl (0x20000000, 0x2FFFFFFF, "RWX", 23,  5,  7,  23,  5,  7, CFDEF_GLOBAL,  8,        2) # VCI Slave1
...
error_area_set (0xFF001000, 0xFF001FFF)
