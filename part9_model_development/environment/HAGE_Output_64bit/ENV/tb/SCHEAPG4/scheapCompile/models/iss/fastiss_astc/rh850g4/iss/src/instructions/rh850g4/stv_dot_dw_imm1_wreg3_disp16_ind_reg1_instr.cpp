...
//------------------------------------------------------------------------------
// stv.dw imm1, wreg3, disp16 [reg1] implementation
//------------------------------------------------------------------------------

rh850g4::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t
(
...
void rh850g4::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(6);  
}

std::string rh850g4::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  unsigned int imm1 = get_imm1_u32_21(opcode);
  ...
  disass_string << "stv.dw " << imm1 << ", " << wreg3_name << ", 0x" << std::hex << disp16 << "[" << reg1_name << "]"; 
  return disass_string.str();
}

unsigned int rh850g4::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 6;
}

void rh850g4::stv_dot_dw_imm1_wreg3_disp16_ind_reg1_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  fastiss::i32_t *imm1 = gen_get_imm1_u32_21(opcode);
  WR_index_t wreg3 = get_wreg3_u8_27_31(opcode);
  ...
  fastiss::i64_t *write_val = gen_select(gen_icmp_eq(imm1, gen_i32_constant(0)), 
					 wreg3lo_load,
					 wreg3up_load);
