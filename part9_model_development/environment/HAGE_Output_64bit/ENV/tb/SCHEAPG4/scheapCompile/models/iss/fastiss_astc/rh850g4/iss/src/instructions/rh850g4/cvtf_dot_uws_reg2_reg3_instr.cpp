...
//------------------------------------------------------------------------------
// cvtf.uws reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::cvtf_dot_uws_reg2_reg3_instr_t::cvtf_dot_uws_reg2_reg3_instr_t
(
...
void rh850g4::cvtf_dot_uws_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::cvtf_dot_uws_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "cvtf.uws " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::cvtf_dot_uws_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::cvtf_dot_uws_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  GR_index_t reg3 = get_reg3_u8_27_31(opcode);
  ...
  fastiss::f32_with_exception_flags_t convert_result = gen_f32_unsigned_convert(reg2_load, gen_read_round_mode());
