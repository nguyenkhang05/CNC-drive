...
#ifndef _RH850G4_XORI_IMM16_REG1_REG2_INSTR_H_
#define _RH850G4_XORI_IMM16_REG1_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// xori imm16, reg1, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief xori_imm16_reg1_reg2 instruction
   */
  class xori_imm16_reg1_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief xori_imm16_reg1_reg2 instruction constructor
    ...
    /**
     * \brief xori_imm16_reg1_reg2 instruction destructor
     */
    virtual ~xori_imm16_reg1_reg2_instr_t();
    ...
    /**
     * \brief xori_imm16_reg1_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief xori_imm16_reg1_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief xori_imm16_reg1_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_XORI_IMM16_REG1_REG2_INSTR_H_
