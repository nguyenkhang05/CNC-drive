...
rh850g4::satadd_imm5_reg2_instr_t::satadd_imm5_reg2_instr_t
(
...
void rh850g4::satadd_imm5_reg2_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(2);  
}

std::string rh850g4::satadd_imm5_reg2_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850g4::satadd_imm5_reg2_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850g4::satadd_imm5_reg2_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
