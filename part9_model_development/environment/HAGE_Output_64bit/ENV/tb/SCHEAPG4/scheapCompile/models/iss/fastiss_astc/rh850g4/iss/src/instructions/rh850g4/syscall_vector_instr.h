...
#ifndef _RH850G4_SYSCALL_VECTOR_INSTR_H_
#define _RH850G4_SYSCALL_VECTOR_INSTR_H_
...
//------------------------------------------------------------------------------
// syscall vector declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief syscall_vector instruction
   */
  class syscall_vector_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief syscall_vector instruction constructor
    ...
    /**
     * \brief syscall_vector instruction destructor
     */
    virtual ~syscall_vector_instr_t();
    ...
    /**
     * \brief syscall_vector instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief syscall_vector instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief syscall_vector instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief syscall_vector instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief syscall_vector instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_SYSCALL_VECTOR_INSTR_H_
