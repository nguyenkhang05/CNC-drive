...
#ifndef _RH850G4_SHL_IMM5_REG2_INSTR_H_
#define _RH850G4_SHL_IMM5_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// shl imm5, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief shl_imm5_reg2 instruction
   */
  class shl_imm5_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief shl_imm5_reg2 instruction constructor
    ...
    /**
     * \brief shl_imm5_reg2 instruction destructor
     */
    virtual ~shl_imm5_reg2_instr_t();
    ...
    /**
     * \brief shl_imm5_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief shl_imm5_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief shl_imm5_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SHL_IMM5_REG2_INSTR_H_
