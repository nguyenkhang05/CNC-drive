...
#ifndef _RH850G4_SETF_CCCC_REG2_INSTR_H_
#define _RH850G4_SETF_CCCC_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// setf cccc, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief setf_cccc_reg2 instruction
   */
  class setf_cccc_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief setf_cccc_reg2 instruction constructor
    ...
    /**
     * \brief setf_cccc_reg2 instruction destructor
     */
    virtual ~setf_cccc_reg2_instr_t();
    ...
    /**
     * \brief setf_cccc_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief setf_cccc_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief setf_cccc_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_SETF_CCCC_REG2_INSTR_H_
