...
#ifndef _RH850_LDTC_DOT_SR_REG2_REGID_SELID_INSTR_H_
#define _RH850_LDTC_DOT_SR_REG2_REGID_SELID_INSTR_H_
...
//------------------------------------------------------------------------------
// ldtc.sr reg2, regID, selID declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief ldtc_dot_sr_reg2_regid_selid instruction
   */
  class ldtc_dot_sr_reg2_regid_selid_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldtc_dot_sr_reg2_regid_selid instruction constructor
     ...
     */
    ldtc_dot_sr_reg2_regid_selid_instr_t
    (
    ...
    /**
     * \brief ldtc_dot_sr_reg2_regid_selid instruction destructor
     */
    virtual ~ldtc_dot_sr_reg2_regid_selid_instr_t();
    ...
    /**
     * \brief ldtc_dot_sr_reg2_regid_selid instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldtc_dot_sr_reg2_regid_selid instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldtc_dot_sr_reg2_regid_selid instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_LDTC_DOT_SR_REG2_REGID_SELID_INSTR_H_
