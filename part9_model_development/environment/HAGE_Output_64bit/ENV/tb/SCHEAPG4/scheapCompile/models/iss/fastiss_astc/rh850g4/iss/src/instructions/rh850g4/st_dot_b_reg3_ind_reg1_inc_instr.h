...
#ifndef _RH850G4_ST_DOT_B_REG3_IND_REG1_INC_INSTR_H_
#define _RH850G4_ST_DOT_B_REG3_IND_REG1_INC_INSTR_H_
...
//------------------------------------------------------------------------------
// st.b reg3, [reg1]+ declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief st_dot_b_reg3_ind_reg1_inc instruction
   */
  class st_dot_b_reg3_ind_reg1_inc_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief st_dot_b_reg3_ind_reg1_inc instruction constructor
     ...
     */
    st_dot_b_reg3_ind_reg1_inc_instr_t
    (
    ...
    /**
     * \brief st_dot_b_reg3_ind_reg1_inc instruction destructor
     */
    virtual ~st_dot_b_reg3_ind_reg1_inc_instr_t();
    ...
    /**
     * \brief st_dot_b_reg3_ind_reg1_inc instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief st_dot_b_reg3_ind_reg1_inc instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief st_dot_b_reg3_ind_reg1_inc instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ST_DOT_B_REG3_IND_REG1_INC_INSTR_H_
