...
#ifndef _RH850_LDTC_DOT_VR_REG2_VREG1_INSTR_H_
#define _RH850_LDTC_DOT_VR_REG2_VREG1_INSTR_H_
...
//------------------------------------------------------------------------------
// ldtc.vr reg2, vreg1 declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief ldtc_dot_vr_reg2_vreg1 instruction
   */
  class ldtc_dot_vr_reg2_vreg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ldtc_dot_vr_reg2_vreg1 instruction constructor
     ...
     */
    ldtc_dot_vr_reg2_vreg1_instr_t
    (
    ...
    /**
     * \brief ldtc_dot_vr_reg2_vreg1 instruction destructor
     */
    virtual ~ldtc_dot_vr_reg2_vreg1_instr_t();
    ...
    /**
     * \brief ldtc_dot_vr_reg2_vreg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ldtc_dot_vr_reg2_vreg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ldtc_dot_vr_reg2_vreg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_LDTC_DOT_VR_REG2_VREG1_INSTR_H_
