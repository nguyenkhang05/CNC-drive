...
#ifndef _RH850_ANALYSIS_POINT_IF_H_
#define _RH850_ANALYSIS_POINT_IF_H_
...
{
  /**
   * \class rh850::analysis_point_error
...
#endif // _RH850_ANALYSIS_POINT_IF_H_
