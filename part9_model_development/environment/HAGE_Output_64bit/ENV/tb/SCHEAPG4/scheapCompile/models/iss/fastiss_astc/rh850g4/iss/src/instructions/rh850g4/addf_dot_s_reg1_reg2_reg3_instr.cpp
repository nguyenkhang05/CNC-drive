...
//------------------------------------------------------------------------------
// addf.s reg1, reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850g4::addf_dot_s_reg1_reg2_reg3_instr_t::addf_dot_s_reg1_reg2_reg3_instr_t
(
...
void rh850g4::addf_dot_s_reg1_reg2_reg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::addf_dot_s_reg1_reg2_reg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "addf.s " << reg1_name << ", " << reg2_name << ", " << reg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::addf_dot_s_reg1_reg2_reg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::addf_dot_s_reg1_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  fastiss::i1_t* is_both_infinity = gen_and(gen_is_infinity(reg1_float32), gen_is_infinity(reg2_float32));
  fastiss::i1_t* is_opposite_sign = gen_icmp_ne(gen_is_positive(reg1_float32), gen_is_positive(reg2_float32));
  ...
  fastiss::f32_with_exception_flags_t add_result = gen_f32_add(reg1_float80, reg2_float80, gen_read_round_mode());
  ...
  add_result.inexact = gen_inexact_denorm_update(add_result.invalid, add_result.divide_by_zero, add_result.inexact, reg1_float32, reg2_float32);
