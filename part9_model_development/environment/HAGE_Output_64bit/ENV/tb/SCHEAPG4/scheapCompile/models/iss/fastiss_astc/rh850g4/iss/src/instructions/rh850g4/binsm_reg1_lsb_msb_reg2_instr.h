...
#ifndef _RH850G4_BINSM_REG1_LSB_MSB_REG2_INSTR_H_
#define _RH850G4_BINSM_REG1_LSB_MSB_REG2_INSTR_H_
...
//------------------------------------------------------------------------------
// binsm reg1, lsb, msb, reg2 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief binsm_reg1_lsb_msb_reg2 instruction
   */
  class binsm_reg1_lsb_msb_reg2_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief binsm_reg1_lsb_msb_reg2 instruction constructor
     ...
     */
    binsm_reg1_lsb_msb_reg2_instr_t
    (
    ...
    /**
     * \brief binsm_reg1_lsb_msb_reg2 instruction destructor
     */
    virtual ~binsm_reg1_lsb_msb_reg2_instr_t();
    ...
    /**
     * \brief binsm_reg1_lsb_msb_reg2 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief binsm_reg1_lsb_msb_reg2 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief binsm_reg1_lsb_msb_reg2 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_BINSM_REG1_LSB_MSB_REG2_INSTR_H_
