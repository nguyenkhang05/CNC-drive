...
#ifndef _RH850G4_PREF_PREFOP_IND_REG1_INSTR_H_
#define _RH850G4_PREF_PREFOP_IND_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// pref prefop, [reg1] declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief pref_prefop_ind_reg1 instruction
   */
  class pref_prefop_ind_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief pref_prefop_ind_reg1 instruction constructor
    ...
    /**
     * \brief pref_prefop_ind_reg1 instruction destructor
     */
    virtual ~pref_prefop_ind_reg1_instr_t();
    ...
    /**
     * \brief pref_prefop_ind_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief pref_prefop_ind_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief pref_prefop_ind_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_PREF_PREFOP_IND_REG1_INSTR_H_
