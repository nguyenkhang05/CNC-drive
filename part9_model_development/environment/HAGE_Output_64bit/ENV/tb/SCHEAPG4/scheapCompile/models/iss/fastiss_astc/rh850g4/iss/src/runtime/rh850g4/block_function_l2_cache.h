...
#ifndef _RH850G4_BLOCK_FUNCTION_L2_CACHE_H_
#define _RH850G4_BLOCK_FUNCTION_L2_CACHE_H_
...
namespace rh850g4
{
  ...
  private:
     ...
     */
    rh850g4::block_function_l2_cache_t::entry_t* m_entries[4096];
  };
}

inline fastiss::block_function_t *rh850g4::block_function_l2_cache_t::lookup_function(unsigned int key)
{
  unsigned short index = (unsigned short)(40503 * key) >> 4;
  unsigned char number_of_entries = 0;
  rh850g4::block_function_l2_cache_t::entry_t *cache_entry = m_entries[index];  
  rh850g4::block_function_l2_cache_t::entry_t *first_entry = cache_entry;
  rh850g4::block_function_l2_cache_t::entry_t *previous_entry = NULL;
...
inline void rh850g4::block_function_l2_cache_t::flush_function(unsigned int key)
{
  unsigned short index = (unsigned short)(40503 * key) >> 4;
  rh850g4::block_function_l2_cache_t::entry_t *cache_entry = m_entries[index];  
  rh850g4::block_function_l2_cache_t::entry_t *previous_entry = NULL;
...
#endif // _RH850G4_BLOCK_FUNCTION_L2_CACHE_H_
