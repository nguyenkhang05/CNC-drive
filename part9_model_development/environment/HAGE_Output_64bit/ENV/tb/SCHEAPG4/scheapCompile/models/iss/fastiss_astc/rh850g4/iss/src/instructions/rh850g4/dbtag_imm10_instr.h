...
#ifndef _RH850G4_DBTAG_IMM10_INSTR_H_
#define _RH850G4_DBTAG_IMM10_INSTR_H_
...
//------------------------------------------------------------------------------
// dbtag imm10 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief dbtag_imm10 instruction
   */
  class dbtag_imm10_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief dbtag_imm10 instruction constructor
    ...
    /**
     * \brief dbtag_imm10 instruction destructor
     */
    virtual ~dbtag_imm10_instr_t();
    ...
    /**
     * \brief dbtag_imm10 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief dbtag_imm10 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief dbtag_imm10 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_DBTAG_IMM10_INSTR_H_
