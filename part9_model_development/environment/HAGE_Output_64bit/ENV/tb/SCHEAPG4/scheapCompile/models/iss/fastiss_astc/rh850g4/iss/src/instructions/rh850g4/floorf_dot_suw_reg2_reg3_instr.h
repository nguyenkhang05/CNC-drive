...
#ifndef _RH850G4_FLOORF_DOT_SUW_REG2_REG3_INSTR_H_
#define _RH850G4_FLOORF_DOT_SUW_REG2_REG3_INSTR_H_
...
//------------------------------------------------------------------------------
// floorf.suw reg2, reg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief floorf_dot_suw_reg2_reg3 instruction
   */
  class floorf_dot_suw_reg2_reg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief floorf_dot_suw_reg2_reg3 instruction constructor
     ...
     */
    floorf_dot_suw_reg2_reg3_instr_t
    (
    ...
    /**
     * \brief floorf_dot_suw_reg2_reg3 instruction destructor
     */
    virtual ~floorf_dot_suw_reg2_reg3_instr_t();
    ...
    /**
     * \brief floorf_dot_suw_reg2_reg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief floorf_dot_suw_reg2_reg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief floorf_dot_suw_reg2_reg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_FLOORF_DOT_SUW_REG2_REG3_INSTR_H_
