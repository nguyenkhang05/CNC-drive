...
#ifndef _RH850_STVC_DOT_SR_REGID_REG2_SELID_INSTR_H_
#define _RH850_STVC_DOT_SR_REGID_REG2_SELID_INSTR_H_
...
//------------------------------------------------------------------------------
// stvc.sr regID, reg2, selID declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief stvc_dot_sr_regid_reg2_selid instruction
   */
  class stvc_dot_sr_regid_reg2_selid_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief stvc_dot_sr_regid_reg2_selid instruction constructor
     ...
     */
    stvc_dot_sr_regid_reg2_selid_instr_t
    (
    ...
    /**
     * \brief stvc_dot_sr_regid_reg2_selid instruction destructor
     */
    virtual ~stvc_dot_sr_regid_reg2_selid_instr_t();
    ...
    /**
     * \brief stvc_dot_sr_regid_reg2_selid instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief stvc_dot_sr_regid_reg2_selid instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief stvc_dot_sr_regid_reg2_selid instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_STVC_DOT_SR_REGID_REG2_SELID_INSTR_H_
