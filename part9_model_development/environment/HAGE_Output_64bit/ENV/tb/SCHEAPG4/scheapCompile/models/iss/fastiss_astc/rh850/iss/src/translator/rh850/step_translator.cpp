...
//------------------------------------------------------------------------------
// rh850 step translator implementation
//------------------------------------------------------------------------------

rh850::step_translator_t::step_translator_t
(
...
void rh850::step_translator_t::pre_translate_loop_callout(fastiss::block_function_t *block_fn)
{
...
void rh850::step_translator_t::post_translate_loop_callout(fastiss::block_function_t *block_fn)
{
  // Create exit block
...
void rh850::step_translator_t::post_fetch_callout(fastiss::block_function_t *block_fn)
{
...
void rh850::step_translator_t::post_decode_callout(fastiss::block_function_t *block_fn)
{
...
void rh850::step_translator_t::post_execute_callout(fastiss::block_function_t *block_fn)
{
