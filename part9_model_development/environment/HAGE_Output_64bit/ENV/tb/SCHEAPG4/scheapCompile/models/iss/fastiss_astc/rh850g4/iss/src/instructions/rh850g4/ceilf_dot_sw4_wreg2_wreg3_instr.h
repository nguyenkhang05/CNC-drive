...
#ifndef _RH850G4_CEILF_DOT_SW4_WREG2_WREG3_INSTR_H_
#define _RH850G4_CEILF_DOT_SW4_WREG2_WREG3_INSTR_H_
...
//------------------------------------------------------------------------------
// ceilf.sw4 wreg2, wreg3 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief ceilf_dot_sw4_wreg2_wreg3 instruction
   */
  class ceilf_dot_sw4_wreg2_wreg3_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction constructor
     ...
     */
    ceilf_dot_sw4_wreg2_wreg3_instr_t
    (
    ...
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction destructor
     */
    virtual ~ceilf_dot_sw4_wreg2_wreg3_instr_t();
    ...
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief ceilf_dot_sw4_wreg2_wreg3 instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850G4_CEILF_DOT_SW4_WREG2_WREG3_INSTR_H_
