...
#ifndef _RH850G4_MSUBF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
#define _RH850G4_MSUBF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
...
//------------------------------------------------------------------------------
// msubf.s reg1, reg2, reg3, reg4 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction
   */
  class msubf_dot_s_reg1_reg2_reg3_reg4_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction constructor
     ...
     */
    msubf_dot_s_reg1_reg2_reg3_reg4_instr_t
    (
    ...
    /**
     * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction destructor
     */
    virtual ~msubf_dot_s_reg1_reg2_reg3_reg4_instr_t();
    ...
    /**
     * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief msubf_dot_s_reg1_reg2_reg3_reg4 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_MSUBF_DOT_S_REG1_REG2_REG3_REG4_INSTR_H_
