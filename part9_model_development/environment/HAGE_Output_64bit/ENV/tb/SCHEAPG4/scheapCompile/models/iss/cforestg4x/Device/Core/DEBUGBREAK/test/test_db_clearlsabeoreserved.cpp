 ...
 * @brief Check ClearLsabEoReserved method.
 */
TEST_F(DbgBreakMethodCheck, CheckClearLsabEoReserved) {

  m_gdbbreak->m_lsab_eo_reserve.push_back(3);
  m_gdbbreak->m_lsab_eo_reserve.push_back(1);
  m_gdbbreak->m_lsab_eo_reserve.push_back(2);
  ASSERT_EQ(3U, m_gdbbreak->m_lsab_eo_reserve.size());

  // check
  m_gdbbreak->ClearLsabEoReserved(m_trace);

  ASSERT_EQ(0U, m_gdbbreak->m_lsab_eo_reserve.size());
}
