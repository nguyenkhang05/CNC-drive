...
#ifndef _RH850_STTC_DOT_SR_REGID_REG2_SELID_INSTR_H_
#define _RH850_STTC_DOT_SR_REGID_REG2_SELID_INSTR_H_
...
//------------------------------------------------------------------------------
// sttc.sr regID, reg2, selID declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief sttc_dot_sr_regid_reg2_selid instruction
   */
  class sttc_dot_sr_regid_reg2_selid_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief sttc_dot_sr_regid_reg2_selid instruction constructor
     ...
     */
    sttc_dot_sr_regid_reg2_selid_instr_t
    (
    ...
    /**
     * \brief sttc_dot_sr_regid_reg2_selid instruction destructor
     */
    virtual ~sttc_dot_sr_regid_reg2_selid_instr_t();
    ...
    /**
     * \brief sttc_dot_sr_regid_reg2_selid instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief sttc_dot_sr_regid_reg2_selid instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief sttc_dot_sr_regid_reg2_selid instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850_STTC_DOT_SR_REGID_REG2_SELID_INSTR_H_
