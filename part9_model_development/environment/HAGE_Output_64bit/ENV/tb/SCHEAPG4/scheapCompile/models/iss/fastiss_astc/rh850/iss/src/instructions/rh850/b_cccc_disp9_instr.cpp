...
rh850::b_cccc_disp9_instr_t::b_cccc_disp9_instr_t
(
...
void rh850::b_cccc_disp9_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
std::string rh850::b_cccc_disp9_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  unsigned char cccc = get_cccc_u8_0_3(opcode);
  int disp9 = get_disp9_s32_11_15_4_6_shift1(opcode);
...
unsigned int rh850::b_cccc_disp9_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}

void rh850::b_cccc_disp9_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
