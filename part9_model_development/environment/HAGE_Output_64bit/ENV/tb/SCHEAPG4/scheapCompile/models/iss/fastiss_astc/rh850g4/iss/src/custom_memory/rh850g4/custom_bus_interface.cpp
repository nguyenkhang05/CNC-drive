...
rh850g4::custom_bus_interface_t::custom_bus_interface_t(const std::string& name) :
  rh850g4::bus_interface_t(name),
  m_debug_payload(),
  m_fetch_payload(),
  m_dmi_payload(),
  m_payload()
...
rh850g4::custom_bus_interface_t::~custom_bus_interface_t()
{
}

tlm::tlm_generic_payload& rh850g4::custom_bus_interface_t::get_debug_payload(tlm::tlm_command command, sc_dt::uint64 address, unsigned int size, unsigned char *data)
{
...
tlm::tlm_generic_payload& rh850g4::custom_bus_interface_t::get_fetch_payload(sc_dt::uint64 address, unsigned int size, unsigned char *data)
{
...
tlm::tlm_generic_payload& rh850g4::custom_bus_interface_t::get_dmi_payload(tlm::tlm_command command, sc_dt::uint64 address, unsigned int size, unsigned char *data)
{
...
tlm::tlm_generic_payload& rh850g4::custom_bus_interface_t::get_payload(tlm::tlm_command command, sc_dt::uint64 address, unsigned int size, unsigned char *data)
{
...
void rh850g4::custom_bus_interface_t::debug_completed(unsigned int bytes_transferred)
{
}

void rh850g4::custom_bus_interface_t::fetch_completed(unsigned int bytes_transferred)
{
}

void rh850g4::custom_bus_interface_t::dmi_completed(void)
{
}

void rh850g4::custom_bus_interface_t::transaction_completed(void)
{
}

void rh850g4::custom_bus_interface_t::dmi_pointer_post_callout(rh850g4::access_type_t type, dmi_region *val)
{
