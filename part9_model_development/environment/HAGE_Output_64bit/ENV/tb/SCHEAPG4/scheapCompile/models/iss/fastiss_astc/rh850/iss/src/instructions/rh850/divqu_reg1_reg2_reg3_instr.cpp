...
//------------------------------------------------------------------------------
// divqu reg1, reg2, reg3 implementation
//------------------------------------------------------------------------------

rh850::divqu_reg1_reg2_reg3_instr_t::divqu_reg1_reg2_reg3_instr_t
(
...
void rh850::divqu_reg1_reg2_reg3_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850::divqu_reg1_reg2_reg3_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "divqu " << reg1_name << ", " << reg2_name << ", " << reg3_name;
  return disass_string.str();
}

unsigned int rh850::divqu_reg1_reg2_reg3_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850::divqu_reg1_reg2_reg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  GR_index_t reg1 = get_reg1_u8_0_4(opcode);
  GR_index_t reg2 = get_reg2_u8_11_15(opcode);
  ...
  gen_divu_reg1_reg2_reg3(reg1_load, reg2, reg3);
  ...
  fastiss::i32_t *dividend_valid_bits = gen_sub(gen_i32_constant(32), gen_count_lead_zero(reg2_load));
  fastiss::i32_t *divisor_valid_bits = gen_sub(gen_i32_constant(32), gen_count_lead_zero(reg1_load));
