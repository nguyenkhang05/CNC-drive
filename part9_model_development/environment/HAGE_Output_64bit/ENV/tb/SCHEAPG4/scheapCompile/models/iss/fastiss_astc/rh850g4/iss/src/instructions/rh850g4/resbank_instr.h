...
#ifndef _RH850G4_RESBANK_INSTR_H_
#define _RH850G4_RESBANK_INSTR_H_
...
{
  /**
   * \brief resbank instruction
   */
  class resbank_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief resbank instruction constructor
    ...
    /**
     * \brief resbank instruction destructor
     */
    virtual ~resbank_instr_t();
    ...
    /**
     * \brief resbank instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief resbank instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief resbank instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_RESBANK_INSTR_H_
