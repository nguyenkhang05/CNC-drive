...
rh850::prepare_list12_imm5_instr_t::prepare_list12_imm5_instr_t
(
...
void rh850::prepare_list12_imm5_instr_t::decode(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850::prepare_list12_imm5_instr_t::disassemble(rh850::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
...
unsigned int rh850::prepare_list12_imm5_instr_t::length(rh850::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850::prepare_list12_imm5_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  unsigned short list12 = get_list12_u16_21_31_0(opcode);
...
unsigned int rh850::prepare_list12_imm5_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  unsigned short list12 = get_list12_u16_21_31_0(opcode);
