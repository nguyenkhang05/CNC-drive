...
#ifndef _RH850G4_ZXB_REG1_INSTR_H_
#define _RH850G4_ZXB_REG1_INSTR_H_
...
//------------------------------------------------------------------------------
// zxb reg1 declaration
//------------------------------------------------------------------------------

namespace rh850g4
{
  /**
   * \brief zxb_reg1 instruction
   */
  class zxb_reg1_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief zxb_reg1 instruction constructor
    ...
    /**
     * \brief zxb_reg1 instruction destructor
     */
    virtual ~zxb_reg1_instr_t();
    ...
    /**
     * \brief zxb_reg1 instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief zxb_reg1 instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief zxb_reg1 instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
...
#endif // _RH850G4_ZXB_REG1_INSTR_H_
