...
#ifndef _RH850_HVCALL_VECTOR_INSTR_H_
#define _RH850_HVCALL_VECTOR_INSTR_H_
...
//------------------------------------------------------------------------------
// hvcall vector declaration
//------------------------------------------------------------------------------

namespace rh850
{
  /**
   * \brief hvcall_vector instruction
   */
  class hvcall_vector_instr_t : public instruction_base_impl_t
  {
  public:
    /**
     * \brief hvcall_vector instruction constructor
    ...
    /**
     * \brief hvcall_vector instruction destructor
     */
    virtual ~hvcall_vector_instr_t();
    ...
    /**
     * \brief hvcall_vector instruction disassembly operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief hvcall_vector instruction length operation
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief hvcall_vector instruction execute phase handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
     */
    ...
    /**
     * \brief hvcall_vector instruction terminates_block attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
    ...
    /**
     * \brief hvcall_vector instruction cycle_count attribute query handler
     * \param opcode Instruction opcode
     * \param trans_PC Translation-time PC value of the instruction
...
#endif // _RH850_HVCALL_VECTOR_INSTR_H_
