...
//------------------------------------------------------------------------------
// cvtf.ws4 wreg2, wreg3 implementation
//------------------------------------------------------------------------------

rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::cvtf_dot_ws4_wreg2_wreg3_instr_t
(
...
void rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::decode(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Increment PC
  increment_trans_PC(4);  
}

std::string rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::disassemble(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  ...
  disass_string << "cvtf.ws4 " << wreg2_name << ", " << wreg3_name; 
  return disass_string.str();
}

unsigned int rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::length(rh850g4::opcode_t opcode, unsigned int trans_PC)
{
  return 4;
}

void rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::execute(opcode_t opcode, unsigned int trans_PC)
{
  // Extract operands
  WR_index_t wreg2 = get_wreg2_u8_11_15(opcode);
  WR_index_t wreg3 = get_wreg3_u8_27_31(opcode);
  ...
  // for w0
  fastiss::f32_with_exception_flags_t w0_convert_result = gen_f32_signed_convert(wr2_w0_val, gen_read_round_mode());
  ...
  // for w1
  fastiss::f32_with_exception_flags_t w1_convert_result = gen_f32_signed_convert(wr2_w1_val, gen_read_round_mode());
  ...
  // for w2
  fastiss::f32_with_exception_flags_t w2_convert_result = gen_f32_signed_convert(wr2_w2_val, gen_read_round_mode());
  ...
  // for w3
  fastiss::f32_with_exception_flags_t w3_convert_result = gen_f32_signed_convert(wr2_w3_val, gen_read_round_mode());
...
unsigned int rh850g4::cvtf_dot_ws4_wreg2_wreg3_instr_t::cycle_count(opcode_t opcode, unsigned int trans_PC)
{
  return 2;
}
