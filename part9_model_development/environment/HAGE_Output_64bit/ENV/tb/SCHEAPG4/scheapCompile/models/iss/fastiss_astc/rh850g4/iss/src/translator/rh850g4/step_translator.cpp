...
//------------------------------------------------------------------------------
// rh850g4 step translator implementation
//------------------------------------------------------------------------------

rh850g4::step_translator_t::step_translator_t
(
...
void rh850g4::step_translator_t::pre_translate_loop_callout(fastiss::block_function_t *block_fn)
{
...
void rh850g4::step_translator_t::post_translate_loop_callout(fastiss::block_function_t *block_fn)
{
  // Create exit block
...
void rh850g4::step_translator_t::post_fetch_callout(fastiss::block_function_t *block_fn)
{
...
void rh850g4::step_translator_t::post_decode_callout(fastiss::block_function_t *block_fn)
{
  // Grab the decode instruction
  instruction_base_if_t *instruction = m_instruction[m_decode_phase_index];
}

void rh850g4::step_translator_t::post_execute_callout(fastiss::block_function_t *block_fn)
{
  ...
  if (instruction != m_null_instruction)
  {
