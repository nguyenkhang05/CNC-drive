...
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x1, iodef.REG_HAGESEED, 0x1, 0xFF, 0x1, 0x0)
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x0, iodef.REG_HAGESEED, 0x1, 0xFF, 0x1, 0x0)
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_ReadReceivedData("RH850.dummy_master", 0xFF)
