...
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x0, iodef.REG_HAGEODAT, 0x0, 0x0, 0x0, "NULL") # Can not read
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_ReadReceivedData("RH850.dummy_master", 0x0)
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x1, iodef.REG_HAGEODAT, 0x0, 0x0, 0x0, "NULL") # Can not write
SCHEAP.sc_start (50)
SCHEAP.DummyMasterRvc_IssueTransaction("RH850.dummy_master", 0x0, iodef.REG_HAGEODAT, 0x4, 0xFFFFFFFF, 0x0, 0x0)
SCHEAP.sc_start (50)
