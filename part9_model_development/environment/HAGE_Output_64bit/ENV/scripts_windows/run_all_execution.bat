...
REM ****** User settings ******
set Model_List=kcprot,cflash_e2_fcc2,icache_e2_fcc2,dflash,pram,cram_e2_fcc2,dmadts,lram_e2_fcc2
set Product_List=u2b2x,u2b10,u2b6,all_product,e2x_u2a,1632,64128
