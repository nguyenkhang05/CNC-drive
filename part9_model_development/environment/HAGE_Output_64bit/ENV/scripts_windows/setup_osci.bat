...
set SCHEAP_PYTHON_HOME=C:\Python2.7.3_w10_msvc140
REM Renesas network
set RLM_LICENSE=5053@licedu3
REM B2B
REM set RLM_LICENSE=52293@172.29.138.155

:: OSCI
set OSCI_HOME=C:\systemc-2.3.1a_MOD_vc140_64bit
...
:: USK
set OSCAR_HOME=C:\Program Files\VLAB Works\VLAB 2.5.16 (vc140)
...
:: common (for only OSCI as of now)
set SYSTEMC_INCPATH=%OSCI_INC_DIR%
set SYSTEMC_LIBPATH=%OSCI_LIB_DIR%
set TLM_INC_DIR=%OSCI_TLM_DIR%
set PATH=%PATH%;%SCHEAP_HOME%\scheapCompile\lib;%SCHEAP_HOME%\scheapCompile\lib\osci-win-vc140-x64;%SYSTEMC_LIBPATH%
