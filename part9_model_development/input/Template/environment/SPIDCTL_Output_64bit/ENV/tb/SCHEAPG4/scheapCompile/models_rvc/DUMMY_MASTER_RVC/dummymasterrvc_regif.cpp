...
/// @return none
Cdummymasterrvc_regif::Cdummymasterrvc_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    CTRL_REG       = new vpcl::re_register(0x0000, this, "CTRL_REG"      , name.c_str());
    DEBUG_MODE_REG = new vpcl::re_register(0x0004, this, "DEBUG_MODE_REG", name.c_str());
    EXT_REG        = new vpcl::re_register(0x0008, this, "EXT_REG"       , name.c_str());
    ADDR_REG       = new vpcl::re_register(0x000C, this, "ADDR_REG"      , name.c_str());
    SIZE_REG       = new vpcl::re_register(0x0010, this, "SIZE_REG"      , name.c_str());
    CMD_REG        = new vpcl::re_register(0x0014, this, "CMD_REG"       , name.c_str());
    WR_DATA_REG    = new vpcl::re_register(0x0018, this, "WR_DATA_REG"   , name.c_str());
    RD_DATA_REG    = new vpcl::re_register(0x001C, this, "RD_DATA_REG"   , name.c_str());
    WR_DATA_REG_0  = new vpcl::re_register(0x0020, this, "WR_DATA_REG_0" , name.c_str());
    WR_DATA_REG_1  = new vpcl::re_register(0x0024, this, "WR_DATA_REG_1" , name.c_str());
    RD_DATA_REG_0  = new vpcl::re_register(0x0028, this, "RD_DATA_REG_0" , name.c_str());
    RD_DATA_REG_1  = new vpcl::re_register(0x002C, this, "RD_DATA_REG_1" , name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_CTRL_REG        , CTRL_REG->name()      , CTRL_REG->addr()      );
    cw_instantiate_reg(CW_DEBUG_MODE_REG  , DEBUG_MODE_REG->name(), DEBUG_MODE_REG->addr());
    cw_instantiate_reg(CW_EXT_REG         , EXT_REG->name()       , EXT_REG->addr()       );
    cw_instantiate_reg(CW_ADDR_REG        , ADDR_REG->name()      , ADDR_REG->addr()      );
    cw_instantiate_reg(CW_SIZE_REG        , SIZE_REG->name()      , SIZE_REG->addr()      );
    cw_instantiate_reg(CW_CMD_REG         , CMD_REG->name()       , CMD_REG->addr()       );
    cw_instantiate_reg(CW_WR_DATA_REG     , WR_DATA_REG->name()   , WR_DATA_REG->addr()   );
    cw_instantiate_reg(CW_RD_DATA_REG     , RD_DATA_REG->name()   , RD_DATA_REG->addr()   );
    cw_instantiate_reg(CW_WR_DATA_REG_0   , WR_DATA_REG_0->name() , WR_DATA_REG_0->addr() );
    cw_instantiate_reg(CW_WR_DATA_REG_1   , WR_DATA_REG_1->name() , WR_DATA_REG_1->addr() );
    cw_instantiate_reg(CW_RD_DATA_REG_0   , RD_DATA_REG_0->name() , RD_DATA_REG_0->addr() );
    cw_instantiate_reg(CW_RD_DATA_REG_1   , RD_DATA_REG_1->name() , RD_DATA_REG_1->addr() );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(CTRL_REG        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(DEBUG_MODE_REG  , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(EXT_REG         , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(ADDR_REG        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(SIZE_REG        , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(CMD_REG         , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(WR_DATA_REG     , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RD_DATA_REG     , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(WR_DATA_REG_0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(WR_DATA_REG_1   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RD_DATA_REG_0   , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(RD_DATA_REG_1   , mCurReg, 0,  4,      "32", "8|16|32");

    mRegList = mCurReg;

    (*CTRL_REG        ) (15,  0, "CTRL"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*DEBUG_MODE_REG  ) ( 0,  0, "DEBUG"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (31, 31, "SEC"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (30, 30, "SPCLD"   , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (29, 24, "TCID"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (18, 16, "VCID"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (14, 14, "UM"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (13, 13, "VM"      , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) (12,  8, "SPID"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*EXT_REG         ) ( 7,  0, "PEID"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*ADDR_REG        ) (31,  0, "ADDR"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*SIZE_REG        ) ( 7,  0, "SIZE"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*CMD_REG         ) ( 0,  0, "COMMAND" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*WR_DATA_REG     ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RD_DATA_REG     ) (31,  0, "DATA"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*WR_DATA_REG_0   ) (31,  0, "DATA_0"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*WR_DATA_REG_1   ) (31,  0, "DATA_1"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RD_DATA_REG_0   ) (31,  0, "DATA_0"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*RD_DATA_REG_1   ) (31,  0, "DATA_1"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["CTRL_REG"    ]["CTRL"        ] = &Cdummymasterrvc_regif::cb_CTRL_REG_CTRL;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Cdummymasterrvc_regif::~Cdummymasterrvc_regif()
{
...
Cdummymasterrvc_regif::uint Cdummymasterrvc_regif::bit_select(
...
bool Cdummymasterrvc_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Cdummymasterrvc_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdummymasterrvc_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                                       const unsigned char *p_data,   ///< [in] Writing data
                                       cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdummymasterrvc_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                                       unsigned char *p_data,   ///< [out] Reading data
                                       cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Cdummymasterrvc_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                           const unsigned char *p_data,  ///< [in] Writing data
                                           cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Cdummymasterrvc_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                           unsigned char *p_data,   ///< [out] Reading data
                                           cuint size,              ///< [in]  Data size (byte)
                                           bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Cdummymasterrvc_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                                        unsigned char *p_data,          ///< [out] Reading data
                                        cuint size,                     ///< [in]  Data size (byte)
...
bool Cdummymasterrvc_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                                        const unsigned char *p_data,      ///< [in] Writing data
                                        cuint size,                       ///< [in] Data size (byte)
                                        cuint reg_index,                  ///< [in] Register index
...
bool Cdummymasterrvc_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return none
void Cdummymasterrvc_regif::CommandInit()
{
...
/// @return string
std::string Cdummymasterrvc_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Cdummymasterrvc_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
/// @return none
void Cdummymasterrvc_regif::InitLocalVal()
{
    // Initialize local variables
    CTRL_REG_CTRL  = 0x0;
    DEBUG_MODE_REG_DEBUG = 0x0;
    EXT_REG_SEC    = 0x0;
    EXT_REG_SPCLD  = 0x0;
    EXT_REG_TCID   = 0x0;
    EXT_REG_VCID   = 0x0;
    ...
    SIZE_REG_SIZE  = 0x0;
    CMD_REG_COMMAND = 0x0;
    WR_DATA_REG_DATA = 0x0;
    RD_DATA_REG_DATA = 0x0;
    WR_DATA_REG_0_DATA_0 = 0x0;
    WR_DATA_REG_1_DATA_1 = 0x0;
    RD_DATA_REG_0_DATA_0 = 0x0;
    RD_DATA_REG_1_DATA_1 = 0x0;
}

/// Update bit value to local value
/// @return None
void Cdummymasterrvc_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        CTRL_REG_CTRL                      = (*CTRL_REG      )["CTRL"          ];
        return;
    }
    if (addr == 0x0004) {
        DEBUG_MODE_REG_DEBUG               = (*DEBUG_MODE_REG)["DEBUG"         ];
        return;
    }
    if (addr == 0x0008) {
        EXT_REG_SEC                        = (*EXT_REG       )["SEC"           ];
        EXT_REG_SPCLD                      = (*EXT_REG       )["SPCLD"         ];
        EXT_REG_TCID                       = (*EXT_REG       )["TCID"          ];
        EXT_REG_VCID                       = (*EXT_REG       )["VCID"          ];
        EXT_REG_UM                         = (*EXT_REG       )["UM"            ];
        EXT_REG_VM                         = (*EXT_REG       )["VM"            ];
        EXT_REG_SPID                       = (*EXT_REG       )["SPID"          ];
        EXT_REG_PEID                       = (*EXT_REG       )["PEID"          ];
        return;
    }
    if (addr == 0x000C) {
    ...
    if (addr == 0x0010) {
        SIZE_REG_SIZE                      = (*SIZE_REG      )["SIZE"          ];
        return;
    }
    if (addr == 0x0014) {
        CMD_REG_COMMAND                    = (*CMD_REG       )["COMMAND"       ];
        return;
    }
    if (addr == 0x0018) {
        WR_DATA_REG_DATA                   = (*WR_DATA_REG   )["DATA"          ];
        return;
    }
    if (addr == 0x001C) {
        RD_DATA_REG_DATA                   = (*RD_DATA_REG   )["DATA"          ];
        return;
    }
    if (addr == 0x0020) {
        WR_DATA_REG_0_DATA_0               = (*WR_DATA_REG_0 )["DATA_0"        ];
        return;
    }
    if (addr == 0x0024) {
        WR_DATA_REG_1_DATA_1               = (*WR_DATA_REG_1 )["DATA_1"        ];
        return;
    }
    if (addr == 0x0028) {
        RD_DATA_REG_0_DATA_0               = (*RD_DATA_REG_0 )["DATA_0"        ];
        return;
    }
    if (addr == 0x002C) {
        RD_DATA_REG_1_DATA_1               = (*RD_DATA_REG_1 )["DATA_1"        ];
        return;
    }
}
...
/// @return None
void Cdummymasterrvc_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*CTRL_REG      )["CTRL"          ] = CTRL_REG_CTRL;
        return;
    }
    if (addr == 0x0004) {
        (*DEBUG_MODE_REG)["DEBUG"         ] = DEBUG_MODE_REG_DEBUG;
        return;
    }
    if (addr == 0x0008) {
        (*EXT_REG       )["SEC"           ] = EXT_REG_SEC;
        (*EXT_REG       )["SPCLD"         ] = EXT_REG_SPCLD;
        (*EXT_REG       )["TCID"          ] = EXT_REG_TCID;
        (*EXT_REG       )["VCID"          ] = EXT_REG_VCID;
        (*EXT_REG       )["UM"            ] = EXT_REG_UM;
        (*EXT_REG       )["VM"            ] = EXT_REG_VM;
        (*EXT_REG       )["SPID"          ] = EXT_REG_SPID;
        (*EXT_REG       )["PEID"          ] = EXT_REG_PEID;
        return;
    }
    if (addr == 0x000C) {
        (*ADDR_REG      )["ADDR"          ] = ADDR_REG_ADDR;
        return;
    }
    if (addr == 0x0010) {
        (*SIZE_REG      )["SIZE"          ] = SIZE_REG_SIZE;
        return;
    }
    if (addr == 0x0014) {
        (*CMD_REG       )["COMMAND"       ] = CMD_REG_COMMAND;
        return;
    }
    if (addr == 0x0018) {
        (*WR_DATA_REG   )["DATA"          ] = WR_DATA_REG_DATA;
        return;
    }
    if (addr == 0x001C) {
        (*RD_DATA_REG   )["DATA"          ] = RD_DATA_REG_DATA;
        return;
    }
    if (addr == 0x0020) {
        (*WR_DATA_REG_0 )["DATA_0"        ] = WR_DATA_REG_0_DATA_0;
        return;
    }
    if (addr == 0x0024) {
        (*WR_DATA_REG_1 )["DATA_1"        ] = WR_DATA_REG_1_DATA_1;
        return;
    }
    if (addr == 0x0028) {
        (*RD_DATA_REG_0 )["DATA_0"        ] = RD_DATA_REG_0_DATA_0;
        return;
    }
    if (addr == 0x002C) {
        (*RD_DATA_REG_1 )["DATA_1"        ] = RD_DATA_REG_1_DATA_1;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Cdummymasterrvc_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Cdummymasterrvc_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Cdummymasterrvc_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Cdummymasterrvc_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Cdummymasterrvc_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Cdummymasterrvc_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Cdummymasterrvc_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Cdummymasterrvc_regif::uint Cdummymasterrvc_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Cdummymasterrvc_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Cdummymasterrvc_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Cdummymasterrvc_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Cdummymasterrvc_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Cdummymasterrvc_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Cdummymasterrvc_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Cdummymasterrvc_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
