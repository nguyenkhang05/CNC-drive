// -----------------------------------------------------------------------------
// $Id: spidctl_regif.cpp,v 1.3 2021/11/18 07:22:52 minhquocha Exp $
//
...
// Ref: {SPIDCTL_UD_ATT1_001, SPIDCTL_UD_ATT1_002}
    ...
    #endif
{
    ...
    index = 0;
#ifdef USR_CWR_SYSTEMC
    for(uint i = 0; i < emNUM_BMSPID       ; i++) mCurReg = mRegArray[index++] = new SRegList(BMSPID         [i], mCurReg, i,  4, "8|16|32", "8|16|32", false, &cwmem);
#else
    ...
    for(uint i = 0; i < emNUM_BMSPID; i++) {
        (*BMSPID         [i]) ( 4,  0, "SPID"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    }
    for(uint i = 0; i < emNUM_BMSPIDMSKLOCK; i++) {
    ...
    mNotifyRegValueIDAPI = &Cspidctl_regif::NotifyRegValueID;
    #endif
}
...
Cspidctl_regif::uint Cspidctl_regif::bit_select(cuint val,    ///< [in] Writting address
...
/// Write the value to requested module register
// Ref: {SPIDCTL_UD_Direction_032, SPIDCTL_UD_Direction_022, SPIDCTL_UD_Direction_017}
/// @return true if writing transaction is finished normally
...
/// Read the register value of requested module
// Ref: {SPIDCTL_UD_Direction_021, SPIDCTL_UD_Direction_017}
/// @return true if reading transaction is finished normally
...
// Ref: {SPIDCTL_UD_Direction_031, SPIDCTL_UD_Direction_033}
...
/// Check access size
// Ref: {SPIDCTL_UD_Direction_016}
/// @@return true if detect_size equal expect_size
bool Cspidctl_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr, bool is_wr)
{
...
// Ref: {SPIDCTL_UD_Direction_019, SPIDCTL_UD_Direction_020, SPIDCTL_UD_Direction_049}
/// @return string
...
/// @return none
void Cspidctl_regif::InitializeRegValueID()
{//{{{
...
/// @return none
void Cspidctl_regif::CalcTargetRegVal(void)
{//{{{
...
/// @return none
void Cspidctl_regif::IssueRegValueID(void)
{//{{{
...
std::string Cspidctl_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip, bool is_wr_data, uint acc_size)
{
    std::ostringstream str_tmp;
...
void Cspidctl_regif::cw_set_all_callback_reg(void)
{
