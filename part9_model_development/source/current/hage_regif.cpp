...
/// @return none
Chage_regif::Chage_regif(std::string name, uint buswidth)
    :vpcl::reg_super()
    #ifdef CWR_SYSTEMC
...
{
    CommandInit();
    HAGECR     = new vpcl::re_register(0x0000, this, "HAGECR"    , name.c_str());
    HAGESEED   = new vpcl::re_register(0x0004, this, "HAGESEED"  , name.c_str());
    HAGEIDAT   = new vpcl::re_register(0x0008, this, "HAGEIDAT"  , name.c_str());
    HAGEODAT   = new vpcl::re_register(0x000C, this, "HAGEODAT"  , name.c_str());
    HAGESRCADD = new vpcl::re_register(0x0010, this, "HAGESRCADD", name.c_str());
    HAGEDSTADD = new vpcl::re_register(0x0014, this, "HAGEDSTADD", name.c_str());
    HAGEDL     = new vpcl::re_register(0x0018, this, "HAGEDL"    , name.c_str());
    ...
    index = 0;
    #ifdef CWR_SYSTEMC
    cw_instantiate_reg(CW_HAGECR      , HAGECR->name()    , HAGECR->addr()    );
    cw_instantiate_reg(CW_HAGESEED    , HAGESEED->name()  , HAGESEED->addr()  );
    cw_instantiate_reg(CW_HAGEIDAT    , HAGEIDAT->name()  , HAGEIDAT->addr()  );
    cw_instantiate_reg(CW_HAGEODAT    , HAGEODAT->name()  , HAGEODAT->addr()  );
    cw_instantiate_reg(CW_HAGESRCADD  , HAGESRCADD->name(), HAGESRCADD->addr());
    cw_instantiate_reg(CW_HAGEDSTADD  , HAGEDSTADD->name(), HAGEDSTADD->addr());
    cw_instantiate_reg(CW_HAGEDL      , HAGEDL->name()    , HAGEDL->addr()    );
    #endif
    mCurReg = mRegArray[index++] = new SRegList(HAGECR      , mCurReg, 0,  4,      "32", "8|16|32");
    mCurReg = mRegArray[index++] = new SRegList(HAGESEED    , mCurReg, 0,  4,      "32",      "32");
    mCurReg = mRegArray[index++] = new SRegList(HAGEIDAT    , mCurReg, 0,  4,      "32",      "32");
    mCurReg = mRegArray[index++] = new SRegList(HAGEODAT    , mCurReg, 0,  4,      "32",      "32");
    mCurReg = mRegArray[index++] = new SRegList(HAGESRCADD  , mCurReg, 0,  4,      "32",      "32");
    mCurReg = mRegArray[index++] = new SRegList(HAGEDSTADD  , mCurReg, 0,  4,      "32",      "32");
    mCurReg = mRegArray[index++] = new SRegList(HAGEDL      , mCurReg, 0,  4,      "32",      "32");

    mRegList = mCurReg;

    (*HAGECR      ) (24, 24, "DMASTR"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGECR      ) (17, 16, "PLL"     , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGECR      ) ( 8,  8, "EINT_MSK", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGECR      ) ( 2,  2, "HASHOUT" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGECR      ) ( 1,  1, "MODSEL"  , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGECR      ) ( 0,  0, "NEW_SEED", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGESEED    ) (31,  0, "SEED"    , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGEIDAT    ) (31,  0, "DATA_IN" , 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGEODAT    ) (31,  0, "DATA_OUT", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGESRCADD  ) (31,  2, "SRC_ADDR", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGEDSTADD  ) (31,  2, "DST_ADDR", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    (*HAGEDL      ) (31,  0, "DATA_LEN", 0x0       , "R|W"   , vpcl::SPP_ENABLE);
    ...
    mWrCbAPI["HAGECR"  ]["DMASTR"  ] = &Chage_regif::cb_HAGECR_DMASTR;
    mWrCbAPI["HAGECR"  ]["PLL"     ] = &Chage_regif::cb_HAGECR_PLL;
    mWrCbAPI["HAGECR"  ]["EINT_MSK"] = &Chage_regif::cb_HAGECR_EINT_MSK;
    mWrCbAPI["HAGECR"  ]["HASHOUT" ] = &Chage_regif::cb_HAGECR_HASHOUT;
    mWrCbAPI["HAGECR"  ]["MODSEL"  ] = &Chage_regif::cb_HAGECR_MODSEL;
    mWrCbAPI["HAGECR"  ]["NEW_SEED"] = &Chage_regif::cb_HAGECR_NEW_SEED;
    mWrCbAPI["HAGESEED"]["SEED"    ] = &Chage_regif::cb_HAGESEED_SEED;
    mWrCbAPI["HAGEIDAT"]["DATA_IN" ] = &Chage_regif::cb_HAGEIDAT_DATA_IN;
    mWrCbAPI["HAGEODAT"]["DATA_OUT"] = &Chage_regif::cb_HAGEODAT_DATA_OUT;
    mWrCbAPI["HAGESRCADD"]["SRC_ADDR"] = &Chage_regif::cb_HAGESRCADD_SRC_ADDR;
    mWrCbAPI["HAGEDSTADD"]["DST_ADDR"] = &Chage_regif::cb_HAGEDSTADD_DST_ADDR;

    mRdCbAPI["HAGECR"  ]["DMASTR"  ] = &Chage_regif::cb_HAGECR_DMASTR;
    mRdCbAPI["HAGECR"  ]["PLL"     ] = &Chage_regif::cb_HAGECR_PLL;
    mRdCbAPI["HAGECR"  ]["EINT_MSK"] = &Chage_regif::cb_HAGECR_EINT_MSK;
    mRdCbAPI["HAGECR"  ]["HASHOUT" ] = &Chage_regif::cb_HAGECR_HASHOUT;
    mRdCbAPI["HAGECR"  ]["MODSEL"  ] = &Chage_regif::cb_HAGECR_MODSEL;
    mRdCbAPI["HAGECR"  ]["NEW_SEED"] = &Chage_regif::cb_HAGECR_NEW_SEED;
    mRdCbAPI["HAGESEED"]["SEED"    ] = &Chage_regif::cb_HAGESEED_SEED;
    mRdCbAPI["HAGEIDAT"]["DATA_IN" ] = &Chage_regif::cb_HAGEIDAT_DATA_IN;
    mRdCbAPI["HAGEODAT"]["DATA_OUT"] = &Chage_regif::cb_HAGEODAT_DATA_OUT;
    mRdCbAPI["HAGESRCADD"]["SRC_ADDR"] = &Chage_regif::cb_HAGESRCADD_SRC_ADDR;
    mRdCbAPI["HAGEDSTADD"]["DST_ADDR"] = &Chage_regif::cb_HAGEDSTADD_DST_ADDR;
    mRdCbAPI["HAGEDL"  ]["DATA_LEN"] = &Chage_regif::cb_HAGEDL_DATA_LEN;
    InitLocalVal();
}

/// Destructor: delete pointers
/// @return none
Chage_regif::~Chage_regif()
{
...
Chage_regif::uint Chage_regif::bit_select(
...
bool Chage_regif::reg_wr(cuint addr,                    ///< [in] Writting address
...
bool Chage_regif::reg_rd(cuint addr,              ///< [in]  Reading address
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chage_regif::reg_wr_dbg(cuint addr,                    ///< [in] Writting address
                             const unsigned char *p_data,   ///< [in] Writing data
                             cuint size)                    ///< [in] Data size (byte)
{
    if(size == 0) return false;
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chage_regif::reg_rd_dbg(cuint addr,              ///< [in]  Reading address
                             unsigned char *p_data,   ///< [out] Reading data
                             cuint size)              ///< [in]  Data size (byte)
{
    if(size == 0) return false;
...
/// Write the value to requested module register
/// @return true if writing transaction is finished normally
bool Chage_regif::reg_wr_process(cuint addr,                   ///< [in] Writting address
                                 const unsigned char *p_data,  ///< [in] Writing data
                                 cuint size,                   ///< [in] Data size (byte)
...
/// Read the register value of requested module
/// @return true if reading transaction is finished normally
bool Chage_regif::reg_rd_process(cuint addr,              ///< [in]  Reading address
                                 unsigned char *p_data,   ///< [out] Reading data
                                 cuint size,              ///< [in]  Data size (byte)
                                 bool IsDbgFunc)          ///< [in] flag indicate reg_rd or reg_rd_dbg
{
...
bool Chage_regif::reg_rd_func(cuint addr,                     ///< [in]  Reading address
                              unsigned char *p_data,          ///< [out] Reading data
                              cuint size,                     ///< [in]  Data size (byte)
...
bool Chage_regif::reg_wr_func(cuint addr,                       ///< [in] Writting address
                              const unsigned char *p_data,      ///< [in] Writing data
                              cuint size,                       ///< [in] Data size (byte)
                              cuint reg_index,                  ///< [in] Register index
...
bool Chage_regif::ChkSize(std::string expect_size, cuint detect_size, cuint addr)
{
...
/// @return string
std::string Chage_regif::reg_handle_command(const std::vector<std::string>& args)
{
    std::string ret = "";
...
/// @return string
std::string Chage_regif::AccessRegCommand(const std::vector<std::string>& args, vpcl::re_register *Register, bool &BlockReg)
{
    std::string ret = "";
    char *err_p = NULL;
    std::string err_msg = "Error ("   + mInstName + ") ";   // error message
...
void Chage_regif::InitLocalVal()
{
    ...
    HAGECR_NEW_SEED = 0x0;
    HAGESEED_SEED = 0x0;
    HAGEIDAT_DATA_IN = 0x0;
    HAGEODAT_DATA_OUT = 0x0;
    HAGESRCADD_SRC_ADDR = 0x0;
    HAGEDSTADD_DST_ADDR = 0x0;
    HAGEDL_DATA_LEN = 0x0;
}

/// Update bit value to local value
/// @return None
void Chage_regif::UpdateLocalVal(cuint addr)
{
    if (addr == 0x0000) {
        HAGECR_DMASTR                  = (*HAGECR    )["DMASTR"    ];
        HAGECR_PLL                     = (*HAGECR    )["PLL"       ];
        HAGECR_EINT_MSK                = (*HAGECR    )["EINT_MSK"  ];
        HAGECR_HASHOUT                 = (*HAGECR    )["HASHOUT"   ];
        HAGECR_MODSEL                  = (*HAGECR    )["MODSEL"    ];
        HAGECR_NEW_SEED                = (*HAGECR    )["NEW_SEED"  ];
        return;
    }
    if (addr == 0x0004) {
        HAGESEED_SEED                  = (*HAGESEED  )["SEED"      ];
        return;
    }
    if (addr == 0x0008) {
        HAGEIDAT_DATA_IN               = (*HAGEIDAT  )["DATA_IN"   ];
        return;
    }
    if (addr == 0x000C) {
        HAGEODAT_DATA_OUT              = (*HAGEODAT  )["DATA_OUT"  ];
        return;
    }
    if (addr == 0x0010) {
        HAGESRCADD_SRC_ADDR            = (*HAGESRCADD)["SRC_ADDR"  ];
        return;
    }
    if (addr == 0x0014) {
        HAGEDSTADD_DST_ADDR            = (*HAGEDSTADD)["DST_ADDR"  ];
        return;
    }
    if (addr == 0x0018) {
        HAGEDL_DATA_LEN                = (*HAGEDL    )["DATA_LEN"  ];
        return;
    }
}
...
/// @return None
void Chage_regif::UpdateRegVal(cuint addr)
{
    if (addr == 0x0000) {
        (*HAGECR    )["DMASTR"    ] = HAGECR_DMASTR;
        (*HAGECR    )["PLL"       ] = HAGECR_PLL;
        (*HAGECR    )["EINT_MSK"  ] = HAGECR_EINT_MSK;
        (*HAGECR    )["HASHOUT"   ] = HAGECR_HASHOUT;
        (*HAGECR    )["MODSEL"    ] = HAGECR_MODSEL;
        (*HAGECR    )["NEW_SEED"  ] = HAGECR_NEW_SEED;
        return;
    }
    if (addr == 0x0004) {
        (*HAGESEED  )["SEED"      ] = HAGESEED_SEED;
        return;
    }
    if (addr == 0x0008) {
        (*HAGEIDAT  )["DATA_IN"   ] = HAGEIDAT_DATA_IN;
        return;
    }
    if (addr == 0x000C) {
        (*HAGEODAT  )["DATA_OUT"  ] = HAGEODAT_DATA_OUT;
        return;
    }
    if (addr == 0x0010) {
        (*HAGESRCADD)["SRC_ADDR"  ] = HAGESRCADD_SRC_ADDR;
        return;
    }
    if (addr == 0x0014) {
        (*HAGEDSTADD)["DST_ADDR"  ] = HAGEDSTADD_DST_ADDR;
        return;
    }
    if (addr == 0x0018) {
        (*HAGEDL    )["DATA_LEN"  ] = HAGEDL_DATA_LEN;
        return;
    }
}
...
/// @return vector
std::vector<std::string> Chage_regif::Str2Vec(std::string str, const char sep)
{
...
std::string Chage_regif::Num2HexStr(cuint num, cuint num_length, bool space_strip)
{
    std::ostringstream str_tmp;
...
/// @return none
void Chage_regif::DumpRegMsg(const std::string operation, const std::string RegName, const std::string BitName, cuint size, cuint addr, cuint wr_data, cuint pre_data, cuint data, cuint reg_length)
{
...
int Chage_regif::get_reg_index(cuint access_addr)
{
...
vpcl::re_register *Chage_regif::first_reg_object()
{
    mCurReg = mRegList;
    return mCurReg->my_p;
}
...
vpcl::re_register *Chage_regif::next_reg_object()
{
    if (mCurReg != NULL) {
...
/// @return none
void Chage_regif::wr_cb(cuint addr, uint data)
{
    #ifdef CWR_SYSTEMC
...
/// @return read data
Chage_regif::uint Chage_regif::rd_cb(cuint addr)
{
    #ifdef CWR_SYSTEMC
...
/// @return none
void Chage_regif::_re_printf(std::string group, const char *message, ...)
{
    // message group check
    if (group == "DumpRegMsg") {
        group = "info";
...
/// @return none
void Chage_regif::get_fileline(std::string filename, int line_number)
{
    mFileName = filename;
...
/// @return none
void Chage_regif::set_instance_name(std::string InstName)
{
    mInstName = InstName;
}
...
/// @return none
void Chage_regif::EnableReset(const bool is_active)
{
...
#ifdef CWR_SYSTEMC
uint Chage_regif::cw_rd_cb(tlm::tlm_generic_payload& trans, int tag)
{
...
uint Chage_regif::cw_wr_cb(tlm::tlm_generic_payload& trans, int tag)
{
    unsigned char* ptr = (unsigned char*)trans.get_data_ptr();
    reg_wr_dbg((cuint)tag, ptr, sizeof(uint));
    return sizeof(uint);
}
void Chage_regif::cw_instantiate_reg(scml2::reg<uint> * reg, std::string reg_name, int offset)
{
